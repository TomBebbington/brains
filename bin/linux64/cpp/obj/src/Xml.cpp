...
{
HX_STACK_FRAME("Xml","new","Xml.new","Xml.hx",41)
{
}
;
	return null();
...
HX_STACK_FRAME("Xml","__init__","Xml.__init__","Xml.hx",403)
{
	HX_STACK_LINE(404)
...
{
		HX_STACK_FRAME("Xml","addChild","Xml.addChild","Xml.hx",322)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(323)
...
::Xml Xml_obj::firstElement( ){
	HX_STACK_FRAME("Xml","firstElement","Xml.firstElement","Xml.hx",311)
	HX_STACK_THIS(this)
	HX_STACK_LINE(312)
	if (((this->_children == null()))){
		HX_STACK_LINE(313)
...
Dynamic Xml_obj::elements( ){
	HX_STACK_FRAME("Xml","elements","Xml.elements","Xml.hx",238)
	HX_STACK_THIS(this)
	HX_STACK_LINE(239)
	if (((this->_children == null()))){
		HX_STACK_LINE(240)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Array< ::Dynamic > &children){
			HX_STACK_FRAME("*","closure","*.closure","Xml.hx",242)
			{
				...
				bool run(){
					HX_STACK_FRAME("*","_Function_2_1","*._Function_2_1","Xml.hx",244)
				...
				::Xml run(){
					HX_STACK_FRAME("*","_Function_2_2","*._Function_2_2","Xml.hx",255)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(256)
						int k = __this->__Field(HX_CSTRING("cur"),true);		HX_STACK_VAR(k,"k");
...
bool Xml_obj::exists( ::String att){
	HX_STACK_FRAME("Xml","exists","Xml.exists","Xml.hx",219)
	HX_STACK_THIS(this)
...
::String Xml_obj::get( ::String att){
	HX_STACK_FRAME("Xml","get","Xml.get","Xml.hx",197)
	HX_STACK_THIS(this)
	HX_STACK_ARG(att,"att")
	HX_STACK_LINE(198)
	if (((this->nodeType != ::Xml_obj::Element))){
...
::Xml Xml_obj::parse( ::String str){
	HX_STACK_FRAME("Xml","parse","Xml.parse","Xml.hx",46)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::Xml &x){
			HX_STACK_FRAME("*","closure","*.closure","Xml.hx",49)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				...
				Void run(::String name,Dynamic att){
					HX_STACK_FRAME("*","_Function_2_1","*._Function_2_1","Xml.hx",51)
					HX_STACK_THIS(__this.mPtr)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_2","*._Function_2_2","Xml.hx",64)
					HX_STACK_THIS(__this.mPtr)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_3","*._Function_2_3","Xml.hx",71)
					HX_STACK_THIS(__this.mPtr)
					HX_STACK_ARG(text,"text")
					{
						HX_STACK_LINE(72)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_4","*._Function_2_4","Xml.hx",78)
					HX_STACK_THIS(__this.mPtr)
					HX_STACK_ARG(text,"text")
					{
						HX_STACK_LINE(79)
				...
				Void run(::String text){
					HX_STACK_FRAME("*","_Function_2_5","*._Function_2_5","Xml.hx",92)
					HX_STACK_THIS(__this.mPtr)
					HX_STACK_ARG(text,"text")
					{
						HX_STACK_LINE(93)
				...
				Void run(){
					HX_STACK_FRAME("*","_Function_2_6","*._Function_2_6","Xml.hx",101)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(101)
