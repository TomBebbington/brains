...
{
HX_STACK_FRAME("Debug","new","Debug.new","nape/util/Debug.hx",179)
{
	HX_STACK_LINE(1259)
...
Float radius = __o_radius.Default(3.0);
	HX_STACK_FRAME("Debug","drawSpring","Debug.drawSpring","nape/util/Debug.hx",1423)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Debug","drawFilledPolygon","Debug.drawFilledPolygon","nape/util/Debug.hx",1409)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Debug","drawPolygon","Debug.drawPolygon","nape/util/Debug.hx",1395)
		HX_STACK_THIS(this)
		HX_STACK_ARG(polygon,"polygon")
		HX_STACK_ARG(colour,"colour")
	}
...
{
		HX_STACK_FRAME("Debug","drawFilledCircle","Debug.drawFilledCircle","nape/util/Debug.hx",1381)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Debug","drawFilledTriangle","Debug.drawFilledTriangle","nape/util/Debug.hx",1368)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p0,"p0")
		HX_STACK_ARG(p1,"p1")
		HX_STACK_ARG(p2,"p2")
...
{
		HX_STACK_FRAME("Debug","drawAABB","Debug.drawAABB","nape/util/Debug.hx",1356)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Debug","drawCircle","Debug.drawCircle","nape/util/Debug.hx",1346)
		HX_STACK_THIS(this)
		HX_STACK_ARG(position,"position")
		HX_STACK_ARG(radius,"radius")
		HX_STACK_ARG(colour,"colour")
...
{
		HX_STACK_FRAME("Debug","drawCurve","Debug.drawCurve","nape/util/Debug.hx",1333)
		HX_STACK_THIS(this)
		HX_STACK_ARG(start,"start")
...
{
		HX_STACK_FRAME("Debug","drawLine","Debug.drawLine","nape/util/Debug.hx",1321)
		HX_STACK_THIS(this)
		HX_STACK_ARG(start,"start")
		HX_STACK_ARG(end,"end")
		HX_STACK_ARG(colour,"colour")
...
{
		HX_STACK_FRAME("Debug","draw","Debug.draw","nape/util/Debug.hx",1310)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Debug","flush","Debug.flush","nape/util/Debug.hx",1295)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("Debug","clear","Debug.clear","nape/util/Debug.hx",1289)
		HX_STACK_THIS(this)
	}
return null();
}
...
::nape::geom::Mat23 Debug_obj::set_transform( ::nape::geom::Mat23 transform){
	HX_STACK_FRAME("Debug","set_transform","Debug.set_transform","nape/util/Debug.hx",1277)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(1278)
	{
		...
		struct _Function_2_1{
			inline static ::nape::geom::Mat23 Block( ::nape::util::Debug_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1282)
				{
					HX_STACK_LINE(1282)
...
::nape::geom::Mat23 Debug_obj::get_transform( ){
	HX_STACK_FRAME("Debug","get_transform","Debug.get_transform","nape/util/Debug.hx",1273)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1274)
	if (((this->zpp_inner->xform == null()))){
		HX_STACK_LINE(1274)
...
::flash::display::DisplayObject Debug_obj::get_display( ){
	HX_STACK_FRAME("Debug","get_display","Debug.get_display","nape/util/Debug.hx",1244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1244)
...
int Debug_obj::set_bgColour( int bgColour){
	HX_STACK_FRAME("Debug","set_bgColour","Debug.set_bgColour","nape/util/Debug.hx",1194)
	HX_STACK_THIS(this)
...
int Debug_obj::get_bgColour( ){
	HX_STACK_FRAME("Debug","get_bgColour","Debug.get_bgColour","nape/util/Debug.hx",1192)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1192)
	return this->zpp_inner->bg_col;
}
...
::String Debug_obj::version( ){
	HX_STACK_FRAME("Debug","version","Debug.version","nape/util/Debug.hx",184)
	HX_STACK_LINE(184)
...
{
		HX_STACK_FRAME("Debug","clearObjectPools","Debug.clearObjectPools","nape/util/Debug.hx",189)
		HX_STACK_LINE(192)
...
::flash::display::Shape Debug_obj::createGraphic( ::nape::phys::Body body){
	HX_STACK_FRAME("Debug","createGraphic","Debug.createGraphic","nape/util/Debug.hx",1091)
	...
	HX_STACK_LINE(1095)
	::flash::display::Shape ret = ::flash::display::Shape_obj::__new();		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(1096)
	::flash::display::Graphics graphics = ret->get_graphics();		HX_STACK_VAR(graphics,"graphics");
	HX_STACK_LINE(1097)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::nape::phys::Body &body){
			HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1103)
			{
				HX_STACK_LINE(1103)
	...
	for(::cpp::FastIterator_obj< ::nape::shape::Shape > *__it = ::cpp::CreateFastIterator< ::nape::shape::Shape >(_Function_1_1::Block(body));  __it->hasNext(); ){
		::nape::shape::Shape s = __it->next();
		{
			...
			if (((s->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_CIRCLE))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::shape::Circle &c){
						HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1106)
						{
							HX_STACK_LINE(1106)
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::shape::Shape &s){
						HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1110)
						{
							HX_STACK_LINE(1110)
							::nape::geom::Vec2 _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(1110)
					...
					while(((_g1 < _g2))){
						...
						struct _Function_5_1{
							inline static ::nape::geom::Vec2List Block( ::nape::shape::Polygon &p){
								HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1112)
								{
									HX_STACK_LINE(1112)
						...
						struct _Function_5_2{
							inline static Float Block( ::nape::geom::Vec2 &px){
								HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1113)
								{
									HX_STACK_LINE(1113)
				...
				struct _Function_3_3{
					inline static ::nape::geom::Vec2List Block( ::nape::shape::Polygon &p){
						HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1115)
						{
							HX_STACK_LINE(1115)
							if (((p->zpp_inner_zn->wrap_lverts == null()))){
								HX_STACK_LINE(1115)
				...
				struct _Function_3_4{
					inline static Float Block( ::nape::geom::Vec2 &px){
						HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1116)
						{
							HX_STACK_LINE(1116)
							if (((bool((px != null())) && bool(px->zpp_disp)))){
								HX_STACK_LINE(1116)
			...
			if (((s->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_CIRCLE))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::shape::Circle &c){
						HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1120)
						{
							HX_STACK_LINE(1120)
							::nape::geom::Vec2 _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(1120)
				...
				struct _Function_3_3{
					inline static Float Block( ::nape::shape::Circle &c){
						HX_STACK_FRAME("*","closure","*.closure","nape/util/Debug.hx",1121)
						{
							HX_STACK_LINE(1121)
							::nape::geom::Vec2 _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(1121)
