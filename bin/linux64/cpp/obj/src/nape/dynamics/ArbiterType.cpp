...
{
HX_STACK_FRAME("ArbiterType","new","ArbiterType.new","nape/dynamics/ArbiterType.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("ArbiterType")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String ArbiterType_obj::toString( ){
	HX_STACK_FRAME("ArbiterType","toString","ArbiterType.toString","nape/dynamics/ArbiterType.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::dynamics::ArbiterType Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ArbiterType.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::dynamics::ArbiterType Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ArbiterType.hx",193)
				{
					HX_STACK_LINE(193)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::dynamics::ArbiterType Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ArbiterType.hx",194)
					{
						HX_STACK_LINE(194)
...
::nape::dynamics::ArbiterType ArbiterType_obj::get_COLLISION( ){
	HX_STACK_FRAME("ArbiterType","get_COLLISION","ArbiterType.get_COLLISION","nape/dynamics/ArbiterType.hx",202)
	HX_STACK_LINE(203)
	if (((::zpp_nape::util::ZPP_Flags_obj::ArbiterType_COLLISION == null()))){
		HX_STACK_LINE(204)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::dynamics::ArbiterType ArbiterType_obj::get_SENSOR( ){
	HX_STACK_FRAME("ArbiterType","get_SENSOR","ArbiterType.get_SENSOR","nape/dynamics/ArbiterType.hx",215)
	HX_STACK_LINE(216)
	if (((::zpp_nape::util::ZPP_Flags_obj::ArbiterType_SENSOR == null()))){
		HX_STACK_LINE(217)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::dynamics::ArbiterType ArbiterType_obj::get_FLUID( ){
	HX_STACK_FRAME("ArbiterType","get_FLUID","ArbiterType.get_FLUID","nape/dynamics/ArbiterType.hx",228)
	HX_STACK_LINE(229)
	if (((::zpp_nape::util::ZPP_Flags_obj::ArbiterType_FLUID == null()))){
		HX_STACK_LINE(230)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
