...
{
HX_STACK_FRAME("InteractionGroupList","new","InteractionGroupList.new","nape/dynamics/InteractionGroupList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	this->zpp_inner = ::zpp_nape::util::ZPP_InteractionGroupList_obj::__new();
	HX_STACK_LINE(697)
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("InteractionGroupList","filter","InteractionGroupList.filter","nape/dynamics/InteractionGroupList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("InteractionGroupList","foreach","InteractionGroupList.foreach","nape/dynamics/InteractionGroupList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::dynamics::InteractionGroupIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",737)
			{
				HX_STACK_LINE(737)
	...
	while((_Function_1_1::Block(it))){
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::dynamics::InteractionGroup Block( ::nape::dynamics::InteractionGroupIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String InteractionGroupList_obj::toString( ){
	HX_STACK_FRAME("InteractionGroupList","toString","InteractionGroupList.toString","nape/dynamics/InteractionGroupList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::dynamics::InteractionGroupIterator Block( ::nape::dynamics::InteractionGroupList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
				return ::nape::dynamics::InteractionGroupIterator_obj::get(__this);
			}
			return null();
		}
	};
	HX_STACK_LINE(705)
	for(::cpp::FastIterator_obj< ::nape::dynamics::InteractionGroup > *__it = ::cpp::CreateFastIterator< ::nape::dynamics::InteractionGroup >(_Function_1_1::Block(this));  __it->hasNext(); ){
		::nape::dynamics::InteractionGroup i = __it->next();
		{
			HX_STACK_LINE(706)
			if ((!(fst))){
				HX_STACK_LINE(706)
...
{
		HX_STACK_FRAME("InteractionGroupList","merge","InteractionGroupList.merge","nape/dynamics/InteractionGroupList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::dynamics::InteractionGroupIterator Block( ::nape::dynamics::InteractionGroupList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
					return ::nape::dynamics::InteractionGroupIterator_obj::get(xs);
				}
				return null();
			}
		};
		HX_STACK_LINE(688)
		for(::cpp::FastIterator_obj< ::nape::dynamics::InteractionGroup > *__it = ::cpp::CreateFastIterator< ::nape::dynamics::InteractionGroup >(_Function_1_1::Block(xs));  __it->hasNext(); ){
			::nape::dynamics::InteractionGroup x = __it->next();
			if ((!(this->has(x)))){
				HX_STACK_LINE(689)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("InteractionGroupList","copy","InteractionGroupList.copy","nape/dynamics/InteractionGroupList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::dynamics::InteractionGroupIterator Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::dynamics::InteractionGroup Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",664)
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("InteractionGroup")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
		...
		for(::cpp::FastIterator_obj< ::nape::dynamics::InteractionGroup > *__it = ::cpp::CreateFastIterator< ::nape::dynamics::InteractionGroup >(_Function_1_1::Block(this));  __it->hasNext(); ){
			::nape::dynamics::InteractionGroup i = __it->next();
			ret->push((  ((deep)) ? ::nape::dynamics::InteractionGroup(_Function_1_2::Block()) : ::nape::dynamics::InteractionGroup(i) ));
		}
		HX_STACK_LINE(671)
		return ret;
	}
...
::nape::dynamics::InteractionGroupIterator InteractionGroupList_obj::iterator( ){
	HX_STACK_FRAME("InteractionGroupList","iterator","InteractionGroupList.iterator","nape/dynamics/InteractionGroupList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool InteractionGroupList_obj::empty( ){
	HX_STACK_FRAME("InteractionGroupList","empty","InteractionGroupList.empty","nape/dynamics/InteractionGroupList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("InteractionGroupList","clear","InteractionGroupList.clear","nape/dynamics/InteractionGroupList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("InteractionGroup")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool InteractionGroupList_obj::remove( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_FRAME("InteractionGroupList","remove","InteractionGroupList.remove","nape/dynamics/InteractionGroupList.hx",576)
	HX_STACK_THIS(this)
...
bool InteractionGroupList_obj::add( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_FRAME("InteractionGroupList","add","InteractionGroupList.add","nape/dynamics/InteractionGroupList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::shift( ){
	HX_STACK_FRAME("InteractionGroupList","shift","InteractionGroupList.shift","nape/dynamics/InteractionGroupList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::pop( ){
	HX_STACK_FRAME("InteractionGroupList","pop","InteractionGroupList.pop","nape/dynamics/InteractionGroupList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool InteractionGroupList_obj::unshift( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_FRAME("InteractionGroupList","unshift","InteractionGroupList.unshift","nape/dynamics/InteractionGroupList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool InteractionGroupList_obj::push( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_FRAME("InteractionGroupList","push","InteractionGroupList.push","nape/dynamics/InteractionGroupList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::at( int index){
	HX_STACK_FRAME("InteractionGroupList","at","InteractionGroupList.at","nape/dynamics/InteractionGroupList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/InteractionGroupList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool InteractionGroupList_obj::has( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_FRAME("InteractionGroupList","has","InteractionGroupList.has","nape/dynamics/InteractionGroupList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int InteractionGroupList_obj::get_length( ){
	HX_STACK_FRAME("InteractionGroupList","get_length","InteractionGroupList.get_length","nape/dynamics/InteractionGroupList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("InteractionGroupList","fromArray","InteractionGroupList.fromArray","nape/dynamics/InteractionGroupList.hx",304)
