...
{
HX_STACK_FRAME("CollisionArbiter","new","CollisionArbiter.new","nape/dynamics/CollisionArbiter.hx",728)
{
	HX_STACK_LINE(730)
...
Float CollisionArbiter_obj::set_rollingFriction( Float rollingFriction){
	HX_STACK_FRAME("CollisionArbiter","set_rollingFriction","CollisionArbiter.set_rollingFriction","nape/dynamics/CollisionArbiter.hx",709)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(710)
	{
		...
		if ((!(this->zpp_inner->colarb->_mutable))){
			HX_STACK_LINE(712)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("rollingFriction")) + HX_CSTRING(" is only mutable during a pre-handler")));
		}
		HX_STACK_LINE(715)
		if (((rollingFriction != rollingFriction))){
			HX_STACK_LINE(715)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("rollingFriction")) + HX_CSTRING(" cannot be NaN")));
		}
		HX_STACK_LINE(716)
		if (((rollingFriction < (int)0))){
			HX_STACK_LINE(716)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("rollingFriction")) + HX_CSTRING(" cannot be negative")));
		}
		HX_STACK_LINE(719)
...
Float CollisionArbiter_obj::get_rollingFriction( ){
	HX_STACK_FRAME("CollisionArbiter","get_rollingFriction","CollisionArbiter.get_rollingFriction","nape/dynamics/CollisionArbiter.hx",701)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(703)
...
Float CollisionArbiter_obj::set_staticFriction( Float staticFriction){
	HX_STACK_FRAME("CollisionArbiter","set_staticFriction","CollisionArbiter.set_staticFriction","nape/dynamics/CollisionArbiter.hx",674)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(675)
	{
		...
		if ((!(this->zpp_inner->colarb->_mutable))){
			HX_STACK_LINE(677)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("staticFriction")) + HX_CSTRING(" is only mutable during a pre-handler")));
		}
		HX_STACK_LINE(680)
		if (((staticFriction != staticFriction))){
			HX_STACK_LINE(680)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("staticFriction")) + HX_CSTRING(" cannot be NaN")));
		}
		HX_STACK_LINE(681)
		if (((staticFriction < (int)0))){
			HX_STACK_LINE(681)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("staticFriction")) + HX_CSTRING(" cannot be negative")));
		}
		HX_STACK_LINE(684)
		::zpp_nape::dynamics::ZPP_ColArbiter colarb = this->zpp_inner->colarb;		HX_STACK_VAR(colarb,"colarb");
		HX_STACK_LINE(685)
...
Float CollisionArbiter_obj::get_staticFriction( ){
	HX_STACK_FRAME("CollisionArbiter","get_staticFriction","CollisionArbiter.get_staticFriction","nape/dynamics/CollisionArbiter.hx",666)
	HX_STACK_THIS(this)
	HX_STACK_LINE(668)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(668)
...
Float CollisionArbiter_obj::set_dynamicFriction( Float dynamicFriction){
	HX_STACK_FRAME("CollisionArbiter","set_dynamicFriction","CollisionArbiter.set_dynamicFriction","nape/dynamics/CollisionArbiter.hx",639)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(640)
	{
		...
		if ((!(this->zpp_inner->colarb->_mutable))){
			HX_STACK_LINE(642)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("dynamicFriction")) + HX_CSTRING(" is only mutable during a pre-handler")));
		}
		HX_STACK_LINE(645)
		if (((dynamicFriction != dynamicFriction))){
			HX_STACK_LINE(645)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("dynamicFriction")) + HX_CSTRING(" cannot be NaN")));
		}
		HX_STACK_LINE(646)
		if (((dynamicFriction < (int)0))){
			HX_STACK_LINE(646)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("dynamicFriction")) + HX_CSTRING(" cannot be negative")));
		}
		HX_STACK_LINE(649)
		::zpp_nape::dynamics::ZPP_ColArbiter colarb = this->zpp_inner->colarb;		HX_STACK_VAR(colarb,"colarb");
		HX_STACK_LINE(650)
...
Float CollisionArbiter_obj::get_dynamicFriction( ){
	HX_STACK_FRAME("CollisionArbiter","get_dynamicFriction","CollisionArbiter.get_dynamicFriction","nape/dynamics/CollisionArbiter.hx",631)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(633)
...
Float CollisionArbiter_obj::set_elasticity( Float elasticity){
	HX_STACK_FRAME("CollisionArbiter","set_elasticity","CollisionArbiter.set_elasticity","nape/dynamics/CollisionArbiter.hx",604)
	HX_STACK_THIS(this)
	...
	HX_STACK_LINE(605)
	{
		...
		if ((!(this->zpp_inner->colarb->_mutable))){
			HX_STACK_LINE(607)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("elasticity")) + HX_CSTRING(" is only mutable during a pre-handler")));
		}
		HX_STACK_LINE(610)
		if (((elasticity != elasticity))){
			HX_STACK_LINE(610)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("elasticity")) + HX_CSTRING(" cannot be NaN")));
		}
		HX_STACK_LINE(611)
		if (((elasticity < (int)0))){
			HX_STACK_LINE(611)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: CollisionArbiter::") + HX_CSTRING("elasticity")) + HX_CSTRING(" cannot be negative")));
		}
		HX_STACK_LINE(614)
		::zpp_nape::dynamics::ZPP_ColArbiter colarb = this->zpp_inner->colarb;		HX_STACK_VAR(colarb,"colarb");
		HX_STACK_LINE(615)
...
Float CollisionArbiter_obj::get_elasticity( ){
	HX_STACK_FRAME("CollisionArbiter","get_elasticity","CollisionArbiter.get_elasticity","nape/dynamics/CollisionArbiter.hx",596)
	HX_STACK_THIS(this)
	HX_STACK_LINE(598)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(598)
...
bool freshOnly = __o_freshOnly.Default(false);
	HX_STACK_FRAME("CollisionArbiter","rollingImpulse","CollisionArbiter.rollingImpulse","nape/dynamics/CollisionArbiter.hx",573)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(freshOnly,"freshOnly")
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::Body Block( ::nape::dynamics::CollisionArbiter_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",578)
				{
					HX_STACK_LINE(578)
...
bool freshOnly = __o_freshOnly.Default(false);
	HX_STACK_FRAME("CollisionArbiter","totalImpulse","CollisionArbiter.totalImpulse","nape/dynamics/CollisionArbiter.hx",485)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body,"body")
	HX_STACK_ARG(freshOnly,"freshOnly")
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::Body Block( ::nape::dynamics::CollisionArbiter_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",490)
				{
					HX_STACK_LINE(490)
					if ((!(__this->zpp_inner->active))){
						HX_STACK_LINE(490)
		...
		if (((bool(!(freshOnly)) || bool(colarb->oc1->fresh)))){
			...
			HX_STACK_LINE(515)
			{
				...
				HX_STACK_LINE(517)
				{
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",527)
							{
								HX_STACK_LINE(527)
					...
					struct _Function_4_2{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",528)
							{
								HX_STACK_LINE(528)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(528)
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec3 &imp){
						HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",530)
						{
							HX_STACK_LINE(530)
							if (((bool((imp != null())) && bool(imp->zpp_disp)))){
								HX_STACK_LINE(530)
				...
				HX_STACK_LINE(538)
				{
					...
					HX_STACK_LINE(540)
					{
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",550)
								{
									HX_STACK_LINE(550)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(550)
						...
						struct _Function_5_2{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",551)
								{
									HX_STACK_LINE(551)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(551)
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",553)
							{
								HX_STACK_LINE(553)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(553)
...
bool freshOnly = __o_freshOnly.Default(false);
	HX_STACK_FRAME("CollisionArbiter","tangentImpulse","CollisionArbiter.tangentImpulse","nape/dynamics/CollisionArbiter.hx",394)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body,"body")
	HX_STACK_ARG(freshOnly,"freshOnly")
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::Body Block( ::nape::dynamics::CollisionArbiter_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",399)
				{
					HX_STACK_LINE(399)
					if ((!(__this->zpp_inner->active))){
						HX_STACK_LINE(399)
		...
		if (((bool(!(freshOnly)) || bool(colarb->oc1->fresh)))){
			...
			HX_STACK_LINE(424)
			{
				...
				HX_STACK_LINE(426)
				{
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",436)
							{
								HX_STACK_LINE(436)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(436)
					...
					struct _Function_4_2{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",437)
							{
								HX_STACK_LINE(437)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(437)
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec3 &imp){
						HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",439)
						{
							HX_STACK_LINE(439)
							if (((bool((imp != null())) && bool(imp->zpp_disp)))){
								HX_STACK_LINE(439)
			...
			if (((bool(!(freshOnly)) || bool(colarb->oc2->fresh)))){
				...
				HX_STACK_LINE(447)
				{
					...
					HX_STACK_LINE(449)
					{
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",459)
								{
									HX_STACK_LINE(459)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(459)
						...
						struct _Function_5_2{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",460)
								{
									HX_STACK_LINE(460)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(460)
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",462)
							{
								HX_STACK_LINE(462)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(462)
...
bool freshOnly = __o_freshOnly.Default(false);
	HX_STACK_FRAME("CollisionArbiter","normalImpulse","CollisionArbiter.normalImpulse","nape/dynamics/CollisionArbiter.hx",300)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body,"body")
	HX_STACK_ARG(freshOnly,"freshOnly")
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::Body Block( ::nape::dynamics::CollisionArbiter_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",305)
				{
					HX_STACK_LINE(305)
					if ((!(__this->zpp_inner->active))){
						HX_STACK_LINE(305)
		...
		if (((bool(!(freshOnly)) || bool(colarb->oc1->fresh)))){
			...
			HX_STACK_LINE(330)
			{
				...
				HX_STACK_LINE(332)
				{
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",342)
							{
								HX_STACK_LINE(342)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(342)
					...
					struct _Function_4_2{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",343)
							{
								HX_STACK_LINE(343)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(343)
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec3 &imp){
						HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",345)
						{
							HX_STACK_LINE(345)
							if (((bool((imp != null())) && bool(imp->zpp_disp)))){
								HX_STACK_LINE(345)
			...
			if (((bool(!(freshOnly)) || bool(colarb->oc2->fresh)))){
				...
				HX_STACK_LINE(353)
				{
					...
					HX_STACK_LINE(355)
					{
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",365)
								{
									HX_STACK_LINE(365)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(365)
						...
						struct _Function_5_2{
							inline static Float Block( ::nape::geom::Vec3 &imp){
								HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",366)
								{
									HX_STACK_LINE(366)
									if (((bool((imp != null())) && bool(imp->zpp_disp)))){
										HX_STACK_LINE(366)
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec3 &imp){
							HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",368)
							{
								HX_STACK_LINE(368)
								if (((bool((imp != null())) && bool(imp->zpp_disp)))){
									HX_STACK_LINE(368)
...
bool CollisionArbiter_obj::secondVertex( ){
	HX_STACK_FRAME("CollisionArbiter","secondVertex","CollisionArbiter.secondVertex","nape/dynamics/CollisionArbiter.hx",276)
	HX_STACK_THIS(this)
	HX_STACK_LINE(278)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(278)
...
bool CollisionArbiter_obj::firstVertex( ){
	HX_STACK_FRAME("CollisionArbiter","firstVertex","CollisionArbiter.firstVertex","nape/dynamics/CollisionArbiter.hx",257)
	HX_STACK_THIS(this)
	HX_STACK_LINE(259)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(259)
...
::nape::shape::Edge CollisionArbiter_obj::get_referenceEdge2( ){
	HX_STACK_FRAME("CollisionArbiter","get_referenceEdge2","CollisionArbiter.get_referenceEdge2","nape/dynamics/CollisionArbiter.hx",239)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(241)
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::dynamics::CollisionArbiter_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",244)
			{
				HX_STACK_LINE(244)
	...
	HX_STACK_LINE(244)
	if (((bool((edge != null())) && bool(((bool(!(_Function_1_1::Block(this))) || bool(((_Function_1_2::Block(this))->zpp_inner != edge->polygon)))))))){
		HX_STACK_LINE(244)
...
::nape::shape::Edge CollisionArbiter_obj::get_referenceEdge1( ){
	HX_STACK_FRAME("CollisionArbiter","get_referenceEdge1","CollisionArbiter.get_referenceEdge1","nape/dynamics/CollisionArbiter.hx",225)
	HX_STACK_THIS(this)
	HX_STACK_LINE(227)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(227)
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::dynamics::CollisionArbiter_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/CollisionArbiter.hx",230)
			{
				HX_STACK_LINE(230)
				::nape::shape::Shape _this;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(230)
...
Float CollisionArbiter_obj::get_radius( ){
	HX_STACK_FRAME("CollisionArbiter","get_radius","CollisionArbiter.get_radius","nape/dynamics/CollisionArbiter.hx",213)
	HX_STACK_THIS(this)
	HX_STACK_LINE(215)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(215)
...
::nape::geom::Vec2 CollisionArbiter_obj::get_normal( ){
	HX_STACK_FRAME("CollisionArbiter","get_normal","CollisionArbiter.get_normal","nape/dynamics/CollisionArbiter.hx",199)
	HX_STACK_THIS(this)
	HX_STACK_LINE(201)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(201)
...
::nape::dynamics::ContactList CollisionArbiter_obj::get_contacts( ){
	HX_STACK_FRAME("CollisionArbiter","get_contacts","CollisionArbiter.get_contacts","nape/dynamics/CollisionArbiter.hx",183)
	HX_STACK_THIS(this)
	HX_STACK_LINE(185)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(185)
