...
{
HX_STACK_FRAME("ContactIterator","new","ContactIterator.new","nape/dynamics/ContactIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_ContactList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Contact")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::dynamics::Contact ContactIterator_obj::next( ){
	HX_STACK_FRAME("ContactIterator","next","ContactIterator.next","nape/dynamics/ContactIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool ContactIterator_obj::hasNext( ){
	HX_STACK_FRAME("ContactIterator","hasNext","ContactIterator.hasNext","nape/dynamics/ContactIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::dynamics::ContactIterator ContactIterator_obj::get( ::nape::dynamics::ContactList list){
	HX_STACK_FRAME("ContactIterator","get","ContactIterator.get","nape/dynamics/ContactIterator.hx",217)
