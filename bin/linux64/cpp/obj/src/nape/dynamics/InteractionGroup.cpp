...
{
HX_STACK_FRAME("InteractionGroup","new","InteractionGroup.new","nape/dynamics/InteractionGroup.hx",218)
...
::String InteractionGroup_obj::toString( ){
	HX_STACK_FRAME("InteractionGroup","toString","InteractionGroup.toString","nape/dynamics/InteractionGroup.hx",299)
	HX_STACK_THIS(this)
	HX_STACK_LINE(300)
...
::nape::dynamics::InteractionGroupList InteractionGroup_obj::get_groups( ){
	HX_STACK_FRAME("InteractionGroup","get_groups","InteractionGroup.get_groups","nape/dynamics/InteractionGroup.hx",282)
	HX_STACK_THIS(this)
	HX_STACK_LINE(283)
...
::nape::phys::InteractorList InteractionGroup_obj::get_interactors( ){
	HX_STACK_FRAME("InteractionGroup","get_interactors","InteractionGroup.get_interactors","nape/dynamics/InteractionGroup.hx",268)
	HX_STACK_THIS(this)
	HX_STACK_LINE(269)
...
bool InteractionGroup_obj::set_ignore( bool ignore){
	HX_STACK_FRAME("InteractionGroup","set_ignore","InteractionGroup.set_ignore","nape/dynamics/InteractionGroup.hx",250)
	HX_STACK_THIS(this)
...
bool InteractionGroup_obj::get_ignore( ){
	HX_STACK_FRAME("InteractionGroup","get_ignore","InteractionGroup.get_ignore","nape/dynamics/InteractionGroup.hx",248)
	HX_STACK_THIS(this)
	HX_STACK_LINE(248)
	return this->zpp_inner->ignore;
}
...
::nape::dynamics::InteractionGroup InteractionGroup_obj::set_group( ::nape::dynamics::InteractionGroup group){
	HX_STACK_FRAME("InteractionGroup","set_group","InteractionGroup.set_group","nape/dynamics/InteractionGroup.hx",232)
	HX_STACK_THIS(this)
...
::nape::dynamics::InteractionGroup InteractionGroup_obj::get_group( ){
	HX_STACK_FRAME("InteractionGroup","get_group","InteractionGroup.get_group","nape/dynamics/InteractionGroup.hx",230)
	HX_STACK_THIS(this)
	HX_STACK_LINE(230)
	if (((this->zpp_inner->group == null()))){
		HX_STACK_LINE(230)
