...
{
HX_STACK_FRAME("ContactList","new","ContactList.new","nape/dynamics/ContactList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::dynamics::ContactList ContactList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("ContactList","filter","ContactList.filter","nape/dynamics/ContactList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::ContactList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::dynamics::ContactList ContactList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("ContactList","foreach","ContactList.foreach","nape/dynamics/ContactList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::dynamics::ContactIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",737)
			{
				HX_STACK_LINE(737)
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::dynamics::Contact Block( ::nape::dynamics::ContactIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String ContactList_obj::toString( ){
	HX_STACK_FRAME("ContactList","toString","ContactList.toString","nape/dynamics/ContactList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::dynamics::ContactIterator Block( ::nape::dynamics::ContactList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_FRAME("ContactList","merge","ContactList.merge","nape/dynamics/ContactList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::dynamics::ContactIterator Block( ::nape::dynamics::ContactList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("ContactList","copy","ContactList.copy","nape/dynamics/ContactList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::dynamics::ContactIterator Block( ::nape::dynamics::ContactList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::dynamics::Contact Block( ){
				...
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Contact")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::dynamics::ContactIterator ContactList_obj::iterator( ){
	HX_STACK_FRAME("ContactList","iterator","ContactList.iterator","nape/dynamics/ContactList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool ContactList_obj::empty( ){
	HX_STACK_FRAME("ContactList","empty","ContactList.empty","nape/dynamics/ContactList.hx",632)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::ContactList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",632)
			{
				HX_STACK_LINE(632)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(632)
...
{
		HX_STACK_FRAME("ContactList","clear","ContactList.clear","nape/dynamics/ContactList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Contact")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			struct _Function_2_1{
				inline static int Block( ::nape::dynamics::ContactList_obj *__this){
					HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",619)
					{
						HX_STACK_LINE(619)
						__this->zpp_inner->valmod();
						HX_STACK_LINE(619)
			...
			struct _Function_2_1{
				inline static int Block( ::nape::dynamics::ContactList_obj *__this){
					HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",622)
					{
						HX_STACK_LINE(622)
						__this->zpp_inner->valmod();
						HX_STACK_LINE(622)
...
bool ContactList_obj::remove( ::nape::dynamics::Contact obj){
	HX_STACK_FRAME("ContactList","remove","ContactList.remove","nape/dynamics/ContactList.hx",576)
	HX_STACK_THIS(this)
...
bool ContactList_obj::add( ::nape::dynamics::Contact obj){
	HX_STACK_FRAME("ContactList","add","ContactList.add","nape/dynamics/ContactList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::dynamics::Contact ContactList_obj::shift( ){
	HX_STACK_FRAME("ContactList","shift","ContactList.shift","nape/dynamics/ContactList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::ContactList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",525)
			{
				HX_STACK_LINE(525)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(525)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::ContactList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::dynamics::Contact ContactList_obj::pop( ){
	HX_STACK_FRAME("ContactList","pop","ContactList.pop","nape/dynamics/ContactList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::ContactList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",484)
			{
				HX_STACK_LINE(484)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(484)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::ContactList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool ContactList_obj::unshift( ::nape::dynamics::Contact obj){
	HX_STACK_FRAME("ContactList","unshift","ContactList.unshift","nape/dynamics/ContactList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::dynamics::ContactList_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",458)
						{
							HX_STACK_LINE(458)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(458)
...
bool ContactList_obj::push( ::nape::dynamics::Contact obj){
	HX_STACK_FRAME("ContactList","push","ContactList.push","nape/dynamics/ContactList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::dynamics::ContactList_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",428)
						{
							HX_STACK_LINE(428)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(428)
...
::nape::dynamics::Contact ContactList_obj::at( int index){
	HX_STACK_FRAME("ContactList","at","ContactList.at","nape/dynamics/ContactList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::ContactList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::ContactList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ContactList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool ContactList_obj::has( ::nape::dynamics::Contact obj){
	HX_STACK_FRAME("ContactList","has","ContactList.has","nape/dynamics/ContactList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int ContactList_obj::get_length( ){
	HX_STACK_FRAME("ContactList","get_length","ContactList.get_length","nape/dynamics/ContactList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::dynamics::ContactList ContactList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("ContactList","fromArray","ContactList.fromArray","nape/dynamics/ContactList.hx",304)
