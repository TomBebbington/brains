...
{
HX_STACK_FRAME("ArbiterIterator","new","ArbiterIterator.new","nape/dynamics/ArbiterIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_ArbiterList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Arbiter")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::dynamics::Arbiter ArbiterIterator_obj::next( ){
	HX_STACK_FRAME("ArbiterIterator","next","ArbiterIterator.next","nape/dynamics/ArbiterIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool ArbiterIterator_obj::hasNext( ){
	HX_STACK_FRAME("ArbiterIterator","hasNext","ArbiterIterator.hasNext","nape/dynamics/ArbiterIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::dynamics::ArbiterIterator ArbiterIterator_obj::get( ::nape::dynamics::ArbiterList list){
	HX_STACK_FRAME("ArbiterIterator","get","ArbiterIterator.get","nape/dynamics/ArbiterIterator.hx",217)
