...
{
HX_STACK_FRAME("ArbiterList","new","ArbiterList.new","nape/dynamics/ArbiterList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::dynamics::ArbiterList ArbiterList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("ArbiterList","filter","ArbiterList.filter","nape/dynamics/ArbiterList.hx",779)
	HX_STACK_THIS(this)
...
::nape::dynamics::ArbiterList ArbiterList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("ArbiterList","foreach","ArbiterList.foreach","nape/dynamics/ArbiterList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::dynamics::ArbiterIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ArbiterList.hx",737)
			{
				HX_STACK_LINE(737)
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::dynamics::Arbiter Block( ::nape::dynamics::ArbiterIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ArbiterList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String ArbiterList_obj::toString( ){
	HX_STACK_FRAME("ArbiterList","toString","ArbiterList.toString","nape/dynamics/ArbiterList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
...
{
		HX_STACK_FRAME("ArbiterList","merge","ArbiterList.merge","nape/dynamics/ArbiterList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("ArbiterList","copy","ArbiterList.copy","nape/dynamics/ArbiterList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::dynamics::Arbiter Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/ArbiterList.hx",664)
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Arbiter")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::dynamics::ArbiterIterator ArbiterList_obj::iterator( ){
	HX_STACK_FRAME("ArbiterList","iterator","ArbiterList.iterator","nape/dynamics/ArbiterList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(649)
	this->zpp_vm();
	HX_STACK_LINE(651)
...
bool ArbiterList_obj::empty( ){
	HX_STACK_FRAME("ArbiterList","empty","ArbiterList.empty","nape/dynamics/ArbiterList.hx",634)
	HX_STACK_THIS(this)
	HX_STACK_LINE(634)
...
{
		HX_STACK_FRAME("ArbiterList","clear","ArbiterList.clear","nape/dynamics/ArbiterList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Arbiter")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
...
bool ArbiterList_obj::remove( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("ArbiterList","remove","ArbiterList.remove","nape/dynamics/ArbiterList.hx",576)
	HX_STACK_THIS(this)
...
bool ArbiterList_obj::add( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("ArbiterList","add","ArbiterList.add","nape/dynamics/ArbiterList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::dynamics::Arbiter ArbiterList_obj::shift( ){
	HX_STACK_FRAME("ArbiterList","shift","ArbiterList.shift","nape/dynamics/ArbiterList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		HX_STACK_LINE(533)
		if (((this->zpp_gl() == (int)1))){
			HX_STACK_LINE(533)
			ite = null();
		}
		else{
			HX_STACK_LINE(533)
			ite = this->zpp_inner->inner->iterator_at((this->zpp_gl() - (int)2));
		}
		HX_STACK_LINE(534)
		if (((ite == null()))){
			HX_STACK_LINE(534)
...
::nape::dynamics::Arbiter ArbiterList_obj::pop( ){
	HX_STACK_FRAME("ArbiterList","pop","ArbiterList.pop","nape/dynamics/ArbiterList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
...
bool ArbiterList_obj::unshift( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("ArbiterList","unshift","ArbiterList.unshift","nape/dynamics/ArbiterList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if ((this->empty())){
					...
					HX_STACK_LINE(458)
					this->zpp_inner->push_ite = this->zpp_inner->inner->iterator_at((this->zpp_gl() - (int)1));
				}
			}
			HX_STACK_LINE(459)
...
bool ArbiterList_obj::push( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("ArbiterList","push","ArbiterList.push","nape/dynamics/ArbiterList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
...
::nape::dynamics::Arbiter ArbiterList_obj::at( int index){
	HX_STACK_FRAME("ArbiterList","at","ArbiterList.at","nape/dynamics/ArbiterList.hx",363)
	HX_STACK_THIS(this)
...
bool ArbiterList_obj::has( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("ArbiterList","has","ArbiterList.has","nape/dynamics/ArbiterList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(348)
	this->zpp_vm();
...
{
		HX_STACK_FRAME("ArbiterList","zpp_vm","ArbiterList.zpp_vm","nape/dynamics/ArbiterList.hx",292)
		HX_STACK_THIS(this)
		HX_STACK_LINE(292)
...
int ArbiterList_obj::zpp_gl( ){
	HX_STACK_FRAME("ArbiterList","zpp_gl","ArbiterList.zpp_gl","nape/dynamics/ArbiterList.hx",269)
	HX_STACK_THIS(this)
	HX_STACK_LINE(270)
	this->zpp_inner->valmod();
	HX_STACK_LINE(271)
...
int ArbiterList_obj::get_length( ){
	HX_STACK_FRAME("ArbiterList","get_length","ArbiterList.get_length","nape/dynamics/ArbiterList.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(264)
	return this->zpp_gl();
}
...
::nape::dynamics::ArbiterList ArbiterList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("ArbiterList","fromArray","ArbiterList.fromArray","nape/dynamics/ArbiterList.hx",304)
