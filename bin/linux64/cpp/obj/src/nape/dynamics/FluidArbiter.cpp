...
{
HX_STACK_FRAME("FluidArbiter","new","FluidArbiter.new","nape/dynamics/FluidArbiter.hx",316)
{
	HX_STACK_LINE(318)
...
bool freshOnly = __o_freshOnly.Default(false);
	HX_STACK_FRAME("FluidArbiter","totalImpulse","FluidArbiter.totalImpulse","nape/dynamics/FluidArbiter.hx",298)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(freshOnly,"freshOnly")
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::Body Block( ::nape::dynamics::FluidArbiter_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/FluidArbiter.hx",303)
				{
					HX_STACK_LINE(303)
			...
			HX_STACK_LINE(307)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec3 &_g){
						HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/FluidArbiter.hx",307)
						{
							HX_STACK_LINE(307)
				...
				HX_STACK_LINE(307)
				x = (_Function_3_1::Block(_g) + _Function_3_2::Block(tmp));
				HX_STACK_LINE(307)
				{
					HX_STACK_LINE(307)
					if (((bool((_g != null())) && bool(_g->zpp_disp)))){
		...
		HX_STACK_LINE(308)
		{
			...
			HX_STACK_LINE(308)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec3 &_g){
						HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/FluidArbiter.hx",308)
						{
							HX_STACK_LINE(308)
							if (((bool((_g != null())) && bool(_g->zpp_disp)))){
								HX_STACK_LINE(308)
				...
				HX_STACK_LINE(308)
				y = (_Function_3_1::Block(_g) + _Function_3_2::Block(tmp));
				HX_STACK_LINE(308)
				{
					HX_STACK_LINE(308)
					if (((bool((_g != null())) && bool(_g->zpp_disp)))){
		...
		HX_STACK_LINE(309)
		{
			...
			HX_STACK_LINE(309)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec3 &_g){
						HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/FluidArbiter.hx",309)
						{
							HX_STACK_LINE(309)
							if (((bool((_g != null())) && bool(_g->zpp_disp)))){
								HX_STACK_LINE(309)
				...
				HX_STACK_LINE(309)
				z = (_Function_3_1::Block(_g) + _Function_3_2::Block(tmp));
				HX_STACK_LINE(309)
				{
					HX_STACK_LINE(309)
					if (((bool((_g != null())) && bool(_g->zpp_disp)))){
...
::nape::geom::Vec3 FluidArbiter_obj::dragImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("FluidArbiter","dragImpulse","FluidArbiter.dragImpulse","nape/dynamics/FluidArbiter.hx",275)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body,"body")
	HX_STACK_LINE(277)
	if ((!(this->zpp_inner->active))){
	...
	struct _Function_1_1{
		inline static ::nape::phys::Body Block( ::nape::dynamics::FluidArbiter_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/FluidArbiter.hx",280)
			{
				HX_STACK_LINE(280)
				if ((!(__this->zpp_inner->active))){
					HX_STACK_LINE(280)
...
::nape::geom::Vec3 FluidArbiter_obj::buoyancyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("FluidArbiter","buoyancyImpulse","FluidArbiter.buoyancyImpulse","nape/dynamics/FluidArbiter.hx",246)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body,"body")
	HX_STACK_LINE(248)
	if ((!(this->zpp_inner->active))){
	...
	struct _Function_1_1{
		inline static ::nape::phys::Body Block( ::nape::dynamics::FluidArbiter_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/FluidArbiter.hx",251)
			{
				HX_STACK_LINE(251)
				if ((!(__this->zpp_inner->active))){
					HX_STACK_LINE(251)
...
Float FluidArbiter_obj::set_overlap( Float overlap){
	HX_STACK_FRAME("FluidArbiter","set_overlap","FluidArbiter.set_overlap","nape/dynamics/FluidArbiter.hx",220)
	HX_STACK_THIS(this)
...
Float FluidArbiter_obj::get_overlap( ){
	HX_STACK_FRAME("FluidArbiter","get_overlap","FluidArbiter.get_overlap","nape/dynamics/FluidArbiter.hx",214)
	HX_STACK_THIS(this)
	HX_STACK_LINE(216)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(216)
...
::nape::geom::Vec2 FluidArbiter_obj::set_position( ::nape::geom::Vec2 position){
	HX_STACK_FRAME("FluidArbiter","set_position","FluidArbiter.set_position","nape/dynamics/FluidArbiter.hx",192)
	HX_STACK_THIS(this)
			...
			HX_STACK_LINE(200)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 _this){
						HX_STACK_FRAME("*","closure","*.closure","nape/dynamics/FluidArbiter.hx",200)
						{
							HX_STACK_LINE(200)
							if (((bool((_this != null())) && bool(_this->zpp_disp)))){
								HX_STACK_LINE(200)
...
::nape::geom::Vec2 FluidArbiter_obj::get_position( ){
	HX_STACK_FRAME("FluidArbiter","get_position","FluidArbiter.get_position","nape/dynamics/FluidArbiter.hx",185)
	HX_STACK_THIS(this)
	HX_STACK_LINE(187)
	if ((!(this->zpp_inner->active))){
		HX_STACK_LINE(187)
