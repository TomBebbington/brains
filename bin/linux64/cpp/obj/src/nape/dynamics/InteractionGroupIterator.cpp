...
{
HX_STACK_FRAME("InteractionGroupIterator","new","InteractionGroupIterator.new","nape/dynamics/InteractionGroupIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_InteractionGroupList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("InteractionGroup")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::dynamics::InteractionGroup InteractionGroupIterator_obj::next( ){
	HX_STACK_FRAME("InteractionGroupIterator","next","InteractionGroupIterator.next","nape/dynamics/InteractionGroupIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool InteractionGroupIterator_obj::hasNext( ){
	HX_STACK_FRAME("InteractionGroupIterator","hasNext","InteractionGroupIterator.hasNext","nape/dynamics/InteractionGroupIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::dynamics::InteractionGroupIterator InteractionGroupIterator_obj::get( ::nape::dynamics::InteractionGroupList list){
	HX_STACK_FRAME("InteractionGroupIterator","get","InteractionGroupIterator.get","nape/dynamics/InteractionGroupIterator.hx",217)
