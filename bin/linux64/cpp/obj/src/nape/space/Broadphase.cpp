...
{
HX_STACK_FRAME("Broadphase","new","Broadphase.new","nape/space/Broadphase.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Broadphase")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String Broadphase_obj::toString( ){
	HX_STACK_FRAME("Broadphase","toString","Broadphase.toString","nape/space/Broadphase.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::space::Broadphase Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/space/Broadphase.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::space::Broadphase Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/space/Broadphase.hx",193)
				{
					HX_STACK_LINE(193)
...
::nape::space::Broadphase Broadphase_obj::get_DYNAMIC_AABB_TREE( ){
	HX_STACK_FRAME("Broadphase","get_DYNAMIC_AABB_TREE","Broadphase.get_DYNAMIC_AABB_TREE","nape/space/Broadphase.hx",210)
	HX_STACK_LINE(211)
	if (((::zpp_nape::util::ZPP_Flags_obj::Broadphase_DYNAMIC_AABB_TREE == null()))){
		HX_STACK_LINE(212)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::space::Broadphase Broadphase_obj::get_SWEEP_AND_PRUNE( ){
	HX_STACK_FRAME("Broadphase","get_SWEEP_AND_PRUNE","Broadphase.get_SWEEP_AND_PRUNE","nape/space/Broadphase.hx",238)
	HX_STACK_LINE(239)
	if (((::zpp_nape::util::ZPP_Flags_obj::Broadphase_SWEEP_AND_PRUNE == null()))){
		HX_STACK_LINE(240)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
