...
{
HX_STACK_FRAME("EdgeIterator","new","EdgeIterator.new","nape/shape/EdgeIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_EdgeList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Edge")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::shape::Edge EdgeIterator_obj::next( ){
	HX_STACK_FRAME("EdgeIterator","next","EdgeIterator.next","nape/shape/EdgeIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool EdgeIterator_obj::hasNext( ){
	HX_STACK_FRAME("EdgeIterator","hasNext","EdgeIterator.hasNext","nape/shape/EdgeIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::shape::EdgeIterator EdgeIterator_obj::get( ::nape::shape::EdgeList list){
	HX_STACK_FRAME("EdgeIterator","get","EdgeIterator.get","nape/shape/EdgeIterator.hx",217)
