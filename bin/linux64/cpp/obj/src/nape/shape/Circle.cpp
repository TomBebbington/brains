...
{
HX_STACK_FRAME("Circle","new","Circle.new","nape/shape/Circle.hx",177)
...
Float Circle_obj::set_radius( Float radius){
	HX_STACK_FRAME("Circle","set_radius","Circle.set_radius","nape/shape/Circle.hx",321)
	HX_STACK_THIS(this)
	HX_STACK_ARG(radius,"radius")
	HX_STACK_LINE(322)
	{
...
Float Circle_obj::get_radius( ){
	HX_STACK_FRAME("Circle","get_radius","Circle.get_radius","nape/shape/Circle.hx",319)
	HX_STACK_THIS(this)
	HX_STACK_LINE(319)
	return this->zpp_inner_zn->radius;
}
