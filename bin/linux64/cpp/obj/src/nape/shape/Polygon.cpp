...
{
HX_STACK_FRAME("Polygon","new","Polygon.new","nape/shape/Polygon.hx",179)
			...
			while(((_g < lv->__Field(HX_CSTRING("length"),true)))){
				...
				struct _Function_4_1{
					inline static ::nape::geom::Vec2List Block( ::nape::shape::Polygon_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","nape/shape/Polygon.hx",366)
						{
							HX_STACK_LINE(366)
		...
		if ((::Std_obj::is(localVerts,hx::ClassOf< ::nape::geom::Vec2List >()))){
			...
			for(::cpp::FastIterator_obj< ::nape::geom::Vec2 > *__it = ::cpp::CreateFastIterator< ::nape::geom::Vec2 >(lv->iterator());  __it->hasNext(); ){
				::nape::geom::Vec2 x = __it->next();
				{
					...
					struct _Function_4_1{
						inline static ::nape::geom::Vec2List Block( ::nape::shape::Polygon_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/shape/Polygon.hx",396)
							{
								HX_STACK_LINE(396)
								if (((__this->zpp_inner_zn->wrap_lverts == null()))){
									HX_STACK_LINE(396)
				...
				if (((verts != null()))){
					...
					do{
						...
						HX_STACK_LINE(410)
						{
							...
							if (((ret->zpp_inner == null()))){
								...
								struct _Function_8_1{
									inline static Float Block( ::nape::geom::Vec2 &ret){
										HX_STACK_FRAME("*","closure","*.closure","nape/shape/Polygon.hx",410)
										{
											HX_STACK_LINE(410)
											if (((bool((ret != null())) && bool(ret->zpp_disp)))){
												HX_STACK_LINE(410)
								...
								HX_STACK_LINE(410)
								if ((!(((bool((_Function_8_1::Block(ret) == x1)) && bool((_Function_8_2::Block(ret) == y))))))){
									HX_STACK_LINE(410)
									{
										HX_STACK_LINE(410)
										ret->zpp_inner->x = x1;
						...
						struct _Function_6_1{
							inline static ::nape::geom::Vec2List Block( ::nape::shape::Polygon_obj *__this){
								HX_STACK_FRAME("*","closure","*.closure","nape/shape/Polygon.hx",412)
								{
									HX_STACK_LINE(412)
									if (((__this->zpp_inner_zn->wrap_lverts == null()))){
										HX_STACK_LINE(412)
						...
						HX_STACK_LINE(412)
						(_Function_6_1::Block(this))->push(_Function_6_2::Block(x));
						HX_STACK_LINE(413)
						{
							HX_STACK_LINE(413)
							if (((bool((x != null())) && bool(x->zpp_disp)))){
		...
		while(((i < lv->length))){
			...
			struct _Function_3_1{
				inline static bool Block( ::nape::geom::Vec2 &cur){
					HX_STACK_FRAME("*","closure","*.closure","nape/shape/Polygon.hx",433)
					{
						HX_STACK_LINE(434)
						{
							HX_STACK_LINE(434)
...
::nape::shape::ValidationResult Polygon_obj::validity( ){
	HX_STACK_FRAME("Polygon","validity","Polygon.validity","nape/shape/Polygon.hx",313)
	HX_STACK_THIS(this)
	HX_STACK_LINE(313)
...
::nape::shape::EdgeList Polygon_obj::get_edges( ){
	HX_STACK_FRAME("Polygon","get_edges","Polygon.get_edges","nape/shape/Polygon.hx",304)
	HX_STACK_THIS(this)
	HX_STACK_LINE(305)
...
::nape::geom::Vec2List Polygon_obj::get_worldVerts( ){
	HX_STACK_FRAME("Polygon","get_worldVerts","Polygon.get_worldVerts","nape/shape/Polygon.hx",293)
	HX_STACK_THIS(this)
	HX_STACK_LINE(294)
...
::nape::geom::Vec2List Polygon_obj::get_localVerts( ){
	HX_STACK_FRAME("Polygon","get_localVerts","Polygon.get_localVerts","nape/shape/Polygon.hx",279)
	HX_STACK_THIS(this)
	HX_STACK_LINE(280)
...
bool weak = __o_weak.Default(false);
	HX_STACK_FRAME("Polygon","rect","Polygon.rect","nape/shape/Polygon.hx",209)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( Float &y,bool &weak,Float &x){
				HX_STACK_FRAME("*","closure","*.closure","nape/shape/Polygon.hx",213)
				{
					HX_STACK_LINE(213)
		...
		HX_STACK_LINE(213)
		return Array_obj< ::Dynamic >::__new().Add(_Function_1_1::Block(y,weak,x)).Add(_Function_1_2::Block(width,y,weak,x)).Add(_Function_1_3::Block(width,y,weak,x,height)).Add(_Function_1_4::Block(y,weak,height,x));
	}
}
...
bool weak = __o_weak.Default(false);
	HX_STACK_FRAME("Polygon","box","Polygon.box","nape/shape/Polygon.hx",231)
	HX_STACK_ARG(width,"width")
	HX_STACK_ARG(height,"height")
	HX_STACK_ARG(weak,"weak")
{
...
bool weak = __o_weak.Default(false);
	HX_STACK_FRAME("Polygon","regular","Polygon.regular","nape/shape/Polygon.hx",257)
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		HX_STACK_LINE(263)
		{
			...
			while(((_g < edgeCount))){
				...
				{
					HX_STACK_LINE(265)
					Float x1 = (::Math_obj::cos(ang) * xRadius);		HX_STACK_VAR(x1,"x1");
					HX_STACK_LINE(265)
					...
					if (((ret1->zpp_inner == null()))){
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec2 &ret1){
								HX_STACK_FRAME("*","closure","*.closure","nape/shape/Polygon.hx",265)
								{
									HX_STACK_LINE(265)
									if (((bool((ret1 != null())) && bool(ret1->zpp_disp)))){
										HX_STACK_LINE(265)
						...
						HX_STACK_LINE(265)
						if ((!(((bool((_Function_5_1::Block(ret1) == x1)) && bool((_Function_5_2::Block(ret1) == y))))))){
							HX_STACK_LINE(265)
							{
								HX_STACK_LINE(265)
								ret1->zpp_inner->x = x1;
