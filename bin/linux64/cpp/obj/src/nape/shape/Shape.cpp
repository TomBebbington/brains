...
{
HX_STACK_FRAME("Shape","new","Shape.new","nape/shape/Shape.hx",177)
{
	HX_STACK_LINE(181)
	this->zpp_inner = null();
	HX_STACK_LINE(215)
...
::String Shape_obj::toString( ){
	HX_STACK_FRAME("Shape","toString","Shape.toString","nape/shape/Shape.hx",660)
	HX_STACK_THIS(this)
	HX_STACK_LINE(661)
...
::nape::shape::Shape Shape_obj::copy( ){
	HX_STACK_FRAME("Shape","copy","Shape.copy","nape/shape/Shape.hx",655)
	HX_STACK_THIS(this)
	HX_STACK_LINE(655)
...
bool Shape_obj::contains( ::nape::geom::Vec2 point){
	HX_STACK_FRAME("Shape","contains","Shape.contains","nape/shape/Shape.hx",616)
	HX_STACK_THIS(this)
...
::nape::shape::Shape Shape_obj::transform( ::nape::geom::Mat23 matrix){
	HX_STACK_FRAME("Shape","transform","Shape.transform","nape/shape/Shape.hx",584)
	HX_STACK_THIS(this)
...
::nape::shape::Shape Shape_obj::rotate( Float angle){
	HX_STACK_FRAME("Shape","rotate","Shape.rotate","nape/shape/Shape.hx",557)
	HX_STACK_THIS(this)
...
::nape::shape::Shape Shape_obj::scale( Float scalex,Float scaley){
	HX_STACK_FRAME("Shape","scale","Shape.scale","nape/shape/Shape.hx",527)
	HX_STACK_THIS(this)
...
::nape::shape::Shape Shape_obj::translate( ::nape::geom::Vec2 translation){
	HX_STACK_FRAME("Shape","translate","Shape.translate","nape/shape/Shape.hx",487)
	HX_STACK_THIS(this)
		...
		if (((this->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_CIRCLE))){
			struct _Function_3_1{
				inline static Float Block( ::nape::geom::Vec2 &translation){
					HX_STACK_FRAME("*","closure","*.closure","nape/shape/Shape.hx",499)
					{
						HX_STACK_LINE(499)
						if (((bool((translation != null())) && bool(translation->zpp_disp)))){
							HX_STACK_LINE(499)
			...
			struct _Function_3_1{
				inline static Float Block( ::nape::geom::Vec2 &translation){
					HX_STACK_FRAME("*","closure","*.closure","nape/shape/Shape.hx",500)
					{
						HX_STACK_LINE(500)
						if (((bool((translation != null())) && bool(translation->zpp_disp)))){
							HX_STACK_LINE(500)
...
::nape::geom::AABB Shape_obj::get_bounds( ){
	HX_STACK_FRAME("Shape","get_bounds","Shape.get_bounds","nape/shape/Shape.hx",474)
	HX_STACK_THIS(this)
	HX_STACK_LINE(474)
...
bool Shape_obj::set_sensorEnabled( bool sensorEnabled){
	HX_STACK_FRAME("Shape","set_sensorEnabled","Shape.set_sensorEnabled","nape/shape/Shape.hx",454)
	HX_STACK_THIS(this)
...
bool Shape_obj::get_sensorEnabled( ){
	HX_STACK_FRAME("Shape","get_sensorEnabled","Shape.get_sensorEnabled","nape/shape/Shape.hx",452)
	HX_STACK_THIS(this)
	HX_STACK_LINE(452)
	return this->zpp_inner->sensorEnabled;
}
...
bool Shape_obj::set_fluidEnabled( bool fluidEnabled){
	HX_STACK_FRAME("Shape","set_fluidEnabled","Shape.set_fluidEnabled","nape/shape/Shape.hx",429)
	HX_STACK_THIS(this)
...
bool Shape_obj::get_fluidEnabled( ){
	HX_STACK_FRAME("Shape","get_fluidEnabled","Shape.get_fluidEnabled","nape/shape/Shape.hx",427)
	HX_STACK_THIS(this)
	HX_STACK_LINE(427)
	return this->zpp_inner->fluidEnabled;
}
...
::nape::phys::FluidProperties Shape_obj::set_fluidProperties( ::nape::phys::FluidProperties fluidProperties){
	HX_STACK_FRAME("Shape","set_fluidProperties","Shape.set_fluidProperties","nape/shape/Shape.hx",403)
	HX_STACK_THIS(this)
...
::nape::phys::FluidProperties Shape_obj::get_fluidProperties( ){
	HX_STACK_FRAME("Shape","get_fluidProperties","Shape.get_fluidProperties","nape/shape/Shape.hx",398)
	HX_STACK_THIS(this)
	HX_STACK_LINE(399)
	this->zpp_inner->immutable_midstep(HX_CSTRING("Shape::fluidProperties"));
	HX_STACK_LINE(400)
...
::nape::dynamics::InteractionFilter Shape_obj::set_filter( ::nape::dynamics::InteractionFilter filter){
	HX_STACK_FRAME("Shape","set_filter","Shape.set_filter","nape/shape/Shape.hx",378)
	HX_STACK_THIS(this)
...
::nape::dynamics::InteractionFilter Shape_obj::get_filter( ){
	HX_STACK_FRAME("Shape","get_filter","Shape.get_filter","nape/shape/Shape.hx",376)
	HX_STACK_THIS(this)
	HX_STACK_LINE(376)
	return this->zpp_inner->filter->wrapper();
}
...
::nape::phys::Material Shape_obj::set_material( ::nape::phys::Material material){
	HX_STACK_FRAME("Shape","set_material","Shape.set_material","nape/shape/Shape.hx",358)
	HX_STACK_THIS(this)
...
::nape::phys::Material Shape_obj::get_material( ){
	HX_STACK_FRAME("Shape","get_material","Shape.get_material","nape/shape/Shape.hx",356)
	HX_STACK_THIS(this)
	HX_STACK_LINE(356)
	return this->zpp_inner->material->wrapper();
}
...
Float Shape_obj::get_angDrag( ){
	HX_STACK_FRAME("Shape","get_angDrag","Shape.get_angDrag","nape/shape/Shape.hx",344)
	HX_STACK_THIS(this)
	HX_STACK_LINE(345)
...
Float Shape_obj::get_inertia( ){
	HX_STACK_FRAME("Shape","get_inertia","Shape.get_inertia","nape/shape/Shape.hx",335)
	HX_STACK_THIS(this)
	HX_STACK_LINE(336)
...
Float Shape_obj::get_area( ){
	HX_STACK_FRAME("Shape","get_area","Shape.get_area","nape/shape/Shape.hx",326)
	HX_STACK_THIS(this)
	HX_STACK_LINE(327)
	this->zpp_inner->validate_area_inertia();
	HX_STACK_LINE(328)
...
::nape::geom::Vec2 Shape_obj::set_localCOM( ::nape::geom::Vec2 localCOM){
	HX_STACK_FRAME("Shape","set_localCOM","Shape.set_localCOM","nape/shape/Shape.hx",305)
	HX_STACK_THIS(this)
			...
			HX_STACK_LINE(317)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 _this){
						HX_STACK_FRAME("*","closure","*.closure","nape/shape/Shape.hx",317)
						{
							HX_STACK_LINE(317)
							if (((bool((_this != null())) && bool(_this->zpp_disp)))){
								HX_STACK_LINE(317)
...
::nape::geom::Vec2 Shape_obj::get_localCOM( ){
	HX_STACK_FRAME("Shape","get_localCOM","Shape.get_localCOM","nape/shape/Shape.hx",298)
	HX_STACK_THIS(this)
	HX_STACK_LINE(299)
	if (((this->zpp_inner->wrap_localCOM == null()))){
		HX_STACK_LINE(300)
...
::nape::geom::Vec2 Shape_obj::get_worldCOM( ){
	HX_STACK_FRAME("Shape","get_worldCOM","Shape.get_worldCOM","nape/shape/Shape.hx",277)
	HX_STACK_THIS(this)
	HX_STACK_LINE(278)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","nape/shape/Shape.hx",279)
						{
							HX_STACK_LINE(279)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(279)
...
::nape::shape::Polygon Shape_obj::get_castPolygon( ){
	HX_STACK_FRAME("Shape","get_castPolygon","Shape.get_castPolygon","nape/shape/Shape.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(264)
...
::nape::shape::Circle Shape_obj::get_castCircle( ){
	HX_STACK_FRAME("Shape","get_castCircle","Shape.get_castCircle","nape/shape/Shape.hx",256)
	HX_STACK_THIS(this)
	HX_STACK_LINE(256)
	if (((this->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_CIRCLE))){
		HX_STACK_LINE(256)
...
::nape::phys::Body Shape_obj::set_body( ::nape::phys::Body body){
	HX_STACK_FRAME("Shape","set_body","Shape.set_body","nape/shape/Shape.hx",240)
	HX_STACK_THIS(this)
...
::nape::phys::Body Shape_obj::get_body( ){
	HX_STACK_FRAME("Shape","get_body","Shape.get_body","nape/shape/Shape.hx",238)
	HX_STACK_THIS(this)
	HX_STACK_LINE(238)
	if (((this->zpp_inner->body != null()))){
		HX_STACK_LINE(238)
...
bool Shape_obj::isPolygon( ){
	HX_STACK_FRAME("Shape","isPolygon","Shape.isPolygon","nape/shape/Shape.hx",208)
	HX_STACK_THIS(this)
	HX_STACK_LINE(208)
...
bool Shape_obj::isCircle( ){
	HX_STACK_FRAME("Shape","isCircle","Shape.isCircle","nape/shape/Shape.hx",198)
	HX_STACK_THIS(this)
	HX_STACK_LINE(198)
...
::nape::shape::ShapeType Shape_obj::get_type( ){
	HX_STACK_FRAME("Shape","get_type","Shape.get_type","nape/shape/Shape.hx",188)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::shape::ShapeType Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/shape/Shape.hx",188)
			{
				HX_STACK_LINE(188)
