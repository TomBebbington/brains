...
{
HX_STACK_FRAME("ShapeType","new","ShapeType.new","nape/shape/ShapeType.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("ShapeType")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String ShapeType_obj::toString( ){
	HX_STACK_FRAME("ShapeType","toString","ShapeType.toString","nape/shape/ShapeType.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::shape::ShapeType Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeType.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::shape::ShapeType Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeType.hx",193)
				{
					HX_STACK_LINE(193)
...
::nape::shape::ShapeType ShapeType_obj::get_CIRCLE( ){
	HX_STACK_FRAME("ShapeType","get_CIRCLE","ShapeType.get_CIRCLE","nape/shape/ShapeType.hx",201)
	HX_STACK_LINE(202)
	if (((::zpp_nape::util::ZPP_Flags_obj::ShapeType_CIRCLE == null()))){
		HX_STACK_LINE(203)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::shape::ShapeType ShapeType_obj::get_POLYGON( ){
	HX_STACK_FRAME("ShapeType","get_POLYGON","ShapeType.get_POLYGON","nape/shape/ShapeType.hx",214)
	HX_STACK_LINE(215)
	if (((::zpp_nape::util::ZPP_Flags_obj::ShapeType_POLYGON == null()))){
		HX_STACK_LINE(216)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
