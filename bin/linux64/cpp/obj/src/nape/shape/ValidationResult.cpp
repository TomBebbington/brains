...
{
HX_STACK_FRAME("ValidationResult","new","ValidationResult.new","nape/shape/ValidationResult.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("ValidationResult")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String ValidationResult_obj::toString( ){
	HX_STACK_FRAME("ValidationResult","toString","ValidationResult.toString","nape/shape/ValidationResult.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::shape::ValidationResult Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/shape/ValidationResult.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::shape::ValidationResult Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/shape/ValidationResult.hx",193)
				{
					HX_STACK_LINE(193)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::shape::ValidationResult Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/shape/ValidationResult.hx",194)
					{
						HX_STACK_LINE(194)
			...
			if (((hx::ObjectPtr<OBJ_>(this) == _Function_3_1::Block()))){
				...
				struct _Function_4_1{
					inline static ::nape::shape::ValidationResult Block( ){
						HX_STACK_FRAME("*","closure","*.closure","nape/shape/ValidationResult.hx",195)
						{
							HX_STACK_LINE(195)
...
::nape::shape::ValidationResult ValidationResult_obj::get_VALID( ){
	HX_STACK_FRAME("ValidationResult","get_VALID","ValidationResult.get_VALID","nape/shape/ValidationResult.hx",203)
	HX_STACK_LINE(204)
	if (((::zpp_nape::util::ZPP_Flags_obj::ValidationResult_VALID == null()))){
		HX_STACK_LINE(205)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::shape::ValidationResult ValidationResult_obj::get_DEGENERATE( ){
	HX_STACK_FRAME("ValidationResult","get_DEGENERATE","ValidationResult.get_DEGENERATE","nape/shape/ValidationResult.hx",216)
	HX_STACK_LINE(217)
	if (((::zpp_nape::util::ZPP_Flags_obj::ValidationResult_DEGENERATE == null()))){
		HX_STACK_LINE(218)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::shape::ValidationResult ValidationResult_obj::get_CONCAVE( ){
	HX_STACK_FRAME("ValidationResult","get_CONCAVE","ValidationResult.get_CONCAVE","nape/shape/ValidationResult.hx",229)
	HX_STACK_LINE(230)
	if (((::zpp_nape::util::ZPP_Flags_obj::ValidationResult_CONCAVE == null()))){
		HX_STACK_LINE(231)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::shape::ValidationResult ValidationResult_obj::get_SELF_INTERSECTING( ){
	HX_STACK_FRAME("ValidationResult","get_SELF_INTERSECTING","ValidationResult.get_SELF_INTERSECTING","nape/shape/ValidationResult.hx",242)
	HX_STACK_LINE(243)
	if (((::zpp_nape::util::ZPP_Flags_obj::ValidationResult_SELF_INTERSECTING == null()))){
		HX_STACK_LINE(244)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
