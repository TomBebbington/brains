...
{
HX_STACK_FRAME("ShapeIterator","new","ShapeIterator.new","nape/shape/ShapeIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_ShapeList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Shape")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::shape::Shape ShapeIterator_obj::next( ){
	HX_STACK_FRAME("ShapeIterator","next","ShapeIterator.next","nape/shape/ShapeIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool ShapeIterator_obj::hasNext( ){
	HX_STACK_FRAME("ShapeIterator","hasNext","ShapeIterator.hasNext","nape/shape/ShapeIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::shape::ShapeIterator ShapeIterator_obj::get( ::nape::shape::ShapeList list){
	HX_STACK_FRAME("ShapeIterator","get","ShapeIterator.get","nape/shape/ShapeIterator.hx",217)
