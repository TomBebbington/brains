...
{
HX_STACK_FRAME("ShapeList","new","ShapeList.new","nape/shape/ShapeList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	this->zpp_inner = ::zpp_nape::util::ZPP_ShapeList_obj::__new();
	HX_STACK_LINE(697)
...
::nape::shape::ShapeList ShapeList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("ShapeList","filter","ShapeList.filter","nape/shape/ShapeList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::shape::ShapeList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::shape::ShapeList ShapeList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("ShapeList","foreach","ShapeList.foreach","nape/shape/ShapeList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::shape::ShapeIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",737)
			{
				HX_STACK_LINE(737)
	...
	while((_Function_1_1::Block(it))){
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::shape::Shape Block( ::nape::shape::ShapeIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String ShapeList_obj::toString( ){
	HX_STACK_FRAME("ShapeList","toString","ShapeList.toString","nape/shape/ShapeList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::shape::ShapeIterator Block( ::nape::shape::ShapeList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
				return ::nape::shape::ShapeIterator_obj::get(__this);
			}
			return null();
		}
	};
	HX_STACK_LINE(705)
	for(::cpp::FastIterator_obj< ::nape::shape::Shape > *__it = ::cpp::CreateFastIterator< ::nape::shape::Shape >(_Function_1_1::Block(this));  __it->hasNext(); ){
		::nape::shape::Shape i = __it->next();
		{
			HX_STACK_LINE(706)
			if ((!(fst))){
				HX_STACK_LINE(706)
...
{
		HX_STACK_FRAME("ShapeList","merge","ShapeList.merge","nape/shape/ShapeList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::shape::ShapeIterator Block( ::nape::shape::ShapeList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
					return ::nape::shape::ShapeIterator_obj::get(xs);
				}
				return null();
			}
		};
		HX_STACK_LINE(688)
		for(::cpp::FastIterator_obj< ::nape::shape::Shape > *__it = ::cpp::CreateFastIterator< ::nape::shape::Shape >(_Function_1_1::Block(xs));  __it->hasNext(); ){
			::nape::shape::Shape x = __it->next();
			if ((!(this->has(x)))){
				HX_STACK_LINE(689)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("ShapeList","copy","ShapeList.copy","nape/shape/ShapeList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::shape::ShapeIterator Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::shape::Shape Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",664)
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Shape")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
		...
		for(::cpp::FastIterator_obj< ::nape::shape::Shape > *__it = ::cpp::CreateFastIterator< ::nape::shape::Shape >(_Function_1_1::Block(this));  __it->hasNext(); ){
			::nape::shape::Shape i = __it->next();
			ret->push((  ((deep)) ? ::nape::shape::Shape(_Function_1_2::Block()) : ::nape::shape::Shape(i) ));
		}
		HX_STACK_LINE(671)
		return ret;
	}
...
::nape::shape::ShapeIterator ShapeList_obj::iterator( ){
	HX_STACK_FRAME("ShapeList","iterator","ShapeList.iterator","nape/shape/ShapeList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool ShapeList_obj::empty( ){
	HX_STACK_FRAME("ShapeList","empty","ShapeList.empty","nape/shape/ShapeList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("ShapeList","clear","ShapeList.clear","nape/shape/ShapeList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Shape")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool ShapeList_obj::remove( ::nape::shape::Shape obj){
	HX_STACK_FRAME("ShapeList","remove","ShapeList.remove","nape/shape/ShapeList.hx",576)
	HX_STACK_THIS(this)
...
bool ShapeList_obj::add( ::nape::shape::Shape obj){
	HX_STACK_FRAME("ShapeList","add","ShapeList.add","nape/shape/ShapeList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::shape::Shape ShapeList_obj::shift( ){
	HX_STACK_FRAME("ShapeList","shift","ShapeList.shift","nape/shape/ShapeList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::shape::Shape ShapeList_obj::pop( ){
	HX_STACK_FRAME("ShapeList","pop","ShapeList.pop","nape/shape/ShapeList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool ShapeList_obj::unshift( ::nape::shape::Shape obj){
	HX_STACK_FRAME("ShapeList","unshift","ShapeList.unshift","nape/shape/ShapeList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::shape::ShapeList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool ShapeList_obj::push( ::nape::shape::Shape obj){
	HX_STACK_FRAME("ShapeList","push","ShapeList.push","nape/shape/ShapeList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::shape::ShapeList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::shape::Shape ShapeList_obj::at( int index){
	HX_STACK_FRAME("ShapeList","at","ShapeList.at","nape/shape/ShapeList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::shape::ShapeList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/shape/ShapeList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool ShapeList_obj::has( ::nape::shape::Shape obj){
	HX_STACK_FRAME("ShapeList","has","ShapeList.has","nape/shape/ShapeList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int ShapeList_obj::get_length( ){
	HX_STACK_FRAME("ShapeList","get_length","ShapeList.get_length","nape/shape/ShapeList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::shape::ShapeList ShapeList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("ShapeList","fromArray","ShapeList.fromArray","nape/shape/ShapeList.hx",304)
