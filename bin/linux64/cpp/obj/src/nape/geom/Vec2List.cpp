...
{
HX_STACK_FRAME("Vec2List","new","Vec2List.new","nape/geom/Vec2List.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(690)
...
::nape::geom::Vec2List Vec2List_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("Vec2List","filter","Vec2List.filter","nape/geom/Vec2List.hx",773)
	HX_STACK_THIS(this)
...
::nape::geom::Vec2List Vec2List_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("Vec2List","foreach","Vec2List.foreach","nape/geom/Vec2List.hx",726)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(728)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::geom::Vec2Iterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/Vec2List.hx",731)
			{
				HX_STACK_LINE(731)
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::geom::Vec2 Block( ::nape::geom::Vec2Iterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/Vec2List.hx",733)
					{
						HX_STACK_LINE(733)
...
::String Vec2List_obj::toString( ){
	HX_STACK_FRAME("Vec2List","toString","Vec2List.toString","nape/geom/Vec2List.hx",696)
	HX_STACK_THIS(this)
	HX_STACK_LINE(697)
...
{
		HX_STACK_FRAME("Vec2List","merge","Vec2List.merge","nape/geom/Vec2List.hx",678)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(680)
		if (((xs == null()))){
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("Vec2List","copy","Vec2List.copy","nape/geom/Vec2List.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::geom::Vec2 &i){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/Vec2List.hx",664)
				{
					HX_STACK_LINE(664)
...
::nape::geom::Vec2Iterator Vec2List_obj::iterator( ){
	HX_STACK_FRAME("Vec2List","iterator","Vec2List.iterator","nape/geom/Vec2List.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(649)
	this->zpp_vm();
	HX_STACK_LINE(651)
...
bool Vec2List_obj::empty( ){
	HX_STACK_FRAME("Vec2List","empty","Vec2List.empty","nape/geom/Vec2List.hx",634)
	HX_STACK_THIS(this)
	HX_STACK_LINE(634)
...
{
		HX_STACK_FRAME("Vec2List","clear","Vec2List.clear","nape/geom/Vec2List.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Vec2")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
...
bool Vec2List_obj::remove( ::nape::geom::Vec2 obj){
	HX_STACK_FRAME("Vec2List","remove","Vec2List.remove","nape/geom/Vec2List.hx",576)
	HX_STACK_THIS(this)
...
bool Vec2List_obj::add( ::nape::geom::Vec2 obj){
	HX_STACK_FRAME("Vec2List","add","Vec2List.add","nape/geom/Vec2List.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::geom::Vec2 Vec2List_obj::shift( ){
	HX_STACK_FRAME("Vec2List","shift","Vec2List.shift","nape/geom/Vec2List.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
...
::nape::geom::Vec2 Vec2List_obj::pop( ){
	HX_STACK_FRAME("Vec2List","pop","Vec2List.pop","nape/geom/Vec2List.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
...
bool Vec2List_obj::unshift( ::nape::geom::Vec2 obj){
	HX_STACK_FRAME("Vec2List","unshift","Vec2List.unshift","nape/geom/Vec2List.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
...
bool Vec2List_obj::push( ::nape::geom::Vec2 obj){
	HX_STACK_FRAME("Vec2List","push","Vec2List.push","nape/geom/Vec2List.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
...
::nape::geom::Vec2 Vec2List_obj::at( int index){
	HX_STACK_FRAME("Vec2List","at","Vec2List.at","nape/geom/Vec2List.hx",363)
	HX_STACK_THIS(this)
...
bool Vec2List_obj::has( ::nape::geom::Vec2 obj){
	HX_STACK_FRAME("Vec2List","has","Vec2List.has","nape/geom/Vec2List.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(348)
	this->zpp_vm();
...
{
		HX_STACK_FRAME("Vec2List","zpp_vm","Vec2List.zpp_vm","nape/geom/Vec2List.hx",292)
		HX_STACK_THIS(this)
		HX_STACK_LINE(292)
...
int Vec2List_obj::zpp_gl( ){
	HX_STACK_FRAME("Vec2List","zpp_gl","Vec2List.zpp_gl","nape/geom/Vec2List.hx",269)
	HX_STACK_THIS(this)
	HX_STACK_LINE(270)
	this->zpp_inner->valmod();
	HX_STACK_LINE(271)
...
int Vec2List_obj::get_length( ){
	HX_STACK_FRAME("Vec2List","get_length","Vec2List.get_length","nape/geom/Vec2List.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(264)
	return this->zpp_gl();
}
...
::nape::geom::Vec2List Vec2List_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("Vec2List","fromArray","Vec2List.fromArray","nape/geom/Vec2List.hx",304)
