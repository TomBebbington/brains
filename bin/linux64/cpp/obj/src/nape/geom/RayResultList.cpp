...
{
HX_STACK_FRAME("RayResultList","new","RayResultList.new","nape/geom/RayResultList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	this->zpp_inner = ::zpp_nape::util::ZPP_RayResultList_obj::__new();
	HX_STACK_LINE(697)
...
::nape::geom::RayResultList RayResultList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("RayResultList","filter","RayResultList.filter","nape/geom/RayResultList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::RayResultList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::geom::RayResultList RayResultList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("RayResultList","foreach","RayResultList.foreach","nape/geom/RayResultList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::geom::RayResultIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",737)
			{
				HX_STACK_LINE(737)
	...
	while((_Function_1_1::Block(it))){
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::geom::RayResult Block( ::nape::geom::RayResultIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String RayResultList_obj::toString( ){
	HX_STACK_FRAME("RayResultList","toString","RayResultList.toString","nape/geom/RayResultList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::geom::RayResultIterator Block( ::nape::geom::RayResultList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
				return ::nape::geom::RayResultIterator_obj::get(__this);
			}
			return null();
		}
	};
	HX_STACK_LINE(705)
	for(::cpp::FastIterator_obj< ::nape::geom::RayResult > *__it = ::cpp::CreateFastIterator< ::nape::geom::RayResult >(_Function_1_1::Block(this));  __it->hasNext(); ){
		::nape::geom::RayResult i = __it->next();
		{
			HX_STACK_LINE(706)
			if ((!(fst))){
				HX_STACK_LINE(706)
...
{
		HX_STACK_FRAME("RayResultList","merge","RayResultList.merge","nape/geom/RayResultList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::geom::RayResultIterator Block( ::nape::geom::RayResultList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
					return ::nape::geom::RayResultIterator_obj::get(xs);
				}
				return null();
			}
		};
		HX_STACK_LINE(688)
		for(::cpp::FastIterator_obj< ::nape::geom::RayResult > *__it = ::cpp::CreateFastIterator< ::nape::geom::RayResult >(_Function_1_1::Block(xs));  __it->hasNext(); ){
			::nape::geom::RayResult x = __it->next();
			if ((!(this->has(x)))){
				HX_STACK_LINE(689)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("RayResultList","copy","RayResultList.copy","nape/geom/RayResultList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::RayResultIterator Block( ::nape::geom::RayResultList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::geom::RayResult Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",664)
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("RayResult")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
		...
		for(::cpp::FastIterator_obj< ::nape::geom::RayResult > *__it = ::cpp::CreateFastIterator< ::nape::geom::RayResult >(_Function_1_1::Block(this));  __it->hasNext(); ){
			::nape::geom::RayResult i = __it->next();
			ret->push((  ((deep)) ? ::nape::geom::RayResult(_Function_1_2::Block()) : ::nape::geom::RayResult(i) ));
		}
		HX_STACK_LINE(671)
		return ret;
	}
...
::nape::geom::RayResultIterator RayResultList_obj::iterator( ){
	HX_STACK_FRAME("RayResultList","iterator","RayResultList.iterator","nape/geom/RayResultList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool RayResultList_obj::empty( ){
	HX_STACK_FRAME("RayResultList","empty","RayResultList.empty","nape/geom/RayResultList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("RayResultList","clear","RayResultList.clear","nape/geom/RayResultList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("RayResult")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool RayResultList_obj::remove( ::nape::geom::RayResult obj){
	HX_STACK_FRAME("RayResultList","remove","RayResultList.remove","nape/geom/RayResultList.hx",576)
	HX_STACK_THIS(this)
...
bool RayResultList_obj::add( ::nape::geom::RayResult obj){
	HX_STACK_FRAME("RayResultList","add","RayResultList.add","nape/geom/RayResultList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::geom::RayResult RayResultList_obj::shift( ){
	HX_STACK_FRAME("RayResultList","shift","RayResultList.shift","nape/geom/RayResultList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::RayResultList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::geom::RayResult RayResultList_obj::pop( ){
	HX_STACK_FRAME("RayResultList","pop","RayResultList.pop","nape/geom/RayResultList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::RayResultList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool RayResultList_obj::unshift( ::nape::geom::RayResult obj){
	HX_STACK_FRAME("RayResultList","unshift","RayResultList.unshift","nape/geom/RayResultList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::geom::RayResultList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool RayResultList_obj::push( ::nape::geom::RayResult obj){
	HX_STACK_FRAME("RayResultList","push","RayResultList.push","nape/geom/RayResultList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::geom::RayResultList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::geom::RayResult RayResultList_obj::at( int index){
	HX_STACK_FRAME("RayResultList","at","RayResultList.at","nape/geom/RayResultList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::RayResultList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::geom::RayResultList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResultList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool RayResultList_obj::has( ::nape::geom::RayResult obj){
	HX_STACK_FRAME("RayResultList","has","RayResultList.has","nape/geom/RayResultList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int RayResultList_obj::get_length( ){
	HX_STACK_FRAME("RayResultList","get_length","RayResultList.get_length","nape/geom/RayResultList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::geom::RayResultList RayResultList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("RayResultList","fromArray","RayResultList.fromArray","nape/geom/RayResultList.hx",304)
