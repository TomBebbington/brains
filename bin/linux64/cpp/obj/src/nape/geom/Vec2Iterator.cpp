...
{
HX_STACK_FRAME("Vec2Iterator","new","Vec2Iterator.new","nape/geom/Vec2Iterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_Vec2List_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Vec2")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::geom::Vec2 Vec2Iterator_obj::next( ){
	HX_STACK_FRAME("Vec2Iterator","next","Vec2Iterator.next","nape/geom/Vec2Iterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool Vec2Iterator_obj::hasNext( ){
	HX_STACK_FRAME("Vec2Iterator","hasNext","Vec2Iterator.hasNext","nape/geom/Vec2Iterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::geom::Vec2Iterator Vec2Iterator_obj::get( ::nape::geom::Vec2List list){
	HX_STACK_FRAME("Vec2Iterator","get","Vec2Iterator.get","nape/geom/Vec2Iterator.hx",217)
