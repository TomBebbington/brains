...
{
HX_STACK_FRAME("Mat23","new","Mat23.new","nape/geom/Mat23.hx",187)
...
Float ty = __o_ty.Default(0.0);
{
	...
	HX_STACK_LINE(373)
	{
		HX_STACK_LINE(373)
		{
			...
			if (((a != a))){
				HX_STACK_LINE(373)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Mat23::") + HX_CSTRING("a")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(373)
			this->zpp_inner->a = a;
			HX_STACK_LINE(373)
	...
	HX_STACK_LINE(374)
	{
		HX_STACK_LINE(374)
		{
			...
			if (((b != b))){
				HX_STACK_LINE(374)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Mat23::") + HX_CSTRING("b")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(374)
			this->zpp_inner->b = b;
			HX_STACK_LINE(374)
	...
	HX_STACK_LINE(375)
	{
		HX_STACK_LINE(375)
		{
			...
			if (((tx != tx))){
				HX_STACK_LINE(375)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Mat23::") + HX_CSTRING("tx")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(375)
	...
	HX_STACK_LINE(376)
	{
		HX_STACK_LINE(376)
		{
			...
			if (((c != c))){
				HX_STACK_LINE(376)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Mat23::") + HX_CSTRING("c")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(376)
			this->zpp_inner->c = c;
			HX_STACK_LINE(376)
	...
	HX_STACK_LINE(377)
	{
		HX_STACK_LINE(377)
		{
			...
			if (((d != d))){
				HX_STACK_LINE(377)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Mat23::") + HX_CSTRING("d")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(377)
			this->zpp_inner->d = d;
			HX_STACK_LINE(377)
	...
	HX_STACK_LINE(378)
	{
		HX_STACK_LINE(378)
		{
			...
			if (((ty != ty))){
				HX_STACK_LINE(378)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Mat23::") + HX_CSTRING("ty")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(378)
...
::nape::geom::Mat23 Mat23_obj::orthogonalise( ){
	HX_STACK_FRAME("Mat23","orthogonalise","Mat23.orthogonalise","nape/geom/Mat23.hx",862)
	HX_STACK_THIS(this)
	HX_STACK_LINE(863)
	if ((!(this->orthogonal()))){
		HX_STACK_LINE(864)
		...
		if (((bool(((k1 * k1) < ::nape::Config_obj::epsilon)) || bool(((k2 * k2) < ::nape::Config_obj::epsilon))))){
			HX_STACK_LINE(868)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: Matrix is singular and cannot be ") + HX_CSTRING("orthogonal")) + HX_CSTRING("ised")));
		}
		HX_STACK_LINE(871)
...
::nape::geom::Mat23 Mat23_obj::equiorthogonalise( ){
	HX_STACK_FRAME("Mat23","equiorthogonalise","Mat23.equiorthogonalise","nape/geom/Mat23.hx",817)
	HX_STACK_THIS(this)
	HX_STACK_LINE(818)
	if ((!(this->equiorthogonal()))){
		...
		if (((bool(((k1 * k1) < ::nape::Config_obj::epsilon)) || bool(((k2 * k2) < ::nape::Config_obj::epsilon))))){
			HX_STACK_LINE(823)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: Matrix is singular and cannot be ") + HX_CSTRING("equiorthogonal")) + HX_CSTRING("ised")));
		}
		HX_STACK_LINE(826)
...
bool Mat23_obj::orthogonal( ){
	HX_STACK_FRAME("Mat23","orthogonal","Mat23.orthogonal","nape/geom/Mat23.hx",794)
	HX_STACK_THIS(this)
	HX_STACK_LINE(795)
...
bool Mat23_obj::equiorthogonal( ){
	HX_STACK_FRAME("Mat23","equiorthogonal","Mat23.equiorthogonal","nape/geom/Mat23.hx",767)
	HX_STACK_THIS(this)
	HX_STACK_LINE(767)
	if ((this->singular())){
		HX_STACK_LINE(768)
...
::String Mat23_obj::toString( ){
	HX_STACK_FRAME("Mat23","toString","Mat23.toString","nape/geom/Mat23.hx",743)
	HX_STACK_THIS(this)
	HX_STACK_LINE(743)
...
bool weak = __o_weak.Default(false);
	HX_STACK_FRAME("Mat23","inverseTransform","Mat23.inverseTransform","nape/geom/Mat23.hx",702)
	HX_STACK_THIS(this)
		...
		if ((noTranslation)){
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &point){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/Mat23.hx",719)
					{
						HX_STACK_LINE(719)
						if (((bool((point != null())) && bool(point->zpp_disp)))){
							HX_STACK_LINE(719)
			...
			HX_STACK_LINE(719)
			x = ((((_Function_2_1::Block(point) * this->zpp_inner->d) - (_Function_2_2::Block(point) * this->zpp_inner->b))) * idet);
			HX_STACK_LINE(719)
			...
			HX_STACK_LINE(719)
			y = ((((_Function_2_3::Block(point) * this->zpp_inner->a) - (_Function_2_4::Block(point) * this->zpp_inner->c))) * idet);
			HX_STACK_LINE(719)
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &point){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/Mat23.hx",722)
					{
						HX_STACK_LINE(722)
						if (((bool((point != null())) && bool(point->zpp_disp)))){
							HX_STACK_LINE(722)
			...
			HX_STACK_LINE(722)
			dx = (_Function_2_1::Block(point) - this->zpp_inner->tx);
			HX_STACK_LINE(723)
			Float dy;		HX_STACK_VAR(dy,"dy");
			struct _Function_2_2{
				inline static Float Block( ::nape::geom::Vec2 &point){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/Mat23.hx",723)
					{
						HX_STACK_LINE(723)
						if (((bool((point != null())) && bool(point->zpp_disp)))){
							HX_STACK_LINE(723)
			...
			HX_STACK_LINE(723)
			dy = (_Function_2_2::Block(point) - this->zpp_inner->ty);
			HX_STACK_LINE(724)
			{
				HX_STACK_LINE(724)
				...
				if (((ret1->zpp_inner == null()))){
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec2 &ret1){
							HX_STACK_FRAME("*","closure","*.closure","nape/geom/Mat23.hx",724)
							{
								HX_STACK_LINE(724)
								if (((bool((ret1 != null())) && bool(ret1->zpp_disp)))){
									HX_STACK_LINE(724)
...
bool noTranslation = __o_noTranslation.Default(false);
bool weak = __o_weak.Default(false);
	HX_STACK_FRAME("Mat23","transform","Mat23.transform","nape/geom/Mat23.hx",648)
	HX_STACK_THIS(this)
	HX_STACK_ARG(point,"point")
	HX_STACK_ARG(noTranslation,"noTranslation")
	HX_STACK_ARG(weak,"weak")
{
		...
		if ((noTranslation)){
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &point){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/Mat23.hx",661)
					{
						HX_STACK_LINE(661)
						if (((bool((point != null())) && bool(point->zpp_disp)))){
							HX_STACK_LINE(661)
			...
			HX_STACK_LINE(661)
			x = ((_Function_2_1::Block(point) * this->zpp_inner->a) + (_Function_2_2::Block(point) * this->zpp_inner->b));
			HX_STACK_LINE(661)
			Float y;		HX_STACK_VAR(y,"y");
			struct _Function_2_3{
				inline static Float Block( ::nape::geom::Vec2 &point){
			...
			HX_STACK_LINE(661)
			y = ((_Function_2_3::Block(point) * this->zpp_inner->c) + (_Function_2_4::Block(point) * this->zpp_inner->d));
			HX_STACK_LINE(661)
			if (((bool((x != x)) || bool((y != y))))){
				HX_STACK_LINE(661)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2 components cannot be NaN"));
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &point){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/Mat23.hx",664)
					{
						HX_STACK_LINE(664)
						if (((bool((point != null())) && bool(point->zpp_disp)))){
							HX_STACK_LINE(664)
			...
			HX_STACK_LINE(664)
			x = (((_Function_2_1::Block(point) * this->zpp_inner->a) + (_Function_2_2::Block(point) * this->zpp_inner->b)) + this->zpp_inner->tx);
			HX_STACK_LINE(664)
			Float y;		HX_STACK_VAR(y,"y");
			struct _Function_2_3{
				inline static Float Block( ::nape::geom::Vec2 &point){
			...
			HX_STACK_LINE(664)
			y = (((_Function_2_3::Block(point) * this->zpp_inner->c) + (_Function_2_4::Block(point) * this->zpp_inner->d)) + this->zpp_inner->ty);
			HX_STACK_LINE(664)
			if (((bool((x != x)) || bool((y != y))))){
				HX_STACK_LINE(664)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2 components cannot be NaN"));
...
::nape::geom::Mat23 Mat23_obj::concat( ::nape::geom::Mat23 matrix){
	HX_STACK_FRAME("Mat23","concat","Mat23.concat","nape/geom/Mat23.hx",622)
	HX_STACK_THIS(this)
...
::nape::geom::Mat23 Mat23_obj::transpose( ){
	HX_STACK_FRAME("Mat23","transpose","Mat23.transpose","nape/geom/Mat23.hx",607)
	HX_STACK_THIS(this)
	HX_STACK_LINE(607)
...
::nape::geom::Mat23 Mat23_obj::inverse( ){
	HX_STACK_FRAME("Mat23","inverse","Mat23.inverse","nape/geom/Mat23.hx",577)
	HX_STACK_THIS(this)
	HX_STACK_LINE(579)
	if ((this->singular())){
		HX_STACK_LINE(580)
...
bool Mat23_obj::singular( ){
	HX_STACK_FRAME("Mat23","singular","Mat23.singular","nape/geom/Mat23.hx",560)
	HX_STACK_THIS(this)
	HX_STACK_LINE(561)
...
Float Mat23_obj::get_determinant( ){
	HX_STACK_FRAME("Mat23","get_determinant","Mat23.get_determinant","nape/geom/Mat23.hx",548)
	HX_STACK_THIS(this)
	HX_STACK_LINE(548)
...
::flash::geom::Matrix Mat23_obj::toMatrix( ::flash::geom::Matrix output){
	HX_STACK_FRAME("Mat23","toMatrix","Mat23.toMatrix","nape/geom/Mat23.hx",467)
	HX_STACK_THIS(this)
	HX_STACK_ARG(output,"output")
	HX_STACK_LINE(468)
	if (((output == null()))){
		HX_STACK_LINE(468)
		output = ::flash::geom::Matrix_obj::__new(null(),null(),null(),null(),null(),null());
	}
	HX_STACK_LINE(469)
...
::nape::geom::Mat23 Mat23_obj::reset( ){
	HX_STACK_FRAME("Mat23","reset","Mat23.reset","nape/geom/Mat23.hx",434)
	HX_STACK_THIS(this)
	HX_STACK_LINE(434)
...
Float tx = __o_tx.Default(0.0);
Float ty = __o_ty.Default(0.0);
	HX_STACK_FRAME("Mat23","setAs","Mat23.setAs","nape/geom/Mat23.hx",420)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_ARG(c,"c")
...
::nape::geom::Mat23 Mat23_obj::set( ::nape::geom::Mat23 matrix){
	HX_STACK_FRAME("Mat23","set","Mat23.set","nape/geom/Mat23.hx",396)
	HX_STACK_THIS(this)
	HX_STACK_ARG(matrix,"matrix")
	HX_STACK_LINE(398)
	if (((matrix == null()))){
...
::nape::geom::Mat23 Mat23_obj::copy( ){
	HX_STACK_FRAME("Mat23","copy","Mat23.copy","nape/geom/Mat23.hx",387)
	HX_STACK_THIS(this)
	HX_STACK_LINE(387)
...
Float Mat23_obj::set_ty( Float ty){
	HX_STACK_FRAME("Mat23","set_ty","Mat23.set_ty","nape/geom/Mat23.hx",342)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ty,"ty")
	HX_STACK_LINE(343)
	{
...
Float Mat23_obj::get_ty( ){
	HX_STACK_FRAME("Mat23","get_ty","Mat23.get_ty","nape/geom/Mat23.hx",340)
	HX_STACK_THIS(this)
	HX_STACK_LINE(340)
	return this->zpp_inner->ty;
}
...
Float Mat23_obj::set_tx( Float tx){
	HX_STACK_FRAME("Mat23","set_tx","Mat23.set_tx","nape/geom/Mat23.hx",315)
	HX_STACK_THIS(this)
	HX_STACK_ARG(tx,"tx")
	HX_STACK_LINE(316)
	{
...
Float Mat23_obj::get_tx( ){
	HX_STACK_FRAME("Mat23","get_tx","Mat23.get_tx","nape/geom/Mat23.hx",313)
	HX_STACK_THIS(this)
	HX_STACK_LINE(313)
	return this->zpp_inner->tx;
}
...
Float Mat23_obj::set_d( Float d){
	HX_STACK_FRAME("Mat23","set_d","Mat23.set_d","nape/geom/Mat23.hx",288)
	HX_STACK_THIS(this)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(289)
	{
...
Float Mat23_obj::get_d( ){
	HX_STACK_FRAME("Mat23","get_d","Mat23.get_d","nape/geom/Mat23.hx",286)
	HX_STACK_THIS(this)
	HX_STACK_LINE(286)
	return this->zpp_inner->d;
}
...
Float Mat23_obj::set_c( Float c){
	HX_STACK_FRAME("Mat23","set_c","Mat23.set_c","nape/geom/Mat23.hx",261)
	HX_STACK_THIS(this)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(262)
	{
...
Float Mat23_obj::get_c( ){
	HX_STACK_FRAME("Mat23","get_c","Mat23.get_c","nape/geom/Mat23.hx",259)
	HX_STACK_THIS(this)
	HX_STACK_LINE(259)
	return this->zpp_inner->c;
}
...
Float Mat23_obj::set_b( Float b){
	HX_STACK_FRAME("Mat23","set_b","Mat23.set_b","nape/geom/Mat23.hx",234)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(235)
	{
...
Float Mat23_obj::get_b( ){
	HX_STACK_FRAME("Mat23","get_b","Mat23.get_b","nape/geom/Mat23.hx",232)
	HX_STACK_THIS(this)
	HX_STACK_LINE(232)
	return this->zpp_inner->b;
}
...
Float Mat23_obj::set_a( Float a){
	HX_STACK_FRAME("Mat23","set_a","Mat23.set_a","nape/geom/Mat23.hx",207)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(208)
	{
...
Float Mat23_obj::get_a( ){
	HX_STACK_FRAME("Mat23","get_a","Mat23.get_a","nape/geom/Mat23.hx",205)
	HX_STACK_THIS(this)
	HX_STACK_LINE(205)
	return this->zpp_inner->a;
}
...
::nape::geom::Mat23 Mat23_obj::fromMatrix( ::flash::geom::Matrix matrix){
	HX_STACK_FRAME("Mat23","fromMatrix","Mat23.fromMatrix","nape/geom/Mat23.hx",451)
	HX_STACK_ARG(matrix,"matrix")
	HX_STACK_LINE(452)
	::flash::geom::Matrix m = matrix;		HX_STACK_VAR(m,"m");
	HX_STACK_LINE(453)
...
::nape::geom::Mat23 Mat23_obj::rotation( Float angle){
	HX_STACK_FRAME("Mat23","rotation","Mat23.rotation","nape/geom/Mat23.hx",490)
...
::nape::geom::Mat23 Mat23_obj::translation( Float tx,Float ty){
	HX_STACK_FRAME("Mat23","translation","Mat23.translation","nape/geom/Mat23.hx",514)
	HX_STACK_ARG(tx,"tx")
	HX_STACK_ARG(ty,"ty")
	HX_STACK_LINE(514)
...
::nape::geom::Mat23 Mat23_obj::scale( Float sx,Float sy){
	HX_STACK_FRAME("Mat23","scale","Mat23.scale","nape/geom/Mat23.hx",530)
	HX_STACK_ARG(sx,"sx")
	HX_STACK_ARG(sy,"sy")
	HX_STACK_LINE(530)
