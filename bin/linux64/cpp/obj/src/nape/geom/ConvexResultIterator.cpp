...
{
HX_STACK_FRAME("ConvexResultIterator","new","ConvexResultIterator.new","nape/geom/ConvexResultIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_ConvexResultList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("ConvexResult")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::geom::ConvexResult ConvexResultIterator_obj::next( ){
	HX_STACK_FRAME("ConvexResultIterator","next","ConvexResultIterator.next","nape/geom/ConvexResultIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool ConvexResultIterator_obj::hasNext( ){
	HX_STACK_FRAME("ConvexResultIterator","hasNext","ConvexResultIterator.hasNext","nape/geom/ConvexResultIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::geom::ConvexResultIterator ConvexResultIterator_obj::get( ::nape::geom::ConvexResultList list){
	HX_STACK_FRAME("ConvexResultIterator","get","ConvexResultIterator.get","nape/geom/ConvexResultIterator.hx",217)
