...
{
HX_STACK_FRAME("ConvexResult","new","ConvexResult.new","nape/geom/ConvexResult.hx",180)
{
	HX_STACK_LINE(184)
	this->zpp_inner = null();
	HX_STACK_LINE(236)
...
::String ConvexResult_obj::toString( ){
	HX_STACK_FRAME("ConvexResult","toString","ConvexResult.toString","nape/geom/ConvexResult.hx",252)
	HX_STACK_THIS(this)
	HX_STACK_LINE(254)
	...
	struct _Function_1_1{
		inline static ::nape::shape::Shape Block( ::nape::geom::ConvexResult_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResult.hx",256)
			{
				HX_STACK_LINE(256)
...
{
		HX_STACK_FRAME("ConvexResult","dispose","ConvexResult.dispose","nape/geom/ConvexResult.hx",243)
		HX_STACK_THIS(this)
		HX_STACK_LINE(245)
		if (((this->zpp_inner->next != null()))){
			HX_STACK_LINE(245)
...
::nape::shape::Shape ConvexResult_obj::get_shape( ){
	HX_STACK_FRAME("ConvexResult","get_shape","ConvexResult.get_shape","nape/geom/ConvexResult.hx",223)
	HX_STACK_THIS(this)
	HX_STACK_LINE(225)
	if (((this->zpp_inner->next != null()))){
		HX_STACK_LINE(225)
...
Float ConvexResult_obj::get_toi( ){
	HX_STACK_FRAME("ConvexResult","get_toi","ConvexResult.get_toi","nape/geom/ConvexResult.hx",212)
	HX_STACK_THIS(this)
	HX_STACK_LINE(214)
	if (((this->zpp_inner->next != null()))){
		HX_STACK_LINE(214)
...
::nape::geom::Vec2 ConvexResult_obj::get_position( ){
	HX_STACK_FRAME("ConvexResult","get_position","ConvexResult.get_position","nape/geom/ConvexResult.hx",201)
	HX_STACK_THIS(this)
	HX_STACK_LINE(203)
	if (((this->zpp_inner->next != null()))){
		HX_STACK_LINE(203)
...
::nape::geom::Vec2 ConvexResult_obj::get_normal( ){
	HX_STACK_FRAME("ConvexResult","get_normal","ConvexResult.get_normal","nape/geom/ConvexResult.hx",190)
	HX_STACK_THIS(this)
	HX_STACK_LINE(192)
	if (((this->zpp_inner->next != null()))){
		HX_STACK_LINE(192)
