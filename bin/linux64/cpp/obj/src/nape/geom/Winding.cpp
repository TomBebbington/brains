...
{
HX_STACK_FRAME("Winding","new","Winding.new","nape/geom/Winding.hx",190)
{
	HX_STACK_LINE(190)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(190)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Winding")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String Winding_obj::toString( ){
	HX_STACK_FRAME("Winding","toString","Winding.toString","nape/geom/Winding.hx",199)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::geom::Winding Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/Winding.hx",199)
			{
				HX_STACK_LINE(199)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::geom::Winding Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/Winding.hx",200)
				{
					HX_STACK_LINE(200)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::geom::Winding Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/Winding.hx",201)
					{
						HX_STACK_LINE(201)
...
::nape::geom::Winding Winding_obj::get_UNDEFINED( ){
	HX_STACK_FRAME("Winding","get_UNDEFINED","Winding.get_UNDEFINED","nape/geom/Winding.hx",213)
	HX_STACK_LINE(214)
	if (((::zpp_nape::util::ZPP_Flags_obj::Winding_UNDEFINED == null()))){
		HX_STACK_LINE(215)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::geom::Winding Winding_obj::get_CLOCKWISE( ){
	HX_STACK_FRAME("Winding","get_CLOCKWISE","Winding.get_CLOCKWISE","nape/geom/Winding.hx",226)
	HX_STACK_LINE(227)
	if (((::zpp_nape::util::ZPP_Flags_obj::Winding_CLOCKWISE == null()))){
		HX_STACK_LINE(228)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::geom::Winding Winding_obj::get_ANTICLOCKWISE( ){
	HX_STACK_FRAME("Winding","get_ANTICLOCKWISE","Winding.get_ANTICLOCKWISE","nape/geom/Winding.hx",239)
	HX_STACK_LINE(240)
	if (((::zpp_nape::util::ZPP_Flags_obj::Winding_ANTICLOCKWISE == null()))){
		HX_STACK_LINE(241)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
