...
{
HX_STACK_FRAME("RayResult","new","RayResult.new","nape/geom/RayResult.hx",180)
{
	HX_STACK_LINE(184)
	this->zpp_inner = null();
	HX_STACK_LINE(236)
...
::String RayResult_obj::toString( ){
	HX_STACK_FRAME("RayResult","toString","RayResult.toString","nape/geom/RayResult.hx",252)
	HX_STACK_THIS(this)
	HX_STACK_LINE(254)
	...
	struct _Function_1_1{
		inline static ::nape::shape::Shape Block( ::nape::geom::RayResult_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/RayResult.hx",256)
			{
				HX_STACK_LINE(256)
...
{
		HX_STACK_FRAME("RayResult","dispose","RayResult.dispose","nape/geom/RayResult.hx",243)
		HX_STACK_THIS(this)
		HX_STACK_LINE(245)
		if (((this->zpp_inner->next != null()))){
			HX_STACK_LINE(245)
...
::nape::shape::Shape RayResult_obj::get_shape( ){
	HX_STACK_FRAME("RayResult","get_shape","RayResult.get_shape","nape/geom/RayResult.hx",223)
	HX_STACK_THIS(this)
	HX_STACK_LINE(225)
	if (((this->zpp_inner->next != null()))){
		HX_STACK_LINE(225)
...
bool RayResult_obj::get_inner( ){
	HX_STACK_FRAME("RayResult","get_inner","RayResult.get_inner","nape/geom/RayResult.hx",212)
	HX_STACK_THIS(this)
	HX_STACK_LINE(214)
	if (((this->zpp_inner->next != null()))){
		HX_STACK_LINE(214)
...
Float RayResult_obj::get_distance( ){
	HX_STACK_FRAME("RayResult","get_distance","RayResult.get_distance","nape/geom/RayResult.hx",201)
	HX_STACK_THIS(this)
	HX_STACK_LINE(203)
	if (((this->zpp_inner->next != null()))){
		HX_STACK_LINE(203)
...
::nape::geom::Vec2 RayResult_obj::get_normal( ){
	HX_STACK_FRAME("RayResult","get_normal","RayResult.get_normal","nape/geom/RayResult.hx",190)
	HX_STACK_THIS(this)
	HX_STACK_LINE(192)
	if (((this->zpp_inner->next != null()))){
		HX_STACK_LINE(192)
