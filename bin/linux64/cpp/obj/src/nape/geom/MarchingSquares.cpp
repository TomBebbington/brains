...
bool combine = __o_combine.Default(true);
	HX_STACK_FRAME("MarchingSquares","run","MarchingSquares.run","nape/geom/MarchingSquares.hx",269)
	...
	HX_STACK_ARG(output,"output")
{
		...
		struct _Function_1_1{
			inline static Float Block( ::nape::geom::Vec2 &cellsize){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/MarchingSquares.hx",290)
				{
					HX_STACK_LINE(290)
					if (((bool((cellsize != null())) && bool(cellsize->zpp_disp)))){
						HX_STACK_LINE(290)
		...
		struct _Function_1_3{
			inline static Float Block( ::nape::geom::Vec2 &subgrid){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/MarchingSquares.hx",296)
				{
					HX_STACK_LINE(296)
					if (((bool((subgrid != null())) && bool(subgrid->zpp_disp)))){
						HX_STACK_LINE(296)
		...
		if (((subgrid == null()))){
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::AABB &bounds){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/MarchingSquares.hx",302)
					{
						HX_STACK_LINE(302)
						{
							HX_STACK_LINE(302)
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::AABB &bounds){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/MarchingSquares.hx",305)
					{
						HX_STACK_LINE(305)
						{
							HX_STACK_LINE(305)
			...
			HX_STACK_LINE(305)
			xp = (Float(_Function_2_1::Block(bounds)) / Float(_Function_2_2::Block(subgrid)));
			HX_STACK_LINE(306)
			Float yp;		HX_STACK_VAR(yp,"yp");
			struct _Function_2_3{
				inline static Float Block( ::nape::geom::AABB &bounds){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/MarchingSquares.hx",306)
					{
						HX_STACK_LINE(306)
						{
							HX_STACK_LINE(306)
			...
			HX_STACK_LINE(306)
			yp = (Float(_Function_2_3::Block(bounds)) / Float(_Function_2_4::Block(subgrid)));
			HX_STACK_LINE(307)
			...
			HX_STACK_LINE(311)
			{
				...
				while(((_g < xn))){
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::AABB &bounds){
							HX_STACK_FRAME("*","closure","*.closure","nape/geom/MarchingSquares.hx",312)
							{
								HX_STACK_LINE(312)
								{
									HX_STACK_LINE(312)
					...
					HX_STACK_LINE(312)
					x0 = (_Function_4_1::Block(bounds) + (_Function_4_2::Block(subgrid) * x));
					HX_STACK_LINE(313)
					...
					if (((x == (xn - (int)1)))){
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec2 &subgrid){
								HX_STACK_FRAME("*","closure","*.closure","nape/geom/MarchingSquares.hx",313)
								{
									HX_STACK_LINE(313)
									if (((bool((subgrid != null())) && bool(subgrid->zpp_disp)))){
										HX_STACK_LINE(313)
						...
						HX_STACK_LINE(313)
						x1 = (x0 + _Function_5_1::Block(subgrid));
					}
					HX_STACK_LINE(314)
					{
						HX_STACK_LINE(314)
						...
						while(((_g1 < yn))){
							...
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::AABB &bounds){
									HX_STACK_FRAME("*","closure","*.closure","nape/geom/MarchingSquares.hx",315)
									{
										HX_STACK_LINE(315)
										{
											HX_STACK_LINE(315)
							...
							HX_STACK_LINE(315)
							y0 = (_Function_6_1::Block(bounds) + (_Function_6_2::Block(subgrid) * y));
							HX_STACK_LINE(316)
							...
							if (((y == (yn - (int)1)))){
								...
								struct _Function_7_1{
									inline static Float Block( ::nape::geom::Vec2 &subgrid){
										HX_STACK_FRAME("*","closure","*.closure","nape/geom/MarchingSquares.hx",316)
										{
											HX_STACK_LINE(316)
											if (((bool((subgrid != null())) && bool(subgrid->zpp_disp)))){
												HX_STACK_LINE(316)
								...
								HX_STACK_LINE(316)
								y1 = (y0 + _Function_7_1::Block(subgrid));
							}
							HX_STACK_LINE(317)
