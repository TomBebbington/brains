...
{
HX_STACK_FRAME("MatMN","new","MatMN.new","nape/geom/MatMN.hx",179)
...
::nape::geom::MatMN MatMN_obj::mul( ::nape::geom::MatMN matrix){
	HX_STACK_FRAME("MatMN","mul","MatMN.mul","nape/geom/MatMN.hx",294)
	HX_STACK_THIS(this)
						...
						while(((_g5 < _g4))){
							...
							struct _Function_7_1{
								inline static Float Block( int &k,::nape::geom::MatMN_obj *__this,int &i){
									HX_STACK_FRAME("*","closure","*.closure","nape/geom/MatMN.hx",305)
									{
										HX_STACK_LINE(305)
...
::nape::geom::MatMN MatMN_obj::transpose( ){
	HX_STACK_FRAME("MatMN","transpose","MatMN.transpose","nape/geom/MatMN.hx",274)
	HX_STACK_THIS(this)
	HX_STACK_LINE(275)
...
::String MatMN_obj::toString( ){
	HX_STACK_FRAME("MatMN","toString","MatMN.toString","nape/geom/MatMN.hx",258)
	HX_STACK_THIS(this)
	HX_STACK_LINE(259)
				...
				while(((_g3 < _g2))){
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::MatMN_obj *__this,int &j,int &i){
							HX_STACK_FRAME("*","closure","*.closure","nape/geom/MatMN.hx",264)
							{
								HX_STACK_LINE(264)
...
Float MatMN_obj::setx( int row,int col,Float x){
	HX_STACK_FRAME("MatMN","setx","MatMN.setx","nape/geom/MatMN.hx",228)
	HX_STACK_THIS(this)
...
Float MatMN_obj::x( int row,int col){
	HX_STACK_FRAME("MatMN","x","MatMN.x","nape/geom/MatMN.hx",209)
	HX_STACK_THIS(this)
	HX_STACK_ARG(row,"row")
	HX_STACK_ARG(col,"col")
	HX_STACK_LINE(211)
...
int MatMN_obj::get_cols( ){
	HX_STACK_FRAME("MatMN","get_cols","MatMN.get_cols","nape/geom/MatMN.hx",198)
	HX_STACK_THIS(this)
	HX_STACK_LINE(198)
...
int MatMN_obj::get_rows( ){
	HX_STACK_FRAME("MatMN","get_rows","MatMN.get_rows","nape/geom/MatMN.hx",190)
	HX_STACK_THIS(this)
	HX_STACK_LINE(190)
