...
{
HX_STACK_FRAME("ConvexResultList","new","ConvexResultList.new","nape/geom/ConvexResultList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::geom::ConvexResultList ConvexResultList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("ConvexResultList","filter","ConvexResultList.filter","nape/geom/ConvexResultList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::ConvexResultList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::geom::ConvexResultList ConvexResultList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("ConvexResultList","foreach","ConvexResultList.foreach","nape/geom/ConvexResultList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::geom::ConvexResultIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",737)
			{
				HX_STACK_LINE(737)
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::geom::ConvexResult Block( ::nape::geom::ConvexResultIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String ConvexResultList_obj::toString( ){
	HX_STACK_FRAME("ConvexResultList","toString","ConvexResultList.toString","nape/geom/ConvexResultList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::geom::ConvexResultIterator Block( ::nape::geom::ConvexResultList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_FRAME("ConvexResultList","merge","ConvexResultList.merge","nape/geom/ConvexResultList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::geom::ConvexResultIterator Block( ::nape::geom::ConvexResultList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("ConvexResultList","copy","ConvexResultList.copy","nape/geom/ConvexResultList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::ConvexResultIterator Block( ::nape::geom::ConvexResultList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::geom::ConvexResult Block( ){
				...
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("ConvexResult")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::geom::ConvexResultIterator ConvexResultList_obj::iterator( ){
	HX_STACK_FRAME("ConvexResultList","iterator","ConvexResultList.iterator","nape/geom/ConvexResultList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool ConvexResultList_obj::empty( ){
	HX_STACK_FRAME("ConvexResultList","empty","ConvexResultList.empty","nape/geom/ConvexResultList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("ConvexResultList","clear","ConvexResultList.clear","nape/geom/ConvexResultList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("ConvexResult")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool ConvexResultList_obj::remove( ::nape::geom::ConvexResult obj){
	HX_STACK_FRAME("ConvexResultList","remove","ConvexResultList.remove","nape/geom/ConvexResultList.hx",576)
	HX_STACK_THIS(this)
...
bool ConvexResultList_obj::add( ::nape::geom::ConvexResult obj){
	HX_STACK_FRAME("ConvexResultList","add","ConvexResultList.add","nape/geom/ConvexResultList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::geom::ConvexResult ConvexResultList_obj::shift( ){
	HX_STACK_FRAME("ConvexResultList","shift","ConvexResultList.shift","nape/geom/ConvexResultList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::ConvexResultList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::geom::ConvexResult ConvexResultList_obj::pop( ){
	HX_STACK_FRAME("ConvexResultList","pop","ConvexResultList.pop","nape/geom/ConvexResultList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::ConvexResultList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool ConvexResultList_obj::unshift( ::nape::geom::ConvexResult obj){
	HX_STACK_FRAME("ConvexResultList","unshift","ConvexResultList.unshift","nape/geom/ConvexResultList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::geom::ConvexResultList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool ConvexResultList_obj::push( ::nape::geom::ConvexResult obj){
	HX_STACK_FRAME("ConvexResultList","push","ConvexResultList.push","nape/geom/ConvexResultList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::geom::ConvexResultList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::geom::ConvexResult ConvexResultList_obj::at( int index){
	HX_STACK_FRAME("ConvexResultList","at","ConvexResultList.at","nape/geom/ConvexResultList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::ConvexResultList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::geom::ConvexResultList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/ConvexResultList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool ConvexResultList_obj::has( ::nape::geom::ConvexResult obj){
	HX_STACK_FRAME("ConvexResultList","has","ConvexResultList.has","nape/geom/ConvexResultList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int ConvexResultList_obj::get_length( ){
	HX_STACK_FRAME("ConvexResultList","get_length","ConvexResultList.get_length","nape/geom/ConvexResultList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::geom::ConvexResultList ConvexResultList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("ConvexResultList","fromArray","ConvexResultList.fromArray","nape/geom/ConvexResultList.hx",304)
