...
{
HX_STACK_FRAME("GeomPolyIterator","new","GeomPolyIterator.new","nape/geom/GeomPolyIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_GeomPolyList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("GeomPoly")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::geom::GeomPoly GeomPolyIterator_obj::next( ){
	HX_STACK_FRAME("GeomPolyIterator","next","GeomPolyIterator.next","nape/geom/GeomPolyIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool GeomPolyIterator_obj::hasNext( ){
	HX_STACK_FRAME("GeomPolyIterator","hasNext","GeomPolyIterator.hasNext","nape/geom/GeomPolyIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::geom::GeomPolyIterator GeomPolyIterator_obj::get( ::nape::geom::GeomPolyList list){
	HX_STACK_FRAME("GeomPolyIterator","get","GeomPolyIterator.get","nape/geom/GeomPolyIterator.hx",217)
