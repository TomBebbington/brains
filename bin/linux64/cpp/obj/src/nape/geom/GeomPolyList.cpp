...
{
HX_STACK_FRAME("GeomPolyList","new","GeomPolyList.new","nape/geom/GeomPolyList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	this->zpp_inner = ::zpp_nape::util::ZPP_GeomPolyList_obj::__new();
	HX_STACK_LINE(697)
...
::nape::geom::GeomPolyList GeomPolyList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("GeomPolyList","filter","GeomPolyList.filter","nape/geom/GeomPolyList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::geom::GeomPolyList GeomPolyList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("GeomPolyList","foreach","GeomPolyList.foreach","nape/geom/GeomPolyList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::geom::GeomPolyIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",737)
			{
				HX_STACK_LINE(737)
	...
	while((_Function_1_1::Block(it))){
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::geom::GeomPoly Block( ::nape::geom::GeomPolyIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String GeomPolyList_obj::toString( ){
	HX_STACK_FRAME("GeomPolyList","toString","GeomPolyList.toString","nape/geom/GeomPolyList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::geom::GeomPolyIterator Block( ::nape::geom::GeomPolyList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
				return ::nape::geom::GeomPolyIterator_obj::get(__this);
			}
			return null();
		}
	};
	HX_STACK_LINE(705)
	for(::cpp::FastIterator_obj< ::nape::geom::GeomPoly > *__it = ::cpp::CreateFastIterator< ::nape::geom::GeomPoly >(_Function_1_1::Block(this));  __it->hasNext(); ){
		::nape::geom::GeomPoly i = __it->next();
		{
			HX_STACK_LINE(706)
			if ((!(fst))){
				HX_STACK_LINE(706)
...
{
		HX_STACK_FRAME("GeomPolyList","merge","GeomPolyList.merge","nape/geom/GeomPolyList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::geom::GeomPolyIterator Block( ::nape::geom::GeomPolyList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
					return ::nape::geom::GeomPolyIterator_obj::get(xs);
				}
				return null();
			}
		};
		HX_STACK_LINE(688)
		for(::cpp::FastIterator_obj< ::nape::geom::GeomPoly > *__it = ::cpp::CreateFastIterator< ::nape::geom::GeomPoly >(_Function_1_1::Block(xs));  __it->hasNext(); ){
			::nape::geom::GeomPoly x = __it->next();
			if ((!(this->has(x)))){
				HX_STACK_LINE(689)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("GeomPolyList","copy","GeomPolyList.copy","nape/geom/GeomPolyList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::GeomPolyIterator Block( ::nape::geom::GeomPolyList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::geom::GeomPoly Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",664)
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("GeomPoly")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
		...
		for(::cpp::FastIterator_obj< ::nape::geom::GeomPoly > *__it = ::cpp::CreateFastIterator< ::nape::geom::GeomPoly >(_Function_1_1::Block(this));  __it->hasNext(); ){
			::nape::geom::GeomPoly i = __it->next();
			ret->push((  ((deep)) ? ::nape::geom::GeomPoly(_Function_1_2::Block()) : ::nape::geom::GeomPoly(i) ));
		}
		HX_STACK_LINE(671)
		return ret;
	}
...
::nape::geom::GeomPolyIterator GeomPolyList_obj::iterator( ){
	HX_STACK_FRAME("GeomPolyList","iterator","GeomPolyList.iterator","nape/geom/GeomPolyList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool GeomPolyList_obj::empty( ){
	HX_STACK_FRAME("GeomPolyList","empty","GeomPolyList.empty","nape/geom/GeomPolyList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("GeomPolyList","clear","GeomPolyList.clear","nape/geom/GeomPolyList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("GeomPoly")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool GeomPolyList_obj::remove( ::nape::geom::GeomPoly obj){
	HX_STACK_FRAME("GeomPolyList","remove","GeomPolyList.remove","nape/geom/GeomPolyList.hx",576)
	HX_STACK_THIS(this)
...
bool GeomPolyList_obj::add( ::nape::geom::GeomPoly obj){
	HX_STACK_FRAME("GeomPolyList","add","GeomPolyList.add","nape/geom/GeomPolyList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::geom::GeomPoly GeomPolyList_obj::shift( ){
	HX_STACK_FRAME("GeomPolyList","shift","GeomPolyList.shift","nape/geom/GeomPolyList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::geom::GeomPoly GeomPolyList_obj::pop( ){
	HX_STACK_FRAME("GeomPolyList","pop","GeomPolyList.pop","nape/geom/GeomPolyList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool GeomPolyList_obj::unshift( ::nape::geom::GeomPoly obj){
	HX_STACK_FRAME("GeomPolyList","unshift","GeomPolyList.unshift","nape/geom/GeomPolyList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool GeomPolyList_obj::push( ::nape::geom::GeomPoly obj){
	HX_STACK_FRAME("GeomPolyList","push","GeomPolyList.push","nape/geom/GeomPolyList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::geom::GeomPoly GeomPolyList_obj::at( int index){
	HX_STACK_FRAME("GeomPolyList","at","GeomPolyList.at","nape/geom/GeomPolyList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/geom/GeomPolyList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool GeomPolyList_obj::has( ::nape::geom::GeomPoly obj){
	HX_STACK_FRAME("GeomPolyList","has","GeomPolyList.has","nape/geom/GeomPolyList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int GeomPolyList_obj::get_length( ){
	HX_STACK_FRAME("GeomPolyList","get_length","GeomPolyList.get_length","nape/geom/GeomPolyList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::geom::GeomPolyList GeomPolyList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("GeomPolyList","fromArray","GeomPolyList.fromArray","nape/geom/GeomPolyList.hx",304)
