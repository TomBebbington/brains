...
{
HX_STACK_FRAME("CompoundList","new","CompoundList.new","nape/phys/CompoundList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	this->zpp_inner = ::zpp_nape::util::ZPP_CompoundList_obj::__new();
	HX_STACK_LINE(697)
...
::nape::phys::CompoundList CompoundList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("CompoundList","filter","CompoundList.filter","nape/phys/CompoundList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::CompoundList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::phys::CompoundList CompoundList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("CompoundList","foreach","CompoundList.foreach","nape/phys/CompoundList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::phys::CompoundIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",737)
			{
				HX_STACK_LINE(737)
	...
	while((_Function_1_1::Block(it))){
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::phys::Compound Block( ::nape::phys::CompoundIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String CompoundList_obj::toString( ){
	HX_STACK_FRAME("CompoundList","toString","CompoundList.toString","nape/phys/CompoundList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::phys::CompoundIterator Block( ::nape::phys::CompoundList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
				return ::nape::phys::CompoundIterator_obj::get(__this);
			}
			return null();
		}
	};
	...
	for(::cpp::FastIterator_obj< ::nape::phys::Compound > *__it = ::cpp::CreateFastIterator< ::nape::phys::Compound >(_Function_1_1::Block(this));  __it->hasNext(); ){
		::nape::phys::Compound i = __it->next();
		{
			HX_STACK_LINE(706)
			if ((!(fst))){
				HX_STACK_LINE(706)
...
{
		HX_STACK_FRAME("CompoundList","merge","CompoundList.merge","nape/phys/CompoundList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::phys::CompoundIterator Block( ::nape::phys::CompoundList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
					return ::nape::phys::CompoundIterator_obj::get(xs);
				}
				return null();
			}
		};
		HX_STACK_LINE(688)
		for(::cpp::FastIterator_obj< ::nape::phys::Compound > *__it = ::cpp::CreateFastIterator< ::nape::phys::Compound >(_Function_1_1::Block(xs));  __it->hasNext(); ){
			::nape::phys::Compound x = __it->next();
			if ((!(this->has(x)))){
				HX_STACK_LINE(689)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("CompoundList","copy","CompoundList.copy","nape/phys/CompoundList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::CompoundIterator Block( ::nape::phys::CompoundList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::phys::Compound Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",664)
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Compound")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
		...
		for(::cpp::FastIterator_obj< ::nape::phys::Compound > *__it = ::cpp::CreateFastIterator< ::nape::phys::Compound >(_Function_1_1::Block(this));  __it->hasNext(); ){
			::nape::phys::Compound i = __it->next();
			ret->push((  ((deep)) ? ::nape::phys::Compound(_Function_1_2::Block()) : ::nape::phys::Compound(i) ));
		}
		HX_STACK_LINE(671)
		return ret;
	}
...
::nape::phys::CompoundIterator CompoundList_obj::iterator( ){
	HX_STACK_FRAME("CompoundList","iterator","CompoundList.iterator","nape/phys/CompoundList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool CompoundList_obj::empty( ){
	HX_STACK_FRAME("CompoundList","empty","CompoundList.empty","nape/phys/CompoundList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("CompoundList","clear","CompoundList.clear","nape/phys/CompoundList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Compound")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool CompoundList_obj::remove( ::nape::phys::Compound obj){
	HX_STACK_FRAME("CompoundList","remove","CompoundList.remove","nape/phys/CompoundList.hx",576)
	HX_STACK_THIS(this)
...
bool CompoundList_obj::add( ::nape::phys::Compound obj){
	HX_STACK_FRAME("CompoundList","add","CompoundList.add","nape/phys/CompoundList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::phys::Compound CompoundList_obj::shift( ){
	HX_STACK_FRAME("CompoundList","shift","CompoundList.shift","nape/phys/CompoundList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::CompoundList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::phys::Compound CompoundList_obj::pop( ){
	HX_STACK_FRAME("CompoundList","pop","CompoundList.pop","nape/phys/CompoundList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::CompoundList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool CompoundList_obj::unshift( ::nape::phys::Compound obj){
	HX_STACK_FRAME("CompoundList","unshift","CompoundList.unshift","nape/phys/CompoundList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::CompoundList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool CompoundList_obj::push( ::nape::phys::Compound obj){
	HX_STACK_FRAME("CompoundList","push","CompoundList.push","nape/phys/CompoundList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::CompoundList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::phys::Compound CompoundList_obj::at( int index){
	HX_STACK_FRAME("CompoundList","at","CompoundList.at","nape/phys/CompoundList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::CompoundList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::phys::CompoundList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/CompoundList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool CompoundList_obj::has( ::nape::phys::Compound obj){
	HX_STACK_FRAME("CompoundList","has","CompoundList.has","nape/phys/CompoundList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int CompoundList_obj::get_length( ){
	HX_STACK_FRAME("CompoundList","get_length","CompoundList.get_length","nape/phys/CompoundList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::phys::CompoundList CompoundList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("CompoundList","fromArray","CompoundList.fromArray","nape/phys/CompoundList.hx",304)
