...
{
HX_STACK_FRAME("BodyIterator","new","BodyIterator.new","nape/phys/BodyIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_BodyList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Body")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::phys::Body BodyIterator_obj::next( ){
	HX_STACK_FRAME("BodyIterator","next","BodyIterator.next","nape/phys/BodyIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool BodyIterator_obj::hasNext( ){
	HX_STACK_FRAME("BodyIterator","hasNext","BodyIterator.hasNext","nape/phys/BodyIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::phys::BodyIterator BodyIterator_obj::get( ::nape::phys::BodyList list){
	HX_STACK_FRAME("BodyIterator","get","BodyIterator.get","nape/phys/BodyIterator.hx",217)
