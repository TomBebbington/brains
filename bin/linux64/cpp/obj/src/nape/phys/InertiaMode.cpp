...
{
HX_STACK_FRAME("InertiaMode","new","InertiaMode.new","nape/phys/InertiaMode.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("InertiaMode")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String InertiaMode_obj::toString( ){
	HX_STACK_FRAME("InertiaMode","toString","InertiaMode.toString","nape/phys/InertiaMode.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::phys::InertiaMode Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/InertiaMode.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::phys::InertiaMode Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/InertiaMode.hx",193)
				{
					HX_STACK_LINE(193)
...
::nape::phys::InertiaMode InertiaMode_obj::get_DEFAULT( ){
	HX_STACK_FRAME("InertiaMode","get_DEFAULT","InertiaMode.get_DEFAULT","nape/phys/InertiaMode.hx",203)
	HX_STACK_LINE(204)
	if (((::zpp_nape::util::ZPP_Flags_obj::InertiaMode_DEFAULT == null()))){
		HX_STACK_LINE(205)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::phys::InertiaMode InertiaMode_obj::get_FIXED( ){
	HX_STACK_FRAME("InertiaMode","get_FIXED","InertiaMode.get_FIXED","nape/phys/InertiaMode.hx",218)
	HX_STACK_LINE(219)
	if (((::zpp_nape::util::ZPP_Flags_obj::InertiaMode_FIXED == null()))){
		HX_STACK_LINE(220)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
