...
{
HX_STACK_FRAME("MassMode","new","MassMode.new","nape/phys/MassMode.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("MassMode")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String MassMode_obj::toString( ){
	HX_STACK_FRAME("MassMode","toString","MassMode.toString","nape/phys/MassMode.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::phys::MassMode Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/MassMode.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::phys::MassMode Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/MassMode.hx",193)
				{
					HX_STACK_LINE(193)
...
::nape::phys::MassMode MassMode_obj::get_DEFAULT( ){
	HX_STACK_FRAME("MassMode","get_DEFAULT","MassMode.get_DEFAULT","nape/phys/MassMode.hx",203)
	HX_STACK_LINE(204)
	if (((::zpp_nape::util::ZPP_Flags_obj::MassMode_DEFAULT == null()))){
		HX_STACK_LINE(205)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::phys::MassMode MassMode_obj::get_FIXED( ){
	HX_STACK_FRAME("MassMode","get_FIXED","MassMode.get_FIXED","nape/phys/MassMode.hx",218)
	HX_STACK_LINE(219)
	if (((::zpp_nape::util::ZPP_Flags_obj::MassMode_FIXED == null()))){
		HX_STACK_LINE(220)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
