...
{
HX_STACK_FRAME("InteractorIterator","new","InteractorIterator.new","nape/phys/InteractorIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_InteractorList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Interactor")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::phys::Interactor InteractorIterator_obj::next( ){
	HX_STACK_FRAME("InteractorIterator","next","InteractorIterator.next","nape/phys/InteractorIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool InteractorIterator_obj::hasNext( ){
	HX_STACK_FRAME("InteractorIterator","hasNext","InteractorIterator.hasNext","nape/phys/InteractorIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::phys::InteractorIterator InteractorIterator_obj::get( ::nape::phys::InteractorList list){
	HX_STACK_FRAME("InteractorIterator","get","InteractorIterator.get","nape/phys/InteractorIterator.hx",217)
