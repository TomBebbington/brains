...
{
HX_STACK_FRAME("BodyList","new","BodyList.new","nape/phys/BodyList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
	this->zpp_inner = ::zpp_nape::util::ZPP_BodyList_obj::__new();
	HX_STACK_LINE(697)
...
::nape::phys::BodyList BodyList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("BodyList","filter","BodyList.filter","nape/phys/BodyList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::BodyList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::phys::BodyList BodyList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("BodyList","foreach","BodyList.foreach","nape/phys/BodyList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::phys::BodyIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",737)
			{
				HX_STACK_LINE(737)
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::phys::Body Block( ::nape::phys::BodyIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String BodyList_obj::toString( ){
	HX_STACK_FRAME("BodyList","toString","BodyList.toString","nape/phys/BodyList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
				return ::nape::phys::BodyIterator_obj::get(__this);
			}
			return null();
		}
	};
...
{
		HX_STACK_FRAME("BodyList","merge","BodyList.merge","nape/phys/BodyList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
					return ::nape::phys::BodyIterator_obj::get(xs);
				}
				return null();
			}
		};
		HX_STACK_LINE(688)
		for(::cpp::FastIterator_obj< ::nape::phys::Body > *__it = ::cpp::CreateFastIterator< ::nape::phys::Body >(_Function_1_1::Block(xs));  __it->hasNext(); ){
			::nape::phys::Body x = __it->next();
			if ((!(this->has(x)))){
				HX_STACK_LINE(689)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("BodyList","copy","BodyList.copy","nape/phys/BodyList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::phys::Body Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",664)
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Body")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
		...
		for(::cpp::FastIterator_obj< ::nape::phys::Body > *__it = ::cpp::CreateFastIterator< ::nape::phys::Body >(_Function_1_1::Block(this));  __it->hasNext(); ){
			::nape::phys::Body i = __it->next();
			ret->push((  ((deep)) ? ::nape::phys::Body(_Function_1_2::Block()) : ::nape::phys::Body(i) ));
		}
		HX_STACK_LINE(671)
		return ret;
	}
...
::nape::phys::BodyIterator BodyList_obj::iterator( ){
	HX_STACK_FRAME("BodyList","iterator","BodyList.iterator","nape/phys/BodyList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool BodyList_obj::empty( ){
	HX_STACK_FRAME("BodyList","empty","BodyList.empty","nape/phys/BodyList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("BodyList","clear","BodyList.clear","nape/phys/BodyList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Body")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool BodyList_obj::remove( ::nape::phys::Body obj){
	HX_STACK_FRAME("BodyList","remove","BodyList.remove","nape/phys/BodyList.hx",576)
	HX_STACK_THIS(this)
...
bool BodyList_obj::add( ::nape::phys::Body obj){
	HX_STACK_FRAME("BodyList","add","BodyList.add","nape/phys/BodyList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::phys::Body BodyList_obj::shift( ){
	HX_STACK_FRAME("BodyList","shift","BodyList.shift","nape/phys/BodyList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::phys::Body BodyList_obj::pop( ){
	HX_STACK_FRAME("BodyList","pop","BodyList.pop","nape/phys/BodyList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool BodyList_obj::unshift( ::nape::phys::Body obj){
	HX_STACK_FRAME("BodyList","unshift","BodyList.unshift","nape/phys/BodyList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::BodyList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool BodyList_obj::push( ::nape::phys::Body obj){
	HX_STACK_FRAME("BodyList","push","BodyList.push","nape/phys/BodyList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::BodyList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::phys::Body BodyList_obj::at( int index){
	HX_STACK_FRAME("BodyList","at","BodyList.at","nape/phys/BodyList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::BodyList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/BodyList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool BodyList_obj::has( ::nape::phys::Body obj){
	HX_STACK_FRAME("BodyList","has","BodyList.has","nape/phys/BodyList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int BodyList_obj::get_length( ){
	HX_STACK_FRAME("BodyList","get_length","BodyList.get_length","nape/phys/BodyList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::phys::BodyList BodyList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("BodyList","fromArray","BodyList.fromArray","nape/phys/BodyList.hx",304)
