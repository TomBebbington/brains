...
{
HX_STACK_FRAME("Material","new","Material.new","nape/phys/Material.hx",177)
...
Float rollingFriction = __o_rollingFriction.Default(0.001);
{
	...
	HX_STACK_LINE(248)
	{
		...
		if (((elasticity != this->zpp_inner->elasticity))){
			...
			if (((elasticity != elasticity))){
				HX_STACK_LINE(248)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Material::") + HX_CSTRING("elasticity")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(248)
	...
	HX_STACK_LINE(249)
	{
		...
		if (((dynamicFriction != this->zpp_inner->dynamicFriction))){
			...
			if (((dynamicFriction != dynamicFriction))){
				HX_STACK_LINE(249)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Material::") + HX_CSTRING("dynamicFriction")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(249)
			if (((dynamicFriction < (int)0))){
				HX_STACK_LINE(249)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Material::") + HX_CSTRING("dynamicFriction")) + HX_CSTRING(" cannot be negative")));
			}
			HX_STACK_LINE(249)
	...
	HX_STACK_LINE(250)
	{
		...
		if (((staticFriction != this->zpp_inner->staticFriction))){
			...
			if (((staticFriction != staticFriction))){
				HX_STACK_LINE(250)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Material::") + HX_CSTRING("staticFriction")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(250)
			if (((staticFriction < (int)0))){
				HX_STACK_LINE(250)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Material::") + HX_CSTRING("staticFriction")) + HX_CSTRING(" cannot be negative")));
			}
			HX_STACK_LINE(250)
	...
	HX_STACK_LINE(251)
	{
		...
		if (((density != (this->zpp_inner->density * (int)1000)))){
			...
			if (((density != density))){
				HX_STACK_LINE(251)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Material::") + HX_CSTRING("density")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(251)
			if (((density < (int)0))){
				HX_STACK_LINE(251)
			...
			if (((density < (int)0))){
				HX_STACK_LINE(251)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Material::") + HX_CSTRING("density")) + HX_CSTRING(" cannot be negative")));
			}
			HX_STACK_LINE(251)
	...
	HX_STACK_LINE(252)
	{
		...
		if (((rollingFriction != this->zpp_inner->rollingFriction))){
			...
			if (((rollingFriction != rollingFriction))){
				HX_STACK_LINE(252)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Material::") + HX_CSTRING("rollingFriction")) + HX_CSTRING(" cannot be NaN")));
			}
			HX_STACK_LINE(252)
			if (((rollingFriction < (int)0))){
				HX_STACK_LINE(252)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Material::") + HX_CSTRING("rollingFriction")) + HX_CSTRING(" cannot be negative")));
			}
			HX_STACK_LINE(252)
...
::String Material_obj::toString( ){
	HX_STACK_FRAME("Material","toString","Material.toString","nape/phys/Material.hx",426)
	HX_STACK_THIS(this)
	HX_STACK_LINE(426)
...
Float Material_obj::set_rollingFriction( Float rollingFriction){
	HX_STACK_FRAME("Material","set_rollingFriction","Material.set_rollingFriction","nape/phys/Material.hx",408)
	HX_STACK_THIS(this)
...
Float Material_obj::get_rollingFriction( ){
	HX_STACK_FRAME("Material","get_rollingFriction","Material.get_rollingFriction","nape/phys/Material.hx",406)
	HX_STACK_THIS(this)
	HX_STACK_LINE(406)
	return this->zpp_inner->rollingFriction;
}
...
Float Material_obj::set_density( Float density){
	HX_STACK_FRAME("Material","set_density","Material.set_density","nape/phys/Material.hx",377)
	HX_STACK_THIS(this)
...
Float Material_obj::get_density( ){
	HX_STACK_FRAME("Material","get_density","Material.get_density","nape/phys/Material.hx",375)
	HX_STACK_THIS(this)
	HX_STACK_LINE(375)
	return (this->zpp_inner->density * (int)1000);
}
...
Float Material_obj::set_staticFriction( Float staticFriction){
	HX_STACK_FRAME("Material","set_staticFriction","Material.set_staticFriction","nape/phys/Material.hx",349)
	HX_STACK_THIS(this)
...
Float Material_obj::get_staticFriction( ){
	HX_STACK_FRAME("Material","get_staticFriction","Material.get_staticFriction","nape/phys/Material.hx",347)
	HX_STACK_THIS(this)
	HX_STACK_LINE(347)
	return this->zpp_inner->staticFriction;
}
...
Float Material_obj::set_dynamicFriction( Float dynamicFriction){
	HX_STACK_FRAME("Material","set_dynamicFriction","Material.set_dynamicFriction","nape/phys/Material.hx",319)
	HX_STACK_THIS(this)
...
Float Material_obj::get_dynamicFriction( ){
	HX_STACK_FRAME("Material","get_dynamicFriction","Material.get_dynamicFriction","nape/phys/Material.hx",317)
	HX_STACK_THIS(this)
	HX_STACK_LINE(317)
	return this->zpp_inner->dynamicFriction;
}
...
Float Material_obj::set_elasticity( Float elasticity){
	HX_STACK_FRAME("Material","set_elasticity","Material.set_elasticity","nape/phys/Material.hx",289)
	HX_STACK_THIS(this)
...
Float Material_obj::get_elasticity( ){
	HX_STACK_FRAME("Material","get_elasticity","Material.get_elasticity","nape/phys/Material.hx",287)
	HX_STACK_THIS(this)
	HX_STACK_LINE(287)
	return this->zpp_inner->elasticity;
}
...
::nape::phys::Material Material_obj::copy( ){
	HX_STACK_FRAME("Material","copy","Material.copy","nape/phys/Material.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
...
::nape::shape::ShapeList Material_obj::get_shapes( ){
	HX_STACK_FRAME("Material","get_shapes","Material.get_shapes","nape/phys/Material.hx",210)
	HX_STACK_THIS(this)
	HX_STACK_LINE(211)
...
Dynamic Material_obj::get_userData( ){
	HX_STACK_FRAME("Material","get_userData","Material.get_userData","nape/phys/Material.hx",195)
	HX_STACK_THIS(this)
	HX_STACK_LINE(196)
	if (((this->zpp_inner->userData == null()))){
		struct _Function_2_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/Material.hx",197)
				{
...
::nape::phys::Material Material_obj::wood( ){
	HX_STACK_FRAME("Material","wood","Material.wood","nape/phys/Material.hx",435)
	HX_STACK_LINE(435)
...
::nape::phys::Material Material_obj::steel( ){
	HX_STACK_FRAME("Material","steel","Material.steel","nape/phys/Material.hx",444)
	HX_STACK_LINE(444)
...
::nape::phys::Material Material_obj::ice( ){
	HX_STACK_FRAME("Material","ice","Material.ice","nape/phys/Material.hx",453)
	HX_STACK_LINE(453)
...
::nape::phys::Material Material_obj::rubber( ){
	HX_STACK_FRAME("Material","rubber","Material.rubber","nape/phys/Material.hx",462)
	HX_STACK_LINE(462)
...
::nape::phys::Material Material_obj::glass( ){
	HX_STACK_FRAME("Material","glass","Material.glass","nape/phys/Material.hx",471)
	HX_STACK_LINE(471)
...
::nape::phys::Material Material_obj::sand( ){
	HX_STACK_FRAME("Material","sand","Material.sand","nape/phys/Material.hx",480)
	HX_STACK_LINE(480)
