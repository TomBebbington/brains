...
{
HX_STACK_FRAME("GravMassMode","new","GravMassMode.new","nape/phys/GravMassMode.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("GravMassMode")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String GravMassMode_obj::toString( ){
	HX_STACK_FRAME("GravMassMode","toString","GravMassMode.toString","nape/phys/GravMassMode.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::phys::GravMassMode Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/GravMassMode.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::phys::GravMassMode Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/GravMassMode.hx",193)
				{
					HX_STACK_LINE(193)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::phys::GravMassMode Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/phys/GravMassMode.hx",194)
					{
						HX_STACK_LINE(194)
...
::nape::phys::GravMassMode GravMassMode_obj::get_DEFAULT( ){
	HX_STACK_FRAME("GravMassMode","get_DEFAULT","GravMassMode.get_DEFAULT","nape/phys/GravMassMode.hx",204)
	HX_STACK_LINE(205)
	if (((::zpp_nape::util::ZPP_Flags_obj::GravMassMode_DEFAULT == null()))){
		HX_STACK_LINE(206)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::phys::GravMassMode GravMassMode_obj::get_FIXED( ){
	HX_STACK_FRAME("GravMassMode","get_FIXED","GravMassMode.get_FIXED","nape/phys/GravMassMode.hx",219)
	HX_STACK_LINE(220)
	if (((::zpp_nape::util::ZPP_Flags_obj::GravMassMode_FIXED == null()))){
		HX_STACK_LINE(221)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::phys::GravMassMode GravMassMode_obj::get_SCALED( ){
	HX_STACK_FRAME("GravMassMode","get_SCALED","GravMassMode.get_SCALED","nape/phys/GravMassMode.hx",235)
	HX_STACK_LINE(236)
	if (((::zpp_nape::util::ZPP_Flags_obj::GravMassMode_SCALED == null()))){
		HX_STACK_LINE(237)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
