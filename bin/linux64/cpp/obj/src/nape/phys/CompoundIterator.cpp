...
{
HX_STACK_FRAME("CompoundIterator","new","CompoundIterator.new","nape/phys/CompoundIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_CompoundList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Compound")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::phys::Compound CompoundIterator_obj::next( ){
	HX_STACK_FRAME("CompoundIterator","next","CompoundIterator.next","nape/phys/CompoundIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool CompoundIterator_obj::hasNext( ){
	HX_STACK_FRAME("CompoundIterator","hasNext","CompoundIterator.hasNext","nape/phys/CompoundIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::phys::CompoundIterator CompoundIterator_obj::get( ::nape::phys::CompoundList list){
	HX_STACK_FRAME("CompoundIterator","get","CompoundIterator.get","nape/phys/CompoundIterator.hx",217)
