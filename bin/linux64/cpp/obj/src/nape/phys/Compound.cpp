...
{
HX_STACK_FRAME("Compound","new","Compound.new","nape/phys/Compound.hx",196)
{
	HX_STACK_LINE(200)
	this->zpp_inner = null();
	HX_STACK_LINE(289)
...
::nape::phys::Compound Compound_obj::rotate( ::nape::geom::Vec2 centre,Float angle){
	HX_STACK_FRAME("Compound","rotate","Compound.rotate","nape/phys/Compound.hx",463)
	HX_STACK_THIS(this)
	...
	HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_1_1,Array< ::Dynamic >,centre1,Array< Float >,angle1)
	Void run(::nape::phys::Body b){
		HX_STACK_FRAME("*","_Function_1_1","*._Function_1_1","nape/phys/Compound.hx",477)
		HX_STACK_ARG(b,"b")
		{
			HX_STACK_LINE(477)
...
::nape::phys::Compound Compound_obj::translate( ::nape::geom::Vec2 translation){
	HX_STACK_FRAME("Compound","translate","Compound.translate","nape/phys/Compound.hx",426)
	HX_STACK_THIS(this)
	...
	Void run(::nape::phys::Body b){
		HX_STACK_FRAME("*","_Function_1_1","*._Function_1_1","nape/phys/Compound.hx",437)
		HX_STACK_ARG(b,"b")
		{
			struct _Function_2_1{
				inline static ::nape::geom::Vec2 Block( ::nape::phys::Body &b){
					HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",437)
					{
						HX_STACK_LINE(437)
...
bool weak = __o_weak.Default(false);
	HX_STACK_FRAME("Compound","COM","Compound.COM","nape/phys/Compound.hx",401)
	HX_STACK_THIS(this)
	HX_STACK_ARG(weak,"weak")
{
			...
			if (((ret1->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret1){
						HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",402)
						{
							HX_STACK_LINE(402)
							if (((bool((ret1 != null())) && bool(ret1->zpp_disp)))){
								HX_STACK_LINE(402)
				...
				HX_STACK_LINE(402)
				if ((!(((bool((_Function_3_1::Block(ret1) == (int)0)) && bool((_Function_3_2::Block(ret1) == (int)0))))))){
					HX_STACK_LINE(402)
					{
						HX_STACK_LINE(402)
						ret1->zpp_inner->x = (int)0;
						HX_STACK_LINE(402)
						ret1->zpp_inner->y = (int)0;
						HX_STACK_LINE(402)
						{
						}
					}
		...
		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_1_1,Array< ::Dynamic >,ret,Array< Float >,total)
		Void run(::nape::phys::Body b){
			HX_STACK_FRAME("*","_Function_1_1","*._Function_1_1","nape/phys/Compound.hx",405)
			HX_STACK_ARG(b,"b")
			{
				struct _Function_2_1{
					inline static bool Block( ::nape::phys::Body &b){
						HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",405)
						{
							HX_STACK_LINE(405)
				...
				if ((!(_Function_2_1::Block(b)))){
					struct _Function_3_1{
						inline static ::nape::geom::Vec2 Block( ::nape::phys::Body &b){
							HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",406)
							{
								HX_STACK_LINE(406)
					...
					struct _Function_3_3{
						inline static Float Block( ::nape::phys::Body &b){
							HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",407)
							{
								HX_STACK_LINE(407)
								if ((b->zpp_inner->world)){
									HX_STACK_LINE(407)
...
{
		HX_STACK_FRAME("Compound","visitCompounds","Compound.visitCompounds","nape/phys/Compound.hx",382)
		HX_STACK_THIS(this)
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::nape::phys::Compound_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",386)
				{
					HX_STACK_LINE(386)
...
{
		HX_STACK_FRAME("Compound","visitConstraints","Compound.visitConstraints","nape/phys/Compound.hx",368)
		HX_STACK_THIS(this)
		HX_STACK_ARG(lambda,"lambda")
		HX_STACK_LINE(370)
		if (((lambda == null()))){
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::nape::phys::Compound_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",372)
				{
					HX_STACK_LINE(372)
		...
		struct _Function_1_2{
			inline static Dynamic Block( ::nape::phys::Compound_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",373)
				{
					HX_STACK_LINE(373)
					::nape::phys::CompoundList _this = __this->zpp_inner->wrap_compounds;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(373)
...
{
		HX_STACK_FRAME("Compound","visitBodies","Compound.visitBodies","nape/phys/Compound.hx",354)
		HX_STACK_THIS(this)
		HX_STACK_ARG(lambda,"lambda")
		HX_STACK_LINE(356)
		if (((lambda == null()))){
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::nape::phys::Compound_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",358)
				{
					HX_STACK_LINE(358)
		...
		struct _Function_1_2{
			inline static Dynamic Block( ::nape::phys::Compound_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/Compound.hx",359)
				{
					HX_STACK_LINE(359)
					::nape::phys::CompoundList _this = __this->zpp_inner->wrap_compounds;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(359)
...
{
		HX_STACK_FRAME("Compound","breakApart","Compound.breakApart","nape/phys/Compound.hx",345)
		HX_STACK_THIS(this)
		HX_STACK_LINE(345)
...
::nape::phys::Compound Compound_obj::copy( ){
	HX_STACK_FRAME("Compound","copy","Compound.copy","nape/phys/Compound.hx",331)
	HX_STACK_THIS(this)
	HX_STACK_LINE(331)
...
::String Compound_obj::toString( ){
	HX_STACK_FRAME("Compound","toString","Compound.toString","nape/phys/Compound.hx",307)
	HX_STACK_THIS(this)
	HX_STACK_LINE(307)
...
::nape::space::Space Compound_obj::set_space( ::nape::space::Space space){
	HX_STACK_FRAME("Compound","set_space","Compound.set_space","nape/phys/Compound.hx",269)
	HX_STACK_THIS(this)
...
::nape::space::Space Compound_obj::get_space( ){
	HX_STACK_FRAME("Compound","get_space","Compound.get_space","nape/phys/Compound.hx",267)
	HX_STACK_THIS(this)
	HX_STACK_LINE(267)
	if (((this->zpp_inner->space == null()))){
		HX_STACK_LINE(267)
...
::nape::phys::Compound Compound_obj::set_compound( ::nape::phys::Compound compound){
	HX_STACK_FRAME("Compound","set_compound","Compound.set_compound","nape/phys/Compound.hx",247)
	HX_STACK_THIS(this)
...
::nape::phys::Compound Compound_obj::get_compound( ){
	HX_STACK_FRAME("Compound","get_compound","Compound.get_compound","nape/phys/Compound.hx",245)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	if (((this->zpp_inner->compound == null()))){
		HX_STACK_LINE(245)
...
::nape::phys::CompoundList Compound_obj::get_compounds( ){
	HX_STACK_FRAME("Compound","get_compounds","Compound.get_compounds","nape/phys/Compound.hx",235)
	HX_STACK_THIS(this)
	HX_STACK_LINE(235)
...
::nape::constraint::ConstraintList Compound_obj::get_constraints( ){
	HX_STACK_FRAME("Compound","get_constraints","Compound.get_constraints","nape/phys/Compound.hx",223)
	HX_STACK_THIS(this)
	HX_STACK_LINE(223)
...
::nape::phys::BodyList Compound_obj::get_bodies( ){
	HX_STACK_FRAME("Compound","get_bodies","Compound.get_bodies","nape/phys/Compound.hx",211)
	HX_STACK_THIS(this)
	HX_STACK_LINE(211)
