...
{
HX_STACK_FRAME("InteractorList","new","InteractorList.new","nape/phys/InteractorList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::phys::InteractorList InteractorList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("InteractorList","filter","InteractorList.filter","nape/phys/InteractorList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::InteractorList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::phys::InteractorList InteractorList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("InteractorList","foreach","InteractorList.foreach","nape/phys/InteractorList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::phys::InteractorIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",737)
			{
				HX_STACK_LINE(737)
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::phys::Interactor Block( ::nape::phys::InteractorIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String InteractorList_obj::toString( ){
	HX_STACK_FRAME("InteractorList","toString","InteractorList.toString","nape/phys/InteractorList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::phys::InteractorIterator Block( ::nape::phys::InteractorList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_FRAME("InteractorList","merge","InteractorList.merge","nape/phys/InteractorList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::phys::InteractorIterator Block( ::nape::phys::InteractorList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("InteractorList","copy","InteractorList.copy","nape/phys/InteractorList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::InteractorIterator Block( ::nape::phys::InteractorList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::phys::Interactor Block( ){
				...
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Interactor")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::phys::InteractorIterator InteractorList_obj::iterator( ){
	HX_STACK_FRAME("InteractorList","iterator","InteractorList.iterator","nape/phys/InteractorList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool InteractorList_obj::empty( ){
	HX_STACK_FRAME("InteractorList","empty","InteractorList.empty","nape/phys/InteractorList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("InteractorList","clear","InteractorList.clear","nape/phys/InteractorList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Interactor")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool InteractorList_obj::remove( ::nape::phys::Interactor obj){
	HX_STACK_FRAME("InteractorList","remove","InteractorList.remove","nape/phys/InteractorList.hx",576)
	HX_STACK_THIS(this)
...
bool InteractorList_obj::add( ::nape::phys::Interactor obj){
	HX_STACK_FRAME("InteractorList","add","InteractorList.add","nape/phys/InteractorList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::phys::Interactor InteractorList_obj::shift( ){
	HX_STACK_FRAME("InteractorList","shift","InteractorList.shift","nape/phys/InteractorList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::InteractorList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::phys::Interactor InteractorList_obj::pop( ){
	HX_STACK_FRAME("InteractorList","pop","InteractorList.pop","nape/phys/InteractorList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::InteractorList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool InteractorList_obj::unshift( ::nape::phys::Interactor obj){
	HX_STACK_FRAME("InteractorList","unshift","InteractorList.unshift","nape/phys/InteractorList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::InteractorList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool InteractorList_obj::push( ::nape::phys::Interactor obj){
	HX_STACK_FRAME("InteractorList","push","InteractorList.push","nape/phys/InteractorList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::phys::InteractorList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::phys::Interactor InteractorList_obj::at( int index){
	HX_STACK_FRAME("InteractorList","at","InteractorList.at","nape/phys/InteractorList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::InteractorList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::phys::InteractorList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/phys/InteractorList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool InteractorList_obj::has( ::nape::phys::Interactor obj){
	HX_STACK_FRAME("InteractorList","has","InteractorList.has","nape/phys/InteractorList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int InteractorList_obj::get_length( ){
	HX_STACK_FRAME("InteractorList","get_length","InteractorList.get_length","nape/phys/InteractorList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::phys::InteractorList InteractorList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("InteractorList","fromArray","InteractorList.fromArray","nape/phys/InteractorList.hx",304)
