...
{
HX_STACK_FRAME("PivotJoint","new","PivotJoint.new","nape/constraint/PivotJoint.hx",186)
				...
				HX_STACK_LINE(344)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec2 _this){
							HX_STACK_FRAME("*","closure","*.closure","nape/constraint/PivotJoint.hx",344)
							{
								HX_STACK_LINE(344)
								if (((bool((_this != null())) && bool(_this->zpp_disp)))){
									HX_STACK_LINE(344)
		...
		HX_STACK_LINE(345)
		{
			...
			HX_STACK_LINE(345)
			{
				...
				HX_STACK_LINE(345)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec2 _this){
							HX_STACK_FRAME("*","closure","*.closure","nape/constraint/PivotJoint.hx",345)
							{
								HX_STACK_LINE(345)
								if (((bool((_this != null())) && bool(_this->zpp_disp)))){
									HX_STACK_LINE(345)
...
{
		HX_STACK_FRAME("PivotJoint","visitBodies","PivotJoint.visitBodies","nape/constraint/PivotJoint.hx",380)
		HX_STACK_THIS(this)
...
::nape::geom::Vec3 PivotJoint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("PivotJoint","bodyImpulse","PivotJoint.bodyImpulse","nape/constraint/PivotJoint.hx",361)
	HX_STACK_THIS(this)
...
::nape::geom::MatMN PivotJoint_obj::impulse( ){
	HX_STACK_FRAME("PivotJoint","impulse","PivotJoint.impulse","nape/constraint/PivotJoint.hx",352)
	HX_STACK_THIS(this)
	HX_STACK_LINE(353)
...
::nape::geom::Vec2 PivotJoint_obj::set_anchor2( ::nape::geom::Vec2 anchor2){
	HX_STACK_FRAME("PivotJoint","set_anchor2","PivotJoint.set_anchor2","nape/constraint/PivotJoint.hx",303)
	HX_STACK_THIS(this)
	HX_STACK_ARG(anchor2,"anchor2")
	HX_STACK_LINE(304)
	{
		...
		HX_STACK_LINE(313)
		{
			...
			HX_STACK_LINE(313)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 _this){
						HX_STACK_FRAME("*","closure","*.closure","nape/constraint/PivotJoint.hx",313)
						{
							HX_STACK_LINE(313)
							if (((bool((_this != null())) && bool(_this->zpp_disp)))){
								HX_STACK_LINE(313)
...
::nape::geom::Vec2 PivotJoint_obj::get_anchor2( ){
	HX_STACK_FRAME("PivotJoint","get_anchor2","PivotJoint.get_anchor2","nape/constraint/PivotJoint.hx",299)
	HX_STACK_THIS(this)
	HX_STACK_LINE(300)
	if (((this->zpp_inner_zn->wrap_a2 == null()))){
		HX_STACK_LINE(300)
...
::nape::geom::Vec2 PivotJoint_obj::set_anchor1( ::nape::geom::Vec2 anchor1){
	HX_STACK_FRAME("PivotJoint","set_anchor1","PivotJoint.set_anchor1","nape/constraint/PivotJoint.hx",278)
	HX_STACK_THIS(this)
	HX_STACK_ARG(anchor1,"anchor1")
	HX_STACK_LINE(279)
	{
		...
		HX_STACK_LINE(288)
		{
			...
			HX_STACK_LINE(288)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 _this){
						HX_STACK_FRAME("*","closure","*.closure","nape/constraint/PivotJoint.hx",288)
						{
							HX_STACK_LINE(288)
							if (((bool((_this != null())) && bool(_this->zpp_disp)))){
								HX_STACK_LINE(288)
...
::nape::geom::Vec2 PivotJoint_obj::get_anchor1( ){
	HX_STACK_FRAME("PivotJoint","get_anchor1","PivotJoint.get_anchor1","nape/constraint/PivotJoint.hx",274)
	HX_STACK_THIS(this)
	HX_STACK_LINE(275)
	if (((this->zpp_inner_zn->wrap_a1 == null()))){
		HX_STACK_LINE(275)
...
::nape::phys::Body PivotJoint_obj::set_body2( ::nape::phys::Body body2){
	HX_STACK_FRAME("PivotJoint","set_body2","PivotJoint.set_body2","nape/constraint/PivotJoint.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body2,"body2")
	HX_STACK_LINE(241)
	{
...
::nape::phys::Body PivotJoint_obj::get_body2( ){
	HX_STACK_FRAME("PivotJoint","get_body2","PivotJoint.get_body2","nape/constraint/PivotJoint.hx",238)
	HX_STACK_THIS(this)
	HX_STACK_LINE(238)
	if (((this->zpp_inner_zn->b2 == null()))){
		HX_STACK_LINE(238)
...
::nape::phys::Body PivotJoint_obj::set_body1( ::nape::phys::Body body1){
	HX_STACK_FRAME("PivotJoint","set_body1","PivotJoint.set_body1","nape/constraint/PivotJoint.hx",202)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body1,"body1")
	HX_STACK_LINE(203)
	{
...
::nape::phys::Body PivotJoint_obj::get_body1( ){
	HX_STACK_FRAME("PivotJoint","get_body1","PivotJoint.get_body1","nape/constraint/PivotJoint.hx",200)
	HX_STACK_THIS(this)
	HX_STACK_LINE(200)
	if (((this->zpp_inner_zn->b1 == null()))){
		HX_STACK_LINE(200)
