...
{
HX_STACK_FRAME("UserConstraint","new","UserConstraint.new","nape/constraint/UserConstraint.hx",192)
...
::nape::phys::Body UserConstraint_obj::__registerBody( ::nape::phys::Body oldBody,::nape::phys::Body newBody){
	HX_STACK_FRAME("UserConstraint","__registerBody","UserConstraint.__registerBody","nape/constraint/UserConstraint.hx",504)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("UserConstraint","__invalidate","UserConstraint.__invalidate","nape/constraint/UserConstraint.hx",469)
		HX_STACK_THIS(this)
		HX_STACK_LINE(470)
...
{
		HX_STACK_FRAME("UserConstraint","visitBodies","UserConstraint.visitBodies","nape/constraint/UserConstraint.hx",437)
		HX_STACK_THIS(this)
...
::nape::geom::Vec3 UserConstraint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("UserConstraint","bodyImpulse","UserConstraint.bodyImpulse","nape/constraint/UserConstraint.hx",411)
	HX_STACK_THIS(this)
...
::nape::geom::MatMN UserConstraint_obj::impulse( ){
	HX_STACK_FRAME("UserConstraint","impulse","UserConstraint.impulse","nape/constraint/UserConstraint.hx",401)
	HX_STACK_THIS(this)
	HX_STACK_LINE(402)
...
{
		HX_STACK_FRAME("UserConstraint","__impulse","UserConstraint.__impulse","nape/constraint/UserConstraint.hx",360)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("UserConstraint","__clamp","UserConstraint.__clamp","nape/constraint/UserConstraint.hx",347)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("UserConstraint","__eff_mass","UserConstraint.__eff_mass","nape/constraint/UserConstraint.hx",337)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("UserConstraint","__velocity","UserConstraint.__velocity","nape/constraint/UserConstraint.hx",315)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("UserConstraint","__position","UserConstraint.__position","nape/constraint/UserConstraint.hx",302)
		HX_STACK_THIS(this)
		HX_STACK_ARG(err,"err")
		HX_STACK_LINE(302)
...
{
		HX_STACK_FRAME("UserConstraint","__prepare","UserConstraint.__prepare","nape/constraint/UserConstraint.hx",291)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("UserConstraint","__draw","UserConstraint.__draw","nape/constraint/UserConstraint.hx",282)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("UserConstraint","__validate","UserConstraint.__validate","nape/constraint/UserConstraint.hx",271)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("UserConstraint","__broken","UserConstraint.__broken","nape/constraint/UserConstraint.hx",256)
		HX_STACK_THIS(this)
	}
return null();
}
...
::nape::constraint::UserConstraint UserConstraint_obj::__copy( ){
	HX_STACK_FRAME("UserConstraint","__copy","UserConstraint.__copy","nape/constraint/UserConstraint.hx",241)
	HX_STACK_THIS(this)
	HX_STACK_LINE(243)
...
::nape::geom::Vec2 UserConstraint_obj::__bindVec2( ){
	HX_STACK_FRAME("UserConstraint","__bindVec2","UserConstraint.__bindVec2","nape/constraint/UserConstraint.hx",223)
	HX_STACK_THIS(this)
	HX_STACK_LINE(224)
