...
{
HX_STACK_FRAME("ConstraintList","new","ConstraintList.new","nape/constraint/ConstraintList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::constraint::ConstraintList ConstraintList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("ConstraintList","filter","ConstraintList.filter","nape/constraint/ConstraintList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::constraint::ConstraintList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::constraint::ConstraintList ConstraintList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("ConstraintList","foreach","ConstraintList.foreach","nape/constraint/ConstraintList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::constraint::ConstraintIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",737)
			{
				HX_STACK_LINE(737)
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::constraint::Constraint Block( ::nape::constraint::ConstraintIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String ConstraintList_obj::toString( ){
	HX_STACK_FRAME("ConstraintList","toString","ConstraintList.toString","nape/constraint/ConstraintList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::constraint::ConstraintIterator Block( ::nape::constraint::ConstraintList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_FRAME("ConstraintList","merge","ConstraintList.merge","nape/constraint/ConstraintList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::constraint::ConstraintIterator Block( ::nape::constraint::ConstraintList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("ConstraintList","copy","ConstraintList.copy","nape/constraint/ConstraintList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::constraint::ConstraintIterator Block( ::nape::constraint::ConstraintList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::constraint::Constraint Block( ){
				...
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Constraint")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::constraint::ConstraintIterator ConstraintList_obj::iterator( ){
	HX_STACK_FRAME("ConstraintList","iterator","ConstraintList.iterator","nape/constraint/ConstraintList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool ConstraintList_obj::empty( ){
	HX_STACK_FRAME("ConstraintList","empty","ConstraintList.empty","nape/constraint/ConstraintList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("ConstraintList","clear","ConstraintList.clear","nape/constraint/ConstraintList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Constraint")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool ConstraintList_obj::remove( ::nape::constraint::Constraint obj){
	HX_STACK_FRAME("ConstraintList","remove","ConstraintList.remove","nape/constraint/ConstraintList.hx",576)
	HX_STACK_THIS(this)
...
bool ConstraintList_obj::add( ::nape::constraint::Constraint obj){
	HX_STACK_FRAME("ConstraintList","add","ConstraintList.add","nape/constraint/ConstraintList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::constraint::Constraint ConstraintList_obj::shift( ){
	HX_STACK_FRAME("ConstraintList","shift","ConstraintList.shift","nape/constraint/ConstraintList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::constraint::ConstraintList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::constraint::Constraint ConstraintList_obj::pop( ){
	HX_STACK_FRAME("ConstraintList","pop","ConstraintList.pop","nape/constraint/ConstraintList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::constraint::ConstraintList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool ConstraintList_obj::unshift( ::nape::constraint::Constraint obj){
	HX_STACK_FRAME("ConstraintList","unshift","ConstraintList.unshift","nape/constraint/ConstraintList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::constraint::ConstraintList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool ConstraintList_obj::push( ::nape::constraint::Constraint obj){
	HX_STACK_FRAME("ConstraintList","push","ConstraintList.push","nape/constraint/ConstraintList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::constraint::ConstraintList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::constraint::Constraint ConstraintList_obj::at( int index){
	HX_STACK_FRAME("ConstraintList","at","ConstraintList.at","nape/constraint/ConstraintList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::constraint::ConstraintList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::constraint::ConstraintList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/constraint/ConstraintList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool ConstraintList_obj::has( ::nape::constraint::Constraint obj){
	HX_STACK_FRAME("ConstraintList","has","ConstraintList.has","nape/constraint/ConstraintList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int ConstraintList_obj::get_length( ){
	HX_STACK_FRAME("ConstraintList","get_length","ConstraintList.get_length","nape/constraint/ConstraintList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::constraint::ConstraintList ConstraintList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("ConstraintList","fromArray","ConstraintList.fromArray","nape/constraint/ConstraintList.hx",304)
