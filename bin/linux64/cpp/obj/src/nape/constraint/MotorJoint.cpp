...
{
HX_STACK_FRAME("MotorJoint","new","MotorJoint.new","nape/constraint/MotorJoint.hx",183)
...
{
		HX_STACK_FRAME("MotorJoint","visitBodies","MotorJoint.visitBodies","nape/constraint/MotorJoint.hx",378)
		HX_STACK_THIS(this)
...
::nape::geom::Vec3 MotorJoint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("MotorJoint","bodyImpulse","MotorJoint.bodyImpulse","nape/constraint/MotorJoint.hx",359)
	HX_STACK_THIS(this)
...
::nape::geom::MatMN MotorJoint_obj::impulse( ){
	HX_STACK_FRAME("MotorJoint","impulse","MotorJoint.impulse","nape/constraint/MotorJoint.hx",349)
	HX_STACK_THIS(this)
	HX_STACK_LINE(350)
...
Float MotorJoint_obj::set_rate( Float rate){
	HX_STACK_FRAME("MotorJoint","set_rate","MotorJoint.set_rate","nape/constraint/MotorJoint.hx",299)
	HX_STACK_THIS(this)
...
Float MotorJoint_obj::get_rate( ){
	HX_STACK_FRAME("MotorJoint","get_rate","MotorJoint.get_rate","nape/constraint/MotorJoint.hx",297)
	HX_STACK_THIS(this)
	HX_STACK_LINE(297)
	return this->zpp_inner_zn->rate;
}
...
Float MotorJoint_obj::set_ratio( Float ratio){
	HX_STACK_FRAME("MotorJoint","set_ratio","MotorJoint.set_ratio","nape/constraint/MotorJoint.hx",274)
	HX_STACK_THIS(this)
...
Float MotorJoint_obj::get_ratio( ){
	HX_STACK_FRAME("MotorJoint","get_ratio","MotorJoint.get_ratio","nape/constraint/MotorJoint.hx",272)
	HX_STACK_THIS(this)
	HX_STACK_LINE(272)
	return this->zpp_inner_zn->ratio;
}
...
::nape::phys::Body MotorJoint_obj::set_body2( ::nape::phys::Body body2){
	HX_STACK_FRAME("MotorJoint","set_body2","MotorJoint.set_body2","nape/constraint/MotorJoint.hx",237)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body2,"body2")
	HX_STACK_LINE(238)
	{
...
::nape::phys::Body MotorJoint_obj::get_body2( ){
	HX_STACK_FRAME("MotorJoint","get_body2","MotorJoint.get_body2","nape/constraint/MotorJoint.hx",235)
	HX_STACK_THIS(this)
	HX_STACK_LINE(235)
	if (((this->zpp_inner_zn->b2 == null()))){
		HX_STACK_LINE(235)
...
::nape::phys::Body MotorJoint_obj::set_body1( ::nape::phys::Body body1){
	HX_STACK_FRAME("MotorJoint","set_body1","MotorJoint.set_body1","nape/constraint/MotorJoint.hx",199)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body1,"body1")
	HX_STACK_LINE(200)
	{
...
::nape::phys::Body MotorJoint_obj::get_body1( ){
	HX_STACK_FRAME("MotorJoint","get_body1","MotorJoint.get_body1","nape/constraint/MotorJoint.hx",197)
	HX_STACK_THIS(this)
	HX_STACK_LINE(197)
	if (((this->zpp_inner_zn->b1 == null()))){
		HX_STACK_LINE(197)
