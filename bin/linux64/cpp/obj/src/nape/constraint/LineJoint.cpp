...
{
HX_STACK_FRAME("LineJoint","new","LineJoint.new","nape/constraint/LineJoint.hx",208)
...
HX_STACK_ARG(jointMax,"jointMax")
{
				...
				HX_STACK_LINE(445)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec2 _this){
							HX_STACK_FRAME("*","closure","*.closure","nape/constraint/LineJoint.hx",445)
							{
								HX_STACK_LINE(445)
								if (((bool((_this != null())) && bool(_this->zpp_disp)))){
									HX_STACK_LINE(445)
		...
		HX_STACK_LINE(446)
		{
			...
			HX_STACK_LINE(446)
			{
				...
				HX_STACK_LINE(446)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec2 _this){
							HX_STACK_FRAME("*","closure","*.closure","nape/constraint/LineJoint.hx",446)
							{
								HX_STACK_LINE(446)
								if (((bool((_this != null())) && bool(_this->zpp_disp)))){
									HX_STACK_LINE(446)
	...
	HX_STACK_LINE(447)
	{
		HX_STACK_LINE(447)
		{
			...
			if (((direction == null()))){
				HX_STACK_LINE(447)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: Constraint::") + HX_CSTRING("direction")) + HX_CSTRING(" cannot be null")));
			}
			HX_STACK_LINE(447)
			{
				HX_STACK_LINE(447)
				...
				HX_STACK_LINE(447)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec2 _this){
							HX_STACK_FRAME("*","closure","*.closure","nape/constraint/LineJoint.hx",447)
							{
								HX_STACK_LINE(447)
								if (((bool((_this != null())) && bool(_this->zpp_disp)))){
									HX_STACK_LINE(447)
...
{
		HX_STACK_FRAME("LineJoint","visitBodies","LineJoint.visitBodies","nape/constraint/LineJoint.hx",484)
		HX_STACK_THIS(this)
...
::nape::geom::Vec3 LineJoint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("LineJoint","bodyImpulse","LineJoint.bodyImpulse","nape/constraint/LineJoint.hx",465)
	HX_STACK_THIS(this)
...
::nape::geom::MatMN LineJoint_obj::impulse( ){
	HX_STACK_FRAME("LineJoint","impulse","LineJoint.impulse","nape/constraint/LineJoint.hx",456)
	HX_STACK_THIS(this)
	HX_STACK_LINE(457)
...
Float LineJoint_obj::set_jointMax( Float jointMax){
	HX_STACK_FRAME("LineJoint","set_jointMax","LineJoint.set_jointMax","nape/constraint/LineJoint.hx",400)
	HX_STACK_THIS(this)
	HX_STACK_ARG(jointMax,"jointMax")
	HX_STACK_LINE(401)
	{
...
Float LineJoint_obj::get_jointMax( ){
	HX_STACK_FRAME("LineJoint","get_jointMax","LineJoint.get_jointMax","nape/constraint/LineJoint.hx",398)
	HX_STACK_THIS(this)
	HX_STACK_LINE(398)
	return this->zpp_inner_zn->jointMax;
}
...
Float LineJoint_obj::set_jointMin( Float jointMin){
	HX_STACK_FRAME("LineJoint","set_jointMin","LineJoint.set_jointMin","nape/constraint/LineJoint.hx",375)
	HX_STACK_THIS(this)
	HX_STACK_ARG(jointMin,"jointMin")
	HX_STACK_LINE(376)
	{
...
Float LineJoint_obj::get_jointMin( ){
	HX_STACK_FRAME("LineJoint","get_jointMin","LineJoint.get_jointMin","nape/constraint/LineJoint.hx",373)
	HX_STACK_THIS(this)
	HX_STACK_LINE(373)
	return this->zpp_inner_zn->jointMin;
}
...
::nape::geom::Vec2 LineJoint_obj::set_direction( ::nape::geom::Vec2 direction){
	HX_STACK_FRAME("LineJoint","set_direction","LineJoint.set_direction","nape/constraint/LineJoint.hx",351)
	HX_STACK_THIS(this)
	HX_STACK_ARG(direction,"direction")
	HX_STACK_LINE(352)
	{
		...
		HX_STACK_LINE(361)
		{
			...
			HX_STACK_LINE(361)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 _this){
						HX_STACK_FRAME("*","closure","*.closure","nape/constraint/LineJoint.hx",361)
						{
							HX_STACK_LINE(361)
							if (((bool((_this != null())) && bool(_this->zpp_disp)))){
								HX_STACK_LINE(361)
...
::nape::geom::Vec2 LineJoint_obj::get_direction( ){
	HX_STACK_FRAME("LineJoint","get_direction","LineJoint.get_direction","nape/constraint/LineJoint.hx",347)
	HX_STACK_THIS(this)
	HX_STACK_LINE(348)
	if (((this->zpp_inner_zn->wrap_n == null()))){
		HX_STACK_LINE(348)
...
::nape::geom::Vec2 LineJoint_obj::set_anchor2( ::nape::geom::Vec2 anchor2){
	HX_STACK_FRAME("LineJoint","set_anchor2","LineJoint.set_anchor2","nape/constraint/LineJoint.hx",325)
	HX_STACK_THIS(this)
	HX_STACK_ARG(anchor2,"anchor2")
	HX_STACK_LINE(326)
	{
		...
		HX_STACK_LINE(335)
		{
			...
			HX_STACK_LINE(335)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 _this){
						HX_STACK_FRAME("*","closure","*.closure","nape/constraint/LineJoint.hx",335)
						{
							HX_STACK_LINE(335)
							if (((bool((_this != null())) && bool(_this->zpp_disp)))){
								HX_STACK_LINE(335)
...
::nape::geom::Vec2 LineJoint_obj::get_anchor2( ){
	HX_STACK_FRAME("LineJoint","get_anchor2","LineJoint.get_anchor2","nape/constraint/LineJoint.hx",321)
	HX_STACK_THIS(this)
	HX_STACK_LINE(322)
	if (((this->zpp_inner_zn->wrap_a2 == null()))){
		HX_STACK_LINE(322)
...
::nape::geom::Vec2 LineJoint_obj::set_anchor1( ::nape::geom::Vec2 anchor1){
	HX_STACK_FRAME("LineJoint","set_anchor1","LineJoint.set_anchor1","nape/constraint/LineJoint.hx",300)
	HX_STACK_THIS(this)
	HX_STACK_ARG(anchor1,"anchor1")
	HX_STACK_LINE(301)
	{
		...
		HX_STACK_LINE(310)
		{
			...
			HX_STACK_LINE(310)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 _this){
						HX_STACK_FRAME("*","closure","*.closure","nape/constraint/LineJoint.hx",310)
						{
							HX_STACK_LINE(310)
							if (((bool((_this != null())) && bool(_this->zpp_disp)))){
								HX_STACK_LINE(310)
...
::nape::geom::Vec2 LineJoint_obj::get_anchor1( ){
	HX_STACK_FRAME("LineJoint","get_anchor1","LineJoint.get_anchor1","nape/constraint/LineJoint.hx",296)
	HX_STACK_THIS(this)
	HX_STACK_LINE(297)
	if (((this->zpp_inner_zn->wrap_a1 == null()))){
		HX_STACK_LINE(297)
...
::nape::phys::Body LineJoint_obj::set_body2( ::nape::phys::Body body2){
	HX_STACK_FRAME("LineJoint","set_body2","LineJoint.set_body2","nape/constraint/LineJoint.hx",262)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body2,"body2")
	HX_STACK_LINE(263)
	{
...
::nape::phys::Body LineJoint_obj::get_body2( ){
	HX_STACK_FRAME("LineJoint","get_body2","LineJoint.get_body2","nape/constraint/LineJoint.hx",260)
	HX_STACK_THIS(this)
	HX_STACK_LINE(260)
	if (((this->zpp_inner_zn->b2 == null()))){
		HX_STACK_LINE(260)
...
::nape::phys::Body LineJoint_obj::set_body1( ::nape::phys::Body body1){
	HX_STACK_FRAME("LineJoint","set_body1","LineJoint.set_body1","nape/constraint/LineJoint.hx",224)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body1,"body1")
	HX_STACK_LINE(225)
	{
...
::nape::phys::Body LineJoint_obj::get_body1( ){
	HX_STACK_FRAME("LineJoint","get_body1","LineJoint.get_body1","nape/constraint/LineJoint.hx",222)
	HX_STACK_THIS(this)
	HX_STACK_LINE(222)
	if (((this->zpp_inner_zn->b1 == null()))){
		HX_STACK_LINE(222)
