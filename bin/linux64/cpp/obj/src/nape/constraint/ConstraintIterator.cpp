...
{
HX_STACK_FRAME("ConstraintIterator","new","ConstraintIterator.new","nape/constraint/ConstraintIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_ConstraintList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Constraint")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::constraint::Constraint ConstraintIterator_obj::next( ){
	HX_STACK_FRAME("ConstraintIterator","next","ConstraintIterator.next","nape/constraint/ConstraintIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool ConstraintIterator_obj::hasNext( ){
	HX_STACK_FRAME("ConstraintIterator","hasNext","ConstraintIterator.hasNext","nape/constraint/ConstraintIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::constraint::ConstraintIterator ConstraintIterator_obj::get( ::nape::constraint::ConstraintList list){
	HX_STACK_FRAME("ConstraintIterator","get","ConstraintIterator.get","nape/constraint/ConstraintIterator.hx",217)
