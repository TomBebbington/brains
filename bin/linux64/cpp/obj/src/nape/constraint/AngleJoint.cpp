...
{
HX_STACK_FRAME("AngleJoint","new","AngleJoint.new","nape/constraint/AngleJoint.hx",182)
...
{
		HX_STACK_FRAME("AngleJoint","visitBodies","AngleJoint.visitBodies","nape/constraint/AngleJoint.hx",427)
		HX_STACK_THIS(this)
...
::nape::geom::Vec3 AngleJoint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("AngleJoint","bodyImpulse","AngleJoint.bodyImpulse","nape/constraint/AngleJoint.hx",408)
	HX_STACK_THIS(this)
...
::nape::geom::MatMN AngleJoint_obj::impulse( ){
	HX_STACK_FRAME("AngleJoint","impulse","AngleJoint.impulse","nape/constraint/AngleJoint.hx",398)
	HX_STACK_THIS(this)
	HX_STACK_LINE(399)
...
bool AngleJoint_obj::isSlack( ){
	HX_STACK_FRAME("AngleJoint","isSlack","AngleJoint.isSlack","nape/constraint/AngleJoint.hx",353)
	HX_STACK_THIS(this)
	HX_STACK_LINE(355)
...
Float AngleJoint_obj::set_ratio( Float ratio){
	HX_STACK_FRAME("AngleJoint","set_ratio","AngleJoint.set_ratio","nape/constraint/AngleJoint.hx",327)
	HX_STACK_THIS(this)
...
Float AngleJoint_obj::get_ratio( ){
	HX_STACK_FRAME("AngleJoint","get_ratio","AngleJoint.get_ratio","nape/constraint/AngleJoint.hx",325)
	HX_STACK_THIS(this)
	HX_STACK_LINE(325)
	return this->zpp_inner_zn->ratio;
}
...
Float AngleJoint_obj::set_jointMax( Float jointMax){
	HX_STACK_FRAME("AngleJoint","set_jointMax","AngleJoint.set_jointMax","nape/constraint/AngleJoint.hx",302)
	HX_STACK_THIS(this)
	HX_STACK_ARG(jointMax,"jointMax")
	HX_STACK_LINE(303)
	{
...
Float AngleJoint_obj::get_jointMax( ){
	HX_STACK_FRAME("AngleJoint","get_jointMax","AngleJoint.get_jointMax","nape/constraint/AngleJoint.hx",300)
	HX_STACK_THIS(this)
	HX_STACK_LINE(300)
	return this->zpp_inner_zn->jointMax;
}
...
Float AngleJoint_obj::set_jointMin( Float jointMin){
	HX_STACK_FRAME("AngleJoint","set_jointMin","AngleJoint.set_jointMin","nape/constraint/AngleJoint.hx",275)
	HX_STACK_THIS(this)
	HX_STACK_ARG(jointMin,"jointMin")
	HX_STACK_LINE(276)
	{
...
Float AngleJoint_obj::get_jointMin( ){
	HX_STACK_FRAME("AngleJoint","get_jointMin","AngleJoint.get_jointMin","nape/constraint/AngleJoint.hx",273)
	HX_STACK_THIS(this)
	HX_STACK_LINE(273)
	return this->zpp_inner_zn->jointMin;
}
...
::nape::phys::Body AngleJoint_obj::set_body2( ::nape::phys::Body body2){
	HX_STACK_FRAME("AngleJoint","set_body2","AngleJoint.set_body2","nape/constraint/AngleJoint.hx",236)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body2,"body2")
	HX_STACK_LINE(237)
	{
...
::nape::phys::Body AngleJoint_obj::get_body2( ){
	HX_STACK_FRAME("AngleJoint","get_body2","AngleJoint.get_body2","nape/constraint/AngleJoint.hx",234)
	HX_STACK_THIS(this)
	HX_STACK_LINE(234)
	if (((this->zpp_inner_zn->b2 == null()))){
		HX_STACK_LINE(234)
...
::nape::phys::Body AngleJoint_obj::set_body1( ::nape::phys::Body body1){
	HX_STACK_FRAME("AngleJoint","set_body1","AngleJoint.set_body1","nape/constraint/AngleJoint.hx",198)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body1,"body1")
	HX_STACK_LINE(199)
	{
...
::nape::phys::Body AngleJoint_obj::get_body1( ){
	HX_STACK_FRAME("AngleJoint","get_body1","AngleJoint.get_body1","nape/constraint/AngleJoint.hx",196)
	HX_STACK_THIS(this)
	HX_STACK_LINE(196)
	if (((this->zpp_inner_zn->b1 == null()))){
		HX_STACK_LINE(196)
