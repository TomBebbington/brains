...
{
HX_STACK_FRAME("OptionType","new","OptionType.new","nape/callbacks/OptionType.hx",199)
...
::String OptionType_obj::toString( ){
	HX_STACK_FRAME("OptionType","toString","OptionType.toString","nape/callbacks/OptionType.hx",292)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::callbacks::CbTypeList Block( ::nape::callbacks::OptionType_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/OptionType.hx",293)
			{
				HX_STACK_LINE(293)
	...
	struct _Function_1_2{
		inline static ::nape::callbacks::CbTypeList Block( ::nape::callbacks::OptionType_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/OptionType.hx",294)
			{
				HX_STACK_LINE(294)
...
::nape::callbacks::OptionType OptionType_obj::excluding( Dynamic excludes){
	HX_STACK_FRAME("OptionType","excluding","OptionType.excluding","nape/callbacks/OptionType.hx",285)
	HX_STACK_THIS(this)
	HX_STACK_ARG(excludes,"excludes")
	HX_STACK_LINE(286)
...
::nape::callbacks::OptionType OptionType_obj::including( Dynamic includes){
	HX_STACK_FRAME("OptionType","including","OptionType.including","nape/callbacks/OptionType.hx",267)
	HX_STACK_THIS(this)
	HX_STACK_ARG(includes,"includes")
	HX_STACK_LINE(268)
...
::nape::callbacks::CbTypeList OptionType_obj::get_excludes( ){
	HX_STACK_FRAME("OptionType","get_excludes","OptionType.get_excludes","nape/callbacks/OptionType.hx",228)
	HX_STACK_THIS(this)
	HX_STACK_LINE(229)
...
::nape::callbacks::CbTypeList OptionType_obj::get_includes( ){
	HX_STACK_FRAME("OptionType","get_includes","OptionType.get_includes","nape/callbacks/OptionType.hx",214)
	HX_STACK_THIS(this)
	HX_STACK_LINE(215)
