...
{
HX_STACK_FRAME("CbTypeList","new","CbTypeList.new","nape/callbacks/CbTypeList.hx",234)
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::callbacks::CbTypeList CbTypeList_obj::filter( Dynamic lambda){
	HX_STACK_FRAME("CbTypeList","filter","CbTypeList.filter","nape/callbacks/CbTypeList.hx",779)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::callbacks::CbTypeList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",784)
			{
				HX_STACK_LINE(784)
...
::nape::callbacks::CbTypeList CbTypeList_obj::foreach( Dynamic lambda){
	HX_STACK_FRAME("CbTypeList","foreach","CbTypeList.foreach","nape/callbacks/CbTypeList.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_ARG(lambda,"lambda")
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::callbacks::CbTypeIterator &it){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",737)
			{
				HX_STACK_LINE(737)
		...
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			struct _Function_3_1{
				inline static ::nape::callbacks::CbType Block( ::nape::callbacks::CbTypeIterator &it){
					HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",739)
					{
						HX_STACK_LINE(739)
...
::String CbTypeList_obj::toString( ){
	HX_STACK_FRAME("CbTypeList","toString","CbTypeList.toString","nape/callbacks/CbTypeList.hx",702)
	HX_STACK_THIS(this)
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::callbacks::CbTypeIterator Block( ::nape::callbacks::CbTypeList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",705)
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_FRAME("CbTypeList","merge","CbTypeList.merge","nape/callbacks/CbTypeList.hx",684)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::callbacks::CbTypeIterator Block( ::nape::callbacks::CbTypeList &xs){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",688)
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_FRAME("CbTypeList","copy","CbTypeList.copy","nape/callbacks/CbTypeList.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_ARG(deep,"deep")
{
		...
		struct _Function_1_1{
			inline static ::nape::callbacks::CbTypeIterator Block( ::nape::callbacks::CbTypeList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",664)
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::callbacks::CbType Block( ){
				...
				{
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("CbType")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::callbacks::CbTypeIterator CbTypeList_obj::iterator( ){
	HX_STACK_FRAME("CbTypeList","iterator","CbTypeList.iterator","nape/callbacks/CbTypeList.hx",647)
	HX_STACK_THIS(this)
	HX_STACK_LINE(648)
	this->zpp_inner->valmod();
	HX_STACK_LINE(651)
...
bool CbTypeList_obj::empty( ){
	HX_STACK_FRAME("CbTypeList","empty","CbTypeList.empty","nape/callbacks/CbTypeList.hx",633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(633)
...
{
		HX_STACK_FRAME("CbTypeList","clear","CbTypeList.clear","nape/callbacks/CbTypeList.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("CbType")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(619)
...
bool CbTypeList_obj::remove( ::nape::callbacks::CbType obj){
	HX_STACK_FRAME("CbTypeList","remove","CbTypeList.remove","nape/callbacks/CbTypeList.hx",576)
	HX_STACK_THIS(this)
...
bool CbTypeList_obj::add( ::nape::callbacks::CbType obj){
	HX_STACK_FRAME("CbTypeList","add","CbTypeList.add","nape/callbacks/CbTypeList.hx",564)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(564)
	if ((this->zpp_inner->reverse_flag)){
...
::nape::callbacks::CbType CbTypeList_obj::shift( ){
	HX_STACK_FRAME("CbTypeList","shift","CbTypeList.shift","nape/callbacks/CbTypeList.hx",519)
	HX_STACK_THIS(this)
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::callbacks::CbTypeList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",533)
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
...
::nape::callbacks::CbType CbTypeList_obj::pop( ){
	HX_STACK_FRAME("CbTypeList","pop","CbTypeList.pop","nape/callbacks/CbTypeList.hx",478)
	HX_STACK_THIS(this)
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::callbacks::CbTypeList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",498)
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool CbTypeList_obj::unshift( ::nape::callbacks::CbType obj){
	HX_STACK_FRAME("CbTypeList","unshift","CbTypeList.unshift","nape/callbacks/CbTypeList.hx",447)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::callbacks::CbTypeList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",458)
							{
								HX_STACK_LINE(458)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(458)
...
bool CbTypeList_obj::push( ::nape::callbacks::CbType obj){
	HX_STACK_FRAME("CbTypeList","push","CbTypeList.push","nape/callbacks/CbTypeList.hx",416)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				...
				if (((this->zpp_inner->inner->head == null()))){
					...
					struct _Function_5_1{
						inline static int Block( ::nape::callbacks::CbTypeList_obj *__this){
							HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",428)
							{
								HX_STACK_LINE(428)
								__this->zpp_inner->valmod();
								HX_STACK_LINE(428)
...
::nape::callbacks::CbType CbTypeList_obj::at( int index){
	HX_STACK_FRAME("CbTypeList","at","CbTypeList.at","nape/callbacks/CbTypeList.hx",363)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static int Block( ::nape::callbacks::CbTypeList_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",368)
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::callbacks::CbTypeList_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbTypeList.hx",370)
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool CbTypeList_obj::has( ::nape::callbacks::CbType obj){
	HX_STACK_FRAME("CbTypeList","has","CbTypeList.has","nape/callbacks/CbTypeList.hx",346)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int CbTypeList_obj::get_length( ){
	HX_STACK_FRAME("CbTypeList","get_length","CbTypeList.get_length","nape/callbacks/CbTypeList.hx",244)
	HX_STACK_THIS(this)
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::callbacks::CbTypeList CbTypeList_obj::fromArray( Array< ::Dynamic > array){
	HX_STACK_FRAME("CbTypeList","fromArray","CbTypeList.fromArray","nape/callbacks/CbTypeList.hx",304)
