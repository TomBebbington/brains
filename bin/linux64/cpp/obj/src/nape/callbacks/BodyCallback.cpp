...
{
HX_STACK_FRAME("BodyCallback","new","BodyCallback.new","nape/callbacks/BodyCallback.hx",185)
{
	HX_STACK_LINE(185)
	super::__construct();
}
...
::String BodyCallback_obj::toString( ){
	HX_STACK_FRAME("BodyCallback","toString","BodyCallback.toString","nape/callbacks/BodyCallback.hx",198)
	HX_STACK_THIS(this)
	HX_STACK_LINE(199)
...
::nape::phys::Body BodyCallback_obj::get_body( ){
	HX_STACK_FRAME("BodyCallback","get_body","BodyCallback.get_body","nape/callbacks/BodyCallback.hx",193)
	HX_STACK_THIS(this)
	HX_STACK_LINE(193)
