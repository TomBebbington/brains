...
{
HX_STACK_FRAME("InteractionType","new","InteractionType.new","nape/callbacks/InteractionType.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("InteractionType")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String InteractionType_obj::toString( ){
	HX_STACK_FRAME("InteractionType","toString","InteractionType.toString","nape/callbacks/InteractionType.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::callbacks::InteractionType Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionType.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::InteractionType Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionType.hx",193)
				{
					HX_STACK_LINE(193)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::InteractionType Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionType.hx",194)
					{
						HX_STACK_LINE(194)
			...
			if (((hx::ObjectPtr<OBJ_>(this) == _Function_3_1::Block()))){
				...
				struct _Function_4_1{
					inline static ::nape::callbacks::InteractionType Block( ){
						HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionType.hx",195)
						{
							HX_STACK_LINE(195)
...
::nape::callbacks::InteractionType InteractionType_obj::get_COLLISION( ){
	HX_STACK_FRAME("InteractionType","get_COLLISION","InteractionType.get_COLLISION","nape/callbacks/InteractionType.hx",203)
	HX_STACK_LINE(204)
	if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION == null()))){
		HX_STACK_LINE(205)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::InteractionType InteractionType_obj::get_SENSOR( ){
	HX_STACK_FRAME("InteractionType","get_SENSOR","InteractionType.get_SENSOR","nape/callbacks/InteractionType.hx",215)
	HX_STACK_LINE(216)
	if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR == null()))){
		HX_STACK_LINE(217)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::InteractionType InteractionType_obj::get_FLUID( ){
	HX_STACK_FRAME("InteractionType","get_FLUID","InteractionType.get_FLUID","nape/callbacks/InteractionType.hx",228)
	HX_STACK_LINE(229)
	if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID == null()))){
		HX_STACK_LINE(230)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::InteractionType InteractionType_obj::get_ANY( ){
	HX_STACK_FRAME("InteractionType","get_ANY","InteractionType.get_ANY","nape/callbacks/InteractionType.hx",241)
	HX_STACK_LINE(242)
	if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY == null()))){
		HX_STACK_LINE(243)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
