...
{
HX_STACK_FRAME("ConstraintCallback","new","ConstraintCallback.new","nape/callbacks/ConstraintCallback.hx",185)
{
	HX_STACK_LINE(185)
	super::__construct();
}
...
::String ConstraintCallback_obj::toString( ){
	HX_STACK_FRAME("ConstraintCallback","toString","ConstraintCallback.toString","nape/callbacks/ConstraintCallback.hx",198)
	HX_STACK_THIS(this)
	HX_STACK_LINE(199)
...
::nape::constraint::Constraint ConstraintCallback_obj::get_constraint( ){
	HX_STACK_FRAME("ConstraintCallback","get_constraint","ConstraintCallback.get_constraint","nape/callbacks/ConstraintCallback.hx",193)
	HX_STACK_THIS(this)
	HX_STACK_LINE(193)
