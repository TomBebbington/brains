...
{
HX_STACK_FRAME("InteractionListener","new","InteractionListener.new","nape/callbacks/InteractionListener.hx",207)
...
int precedence = __o_precedence.Default(0);
{
	...
	struct _Function_1_1{
		inline static ::nape::callbacks::CbEvent Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionListener.hx",355)
			{
				HX_STACK_LINE(355)
	...
	if (((event == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::CbEvent Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionListener.hx",356)
				{
					HX_STACK_LINE(356)
		...
		if (((event == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::CbEvent Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionListener.hx",357)
					{
						HX_STACK_LINE(357)
			...
			if (((event == _Function_3_1::Block()))){
				...
				HX_STACK_LINE(360)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: CbEvent '") + event->toString()) + HX_CSTRING("' is not a valid event type for InteractionListener")));
			}
		}
	}
	HX_STACK_LINE(363)
		...
		HX_STACK_LINE(369)
		{
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::InteractionType Block( ::nape::callbacks::InteractionListener_obj *__this){
					HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionListener.hx",369)
					{
						HX_STACK_LINE(369)
...
bool InteractionListener_obj::set_allowSleepingCallbacks( bool allowSleepingCallbacks){
	HX_STACK_FRAME("InteractionListener","set_allowSleepingCallbacks","InteractionListener.set_allowSleepingCallbacks","nape/callbacks/InteractionListener.hx",303)
	HX_STACK_THIS(this)
...
bool InteractionListener_obj::get_allowSleepingCallbacks( ){
	HX_STACK_FRAME("InteractionListener","get_allowSleepingCallbacks","InteractionListener.get_allowSleepingCallbacks","nape/callbacks/InteractionListener.hx",301)
	HX_STACK_THIS(this)
	HX_STACK_LINE(301)
	return this->zpp_inner_zn->allowSleepingCallbacks;
}
...
Dynamic InteractionListener_obj::set_handler( Dynamic handler){
	HX_STACK_FRAME("InteractionListener","set_handler","InteractionListener.set_handler","nape/callbacks/InteractionListener.hx",279)
	HX_STACK_THIS(this)
	HX_STACK_ARG(handler,"handler")
	HX_STACK_LINE(280)
	{
...
Dynamic InteractionListener_obj::get_handler( ){
	HX_STACK_FRAME("InteractionListener","get_handler","InteractionListener.get_handler","nape/callbacks/InteractionListener.hx",277)
	HX_STACK_THIS(this)
	HX_STACK_LINE(277)
	return this->zpp_inner_zn->handleri;
}
...
::nape::callbacks::InteractionType InteractionListener_obj::set_interactionType( ::nape::callbacks::InteractionType interactionType){
	HX_STACK_FRAME("InteractionListener","set_interactionType","InteractionListener.set_interactionType","nape/callbacks/InteractionListener.hx",257)
	HX_STACK_THIS(this)
	HX_STACK_ARG(interactionType,"interactionType")
	HX_STACK_LINE(258)
	{
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::InteractionType Block( ::nape::callbacks::InteractionListener_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionListener.hx",264)
				{
					HX_STACK_LINE(264)
					int ret = __this->zpp_inner_zn->itype;		HX_STACK_VAR(ret,"ret");
					struct _Function_3_1{
		...
		if (((_Function_2_1::Block(this) != interactionType))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::InteractionType Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/InteractionListener.hx",265)
					{
						HX_STACK_LINE(265)
						if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION == null()))){
							HX_STACK_LINE(265)
...
::nape::callbacks::InteractionType InteractionListener_obj::get_interactionType( ){
	HX_STACK_FRAME("InteractionListener","get_interactionType","InteractionListener.get_interactionType","nape/callbacks/InteractionListener.hx",249)
	HX_STACK_THIS(this)
	HX_STACK_LINE(250)
	int ret = this->zpp_inner_zn->itype;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(251)
...
::nape::callbacks::OptionType InteractionListener_obj::set_options2( ::nape::callbacks::OptionType options2){
	HX_STACK_FRAME("InteractionListener","set_options2","InteractionListener.set_options2","nape/callbacks/InteractionListener.hx",234)
	HX_STACK_THIS(this)
	HX_STACK_ARG(options2,"options2")
	HX_STACK_LINE(236)
...
::nape::callbacks::OptionType InteractionListener_obj::get_options2( ){
	HX_STACK_FRAME("InteractionListener","get_options2","InteractionListener.get_options2","nape/callbacks/InteractionListener.hx",232)
	HX_STACK_THIS(this)
	HX_STACK_LINE(232)
	return this->zpp_inner_zn->options2->outer;
}
...
::nape::callbacks::OptionType InteractionListener_obj::set_options1( ::nape::callbacks::OptionType options1){
	HX_STACK_FRAME("InteractionListener","set_options1","InteractionListener.set_options1","nape/callbacks/InteractionListener.hx",220)
	HX_STACK_THIS(this)
	HX_STACK_ARG(options1,"options1")
	HX_STACK_LINE(222)
...
::nape::callbacks::OptionType InteractionListener_obj::get_options1( ){
	HX_STACK_FRAME("InteractionListener","get_options1","InteractionListener.get_options1","nape/callbacks/InteractionListener.hx",218)
	HX_STACK_THIS(this)
	HX_STACK_LINE(218)
	return this->zpp_inner_zn->options1->outer;
}
