...
{
HX_STACK_FRAME("CbTypeIterator","new","CbTypeIterator.new","nape/callbacks/CbTypeIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_CbTypeList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("CbType")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::callbacks::CbType CbTypeIterator_obj::next( ){
	HX_STACK_FRAME("CbTypeIterator","next","CbTypeIterator.next","nape/callbacks/CbTypeIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool CbTypeIterator_obj::hasNext( ){
	HX_STACK_FRAME("CbTypeIterator","hasNext","CbTypeIterator.hasNext","nape/callbacks/CbTypeIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::callbacks::CbTypeIterator CbTypeIterator_obj::get( ::nape::callbacks::CbTypeList list){
	HX_STACK_FRAME("CbTypeIterator","get","CbTypeIterator.get","nape/callbacks/CbTypeIterator.hx",217)
