...
{
HX_STACK_FRAME("Callback","new","Callback.new","nape/callbacks/Callback.hx",180)
{
	HX_STACK_LINE(184)
	this->zpp_inner = null();
	HX_STACK_LINE(206)
...
::String Callback_obj::toString( ){
	HX_STACK_FRAME("Callback","toString","Callback.toString","nape/callbacks/Callback.hx",215)
	HX_STACK_THIS(this)
	HX_STACK_LINE(215)
	return HX_CSTRING("");
}
...
::nape::callbacks::Listener Callback_obj::get_listener( ){
	HX_STACK_FRAME("Callback","get_listener","Callback.get_listener","nape/callbacks/Callback.hx",199)
	HX_STACK_THIS(this)
	HX_STACK_LINE(199)
...
::nape::callbacks::CbEvent Callback_obj::get_event( ){
	HX_STACK_FRAME("Callback","get_event","Callback.get_event","nape/callbacks/Callback.hx",191)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::callbacks::CbEvent Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/Callback.hx",191)
			{
				HX_STACK_LINE(191)
