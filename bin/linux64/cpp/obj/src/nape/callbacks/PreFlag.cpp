...
{
HX_STACK_FRAME("PreFlag","new","PreFlag.new","nape/callbacks/PreFlag.hx",184)
{
	HX_STACK_LINE(184)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(184)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("PreFlag")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String PreFlag_obj::toString( ){
	HX_STACK_FRAME("PreFlag","toString","PreFlag.toString","nape/callbacks/PreFlag.hx",193)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::callbacks::PreFlag Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/PreFlag.hx",193)
			{
				HX_STACK_LINE(193)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::PreFlag Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/PreFlag.hx",194)
				{
					HX_STACK_LINE(194)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::PreFlag Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/PreFlag.hx",195)
					{
						HX_STACK_LINE(195)
			...
			if (((hx::ObjectPtr<OBJ_>(this) == _Function_3_1::Block()))){
				...
				struct _Function_4_1{
					inline static ::nape::callbacks::PreFlag Block( ){
						HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/PreFlag.hx",196)
						{
							HX_STACK_LINE(196)
...
::nape::callbacks::PreFlag PreFlag_obj::get_ACCEPT( ){
	HX_STACK_FRAME("PreFlag","get_ACCEPT","PreFlag.get_ACCEPT","nape/callbacks/PreFlag.hx",204)
	HX_STACK_LINE(205)
	if (((::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT == null()))){
		HX_STACK_LINE(206)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::PreFlag PreFlag_obj::get_IGNORE( ){
	HX_STACK_FRAME("PreFlag","get_IGNORE","PreFlag.get_IGNORE","nape/callbacks/PreFlag.hx",217)
	HX_STACK_LINE(218)
	if (((::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE == null()))){
		HX_STACK_LINE(219)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::PreFlag PreFlag_obj::get_ACCEPT_ONCE( ){
	HX_STACK_FRAME("PreFlag","get_ACCEPT_ONCE","PreFlag.get_ACCEPT_ONCE","nape/callbacks/PreFlag.hx",231)
	HX_STACK_LINE(232)
	if (((::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE == null()))){
		HX_STACK_LINE(233)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::PreFlag PreFlag_obj::get_IGNORE_ONCE( ){
	HX_STACK_FRAME("PreFlag","get_IGNORE_ONCE","PreFlag.get_IGNORE_ONCE","nape/callbacks/PreFlag.hx",245)
	HX_STACK_LINE(246)
	if (((::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE == null()))){
		HX_STACK_LINE(247)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
