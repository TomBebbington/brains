...
{
HX_STACK_FRAME("ConstraintListener","new","ConstraintListener.new","nape/callbacks/ConstraintListener.hx",180)
...
int precedence = __o_precedence.Default(0);
{
	...
	struct _Function_1_1{
		inline static ::nape::callbacks::CbEvent Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/ConstraintListener.hx",262)
			{
				HX_STACK_LINE(262)
	...
	if (((event == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::CbEvent Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/ConstraintListener.hx",263)
				{
					HX_STACK_LINE(263)
		...
		if (((event == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::CbEvent Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/ConstraintListener.hx",264)
					{
						HX_STACK_LINE(264)
			...
			if (((event == _Function_3_1::Block()))){
				...
				HX_STACK_LINE(267)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: cbEvent '") + event->toString()) + HX_CSTRING("' is not a valid event type for a ConstraintListener")));
			}
		}
	}
	HX_STACK_LINE(270)
...
Dynamic ConstraintListener_obj::set_handler( Dynamic handler){
	HX_STACK_FRAME("ConstraintListener","set_handler","ConstraintListener.set_handler","nape/callbacks/ConstraintListener.hx",211)
	HX_STACK_THIS(this)
	HX_STACK_ARG(handler,"handler")
	HX_STACK_LINE(212)
	{
...
Dynamic ConstraintListener_obj::get_handler( ){
	HX_STACK_FRAME("ConstraintListener","get_handler","ConstraintListener.get_handler","nape/callbacks/ConstraintListener.hx",209)
	HX_STACK_THIS(this)
	HX_STACK_LINE(209)
	return this->zpp_inner_zn->handler;
}
...
::nape::callbacks::OptionType ConstraintListener_obj::set_options( ::nape::callbacks::OptionType options){
	HX_STACK_FRAME("ConstraintListener","set_options","ConstraintListener.set_options","nape/callbacks/ConstraintListener.hx",197)
	HX_STACK_THIS(this)
	HX_STACK_ARG(options,"options")
	HX_STACK_LINE(199)
...
::nape::callbacks::OptionType ConstraintListener_obj::get_options( ){
	HX_STACK_FRAME("ConstraintListener","get_options","ConstraintListener.get_options","nape/callbacks/ConstraintListener.hx",195)
	HX_STACK_THIS(this)
	HX_STACK_LINE(195)
	return this->zpp_inner_zn->options->outer;
}
