...
{
HX_STACK_FRAME("ListenerIterator","new","ListenerIterator.new","nape/callbacks/ListenerIterator.hx",178)
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_ListenerList_obj::internal))){
		HX_STACK_LINE(204)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Listener")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::callbacks::Listener ListenerIterator_obj::next( ){
	HX_STACK_FRAME("ListenerIterator","next","ListenerIterator.next","nape/callbacks/ListenerIterator.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool ListenerIterator_obj::hasNext( ){
	HX_STACK_FRAME("ListenerIterator","hasNext","ListenerIterator.hasNext","nape/callbacks/ListenerIterator.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(241)
...
::nape::callbacks::ListenerIterator ListenerIterator_obj::get( ::nape::callbacks::ListenerList list){
	HX_STACK_FRAME("ListenerIterator","get","ListenerIterator.get","nape/callbacks/ListenerIterator.hx",217)
