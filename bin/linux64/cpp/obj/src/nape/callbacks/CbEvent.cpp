...
{
HX_STACK_FRAME("CbEvent","new","CbEvent.new","nape/callbacks/CbEvent.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("CbEvent")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String CbEvent_obj::toString( ){
	HX_STACK_FRAME("CbEvent","toString","CbEvent.toString","nape/callbacks/CbEvent.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::callbacks::CbEvent Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbEvent.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::CbEvent Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbEvent.hx",193)
				{
					HX_STACK_LINE(193)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::CbEvent Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbEvent.hx",194)
					{
						HX_STACK_LINE(194)
			...
			if (((hx::ObjectPtr<OBJ_>(this) == _Function_3_1::Block()))){
				...
				struct _Function_4_1{
					inline static ::nape::callbacks::CbEvent Block( ){
						HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbEvent.hx",195)
						{
							HX_STACK_LINE(195)
				...
				if (((hx::ObjectPtr<OBJ_>(this) == _Function_4_1::Block()))){
					...
					struct _Function_5_1{
						inline static ::nape::callbacks::CbEvent Block( ){
							HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbEvent.hx",196)
							{
								HX_STACK_LINE(196)
					...
					if (((hx::ObjectPtr<OBJ_>(this) == _Function_5_1::Block()))){
						...
						struct _Function_6_1{
							inline static ::nape::callbacks::CbEvent Block( ){
								HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbEvent.hx",197)
								{
									HX_STACK_LINE(197)
						...
						if (((hx::ObjectPtr<OBJ_>(this) == _Function_6_1::Block()))){
							...
							struct _Function_7_1{
								inline static ::nape::callbacks::CbEvent Block( ){
									HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/CbEvent.hx",198)
									{
										HX_STACK_LINE(198)
...
::nape::callbacks::CbEvent CbEvent_obj::get_BEGIN( ){
	HX_STACK_FRAME("CbEvent","get_BEGIN","CbEvent.get_BEGIN","nape/callbacks/CbEvent.hx",206)
	HX_STACK_LINE(207)
	if (((::zpp_nape::util::ZPP_Flags_obj::CbEvent_BEGIN == null()))){
		HX_STACK_LINE(208)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::CbEvent CbEvent_obj::get_ONGOING( ){
	HX_STACK_FRAME("CbEvent","get_ONGOING","CbEvent.get_ONGOING","nape/callbacks/CbEvent.hx",220)
	HX_STACK_LINE(221)
	if (((::zpp_nape::util::ZPP_Flags_obj::CbEvent_ONGOING == null()))){
		HX_STACK_LINE(222)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::CbEvent CbEvent_obj::get_END( ){
	HX_STACK_FRAME("CbEvent","get_END","CbEvent.get_END","nape/callbacks/CbEvent.hx",233)
	HX_STACK_LINE(234)
	if (((::zpp_nape::util::ZPP_Flags_obj::CbEvent_END == null()))){
		HX_STACK_LINE(235)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::CbEvent CbEvent_obj::get_WAKE( ){
	HX_STACK_FRAME("CbEvent","get_WAKE","CbEvent.get_WAKE","nape/callbacks/CbEvent.hx",246)
	HX_STACK_LINE(247)
	if (((::zpp_nape::util::ZPP_Flags_obj::CbEvent_WAKE == null()))){
		HX_STACK_LINE(248)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::CbEvent CbEvent_obj::get_SLEEP( ){
	HX_STACK_FRAME("CbEvent","get_SLEEP","CbEvent.get_SLEEP","nape/callbacks/CbEvent.hx",259)
	HX_STACK_LINE(260)
	if (((::zpp_nape::util::ZPP_Flags_obj::CbEvent_SLEEP == null()))){
		HX_STACK_LINE(261)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::CbEvent CbEvent_obj::get_BREAK( ){
	HX_STACK_FRAME("CbEvent","get_BREAK","CbEvent.get_BREAK","nape/callbacks/CbEvent.hx",272)
	HX_STACK_LINE(273)
	if (((::zpp_nape::util::ZPP_Flags_obj::CbEvent_BREAK == null()))){
		HX_STACK_LINE(274)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::CbEvent CbEvent_obj::get_PRE( ){
	HX_STACK_FRAME("CbEvent","get_PRE","CbEvent.get_PRE","nape/callbacks/CbEvent.hx",286)
	HX_STACK_LINE(287)
	if (((::zpp_nape::util::ZPP_Flags_obj::CbEvent_PRE == null()))){
		HX_STACK_LINE(288)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
