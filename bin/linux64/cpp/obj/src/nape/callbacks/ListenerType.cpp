...
{
HX_STACK_FRAME("ListenerType","new","ListenerType.new","nape/callbacks/ListenerType.hx",183)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("ListenerType")) + HX_CSTRING(" derp!")));
	}
}
;
	return null();
...
::String ListenerType_obj::toString( ){
	HX_STACK_FRAME("ListenerType","toString","ListenerType.toString","nape/callbacks/ListenerType.hx",192)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static ::nape::callbacks::ListenerType Block( ){
			HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/ListenerType.hx",192)
			{
				HX_STACK_LINE(192)
	...
	if (((hx::ObjectPtr<OBJ_>(this) == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::ListenerType Block( ){
				HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/ListenerType.hx",193)
				{
					HX_STACK_LINE(193)
		...
		if (((hx::ObjectPtr<OBJ_>(this) == _Function_2_1::Block()))){
			...
			struct _Function_3_1{
				inline static ::nape::callbacks::ListenerType Block( ){
					HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/ListenerType.hx",194)
					{
						HX_STACK_LINE(194)
			...
			if (((hx::ObjectPtr<OBJ_>(this) == _Function_3_1::Block()))){
				...
				struct _Function_4_1{
					inline static ::nape::callbacks::ListenerType Block( ){
						HX_STACK_FRAME("*","closure","*.closure","nape/callbacks/ListenerType.hx",195)
						{
							HX_STACK_LINE(195)
...
::nape::callbacks::ListenerType ListenerType_obj::get_BODY( ){
	HX_STACK_FRAME("ListenerType","get_BODY","ListenerType.get_BODY","nape/callbacks/ListenerType.hx",203)
	HX_STACK_LINE(204)
	if (((::zpp_nape::util::ZPP_Flags_obj::ListenerType_BODY == null()))){
		HX_STACK_LINE(205)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::ListenerType ListenerType_obj::get_CONSTRAINT( ){
	HX_STACK_FRAME("ListenerType","get_CONSTRAINT","ListenerType.get_CONSTRAINT","nape/callbacks/ListenerType.hx",216)
	HX_STACK_LINE(217)
	if (((::zpp_nape::util::ZPP_Flags_obj::ListenerType_CONSTRAINT == null()))){
		HX_STACK_LINE(218)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::ListenerType ListenerType_obj::get_INTERACTION( ){
	HX_STACK_FRAME("ListenerType","get_INTERACTION","ListenerType.get_INTERACTION","nape/callbacks/ListenerType.hx",229)
	HX_STACK_LINE(230)
	if (((::zpp_nape::util::ZPP_Flags_obj::ListenerType_INTERACTION == null()))){
		HX_STACK_LINE(231)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
...
::nape::callbacks::ListenerType ListenerType_obj::get_PRE( ){
	HX_STACK_FRAME("ListenerType","get_PRE","ListenerType.get_PRE","nape/callbacks/ListenerType.hx",242)
	HX_STACK_LINE(243)
	if (((::zpp_nape::util::ZPP_Flags_obj::ListenerType_PRE == null()))){
		HX_STACK_LINE(244)
		::zpp_nape::util::ZPP_Flags_obj::internal = true;
