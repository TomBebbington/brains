...
{
		HX_STACK_FRAME("Assets","initialize","Assets.initialize","openfl/Assets.hx",64)
		HX_STACK_LINE(64)
...
bool useCache = __o_useCache.Default(true);
	HX_STACK_FRAME("Assets","getBitmapData","Assets.getBitmapData","openfl/Assets.hx",86)
	HX_STACK_ARG(id,"id")
...
::flash::utils::ByteArray Assets_obj::getBytes( ::String id){
	HX_STACK_FRAME("Assets","getBytes","Assets.getBytes","openfl/Assets.hx",198)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(200)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(204)
...
::flash::text::Font Assets_obj::getFont( ::String id){
	HX_STACK_FRAME("Assets","getFont","Assets.getFont","openfl/Assets.hx",255)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(257)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(261)
...
::flash::display::MovieClip Assets_obj::getMovieClip( ::String id){
	HX_STACK_FRAME("Assets","getMovieClip","Assets.getMovieClip","openfl/Assets.hx",293)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(295)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(299)
...
::flash::media::Sound Assets_obj::getSound( ::String id){
	HX_STACK_FRAME("Assets","getSound","Assets.getSound","openfl/Assets.hx",366)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(368)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(372)
...
::String Assets_obj::getText( ::String id){
	HX_STACK_FRAME("Assets","getText","Assets.getText","openfl/Assets.hx",411)
	HX_STACK_ARG(id,"id")
	HX_STACK_LINE(413)
...
Array< ::String > Assets_obj::get_id( ){
	HX_STACK_FRAME("Assets","get_id","Assets.get_id","openfl/Assets.hx",473)
	HX_STACK_LINE(475)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(477)
...
::haxe::ds::StringMap Assets_obj::get_library( ){
	HX_STACK_FRAME("Assets","get_library","Assets.get_library","openfl/Assets.hx",494)
	HX_STACK_LINE(496)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(500)
...
::haxe::ds::StringMap Assets_obj::get_path( ){
	HX_STACK_FRAME("Assets","get_path","Assets.get_path","openfl/Assets.hx",511)
	HX_STACK_LINE(513)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(517)
...
::haxe::ds::StringMap Assets_obj::get_type( ){
	HX_STACK_FRAME("Assets","get_type","Assets.get_type","openfl/Assets.hx",528)
	HX_STACK_LINE(530)
	::openfl::Assets_obj::initialize();
	HX_STACK_LINE(534)
