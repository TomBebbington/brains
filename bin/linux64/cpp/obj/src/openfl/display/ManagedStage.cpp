...
{
HX_STACK_FRAME("ManagedStage","new","ManagedStage.new","openfl/display/ManagedStage.hx",44)
...
{
		HX_STACK_FRAME("ManagedStage","__render","ManagedStage.__render","openfl/display/ManagedStage.hx",103)
		HX_STACK_THIS(this)
...
Float ManagedStage_obj::__doProcessStageEvent( Dynamic event){
	HX_STACK_FRAME("ManagedStage","__doProcessStageEvent","ManagedStage.__doProcessStageEvent","openfl/display/ManagedStage.hx",91)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ManagedStage","setNextWake","ManagedStage.setNextWake","openfl/display/ManagedStage.hx",84)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ManagedStage","sendQuit","ManagedStage.sendQuit","openfl/display/ManagedStage.hx",79)
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_FRAME("*","closure","*.closure","openfl/display/ManagedStage.hx",79)
				{
...
{
		HX_STACK_FRAME("ManagedStage","resize","ManagedStage.resize","openfl/display/ManagedStage.hx",72)
		HX_STACK_THIS(this)
		HX_STACK_ARG(width,"width")
		HX_STACK_ARG(height,"height")
		struct _Function_1_1{
			inline static Dynamic Block( int &width,int &height){
				HX_STACK_FRAME("*","closure","*.closure","openfl/display/ManagedStage.hx",72)
				{
					hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_FRAME("ManagedStage","pumpEvent","ManagedStage.pumpEvent","openfl/display/ManagedStage.hx",65)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(65)
...
Void run(){
{
		HX_STACK_FRAME("ManagedStage","endRender","ManagedStage.endRender","openfl/display/ManagedStage.hx",56)
		HX_STACK_THIS(this)
	}
return null();
}
...
Void run(){
{
		HX_STACK_FRAME("ManagedStage","beginRender","ManagedStage.beginRender","openfl/display/ManagedStage.hx",49)
		HX_STACK_THIS(this)
	}
return null();
}
