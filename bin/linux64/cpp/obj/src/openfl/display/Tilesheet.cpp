...
{
HX_STACK_FRAME("Tilesheet","new","Tilesheet.new","openfl/display/Tilesheet.hx",29)
...
int flags = __o_flags.Default(0);
	HX_STACK_FRAME("Tilesheet","drawTiles","Tilesheet.drawTiles","openfl/display/Tilesheet.hx",46)
	HX_STACK_THIS(this)
...
int Tilesheet_obj::addTileRect( ::flash::geom::Rectangle rectangle,::flash::geom::Point centerPoint){
	HX_STACK_FRAME("Tilesheet","addTileRect","Tilesheet.addTileRect","openfl/display/Tilesheet.hx",39)
	HX_STACK_THIS(this)
