...
{
HX_STACK_FRAME("JoystickEvent","new","JoystickEvent.new","openfl/events/JoystickEvent.hx",23)
...
::String JoystickEvent_obj::toString( ){
	HX_STACK_FRAME("JoystickEvent","toString","JoystickEvent.toString","openfl/events/JoystickEvent.hx",47)
	HX_STACK_THIS(this)
	HX_STACK_LINE(47)
...
::flash::events::Event JoystickEvent_obj::clone( ){
	HX_STACK_FRAME("JoystickEvent","clone","JoystickEvent.clone","openfl/events/JoystickEvent.hx",40)
	HX_STACK_THIS(this)
	HX_STACK_LINE(40)
