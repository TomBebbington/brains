...
::entities::Zombie_obj::__register();
::entities::Wall_obj::__register();
::entities::Player_obj::__register();
::entities::Person_obj::__register();
...
::entities::Bullet_obj::__register();
::entities::PhysicalEntity_obj::__register();
...
::com::haxepunk::graphics::prototype::Rect_obj::__register();
...
::com::haxepunk::graphics::ParticleType_obj::__register();
::com::haxepunk::graphics::Particle_obj::__register();
::com::haxepunk::graphics::Image_obj::__register();
::com::haxepunk::graphics::Graphiclist_obj::__register();
::com::haxepunk::graphics::Emitter_obj::__register();
::com::haxepunk::graphics::Backdrop_obj::__register();
...
::com::haxepunk::graphics::Backdrop_obj::__boot();
::com::haxepunk::graphics::Emitter_obj::__boot();
::com::haxepunk::graphics::Graphiclist_obj::__boot();
::com::haxepunk::graphics::Image_obj::__boot();
::com::haxepunk::graphics::Particle_obj::__boot();
::com::haxepunk::graphics::ParticleType_obj::__boot();
...
::com::haxepunk::graphics::prototype::Rect_obj::__boot();
...
::entities::PhysicalEntity_obj::__boot();
::entities::Bullet_obj::__boot();
...
::entities::Person_obj::__boot();
::entities::Player_obj::__boot();
::entities::Wall_obj::__boot();
::entities::Zombie_obj::__boot();
