...
{
HX_STACK_FRAME("Bytes","new","Bytes.new","haxe/io/Bytes.hx",29)
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_FRAME("Bytes","sub","Bytes.sub","haxe/io/Bytes.hx",99)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Bytes","blit","Bytes.blit","haxe/io/Bytes.hx",68)
		HX_STACK_THIS(this)
		HX_STACK_ARG(pos,"pos")
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_FRAME("Bytes","alloc","Bytes.alloc","haxe/io/Bytes.hx",250)
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(260)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_FRAME("Bytes","ofString","Bytes.ofString","haxe/io/Bytes.hx",275)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(286)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(287)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_FRAME("Bytes","ofData","Bytes.ofData","haxe/io/Bytes.hx",334)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(334)
