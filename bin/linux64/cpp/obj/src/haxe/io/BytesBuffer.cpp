...
{
HX_STACK_FRAME("BytesBuffer","new","BytesBuffer.new","haxe/io/BytesBuffer.hx",53)
{
	HX_STACK_LINE(53)
...
::haxe::io::Bytes BytesBuffer_obj::getBytes( ){
	HX_STACK_FRAME("BytesBuffer","getBytes","BytesBuffer.getBytes","haxe/io/BytesBuffer.hx",138)
	HX_STACK_THIS(this)
	HX_STACK_LINE(154)
