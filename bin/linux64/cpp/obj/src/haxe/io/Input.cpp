...
::String Input_obj::readLine( ){
	HX_STACK_FRAME("Input","readLine","Input.readLine","haxe/io/Input.hx",127)
	HX_STACK_THIS(this)
	HX_STACK_LINE(128)
...
{
		HX_STACK_FRAME("Input","close","Input.close","haxe/io/Input.hx",67)
		HX_STACK_THIS(this)
	}
return null();
}
...
int Input_obj::readByte( ){
	HX_STACK_FRAME("Input","readByte","Input.readByte","haxe/io/Input.hx",37)
	HX_STACK_THIS(this)
	HX_STACK_LINE(39)
