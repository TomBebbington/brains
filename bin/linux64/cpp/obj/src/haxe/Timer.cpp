...
{
HX_STACK_FRAME("Timer","new","Timer.new","haxe/Timer.hx",113)
...
{
		HX_STACK_FRAME("Timer","__check","Timer.__check","haxe/Timer.hx",184)
		HX_STACK_THIS(this)
...
Void Timer_obj::stop( ){
{
		HX_STACK_FRAME("Timer","stop","Timer.stop","haxe/Timer.hx",141)
		HX_STACK_THIS(this)
		HX_STACK_LINE(141)
		if ((this->mRunning)){
			HX_STACK_LINE(143)
...
Void run(){
{
		HX_STACK_FRAME("Timer","run","Timer.run","haxe/Timer.hx",132)
		HX_STACK_THIS(this)
	}
return null();
}
...
Dynamic Timer_obj::measure( Dynamic f,Dynamic pos){
	HX_STACK_FRAME("Timer","measure","Timer.measure","haxe/Timer.hx",123)
	HX_STACK_ARG(f,"f")
...
Float Timer_obj::__nextWake( Float limit){
	HX_STACK_FRAME("Timer","__nextWake","Timer.__nextWake","haxe/Timer.hx",154)
...
{
		HX_STACK_FRAME("Timer","__checkTimers","Timer.__checkTimers","haxe/Timer.hx",197)
		HX_STACK_LINE(199)
...
Float Timer_obj::GetMS( ){
	HX_STACK_FRAME("Timer","GetMS","Timer.GetMS","haxe/Timer.hx",212)
	HX_STACK_LINE(212)
...
::haxe::Timer Timer_obj::delay( Dynamic f,int time){
	HX_STACK_FRAME("Timer","delay","Timer.delay","haxe/Timer.hx",218)
	HX_STACK_ARG(f,"f")
	HX_STACK_ARG(time,"time")
	HX_STACK_LINE(218)
	...
	Void run(){
		HX_STACK_FRAME("*","_Function_1_1","*._Function_1_1","haxe/Timer.hx",222)
		{
			HX_STACK_LINE(223)
...
Float Timer_obj::stamp( ){
	HX_STACK_FRAME("Timer","stamp","Timer.stamp","haxe/Timer.hx",234)
	HX_STACK_LINE(234)
