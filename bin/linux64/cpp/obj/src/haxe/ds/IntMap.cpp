...
{
HX_STACK_FRAME("IntMap","new","IntMap.new","haxe/ds/IntMap.hx",29)
{
	HX_STACK_LINE(29)
...
Dynamic IntMap_obj::iterator( ){
	HX_STACK_FRAME("IntMap","iterator","IntMap.iterator","haxe/ds/IntMap.hx",53)
	HX_STACK_THIS(this)
	HX_STACK_LINE(54)
...
Dynamic IntMap_obj::keys( ){
	HX_STACK_FRAME("IntMap","keys","IntMap.keys","haxe/ds/IntMap.hx",48)
	HX_STACK_THIS(this)
	HX_STACK_LINE(49)
...
bool IntMap_obj::remove( int key){
	HX_STACK_FRAME("IntMap","remove","IntMap.remove","haxe/ds/IntMap.hx",45)
	HX_STACK_THIS(this)
...
bool IntMap_obj::exists( int key){
	HX_STACK_FRAME("IntMap","exists","IntMap.exists","haxe/ds/IntMap.hx",41)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(41)
...
Dynamic IntMap_obj::get( int key){
	HX_STACK_FRAME("IntMap","get","IntMap.get","haxe/ds/IntMap.hx",37)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(37)
...
{
		HX_STACK_FRAME("IntMap","set","IntMap.set","haxe/ds/IntMap.hx",33)
		HX_STACK_THIS(this)
		HX_STACK_ARG(key,"key")
