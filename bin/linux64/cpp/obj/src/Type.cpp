...
::Class Type_obj::getClass( Dynamic o){
	HX_STACK_FRAME("Type","getClass","Type.getClass","Type.hx",35)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(36)
...
::String Type_obj::getClassName( ::Class c){
	HX_STACK_FRAME("Type","getClassName","Type.getClassName","Type.hx",56)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(57)
	if (((c == null()))){
		HX_STACK_LINE(58)
...
::Class Type_obj::resolveClass( ::String name){
	HX_STACK_FRAME("Type","resolveClass","Type.resolveClass","Type.hx",66)
...
::Enum Type_obj::resolveEnum( ::String name){
	HX_STACK_FRAME("Type","resolveEnum","Type.resolveEnum","Type.hx",73)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(74)
	::Class result = ::Class_obj::Resolve(name);		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(75)
...
Dynamic Type_obj::createInstance( ::Class cl,Dynamic args){
	HX_STACK_FRAME("Type","createInstance","Type.createInstance","Type.hx",80)
	HX_STACK_ARG(cl,"cl")
...
Dynamic Type_obj::createEnum( ::Enum e,::String constr,Dynamic params){
	HX_STACK_FRAME("Type","createEnum","Type.createEnum","Type.hx",91)
	HX_STACK_ARG(e,"e")
...
Dynamic Type_obj::createEnumIndex( ::Enum e,int index,Dynamic params){
	HX_STACK_FRAME("Type","createEnumIndex","Type.createEnumIndex","Type.hx",94)
	HX_STACK_ARG(e,"e")
...
Array< ::String > Type_obj::getClassFields( ::Class c){
	HX_STACK_FRAME("Type","getClassFields","Type.getClassFields","Type.hx",105)
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(105)
...
Array< ::String > Type_obj::getEnumConstructs( ::Enum e){
	HX_STACK_FRAME("Type","getEnumConstructs","Type.getEnumConstructs","Type.hx",109)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(109)
