...
{
HX_STACK_FRAME("List","new","List.new","List.hx",41)
{
	HX_STACK_LINE(41)
	this->length = (int)0;
}
...
Dynamic List_obj::iterator( ){
	HX_STACK_FRAME("List","iterator","List.iterator","List.hx",179)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static Dynamic Block( ::List_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","List.hx",179)
			{
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_1","*._Function_2_1","List.hx",182)
				...
				Dynamic run(){
					HX_STACK_FRAME("*","_Function_2_2","*._Function_2_2","List.hx",185)
					HX_STACK_THIS(__this.mPtr)
					{
						HX_STACK_LINE(186)
...
bool List_obj::remove( Dynamic v){
	HX_STACK_FRAME("List","remove","List.remove","List.hx",138)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(139)
...
Void List_obj::clear( ){
{
		HX_STACK_FRAME("List","clear","List.clear","List.hx",124)
		HX_STACK_THIS(this)
		HX_STACK_LINE(125)
		this->h = null();
		HX_STACK_LINE(126)
...
bool List_obj::isEmpty( ){
	HX_STACK_FRAME("List","isEmpty","List.isEmpty","List.hx",115)
	HX_STACK_THIS(this)
	HX_STACK_LINE(115)
	return (this->h == null());
}
...
Dynamic List_obj::first( ){
	HX_STACK_FRAME("List","first","List.first","List.hx",82)
	HX_STACK_THIS(this)
	HX_STACK_LINE(82)
	if (((this->h == null()))){
		HX_STACK_LINE(82)
...
{
		HX_STACK_FRAME("List","push","List.push","List.hx",64)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("List","add","List.add","List.hx",49)
		HX_STACK_THIS(this)
		HX_STACK_ARG(item,"item")
		HX_STACK_LINE(50)
