...
{
HX_STACK_FRAME("ZPP_Edge","new","ZPP_Edge.new","zpp_nape/shape/Edge.hx",174)
{
	HX_STACK_LINE(234)
	this->tp1 = 0.0;
	HX_STACK_LINE(233)
...
{
		HX_STACK_FRAME("ZPP_Edge","getgnorm","ZPP_Edge.getgnorm","zpp_nape/shape/Edge.hx",293)
		HX_STACK_THIS(this)
		HX_STACK_LINE(294)
		{
			HX_STACK_LINE(294)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/shape/Edge.hx",294)
						{
							HX_STACK_LINE(294)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(294)
...
{
		HX_STACK_FRAME("ZPP_Edge","getlnorm","ZPP_Edge.getlnorm","zpp_nape/shape/Edge.hx",288)
		HX_STACK_THIS(this)
		HX_STACK_LINE(289)
		{
			HX_STACK_LINE(289)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/shape/Edge.hx",289)
						{
							HX_STACK_LINE(289)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(289)
...
{
		HX_STACK_FRAME("ZPP_Edge","gnorm_validate","ZPP_Edge.gnorm_validate","zpp_nape/shape/Edge.hx",261)
		HX_STACK_THIS(this)
		HX_STACK_LINE(263)
...
{
		HX_STACK_FRAME("ZPP_Edge","lnorm_validate","ZPP_Edge.lnorm_validate","zpp_nape/shape/Edge.hx",235)
		HX_STACK_THIS(this)
		HX_STACK_LINE(237)
		if (((this->polygon == null()))){
			HX_STACK_LINE(237)
...
::nape::shape::Edge ZPP_Edge_obj::wrapper( ){
	HX_STACK_FRAME("ZPP_Edge","wrapper","ZPP_Edge.wrapper","zpp_nape/shape/Edge.hx",211)
	HX_STACK_THIS(this)
	HX_STACK_LINE(212)
	if (((this->outer == null()))){
		HX_STACK_LINE(213)
...
{
		HX_STACK_FRAME("ZPP_Edge","alloc","ZPP_Edge.alloc","zpp_nape/shape/Edge.hx",207)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Edge","free","ZPP_Edge.free","zpp_nape/shape/Edge.hx",203)
		HX_STACK_THIS(this)
		HX_STACK_LINE(203)
		this->polygon = null();
	}
