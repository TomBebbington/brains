...
{
HX_STACK_FRAME("ZPP_SpaceArbiterList","new","ZPP_SpaceArbiterList.new","zpp_nape/dynamics/SpaceArbiterList.hx",174)
{
	HX_STACK_LINE(260)
...
::nape::dynamics::Arbiter ZPP_SpaceArbiterList_obj::at( int index){
	HX_STACK_FRAME("ZPP_SpaceArbiterList","at","ZPP_SpaceArbiterList.at","zpp_nape/dynamics/SpaceArbiterList.hx",325)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_SpaceArbiterList","clear","ZPP_SpaceArbiterList.clear","zpp_nape/dynamics/SpaceArbiterList.hx",322)
		HX_STACK_THIS(this)
		HX_STACK_LINE(322)
...
bool ZPP_SpaceArbiterList_obj::remove( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("ZPP_SpaceArbiterList","remove","ZPP_SpaceArbiterList.remove","zpp_nape/dynamics/SpaceArbiterList.hx",314)
	HX_STACK_THIS(this)
...
::nape::dynamics::Arbiter ZPP_SpaceArbiterList_obj::shift( ){
	HX_STACK_FRAME("ZPP_SpaceArbiterList","shift","ZPP_SpaceArbiterList.shift","zpp_nape/dynamics/SpaceArbiterList.hx",308)
	HX_STACK_THIS(this)
	HX_STACK_LINE(310)
	HX_STACK_DO_THROW(HX_CSTRING("Error: ArbiterList is immutable"));
	HX_STACK_LINE(312)
...
bool ZPP_SpaceArbiterList_obj::unshift( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("ZPP_SpaceArbiterList","unshift","ZPP_SpaceArbiterList.unshift","zpp_nape/dynamics/SpaceArbiterList.hx",302)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(304)
	HX_STACK_DO_THROW(HX_CSTRING("Error: ArbiterList is immutable"));
...
::nape::dynamics::Arbiter ZPP_SpaceArbiterList_obj::pop( ){
	HX_STACK_FRAME("ZPP_SpaceArbiterList","pop","ZPP_SpaceArbiterList.pop","zpp_nape/dynamics/SpaceArbiterList.hx",296)
	HX_STACK_THIS(this)
	HX_STACK_LINE(298)
	HX_STACK_DO_THROW(HX_CSTRING("Error: ArbiterList is immutable"));
	HX_STACK_LINE(300)
...
bool ZPP_SpaceArbiterList_obj::push( ::nape::dynamics::Arbiter obj){
	HX_STACK_FRAME("ZPP_SpaceArbiterList","push","ZPP_SpaceArbiterList.push","zpp_nape/dynamics/SpaceArbiterList.hx",290)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(292)
	HX_STACK_DO_THROW(HX_CSTRING("Error: ArbiterList is immutable"));
...
{
		HX_STACK_FRAME("ZPP_SpaceArbiterList","zpp_vm","ZPP_SpaceArbiterList.zpp_vm","zpp_nape/dynamics/SpaceArbiterList.hx",261)
		HX_STACK_THIS(this)
		HX_STACK_LINE(262)
...
int ZPP_SpaceArbiterList_obj::zpp_gl( ){
	HX_STACK_FRAME("ZPP_SpaceArbiterList","zpp_gl","ZPP_SpaceArbiterList.zpp_gl","zpp_nape/dynamics/SpaceArbiterList.hx",189)
	HX_STACK_THIS(this)
	HX_STACK_LINE(190)
	this->zpp_vm();
	HX_STACK_LINE(191)
