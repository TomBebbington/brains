...
{
HX_STACK_FRAME("ZPP_SensorArbiter","new","ZPP_SensorArbiter.new","zpp_nape/dynamics/Arbiter.hx",355)
{
	HX_STACK_LINE(356)
	this->next = null();
	HX_STACK_LINE(406)
...
{
		HX_STACK_FRAME("ZPP_SensorArbiter","makeimmutable","ZPP_SensorArbiter.makeimmutable","zpp_nape/dynamics/Arbiter.hx",442)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_SensorArbiter","makemutable","ZPP_SensorArbiter.makemutable","zpp_nape/dynamics/Arbiter.hx",439)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_SensorArbiter","retire","ZPP_SensorArbiter.retire","zpp_nape/dynamics/Arbiter.hx",417)
		HX_STACK_THIS(this)
		HX_STACK_LINE(418)
		{
			HX_STACK_LINE(418)
...
{
		HX_STACK_FRAME("ZPP_SensorArbiter","assign","ZPP_SensorArbiter.assign","zpp_nape/dynamics/Arbiter.hx",413)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s1,"s1")
		HX_STACK_ARG(s2,"s2")
		HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("ZPP_SensorArbiter","free","ZPP_SensorArbiter.free","zpp_nape/dynamics/Arbiter.hx",396)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_SensorArbiter","alloc","ZPP_SensorArbiter.alloc","zpp_nape/dynamics/Arbiter.hx",384)
		HX_STACK_THIS(this)
	}
return null();
}
