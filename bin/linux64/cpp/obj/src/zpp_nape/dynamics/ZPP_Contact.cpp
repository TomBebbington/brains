...
{
HX_STACK_FRAME("ZPP_Contact","new","ZPP_Contact.new","zpp_nape/dynamics/Contact.hx",174)
{
	HX_STACK_LINE(282)
	this->length = (int)0;
	HX_STACK_LINE(281)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::at( int ind){
	HX_STACK_FRAME("ZPP_Contact","at","ZPP_Contact.at","zpp_nape/dynamics/Contact.hx",611)
	HX_STACK_THIS(this)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::iterator_at( int ind){
	HX_STACK_FRAME("ZPP_Contact","iterator_at","ZPP_Contact.iterator_at","zpp_nape/dynamics/Contact.hx",598)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ind,"ind")
	HX_STACK_LINE(607)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::back( ){
	HX_STACK_FRAME("ZPP_Contact","back","ZPP_Contact.back","zpp_nape/dynamics/Contact.hx",589)
	HX_STACK_THIS(this)
	HX_STACK_LINE(590)
	::zpp_nape::dynamics::ZPP_Contact ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(591)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::front( ){
	HX_STACK_FRAME("ZPP_Contact","front","ZPP_Contact.front","zpp_nape/dynamics/Contact.hx",587)
	HX_STACK_THIS(this)
	HX_STACK_LINE(587)
	return this->next;
}
...
bool ZPP_Contact_obj::inlined_has( ::zpp_nape::dynamics::ZPP_Contact obj){
	HX_STACK_FRAME("ZPP_Contact","inlined_has","ZPP_Contact.inlined_has","zpp_nape/dynamics/Contact.hx",556)
	HX_STACK_THIS(this)
...
bool ZPP_Contact_obj::has( ::zpp_nape::dynamics::ZPP_Contact obj){
	HX_STACK_FRAME("ZPP_Contact","has","ZPP_Contact.has","zpp_nape/dynamics/Contact.hx",552)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(552)
	bool ret;		HX_STACK_VAR(ret,"ret");
...
int ZPP_Contact_obj::size( ){
	HX_STACK_FRAME("ZPP_Contact","size","ZPP_Contact.size","zpp_nape/dynamics/Contact.hx",549)
	HX_STACK_THIS(this)
	HX_STACK_LINE(549)
	return this->length;
}
...
bool ZPP_Contact_obj::empty( ){
	HX_STACK_FRAME("ZPP_Contact","empty","ZPP_Contact.empty","zpp_nape/dynamics/Contact.hx",544)
	HX_STACK_THIS(this)
	HX_STACK_LINE(544)
...
{
		HX_STACK_FRAME("ZPP_Contact","reverse","ZPP_Contact.reverse","zpp_nape/dynamics/Contact.hx",528)
		HX_STACK_THIS(this)
		HX_STACK_LINE(529)
...
{
		HX_STACK_FRAME("ZPP_Contact","inlined_clear","ZPP_Contact.inlined_clear","zpp_nape/dynamics/Contact.hx",523)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Contact","clear","ZPP_Contact.clear","zpp_nape/dynamics/Contact.hx",518)
		HX_STACK_THIS(this)
	}
return null();
}
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::splice( ::zpp_nape::dynamics::ZPP_Contact pre,int n){
	HX_STACK_FRAME("ZPP_Contact","splice","ZPP_Contact.splice","zpp_nape/dynamics/Contact.hx",513)
	HX_STACK_THIS(this)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::inlined_erase( ::zpp_nape::dynamics::ZPP_Contact pre){
	HX_STACK_FRAME("ZPP_Contact","inlined_erase","ZPP_Contact.inlined_erase","zpp_nape/dynamics/Contact.hx",481)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(490)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::erase( ::zpp_nape::dynamics::ZPP_Contact pre){
	HX_STACK_FRAME("ZPP_Contact","erase","ZPP_Contact.erase","zpp_nape/dynamics/Contact.hx",477)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(477)
	::zpp_nape::dynamics::ZPP_Contact old;		HX_STACK_VAR(old,"old");
...
bool ZPP_Contact_obj::inlined_try_remove( ::zpp_nape::dynamics::ZPP_Contact obj){
	HX_STACK_FRAME("ZPP_Contact","inlined_try_remove","ZPP_Contact.inlined_try_remove","zpp_nape/dynamics/Contact.hx",453)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(462)
	::zpp_nape::dynamics::ZPP_Contact pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZPP_Contact","inlined_remove","ZPP_Contact.inlined_remove","zpp_nape/dynamics/Contact.hx",449)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(449)
		::zpp_nape::dynamics::ZPP_Contact pre = null();		HX_STACK_VAR(pre,"pre");
...
bool ZPP_Contact_obj::try_remove( ::zpp_nape::dynamics::ZPP_Contact obj){
	HX_STACK_FRAME("ZPP_Contact","try_remove","ZPP_Contact.try_remove","zpp_nape/dynamics/Contact.hx",415)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(424)
	::zpp_nape::dynamics::ZPP_Contact pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZPP_Contact","remove","ZPP_Contact.remove","zpp_nape/dynamics/Contact.hx",413)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(413)
		::zpp_nape::dynamics::ZPP_Contact pre = null();		HX_STACK_VAR(pre,"pre");
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::inlined_pop_unsafe( ){
	HX_STACK_FRAME("ZPP_Contact","inlined_pop_unsafe","ZPP_Contact.inlined_pop_unsafe","zpp_nape/dynamics/Contact.hx",391)
	HX_STACK_THIS(this)
	HX_STACK_LINE(400)
	::zpp_nape::dynamics::ZPP_Contact ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(401)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::pop_unsafe( ){
	HX_STACK_FRAME("ZPP_Contact","pop_unsafe","ZPP_Contact.pop_unsafe","zpp_nape/dynamics/Contact.hx",387)
	HX_STACK_THIS(this)
	HX_STACK_LINE(387)
	::zpp_nape::dynamics::ZPP_Contact ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(387)
...
{
		HX_STACK_FRAME("ZPP_Contact","inlined_pop","ZPP_Contact.inlined_pop","zpp_nape/dynamics/Contact.hx",367)
		HX_STACK_THIS(this)
		HX_STACK_LINE(376)
		::zpp_nape::dynamics::ZPP_Contact ret = this->next;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(377)
...
{
		HX_STACK_FRAME("ZPP_Contact","pop","ZPP_Contact.pop","zpp_nape/dynamics/Contact.hx",363)
		HX_STACK_THIS(this)
		HX_STACK_LINE(363)
		::zpp_nape::dynamics::ZPP_Contact ret = this->next;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(363)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::inlined_insert( ::zpp_nape::dynamics::ZPP_Contact cur,::zpp_nape::dynamics::ZPP_Contact o){
	HX_STACK_FRAME("ZPP_Contact","inlined_insert","ZPP_Contact.inlined_insert","zpp_nape/dynamics/Contact.hx",337)
	HX_STACK_THIS(this)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::insert( ::zpp_nape::dynamics::ZPP_Contact cur,::zpp_nape::dynamics::ZPP_Contact o){
	HX_STACK_FRAME("ZPP_Contact","insert","ZPP_Contact.insert","zpp_nape/dynamics/Contact.hx",333)
	HX_STACK_THIS(this)
	HX_STACK_ARG(cur,"cur")
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(333)
...
{
		HX_STACK_FRAME("ZPP_Contact","addAll","ZPP_Contact.addAll","zpp_nape/dynamics/Contact.hx",323)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(324)
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::inlined_add( ::zpp_nape::dynamics::ZPP_Contact o){
	HX_STACK_FRAME("ZPP_Contact","inlined_add","ZPP_Contact.inlined_add","zpp_nape/dynamics/Contact.hx",295)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(304)
	::zpp_nape::dynamics::ZPP_Contact temp;		HX_STACK_VAR(temp,"temp");
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::add( ::zpp_nape::dynamics::ZPP_Contact o){
	HX_STACK_FRAME("ZPP_Contact","add","ZPP_Contact.add","zpp_nape/dynamics/Contact.hx",291)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(291)
	::zpp_nape::dynamics::ZPP_Contact temp;		HX_STACK_VAR(temp,"temp");
...
{
		HX_STACK_FRAME("ZPP_Contact","setbegin","ZPP_Contact.setbegin","zpp_nape/dynamics/Contact.hx",285)
		HX_STACK_THIS(this)
		HX_STACK_ARG(i,"i")
		HX_STACK_LINE(286)
		this->next = i;
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::begin( ){
	HX_STACK_FRAME("ZPP_Contact","begin","ZPP_Contact.begin","zpp_nape/dynamics/Contact.hx",277)
	HX_STACK_THIS(this)
	HX_STACK_LINE(277)
	return this->next;
}
...
::zpp_nape::dynamics::ZPP_Contact ZPP_Contact_obj::elem( ){
	HX_STACK_FRAME("ZPP_Contact","elem","ZPP_Contact.elem","zpp_nape/dynamics/Contact.hx",272)
	HX_STACK_THIS(this)
	HX_STACK_LINE(272)
...
{
		HX_STACK_FRAME("ZPP_Contact","alloc","ZPP_Contact.alloc","zpp_nape/dynamics/Contact.hx",243)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Contact","free","ZPP_Contact.free","zpp_nape/dynamics/Contact.hx",239)
		HX_STACK_THIS(this)
		HX_STACK_LINE(239)
		this->arbiter = null();
	}
...
bool ZPP_Contact_obj::inactiveme( ){
	HX_STACK_FRAME("ZPP_Contact","inactiveme","ZPP_Contact.inactiveme","zpp_nape/dynamics/Contact.hx",222)
	HX_STACK_THIS(this)
	HX_STACK_LINE(222)
...
{
		HX_STACK_FRAME("ZPP_Contact","getposition","ZPP_Contact.getposition","zpp_nape/dynamics/Contact.hx",214)
		HX_STACK_THIS(this)
		HX_STACK_LINE(215)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/dynamics/Contact.hx",216)
						{
							HX_STACK_LINE(216)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(216)
...
{
		HX_STACK_FRAME("ZPP_Contact","position_validate","ZPP_Contact.position_validate","zpp_nape/dynamics/Contact.hx",188)
		HX_STACK_THIS(this)
		HX_STACK_LINE(190)
		if ((this->inactiveme())){
			HX_STACK_LINE(190)
...
::nape::dynamics::Contact ZPP_Contact_obj::wrapper( ){
	HX_STACK_FRAME("ZPP_Contact","wrapper","ZPP_Contact.wrapper","zpp_nape/dynamics/Contact.hx",177)
	HX_STACK_THIS(this)
	HX_STACK_LINE(178)
	if (((this->outer == null()))){
		HX_STACK_LINE(179)
