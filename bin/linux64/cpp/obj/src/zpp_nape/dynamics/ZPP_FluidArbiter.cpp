...
{
HX_STACK_FRAME("ZPP_FluidArbiter","new","ZPP_FluidArbiter.new","zpp_nape/dynamics/Arbiter.hx",445)
{
	HX_STACK_LINE(705)
	this->pre_dt = 0.0;
	HX_STACK_LINE(667)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","applyImpulseVel","ZPP_FluidArbiter.applyImpulseVel","zpp_nape/dynamics/Arbiter.hx",1302)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1302)
		if ((!(this->nodrag))){
			HX_STACK_LINE(1303)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","warmStart","ZPP_FluidArbiter.warmStart","zpp_nape/dynamics/Arbiter.hx",1267)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1268)
		{
			HX_STACK_LINE(1269)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","preStep","ZPP_FluidArbiter.preStep","zpp_nape/dynamics/Arbiter.hx",708)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_ARG(dt,"dt")
		HX_STACK_LINE(709)
			...
			if (((tViscosity != (int)0))){
				...
				struct _Function_3_1{
					inline static Float Block( ::zpp_nape::dynamics::ZPP_FluidArbiter_obj *__this,Float &biasCoef,Float &tViscosity,Float &dt){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/dynamics/Arbiter.hx",1037)
						{
							HX_STACK_LINE(1038)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","inject","ZPP_FluidArbiter.inject","zpp_nape/dynamics/Arbiter.hx",682)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","makeimmutable","ZPP_FluidArbiter.makeimmutable","zpp_nape/dynamics/Arbiter.hx",676)
		HX_STACK_THIS(this)
		HX_STACK_LINE(677)
		this->_mutable = false;
		HX_STACK_LINE(678)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","makemutable","ZPP_FluidArbiter.makemutable","zpp_nape/dynamics/Arbiter.hx",670)
		HX_STACK_THIS(this)
		HX_STACK_LINE(671)
		this->_mutable = true;
		HX_STACK_LINE(672)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","retire","ZPP_FluidArbiter.retire","zpp_nape/dynamics/Arbiter.hx",646)
		HX_STACK_THIS(this)
		HX_STACK_LINE(647)
		{
			HX_STACK_LINE(647)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","assign","ZPP_FluidArbiter.assign","zpp_nape/dynamics/Arbiter.hx",600)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s1,"s1")
		HX_STACK_ARG(s2,"s2")
		HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","getposition","ZPP_FluidArbiter.getposition","zpp_nape/dynamics/Arbiter.hx",565)
		HX_STACK_THIS(this)
		HX_STACK_LINE(566)
		{
			HX_STACK_LINE(566)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/dynamics/Arbiter.hx",566)
						{
							HX_STACK_LINE(566)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(566)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","position_invalidate","ZPP_FluidArbiter.position_invalidate","zpp_nape/dynamics/Arbiter.hx",543)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(544)
		this->centroidx = x->x;
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","position_validate","ZPP_FluidArbiter.position_validate","zpp_nape/dynamics/Arbiter.hx",517)
		HX_STACK_THIS(this)
		HX_STACK_LINE(519)
		if ((!(this->active))){
			HX_STACK_LINE(519)
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","free","ZPP_FluidArbiter.free","zpp_nape/dynamics/Arbiter.hx",487)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_FluidArbiter","alloc","ZPP_FluidArbiter.alloc","zpp_nape/dynamics/Arbiter.hx",475)
		HX_STACK_THIS(this)
	}
return null();
}
