...
{
HX_STACK_FRAME("ZPP_InteractionFilter","new","ZPP_InteractionFilter.new","zpp_nape/dynamics/InteractionFilter.hx",174)
{
	HX_STACK_LINE(298)
...
{
		HX_STACK_FRAME("ZPP_InteractionFilter","invalidate","ZPP_InteractionFilter.invalidate","zpp_nape/dynamics/InteractionFilter.hx",305)
		HX_STACK_THIS(this)
		HX_STACK_LINE(306)
...
bool ZPP_InteractionFilter_obj::shouldFlow( ::zpp_nape::dynamics::ZPP_InteractionFilter x){
	HX_STACK_FRAME("ZPP_InteractionFilter","shouldFlow","ZPP_InteractionFilter.shouldFlow","zpp_nape/dynamics/InteractionFilter.hx",302)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(302)
...
bool ZPP_InteractionFilter_obj::shouldSense( ::zpp_nape::dynamics::ZPP_InteractionFilter x){
	HX_STACK_FRAME("ZPP_InteractionFilter","shouldSense","ZPP_InteractionFilter.shouldSense","zpp_nape/dynamics/InteractionFilter.hx",295)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(295)
...
bool ZPP_InteractionFilter_obj::shouldCollide( ::zpp_nape::dynamics::ZPP_InteractionFilter x){
	HX_STACK_FRAME("ZPP_InteractionFilter","shouldCollide","ZPP_InteractionFilter.shouldCollide","zpp_nape/dynamics/InteractionFilter.hx",288)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(288)
...
::zpp_nape::dynamics::ZPP_InteractionFilter ZPP_InteractionFilter_obj::copy( ){
	HX_STACK_FRAME("ZPP_InteractionFilter","copy","ZPP_InteractionFilter.copy","zpp_nape/dynamics/InteractionFilter.hx",256)
	HX_STACK_THIS(this)
	HX_STACK_LINE(257)
...
{
		HX_STACK_FRAME("ZPP_InteractionFilter","remShape","ZPP_InteractionFilter.remShape","zpp_nape/dynamics/InteractionFilter.hx",249)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_InteractionFilter","addShape","ZPP_InteractionFilter.addShape","zpp_nape/dynamics/InteractionFilter.hx",244)
		HX_STACK_THIS(this)
		HX_STACK_ARG(shape,"shape")
		HX_STACK_LINE(244)
...
{
		HX_STACK_FRAME("ZPP_InteractionFilter","feature_cons","ZPP_InteractionFilter.feature_cons","zpp_nape/dynamics/InteractionFilter.hx",239)
		HX_STACK_THIS(this)
		HX_STACK_LINE(239)
		this->shapes = ::zpp_nape::util::ZNPList_ZPP_Shape_obj::__new();
	}
...
{
		HX_STACK_FRAME("ZPP_InteractionFilter","alloc","ZPP_InteractionFilter.alloc","zpp_nape/dynamics/InteractionFilter.hx",233)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_InteractionFilter","free","ZPP_InteractionFilter.free","zpp_nape/dynamics/InteractionFilter.hx",229)
		HX_STACK_THIS(this)
		HX_STACK_LINE(229)
		this->outer = null();
	}
...
::nape::dynamics::InteractionFilter ZPP_InteractionFilter_obj::wrapper( ){
	HX_STACK_FRAME("ZPP_InteractionFilter","wrapper","ZPP_InteractionFilter.wrapper","zpp_nape/dynamics/InteractionFilter.hx",202)
	HX_STACK_THIS(this)
	HX_STACK_LINE(203)
	if (((this->outer == null()))){
		HX_STACK_LINE(204)
