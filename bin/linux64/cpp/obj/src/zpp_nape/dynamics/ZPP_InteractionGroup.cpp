...
{
HX_STACK_FRAME("ZPP_InteractionGroup","new","ZPP_InteractionGroup.new","zpp_nape/dynamics/InteractionGroup.hx",174)
{
	HX_STACK_LINE(196)
	this->depth = (int)0;
	HX_STACK_LINE(195)
...
int flag = __o_flag.Default(-1);
	HX_STACK_FRAME("ZPP_InteractionGroup","remInteractor","ZPP_InteractionGroup.remInteractor","zpp_nape/dynamics/InteractionGroup.hx",247)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_InteractionGroup","addInteractor","ZPP_InteractionGroup.addInteractor","zpp_nape/dynamics/InteractionGroup.hx",242)
		HX_STACK_THIS(this)
		HX_STACK_ARG(intx,"intx")
		HX_STACK_LINE(242)
...
{
		HX_STACK_FRAME("ZPP_InteractionGroup","remGroup","ZPP_InteractionGroup.remGroup","zpp_nape/dynamics/InteractionGroup.hx",235)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_InteractionGroup","addGroup","ZPP_InteractionGroup.addGroup","zpp_nape/dynamics/InteractionGroup.hx",229)
		HX_STACK_THIS(this)
		HX_STACK_ARG(group,"group")
		HX_STACK_LINE(230)
...
bool force = __o_force.Default(false);
	HX_STACK_FRAME("ZPP_InteractionGroup","invalidate","ZPP_InteractionGroup.invalidate","zpp_nape/dynamics/InteractionGroup.hx",197)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_InteractionGroup","setGroup","ZPP_InteractionGroup.setGroup","zpp_nape/dynamics/InteractionGroup.hx",179)
		HX_STACK_THIS(this)
		HX_STACK_ARG(group,"group")
		HX_STACK_LINE(179)
		if (((this->group != group))){
