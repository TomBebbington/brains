...
{
HX_STACK_FRAME("ZPP_Arbiter","new","ZPP_Arbiter.new","zpp_nape/dynamics/Arbiter.hx",174)
{
	HX_STACK_LINE(266)
	this->sensorarb = null();
	HX_STACK_LINE(265)
...
{
		HX_STACK_FRAME("ZPP_Arbiter","sup_retire","ZPP_Arbiter.sup_retire","zpp_nape/dynamics/Arbiter.hx",308)
		HX_STACK_THIS(this)
		HX_STACK_LINE(341)
		if ((!(this->cleared))){
			HX_STACK_LINE(342)
...
{
		HX_STACK_FRAME("ZPP_Arbiter","sup_assign","ZPP_Arbiter.sup_assign","zpp_nape/dynamics/Arbiter.hx",290)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s1,"s1")
		HX_STACK_ARG(s2,"s2")
		HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("ZPP_Arbiter","lazyRetire","ZPP_Arbiter.lazyRetire","zpp_nape/dynamics/Arbiter.hx",269)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_ARG(b,"b")
		HX_STACK_LINE(278)
...
{
		HX_STACK_FRAME("ZPP_Arbiter","swap_features","ZPP_Arbiter.swap_features","zpp_nape/dynamics/Arbiter.hx",235)
		HX_STACK_THIS(this)
		HX_STACK_LINE(244)
		{
			HX_STACK_LINE(245)
...
bool ZPP_Arbiter_obj::acting( ){
	HX_STACK_FRAME("ZPP_Arbiter","acting","ZPP_Arbiter.acting","zpp_nape/dynamics/Arbiter.hx",225)
	HX_STACK_THIS(this)
	HX_STACK_LINE(225)
...
bool ZPP_Arbiter_obj::inactiveme( ){
	HX_STACK_FRAME("ZPP_Arbiter","inactiveme","ZPP_Arbiter.inactiveme","zpp_nape/dynamics/Arbiter.hx",200)
	HX_STACK_THIS(this)
	HX_STACK_LINE(200)
	return !(this->active);
}
...
::nape::dynamics::Arbiter ZPP_Arbiter_obj::wrapper( ){
	HX_STACK_FRAME("ZPP_Arbiter","wrapper","ZPP_Arbiter.wrapper","zpp_nape/dynamics/Arbiter.hx",180)
	HX_STACK_THIS(this)
	HX_STACK_LINE(181)
	if (((this->outer == null()))){
		HX_STACK_LINE(182)
