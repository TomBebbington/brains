...
{
HX_STACK_FRAME("ZPP_PartitionedPoly","new","ZPP_PartitionedPoly.new","zpp_nape/geom/PartitionedPoly.hx",587)
...
::zpp_nape::geom::ZPP_PartitionVertex ZPP_PartitionedPoly_obj::pull( ::zpp_nape::geom::ZPP_PartitionVertex start,::zpp_nape::util::ZNPList_ZPP_GeomVert ret){
	HX_STACK_FRAME("ZPP_PartitionedPoly","pull","ZPP_PartitionedPoly.pull","zpp_nape/geom/PartitionedPoly.hx",1218)
	HX_STACK_THIS(this)
	...
	if ((((area * area) >= (::nape::Config_obj::epsilon * ::nape::Config_obj::epsilon)))){
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::geom::ZPP_GeomVert &poly){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",1344)
				{
					HX_STACK_LINE(1345)
					...
					while(((bool(skip) || bool((p != poly))))){
						...
						struct _Function_4_1{
							inline static Float Block( ::zpp_nape::geom::ZPP_GeomVert &p){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",1349)
								{
									HX_STACK_LINE(1349)
...
::zpp_nape::util::ZNPList_ZPP_GeomVert ZPP_PartitionedPoly_obj::extract( ::zpp_nape::util::ZNPList_ZPP_GeomVert ret){
	HX_STACK_FRAME("ZPP_PartitionedPoly","extract","ZPP_PartitionedPoly.extract","zpp_nape/geom/PartitionedPoly.hx",1138)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ret,"ret")
	HX_STACK_LINE(1139)
	if (((ret == null()))){
...
::zpp_nape::geom::ZPP_PartitionVertex ZPP_PartitionedPoly_obj::pull_partitions( ::zpp_nape::geom::ZPP_PartitionVertex start,::zpp_nape::util::ZNPList_ZPP_PartitionedPoly ret){
	HX_STACK_FRAME("ZPP_PartitionedPoly","pull_partitions","ZPP_PartitionedPoly.pull_partitions","zpp_nape/geom/PartitionedPoly.hx",990)
	HX_STACK_THIS(this)
	HX_STACK_ARG(start,"start")
	HX_STACK_ARG(ret,"ret")
	HX_STACK_LINE(991)
...
while(((next != start)));
	struct _Function_1_1{
		inline static Float Block( ::zpp_nape::geom::ZPP_PartitionedPoly &poly){
			HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",1085)
			{
				HX_STACK_LINE(1110)
...
::zpp_nape::util::ZNPList_ZPP_PartitionedPoly ZPP_PartitionedPoly_obj::extract_partitions( ::zpp_nape::util::ZNPList_ZPP_PartitionedPoly ret){
	HX_STACK_FRAME("ZPP_PartitionedPoly","extract_partitions","ZPP_PartitionedPoly.extract_partitions","zpp_nape/geom/PartitionedPoly.hx",895)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ret,"ret")
	HX_STACK_LINE(896)
	if (((ret == null()))){
...
{
		HX_STACK_FRAME("ZPP_PartitionedPoly","add_diagonal","ZPP_PartitionedPoly.add_diagonal","zpp_nape/geom/PartitionedPoly.hx",884)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p,"p")
		HX_STACK_ARG(q,"q")
		HX_STACK_LINE(885)
...
bool ZPP_PartitionedPoly_obj::remove_collinear_vertices( ){
	HX_STACK_FRAME("ZPP_PartitionedPoly","remove_collinear_vertices","ZPP_PartitionedPoly.remove_collinear_vertices","zpp_nape/geom/PartitionedPoly.hx",712)
	HX_STACK_THIS(this)
	HX_STACK_LINE(713)
...
{
		HX_STACK_FRAME("ZPP_PartitionedPoly","init","ZPP_PartitionedPoly.init","zpp_nape/geom/PartitionedPoly.hx",633)
		HX_STACK_THIS(this)
		HX_STACK_ARG(P,"P")
		HX_STACK_LINE(634)
		if (((P == null()))){
		...
		struct _Function_1_1{
			inline static Float Block( ::zpp_nape::geom::ZPP_GeomVert &P){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",636)
				{
					HX_STACK_LINE(661)
					Float area = 0.0;		HX_STACK_VAR(area,"area");
					HX_STACK_LINE(662)
...
{
		HX_STACK_FRAME("ZPP_PartitionedPoly","free","ZPP_PartitionedPoly.free","zpp_nape/geom/PartitionedPoly.hx",624)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_PartitionedPoly","alloc","ZPP_PartitionedPoly.alloc","zpp_nape/geom/PartitionedPoly.hx",621)
		HX_STACK_THIS(this)
	}
return null();
}
...
bool ZPP_PartitionedPoly_obj::eq( ::zpp_nape::geom::ZPP_PartitionVertex a,::zpp_nape::geom::ZPP_PartitionVertex b){
	HX_STACK_FRAME("ZPP_PartitionedPoly","eq","ZPP_PartitionedPoly.eq","zpp_nape/geom/PartitionedPoly.hx",590)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	struct _Function_1_1{
		inline static Float Block( ::zpp_nape::geom::ZPP_PartitionVertex &a,::zpp_nape::geom::ZPP_PartitionVertex &b){
			HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",590)
			{
				HX_STACK_LINE(590)
				Float dx = 0.0;		HX_STACK_VAR(dx,"dx");
				HX_STACK_LINE(590)
...
::zpp_nape::util::ZNPList_ZPP_PartitionedPoly ZPP_PartitionedPoly_obj::getSharedPP( ){
	HX_STACK_FRAME("ZPP_PartitionedPoly","getSharedPP","ZPP_PartitionedPoly.getSharedPP","zpp_nape/geom/PartitionedPoly.hx",891)
	HX_STACK_LINE(892)
...
::zpp_nape::util::ZNPList_ZPP_GeomVert ZPP_PartitionedPoly_obj::getShared( ){
	HX_STACK_FRAME("ZPP_PartitionedPoly","getShared","ZPP_PartitionedPoly.getShared","zpp_nape/geom/PartitionedPoly.hx",1134)
	HX_STACK_LINE(1135)
