...
{
HX_STACK_FRAME("ZPP_MarchPair","new","ZPP_MarchPair.new","zpp_nape/geom/MarchingSquares.hx",219)
{
	HX_STACK_LINE(233)
	this->next = null();
	HX_STACK_LINE(232)
...
{
		HX_STACK_FRAME("ZPP_MarchPair","alloc","ZPP_MarchPair.alloc","zpp_nape/geom/MarchingSquares.hx",266)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_MarchPair","free","ZPP_MarchPair.free","zpp_nape/geom/MarchingSquares.hx",260)
		HX_STACK_THIS(this)
		HX_STACK_LINE(261)
