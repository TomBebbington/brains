...
bool userAPI = __o_userAPI.Default(false);
	HX_STACK_FRAME("ZPP_SweepDistance","dynamicSweep","ZPP_SweepDistance.dynamicSweep","zpp_nape/geom/SweepDistance.hx",230)
	...
	HX_STACK_ARG(userAPI,"userAPI")
{
		...
		while((true)){
			...
			HX_STACK_LINE(261)
			Float sep;		HX_STACK_VAR(sep,"sep");
			struct _Function_2_1{
				inline static Float Block( ::zpp_nape::shape::ZPP_Shape &s1,::zpp_nape::geom::ZPP_Vec2 &c2,::zpp_nape::geom::ZPP_Vec2 &axis,::zpp_nape::geom::ZPP_Vec2 &c1,::zpp_nape::shape::ZPP_Shape &s2){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/SweepDistance.hx",261)
					{
						HX_STACK_LINE(261)
			...
			HX_STACK_LINE(261)
			sep = (_Function_2_1::Block(s1,c2,axis,c1,s2) + negRadius);
			HX_STACK_LINE(262)
			...
			if (((curTOI >= (int)1))){
				...
				HX_STACK_LINE(301)
				Float sep1;		HX_STACK_VAR(sep1,"sep1");
				struct _Function_3_1{
					inline static Float Block( ::zpp_nape::shape::ZPP_Shape &s1,::zpp_nape::geom::ZPP_Vec2 &c2,::zpp_nape::geom::ZPP_Vec2 &axis,::zpp_nape::geom::ZPP_Vec2 &c1,::zpp_nape::shape::ZPP_Shape &s2){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/SweepDistance.hx",301)
						{
							HX_STACK_LINE(301)
							::zpp_nape::shape::ZPP_Shape s11 = s1;		HX_STACK_VAR(s11,"s11");
							HX_STACK_LINE(301)
				...
				HX_STACK_LINE(301)
				sep1 = (_Function_3_1::Block(s1,c2,axis,c1,s2) + negRadius);
				HX_STACK_LINE(302)
...
{
		HX_STACK_FRAME("ZPP_SweepDistance","staticSweep","ZPP_SweepDistance.staticSweep","zpp_nape/geom/SweepDistance.hx",339)
		HX_STACK_ARG(toi,"toi")
		HX_STACK_ARG(timeStep,"timeStep")
		HX_STACK_ARG(lowerBound,"lowerBound")
		HX_STACK_ARG(negRadius,"negRadius")
		...
		while((true)){
			...
			struct _Function_2_1{
				inline static Float Block( ::zpp_nape::shape::ZPP_Shape &s1,::zpp_nape::geom::ZPP_Vec2 &c2,::zpp_nape::geom::ZPP_Vec2 &axis,::zpp_nape::geom::ZPP_Vec2 &c1,::zpp_nape::shape::ZPP_Shape &s2){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/SweepDistance.hx",393)
					{
						HX_STACK_LINE(393)
						::zpp_nape::shape::ZPP_Shape s11 = s1;		HX_STACK_VAR(s11,"s11");
						HX_STACK_LINE(393)
			...
			if (((curTOI >= (int)1))){
				...
				struct _Function_3_1{
					inline static Float Block( ::zpp_nape::shape::ZPP_Shape &s1,::zpp_nape::geom::ZPP_Vec2 &c2,::zpp_nape::geom::ZPP_Vec2 &axis,::zpp_nape::geom::ZPP_Vec2 &c1,::zpp_nape::shape::ZPP_Shape &s2){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/SweepDistance.hx",446)
						{
							HX_STACK_LINE(446)
							::zpp_nape::shape::ZPP_Shape s11 = s1;		HX_STACK_VAR(s11,"s11");
							HX_STACK_LINE(446)
...
Float ZPP_SweepDistance_obj::distanceBody( ::zpp_nape::phys::ZPP_Body b1,::zpp_nape::phys::ZPP_Body b2,::zpp_nape::geom::ZPP_Vec2 w1,::zpp_nape::geom::ZPP_Vec2 w2){
	HX_STACK_FRAME("ZPP_SweepDistance","distanceBody","ZPP_SweepDistance.distanceBody","zpp_nape/geom/SweepDistance.hx",475)
	HX_STACK_ARG(b1,"b1")
	HX_STACK_ARG(b2,"b2")
	HX_STACK_ARG(w1,"w1")
	HX_STACK_ARG(w2,"w2")
...
Float upperBound = __o_upperBound.Default(1e100);
	HX_STACK_FRAME("ZPP_SweepDistance","distance","ZPP_SweepDistance.distance","zpp_nape/geom/SweepDistance.hx",631)
	HX_STACK_ARG(s1,"s1")
	HX_STACK_ARG(s2,"s2")
	HX_STACK_ARG(w1,"w1")
	HX_STACK_ARG(w2,"w2")
