...
::nape::geom::GeomPolyList ZPP_Cutter_obj::run( ::zpp_nape::geom::ZPP_GeomVert P,::nape::geom::Vec2 _start,::nape::geom::Vec2 _end,bool bstart,bool bend,::nape::geom::GeomPolyList output){
	HX_STACK_FRAME("ZPP_Cutter","run","ZPP_Cutter.run","zpp_nape/geom/Cutter.hx",324)
	HX_STACK_ARG(P,"P")
	...
	HX_STACK_LINE(349)
	{
		struct _Function_2_1{
			inline static Float Block( ::nape::geom::Vec2 &_end){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Cutter.hx",350)
				{
					HX_STACK_LINE(350)
		...
		struct _Function_2_2{
			inline static Float Block( ::nape::geom::Vec2 &_end){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Cutter.hx",351)
				{
					HX_STACK_LINE(351)
					if (((bool((_end != null())) && bool(_end->zpp_disp)))){
						HX_STACK_LINE(351)
			...
			if (((bool((s < min)) || bool((s > max))))){
				struct _Function_4_1{
					inline static ::zpp_nape::geom::ZPP_CutInt Block( Float &s){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Cutter.hx",730)
						{
							HX_STACK_LINE(730)
				...
				if (((i->value == (int)0))){
					...
					struct _Function_5_1{
						inline static ::zpp_nape::geom::ZPP_CutVert Block( ::zpp_nape::geom::ZPP_GeomVert &start){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Cutter.hx",770)
							{
								HX_STACK_LINE(770)
								::zpp_nape::geom::ZPP_CutVert ret;		HX_STACK_VAR(ret,"ret");
								HX_STACK_LINE(770)
					...
					struct _Function_5_2{
						inline static ::zpp_nape::geom::ZPP_CutInt Block( ::zpp_nape::geom::ZPP_GeomVert &endof,::zpp_nape::geom::ZPP_CutVert &postpath,::zpp_nape::geom::ZPP_CutVert &prepath,Float &s,::zpp_nape::geom::ZPP_GeomVert &start){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Cutter.hx",772)
							{
								HX_STACK_LINE(772)
								bool vertex = false;		HX_STACK_VAR(vertex,"vertex");
								HX_STACK_LINE(772)
					...
					if (((j->value == (int)0))){
						...
						struct _Function_6_1{
							inline static ::zpp_nape::geom::ZPP_CutVert Block( ::zpp_nape::geom::ZPP_GeomVert &start){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Cutter.hx",800)
								{
									HX_STACK_LINE(800)
									::zpp_nape::geom::ZPP_CutVert ret;		HX_STACK_VAR(ret,"ret");
									HX_STACK_LINE(800)
						...
						struct _Function_6_2{
							inline static ::zpp_nape::geom::ZPP_CutInt Block( ::zpp_nape::geom::ZPP_GeomVert &endof,::zpp_nape::geom::ZPP_CutVert &postpath,::zpp_nape::geom::ZPP_CutVert &prepath,Float &s,::zpp_nape::geom::ZPP_GeomVert &start){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Cutter.hx",802)
								{
									HX_STACK_LINE(802)
									bool vertex = false;		HX_STACK_VAR(vertex,"vertex");
									HX_STACK_LINE(802)
						...
						struct _Function_6_1{
							inline static ::zpp_nape::geom::ZPP_CutVert Block( ::zpp_nape::geom::ZPP_GeomVert &start){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Cutter.hx",877)
								{
									HX_STACK_LINE(877)
									::zpp_nape::geom::ZPP_CutVert ret;		HX_STACK_VAR(ret,"ret");
									HX_STACK_LINE(877)
						...
						struct _Function_6_2{
							inline static ::zpp_nape::geom::ZPP_CutInt Block( ::zpp_nape::geom::ZPP_GeomVert &endof,::zpp_nape::geom::ZPP_CutVert &postpath,::zpp_nape::geom::ZPP_CutVert &prepath,Float &s,::zpp_nape::geom::ZPP_GeomVert &start){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Cutter.hx",879)
								{
									HX_STACK_LINE(879)
									bool vertex = false;		HX_STACK_VAR(vertex,"vertex");
									HX_STACK_LINE(879)
