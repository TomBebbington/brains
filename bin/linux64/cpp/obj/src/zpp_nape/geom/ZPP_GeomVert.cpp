...
{
HX_STACK_FRAME("ZPP_GeomVert","new","ZPP_GeomVert.new","zpp_nape/geom/GeomPoly.hx",174)
{
	HX_STACK_LINE(180)
	this->forced = false;
	HX_STACK_LINE(179)
...
{
		HX_STACK_FRAME("ZPP_GeomVert","getwrap","ZPP_GeomVert.getwrap","zpp_nape/geom/GeomPoly.hx",253)
		HX_STACK_THIS(this)
		HX_STACK_LINE(254)
...
{
		HX_STACK_FRAME("ZPP_GeomVert","modwrap","ZPP_GeomVert.modwrap","zpp_nape/geom/GeomPoly.hx",230)
		HX_STACK_THIS(this)
		HX_STACK_ARG(n,"n")
		HX_STACK_LINE(231)
		this->x = n->x;
...
::nape::geom::Vec2 ZPP_GeomVert_obj::wrapper( ){
	HX_STACK_FRAME("ZPP_GeomVert","wrapper","ZPP_GeomVert.wrapper","zpp_nape/geom/GeomPoly.hx",219)
	HX_STACK_THIS(this)
	HX_STACK_LINE(220)
	if (((this->wrap == null()))){
		HX_STACK_LINE(221)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/GeomPoly.hx",221)
						{
							HX_STACK_LINE(221)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(221)
...
{
		HX_STACK_FRAME("ZPP_GeomVert","alloc","ZPP_GeomVert.alloc","zpp_nape/geom/GeomPoly.hx",216)
		HX_STACK_THIS(this)
		HX_STACK_LINE(216)
		this->forced = false;
	}
...
{
		HX_STACK_FRAME("ZPP_GeomVert","free","ZPP_GeomVert.free","zpp_nape/geom/GeomPoly.hx",206)
		HX_STACK_THIS(this)
		HX_STACK_LINE(207)
		if (((this->wrap != null()))){
			HX_STACK_LINE(208)
...
::zpp_nape::geom::ZPP_GeomVert ZPP_GeomVert_obj::get( Float x,Float y){
	HX_STACK_FRAME("ZPP_GeomVert","get","ZPP_GeomVert.get","zpp_nape/geom/GeomPoly.hx",275)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(276)
