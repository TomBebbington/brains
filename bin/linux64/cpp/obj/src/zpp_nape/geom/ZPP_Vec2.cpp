...
{
HX_STACK_FRAME("ZPP_Vec2","new","ZPP_Vec2.new","zpp_nape/geom/Vec2.hx",174)
{
	HX_STACK_LINE(629)
	this->y = 0.0;
	HX_STACK_LINE(628)
...
::String ZPP_Vec2_obj::toString( ){
	HX_STACK_FRAME("ZPP_Vec2","toString","ZPP_Vec2.toString","zpp_nape/geom/Vec2.hx",680)
	HX_STACK_THIS(this)
	HX_STACK_LINE(680)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::copy( ){
	HX_STACK_FRAME("ZPP_Vec2","copy","ZPP_Vec2.copy","zpp_nape/geom/Vec2.hx",677)
	HX_STACK_THIS(this)
	HX_STACK_LINE(677)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::at( int ind){
	HX_STACK_FRAME("ZPP_Vec2","at","ZPP_Vec2.at","zpp_nape/geom/Vec2.hx",616)
	HX_STACK_THIS(this)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::iterator_at( int ind){
	HX_STACK_FRAME("ZPP_Vec2","iterator_at","ZPP_Vec2.iterator_at","zpp_nape/geom/Vec2.hx",603)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ind,"ind")
	HX_STACK_LINE(612)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::back( ){
	HX_STACK_FRAME("ZPP_Vec2","back","ZPP_Vec2.back","zpp_nape/geom/Vec2.hx",594)
	HX_STACK_THIS(this)
	HX_STACK_LINE(595)
	::zpp_nape::geom::ZPP_Vec2 ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(596)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::front( ){
	HX_STACK_FRAME("ZPP_Vec2","front","ZPP_Vec2.front","zpp_nape/geom/Vec2.hx",592)
	HX_STACK_THIS(this)
	HX_STACK_LINE(592)
	return this->next;
}
...
bool ZPP_Vec2_obj::inlined_has( ::zpp_nape::geom::ZPP_Vec2 obj){
	HX_STACK_FRAME("ZPP_Vec2","inlined_has","ZPP_Vec2.inlined_has","zpp_nape/geom/Vec2.hx",561)
	HX_STACK_THIS(this)
...
bool ZPP_Vec2_obj::has( ::zpp_nape::geom::ZPP_Vec2 obj){
	HX_STACK_FRAME("ZPP_Vec2","has","ZPP_Vec2.has","zpp_nape/geom/Vec2.hx",557)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(557)
	bool ret;		HX_STACK_VAR(ret,"ret");
...
int ZPP_Vec2_obj::size( ){
	HX_STACK_FRAME("ZPP_Vec2","size","ZPP_Vec2.size","zpp_nape/geom/Vec2.hx",554)
	HX_STACK_THIS(this)
	HX_STACK_LINE(554)
	return this->length;
}
...
bool ZPP_Vec2_obj::empty( ){
	HX_STACK_FRAME("ZPP_Vec2","empty","ZPP_Vec2.empty","zpp_nape/geom/Vec2.hx",549)
	HX_STACK_THIS(this)
	HX_STACK_LINE(549)
...
{
		HX_STACK_FRAME("ZPP_Vec2","reverse","ZPP_Vec2.reverse","zpp_nape/geom/Vec2.hx",533)
		HX_STACK_THIS(this)
		HX_STACK_LINE(534)
...
{
		HX_STACK_FRAME("ZPP_Vec2","inlined_clear","ZPP_Vec2.inlined_clear","zpp_nape/geom/Vec2.hx",528)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Vec2","clear","ZPP_Vec2.clear","zpp_nape/geom/Vec2.hx",523)
		HX_STACK_THIS(this)
	}
return null();
}
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::splice( ::zpp_nape::geom::ZPP_Vec2 pre,int n){
	HX_STACK_FRAME("ZPP_Vec2","splice","ZPP_Vec2.splice","zpp_nape/geom/Vec2.hx",518)
	HX_STACK_THIS(this)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::inlined_erase( ::zpp_nape::geom::ZPP_Vec2 pre){
	HX_STACK_FRAME("ZPP_Vec2","inlined_erase","ZPP_Vec2.inlined_erase","zpp_nape/geom/Vec2.hx",486)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(495)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::erase( ::zpp_nape::geom::ZPP_Vec2 pre){
	HX_STACK_FRAME("ZPP_Vec2","erase","ZPP_Vec2.erase","zpp_nape/geom/Vec2.hx",482)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(482)
	::zpp_nape::geom::ZPP_Vec2 old;		HX_STACK_VAR(old,"old");
...
bool ZPP_Vec2_obj::inlined_try_remove( ::zpp_nape::geom::ZPP_Vec2 obj){
	HX_STACK_FRAME("ZPP_Vec2","inlined_try_remove","ZPP_Vec2.inlined_try_remove","zpp_nape/geom/Vec2.hx",458)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(467)
	::zpp_nape::geom::ZPP_Vec2 pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZPP_Vec2","inlined_remove","ZPP_Vec2.inlined_remove","zpp_nape/geom/Vec2.hx",454)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(454)
		::zpp_nape::geom::ZPP_Vec2 pre = null();		HX_STACK_VAR(pre,"pre");
...
bool ZPP_Vec2_obj::try_remove( ::zpp_nape::geom::ZPP_Vec2 obj){
	HX_STACK_FRAME("ZPP_Vec2","try_remove","ZPP_Vec2.try_remove","zpp_nape/geom/Vec2.hx",420)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(429)
	::zpp_nape::geom::ZPP_Vec2 pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZPP_Vec2","remove","ZPP_Vec2.remove","zpp_nape/geom/Vec2.hx",418)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(418)
		::zpp_nape::geom::ZPP_Vec2 pre = null();		HX_STACK_VAR(pre,"pre");
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::inlined_pop_unsafe( ){
	HX_STACK_FRAME("ZPP_Vec2","inlined_pop_unsafe","ZPP_Vec2.inlined_pop_unsafe","zpp_nape/geom/Vec2.hx",396)
	HX_STACK_THIS(this)
	HX_STACK_LINE(405)
	::zpp_nape::geom::ZPP_Vec2 ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(406)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::pop_unsafe( ){
	HX_STACK_FRAME("ZPP_Vec2","pop_unsafe","ZPP_Vec2.pop_unsafe","zpp_nape/geom/Vec2.hx",392)
	HX_STACK_THIS(this)
	HX_STACK_LINE(392)
	::zpp_nape::geom::ZPP_Vec2 ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(392)
...
{
		HX_STACK_FRAME("ZPP_Vec2","inlined_pop","ZPP_Vec2.inlined_pop","zpp_nape/geom/Vec2.hx",372)
		HX_STACK_THIS(this)
		HX_STACK_LINE(381)
		::zpp_nape::geom::ZPP_Vec2 ret = this->next;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(382)
...
{
		HX_STACK_FRAME("ZPP_Vec2","pop","ZPP_Vec2.pop","zpp_nape/geom/Vec2.hx",368)
		HX_STACK_THIS(this)
		HX_STACK_LINE(368)
		::zpp_nape::geom::ZPP_Vec2 ret = this->next;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(368)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::inlined_insert( ::zpp_nape::geom::ZPP_Vec2 cur,::zpp_nape::geom::ZPP_Vec2 o){
	HX_STACK_FRAME("ZPP_Vec2","inlined_insert","ZPP_Vec2.inlined_insert","zpp_nape/geom/Vec2.hx",342)
	HX_STACK_THIS(this)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::insert( ::zpp_nape::geom::ZPP_Vec2 cur,::zpp_nape::geom::ZPP_Vec2 o){
	HX_STACK_FRAME("ZPP_Vec2","insert","ZPP_Vec2.insert","zpp_nape/geom/Vec2.hx",338)
	HX_STACK_THIS(this)
	HX_STACK_ARG(cur,"cur")
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(338)
...
{
		HX_STACK_FRAME("ZPP_Vec2","addAll","ZPP_Vec2.addAll","zpp_nape/geom/Vec2.hx",328)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(329)
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::inlined_add( ::zpp_nape::geom::ZPP_Vec2 o){
	HX_STACK_FRAME("ZPP_Vec2","inlined_add","ZPP_Vec2.inlined_add","zpp_nape/geom/Vec2.hx",300)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(309)
	::zpp_nape::geom::ZPP_Vec2 temp;		HX_STACK_VAR(temp,"temp");
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::add( ::zpp_nape::geom::ZPP_Vec2 o){
	HX_STACK_FRAME("ZPP_Vec2","add","ZPP_Vec2.add","zpp_nape/geom/Vec2.hx",296)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(296)
	::zpp_nape::geom::ZPP_Vec2 temp;		HX_STACK_VAR(temp,"temp");
...
{
		HX_STACK_FRAME("ZPP_Vec2","setbegin","ZPP_Vec2.setbegin","zpp_nape/geom/Vec2.hx",290)
		HX_STACK_THIS(this)
		HX_STACK_ARG(i,"i")
		HX_STACK_LINE(291)
		this->next = i;
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::begin( ){
	HX_STACK_FRAME("ZPP_Vec2","begin","ZPP_Vec2.begin","zpp_nape/geom/Vec2.hx",282)
	HX_STACK_THIS(this)
	HX_STACK_LINE(282)
	return this->next;
}
...
::zpp_nape::geom::ZPP_Vec2 ZPP_Vec2_obj::elem( ){
	HX_STACK_FRAME("ZPP_Vec2","elem","ZPP_Vec2.elem","zpp_nape/geom/Vec2.hx",277)
	HX_STACK_THIS(this)
	HX_STACK_LINE(277)
...
{
		HX_STACK_FRAME("ZPP_Vec2","alloc","ZPP_Vec2.alloc","zpp_nape/geom/Vec2.hx",271)
		HX_STACK_THIS(this)
		HX_STACK_LINE(271)
		this->weak = false;
	}
...
{
		HX_STACK_FRAME("ZPP_Vec2","free","ZPP_Vec2.free","zpp_nape/geom/Vec2.hx",259)
		HX_STACK_THIS(this)
		HX_STACK_LINE(260)
		if (((this->outer != null()))){
			HX_STACK_LINE(261)
...
::nape::geom::Vec2 ZPP_Vec2_obj::wrapper( ){
	HX_STACK_FRAME("ZPP_Vec2","wrapper","ZPP_Vec2.wrapper","zpp_nape/geom/Vec2.hx",208)
	HX_STACK_THIS(this)
	HX_STACK_LINE(209)
	if (((this->outer == null()))){
		HX_STACK_LINE(210)
...
{
		HX_STACK_FRAME("ZPP_Vec2","immutable","ZPP_Vec2.immutable","zpp_nape/geom/Vec2.hx",195)
		HX_STACK_THIS(this)
		HX_STACK_LINE(197)
		if ((this->_immutable)){
			HX_STACK_LINE(198)
...
{
		HX_STACK_FRAME("ZPP_Vec2","invalidate","ZPP_Vec2.invalidate","zpp_nape/geom/Vec2.hx",187)
		HX_STACK_THIS(this)
		HX_STACK_LINE(187)
...
{
		HX_STACK_FRAME("ZPP_Vec2","validate","ZPP_Vec2.validate","zpp_nape/geom/Vec2.hx",180)
		HX_STACK_THIS(this)
		HX_STACK_LINE(180)
...
bool immutable = __o_immutable.Default(false);
	HX_STACK_FRAME("ZPP_Vec2","get","ZPP_Vec2.get","zpp_nape/geom/Vec2.hx",632)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
