...
{
HX_STACK_FRAME("ZPP_PartitionVertex","new","ZPP_PartitionVertex.new","zpp_nape/geom/PartitionedPoly.hx",174)
{
	HX_STACK_LINE(517)
	this->node = null();
	HX_STACK_LINE(210)
...
{
		HX_STACK_FRAME("ZPP_PartitionVertex","sort","ZPP_PartitionVertex.sort","zpp_nape/geom/PartitionedPoly.hx",314)
		HX_STACK_THIS(this)
		HX_STACK_LINE(315)
								...
								if (((bool((rightSize == (int)0)) || bool((right == null()))))){
									...
									struct _Function_8_1{
										inline static int Block( Float &uy,Float &ux,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &left,Float &vy,Float &vx,::zpp_nape::geom::ZPP_PartitionVertex_obj *__this,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &right){
											HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",375)
											{
												HX_STACK_LINE(376)
												{
													HX_STACK_LINE(377)
									...
									struct _Function_8_2{
										inline static bool Block( Float &uy,Float &ux,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &left,Float &vy,Float &vx,::zpp_nape::geom::ZPP_PartitionVertex_obj *__this,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &right){
											HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",388)
											{
												HX_STACK_LINE(389)
												...
												struct _Function_9_1{
													inline static int Block( Float &uy,Float &ux,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &left,Float &vy,Float &vx,::zpp_nape::geom::ZPP_PartitionVertex_obj *__this,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &right){
														HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",414)
														{
															HX_STACK_LINE(415)
															{
																HX_STACK_LINE(416)
												...
												struct _Function_9_2{
													inline static bool Block( Float &uy,Float &ux,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &left,Float &vy,Float &vx,::zpp_nape::geom::ZPP_PartitionVertex_obj *__this,::zpp_nape::util::ZNPNode_ZPP_PartitionVertex &right){
														HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",430)
														{
															HX_STACK_LINE(431)
															{
																HX_STACK_LINE(432)
												...
												HX_STACK_LINE(413)
												return (  (((bool(((d1 * d2) == (int)1)) || bool((bool(((d1 * d2) == (int)0)) && bool(((bool((d1 == (int)1)) || bool((d2 == (int)1)))))))))) ? bool((_Function_9_1::Block(uy,ux,left,vy,vx,__this,right) == (int)1)) : bool((  (((bool((d1 == (int)-1)) || bool((d2 == (int)-1))))) ? bool((d2 == (int)-1)) : bool((  (((bool((d1 == (int)0)) && bool((d2 == (int)0))))) ? bool(_Function_9_2::Block(uy,ux,left,vy,vx,__this,right)) : bool(true) )) )) );
											}
											return null();
										}
									};
...
::zpp_nape::geom::ZPP_PartitionVertex ZPP_PartitionVertex_obj::copy( ){
	HX_STACK_FRAME("ZPP_PartitionVertex","copy","ZPP_PartitionVertex.copy","zpp_nape/geom/PartitionedPoly.hx",272)
	HX_STACK_THIS(this)
	HX_STACK_LINE(273)
...
{
		HX_STACK_FRAME("ZPP_PartitionVertex","free","ZPP_PartitionVertex.free","zpp_nape/geom/PartitionedPoly.hx",218)
		HX_STACK_THIS(this)
		HX_STACK_LINE(219)
		this->helper = null();
		HX_STACK_LINE(220)
...
{
		HX_STACK_FRAME("ZPP_PartitionVertex","alloc","ZPP_PartitionVertex.alloc","zpp_nape/geom/PartitionedPoly.hx",216)
		HX_STACK_THIS(this)
	}
return null();
}
...
::zpp_nape::geom::ZPP_PartitionVertex ZPP_PartitionVertex_obj::get( ::zpp_nape::geom::ZPP_GeomVert x){
	HX_STACK_FRAME("ZPP_PartitionVertex","get","ZPP_PartitionVertex.get","zpp_nape/geom/PartitionedPoly.hx",230)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(231)
	::zpp_nape::geom::ZPP_PartitionVertex ret;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(232)
...
Float ZPP_PartitionVertex_obj::rightdistance( ::zpp_nape::geom::ZPP_PartitionVertex edge,::zpp_nape::geom::ZPP_PartitionVertex vert){
	HX_STACK_FRAME("ZPP_PartitionVertex","rightdistance","ZPP_PartitionVertex.rightdistance","zpp_nape/geom/PartitionedPoly.hx",493)
...
bool ZPP_PartitionVertex_obj::vert_lt( ::zpp_nape::geom::ZPP_PartitionVertex edge,::zpp_nape::geom::ZPP_PartitionVertex vert){
	HX_STACK_FRAME("ZPP_PartitionVertex","vert_lt","ZPP_PartitionVertex.vert_lt","zpp_nape/geom/PartitionedPoly.hx",510)
	HX_STACK_ARG(edge,"edge")
	HX_STACK_ARG(vert,"vert")
	HX_STACK_LINE(510)
		...
		if (((edge->y == edge->next->y))){
			struct _Function_3_1{
				inline static Float Block( ::zpp_nape::geom::ZPP_PartitionVertex &edge){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",510)
					{
						HX_STACK_LINE(511)
			...
			HX_STACK_LINE(515)
			return (::zpp_nape::geom::ZPP_PartitionVertex_obj::rightdistance(edge,vert) <= 0.0);
		}
	}
	HX_STACK_LINE(510)
	return false;
...
{
		HX_STACK_FRAME("ZPP_PartitionVertex","edge_swap","ZPP_PartitionVertex.edge_swap","zpp_nape/geom/PartitionedPoly.hx",518)
		HX_STACK_ARG(p,"p")
		HX_STACK_ARG(q,"q")
		HX_STACK_LINE(519)
...
bool ZPP_PartitionVertex_obj::edge_lt( ::zpp_nape::geom::ZPP_PartitionVertex p,::zpp_nape::geom::ZPP_PartitionVertex q){
	HX_STACK_FRAME("ZPP_PartitionVertex","edge_lt","ZPP_PartitionVertex.edge_lt","zpp_nape/geom/PartitionedPoly.hx",523)
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(q,"q")
	HX_STACK_LINE(524)
		...
		if (((q == p->next))){
			...
			if (((p->y == p->next->y))){
				...
				if (((q->y == q->next->y))){
					struct _Function_5_1{
						inline static Float Block( ::zpp_nape::geom::ZPP_PartitionVertex &p){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",538)
							{
								HX_STACK_LINE(539)
					...
					struct _Function_5_2{
						inline static Float Block( ::zpp_nape::geom::ZPP_PartitionVertex &q){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",542)
							{
								HX_STACK_LINE(543)
					...
					HX_STACK_LINE(546)
					return (bool((::zpp_nape::geom::ZPP_PartitionVertex_obj::rightdistance(q,p) > 0.0)) || bool((::zpp_nape::geom::ZPP_PartitionVertex_obj::rightdistance(q,p->next) > 0.0)));
				}
			}
			else{
				HX_STACK_LINE(549)
				...
				if (((bool((qRight == (int)0)) && bool((qNextRight == (int)0))))){
					struct _Function_5_1{
						inline static Float Block( ::zpp_nape::geom::ZPP_PartitionVertex &p){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",552)
							{
								HX_STACK_LINE(553)
								Float x = p->x;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(554)
					...
					struct _Function_5_2{
						inline static Float Block( ::zpp_nape::geom::ZPP_PartitionVertex &q){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/PartitionedPoly.hx",556)
							{
								HX_STACK_LINE(557)
								Float x = q->x;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(558)
