...
{
HX_STACK_FRAME("ZPP_CutInt","new","ZPP_CutInt.new","zpp_nape/geom/Cutter.hx",247)
{
	HX_STACK_LINE(279)
	this->path1 = null();
	HX_STACK_LINE(278)
...
{
		HX_STACK_FRAME("ZPP_CutInt","free","ZPP_CutInt.free","zpp_nape/geom/Cutter.hx",286)
		HX_STACK_THIS(this)
		HX_STACK_LINE(287)
...
{
		HX_STACK_FRAME("ZPP_CutInt","alloc","ZPP_CutInt.alloc","zpp_nape/geom/Cutter.hx",283)
		HX_STACK_THIS(this)
	}
return null();
}
...
bool vertex = __o_vertex.Default(false);
	HX_STACK_FRAME("ZPP_CutInt","get","ZPP_CutInt.get","zpp_nape/geom/Cutter.hx",291)
