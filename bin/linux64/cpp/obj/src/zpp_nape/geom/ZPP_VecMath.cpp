...
Float ZPP_VecMath_obj::vec_dsq( Float ax,Float ay,Float bx,Float by){
	HX_STACK_FRAME("ZPP_VecMath","vec_dsq","ZPP_VecMath.vec_dsq","zpp_nape/geom/VecMath.hx",176)
	HX_STACK_ARG(ax,"ax")
	HX_STACK_ARG(ay,"ay")
	HX_STACK_ARG(bx,"bx")
	HX_STACK_ARG(by,"by")
...
Float ZPP_VecMath_obj::vec_distance( Float ax,Float ay,Float bx,Float by){
	HX_STACK_FRAME("ZPP_VecMath","vec_distance","ZPP_VecMath.vec_distance","zpp_nape/geom/VecMath.hx",186)
	HX_STACK_ARG(ax,"ax")
	HX_STACK_ARG(ay,"ay")
	HX_STACK_ARG(bx,"bx")
	HX_STACK_ARG(by,"by")
