...
{
HX_STACK_FRAME("ZPP_SimplifyV","new","ZPP_SimplifyV.new","zpp_nape/geom/Simplify.hx",174)
{
	HX_STACK_LINE(204)
	this->forced = false;
	HX_STACK_LINE(203)
...
{
		HX_STACK_FRAME("ZPP_SimplifyV","alloc","ZPP_SimplifyV.alloc","zpp_nape/geom/Simplify.hx",210)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_SimplifyV","free","ZPP_SimplifyV.free","zpp_nape/geom/Simplify.hx",207)
		HX_STACK_THIS(this)
	}
return null();
}
...
::zpp_nape::geom::ZPP_SimplifyV ZPP_SimplifyV_obj::get( ::zpp_nape::geom::ZPP_GeomVert v){
	HX_STACK_FRAME("ZPP_SimplifyV","get","ZPP_SimplifyV.get","zpp_nape/geom/Simplify.hx",213)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(214)
