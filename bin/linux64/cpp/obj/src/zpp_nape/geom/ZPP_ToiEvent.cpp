...
{
HX_STACK_FRAME("ZPP_ToiEvent","new","ZPP_ToiEvent.new","zpp_nape/geom/SweepDistance.hx",174)
{
	HX_STACK_LINE(221)
...
{
		HX_STACK_FRAME("ZPP_ToiEvent","free","ZPP_ToiEvent.free","zpp_nape/geom/SweepDistance.hx",209)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_ToiEvent","alloc","ZPP_ToiEvent.alloc","zpp_nape/geom/SweepDistance.hx",202)
		HX_STACK_THIS(this)
		HX_STACK_LINE(203)
		this->failed = false;
		HX_STACK_LINE(204)
