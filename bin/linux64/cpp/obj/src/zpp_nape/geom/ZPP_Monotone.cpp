...
::zpp_nape::geom::ZPP_Vec2 ZPP_Monotone_obj::bisector( ::zpp_nape::geom::ZPP_PartitionVertex b){
	HX_STACK_FRAME("ZPP_Monotone","bisector","ZPP_Monotone.bisector","zpp_nape/geom/Monotone.hx",175)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(176)
...
bool ZPP_Monotone_obj::below( ::zpp_nape::geom::ZPP_PartitionVertex p,::zpp_nape::geom::ZPP_PartitionVertex q){
	HX_STACK_FRAME("ZPP_Monotone","below","ZPP_Monotone.below","zpp_nape/geom/Monotone.hx",223)
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(q,"q")
	HX_STACK_LINE(223)
	if (((p->y < q->y))){
...
bool ZPP_Monotone_obj::above( ::zpp_nape::geom::ZPP_PartitionVertex p,::zpp_nape::geom::ZPP_PartitionVertex q){
	HX_STACK_FRAME("ZPP_Monotone","above","ZPP_Monotone.above","zpp_nape/geom/Monotone.hx",297)
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(q,"q")
	HX_STACK_LINE(297)
...
bool ZPP_Monotone_obj::left_vertex( ::zpp_nape::geom::ZPP_PartitionVertex p){
	HX_STACK_FRAME("ZPP_Monotone","left_vertex","ZPP_Monotone.left_vertex","zpp_nape/geom/Monotone.hx",299)
	HX_STACK_ARG(p,"p")
	HX_STACK_LINE(300)
...
bool ZPP_Monotone_obj::isMonotone( ::zpp_nape::geom::ZPP_GeomVert P){
	HX_STACK_FRAME("ZPP_Monotone","isMonotone","ZPP_Monotone.isMonotone","zpp_nape/geom/Monotone.hx",303)
	HX_STACK_ARG(P,"P")
	HX_STACK_LINE(304)
...
::zpp_nape::geom::ZPP_PartitionedPoly ZPP_Monotone_obj::getShared( ){
	HX_STACK_FRAME("ZPP_Monotone","getShared","ZPP_Monotone.getShared","zpp_nape/geom/Monotone.hx",378)
	HX_STACK_LINE(379)
...
::zpp_nape::geom::ZPP_PartitionedPoly ZPP_Monotone_obj::decompose( ::zpp_nape::geom::ZPP_GeomVert P,::zpp_nape::geom::ZPP_PartitionedPoly poly){
	HX_STACK_FRAME("ZPP_Monotone","decompose","ZPP_Monotone.decompose","zpp_nape/geom/Monotone.hx",384)
	HX_STACK_ARG(P,"P")
