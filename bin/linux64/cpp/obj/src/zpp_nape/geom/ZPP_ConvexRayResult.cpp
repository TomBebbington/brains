...
{
HX_STACK_FRAME("ZPP_ConvexRayResult","new","ZPP_ConvexRayResult.new","zpp_nape/geom/ConvexRayResult.hx",174)
{
	HX_STACK_LINE(184)
...
{
		HX_STACK_FRAME("ZPP_ConvexRayResult","free","ZPP_ConvexRayResult.free","zpp_nape/geom/ConvexRayResult.hx",239)
		HX_STACK_THIS(this)
		HX_STACK_LINE(240)
...
{
		HX_STACK_FRAME("ZPP_ConvexRayResult","disposed","ZPP_ConvexRayResult.disposed","zpp_nape/geom/ConvexRayResult.hx",236)
		HX_STACK_THIS(this)
		HX_STACK_LINE(236)
		if (((this->next != null()))){
			HX_STACK_LINE(236)
...
::nape::geom::RayResult ZPP_ConvexRayResult_obj::getRay( ::nape::geom::Vec2 normal,Float time,bool inner,::nape::shape::Shape shape){
	HX_STACK_FRAME("ZPP_ConvexRayResult","getRay","ZPP_ConvexRayResult.getRay","zpp_nape/geom/ConvexRayResult.hx",187)
...
::nape::geom::ConvexResult ZPP_ConvexRayResult_obj::getConvex( ::nape::geom::Vec2 normal,::nape::geom::Vec2 position,Float toiDistance,::nape::shape::Shape shape){
	HX_STACK_FRAME("ZPP_ConvexRayResult","getConvex","ZPP_ConvexRayResult.getConvex","zpp_nape/geom/ConvexRayResult.hx",209)
	HX_STACK_ARG(normal,"normal")
