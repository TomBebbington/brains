...
{
HX_STACK_FRAME("ZPP_GeomVertexIterator","new","ZPP_GeomVertexIterator.new","zpp_nape/geom/GeomPoly.hx",327)
{
	HX_STACK_LINE(333)
	this->next = null();
	HX_STACK_LINE(332)
...
{
		HX_STACK_FRAME("ZPP_GeomVertexIterator","alloc","ZPP_GeomVertexIterator.alloc","zpp_nape/geom/GeomPoly.hx",366)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_GeomVertexIterator","free","ZPP_GeomVertexIterator.free","zpp_nape/geom/GeomPoly.hx",360)
		HX_STACK_THIS(this)
		HX_STACK_LINE(361)
...
::nape::geom::GeomVertexIterator ZPP_GeomVertexIterator_obj::get( ::zpp_nape::geom::ZPP_GeomVert poly,bool forward){
	HX_STACK_FRAME("ZPP_GeomVertexIterator","get","ZPP_GeomVertexIterator.get","zpp_nape/geom/GeomPoly.hx",379)
