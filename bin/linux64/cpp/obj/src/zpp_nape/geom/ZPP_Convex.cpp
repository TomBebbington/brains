...
bool ZPP_Convex_obj::isinner( ::zpp_nape::geom::ZPP_PartitionVertex a,::zpp_nape::geom::ZPP_PartitionVertex b,::zpp_nape::geom::ZPP_PartitionVertex c){
	HX_STACK_FRAME("ZPP_Convex","isinner","ZPP_Convex.isinner","zpp_nape/geom/Convex.hx",175)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(176)
...
{
		HX_STACK_FRAME("ZPP_Convex","optimise","ZPP_Convex.optimise","zpp_nape/geom/Convex.hx",190)
		HX_STACK_ARG(P,"P")
		HX_STACK_LINE(191)
		{
			HX_STACK_LINE(192)
