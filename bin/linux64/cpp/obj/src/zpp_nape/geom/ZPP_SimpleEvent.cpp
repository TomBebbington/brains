...
{
HX_STACK_FRAME("ZPP_SimpleEvent","new","ZPP_SimpleEvent.new","zpp_nape/geom/Simple.hx",383)
{
	HX_STACK_LINE(403)
	this->next = null();
	HX_STACK_LINE(388)
...
{
		HX_STACK_FRAME("ZPP_SimpleEvent","alloc","ZPP_SimpleEvent.alloc","zpp_nape/geom/Simple.hx",437)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_SimpleEvent","free","ZPP_SimpleEvent.free","zpp_nape/geom/Simple.hx",430)
		HX_STACK_THIS(this)
		HX_STACK_LINE(431)
		this->vertex = null();
		HX_STACK_LINE(432)
...
{
		HX_STACK_FRAME("ZPP_SimpleEvent","swap_nodes","ZPP_SimpleEvent.swap_nodes","zpp_nape/geom/Simple.hx",389)
		HX_STACK_ARG(a,"a")
		HX_STACK_ARG(b,"b")
		HX_STACK_LINE(390)
...
bool ZPP_SimpleEvent_obj::less_xy( ::zpp_nape::geom::ZPP_SimpleEvent a,::zpp_nape::geom::ZPP_SimpleEvent b){
	HX_STACK_FRAME("ZPP_SimpleEvent","less_xy","ZPP_SimpleEvent.less_xy","zpp_nape/geom/Simple.hx",395)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(395)
...
::zpp_nape::geom::ZPP_SimpleEvent ZPP_SimpleEvent_obj::get( ::zpp_nape::geom::ZPP_SimpleVert v){
	HX_STACK_FRAME("ZPP_SimpleEvent","get","ZPP_SimpleEvent.get","zpp_nape/geom/Simple.hx",440)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(441)
