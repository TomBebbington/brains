...
{
HX_STACK_FRAME("ZPP_AABB","new","ZPP_AABB.new","zpp_nape/geom/AABB.hx",174)
{
	HX_STACK_LINE(406)
	this->wrap_max = null();
	HX_STACK_LINE(405)
...
::String ZPP_AABB_obj::toString( ){
	HX_STACK_FRAME("ZPP_AABB","toString","ZPP_AABB.toString","zpp_nape/geom/AABB.hx",527)
	HX_STACK_THIS(this)
	HX_STACK_LINE(527)
...
{
		HX_STACK_FRAME("ZPP_AABB","setExpandPoint","ZPP_AABB.setExpandPoint","zpp_nape/geom/AABB.hx",520)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_LINE(521)
...
{
		HX_STACK_FRAME("ZPP_AABB","setExpand","ZPP_AABB.setExpand","zpp_nape/geom/AABB.hx",512)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
...
{
		HX_STACK_FRAME("ZPP_AABB","setCombine","ZPP_AABB.setCombine","zpp_nape/geom/AABB.hx",504)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_ARG(b,"b")
		HX_STACK_LINE(505)
...
bool ZPP_AABB_obj::containsPoint( ::zpp_nape::geom::ZPP_Vec2 v){
	HX_STACK_FRAME("ZPP_AABB","containsPoint","ZPP_AABB.containsPoint","zpp_nape/geom/AABB.hx",500)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(500)
...
bool ZPP_AABB_obj::contains( ::zpp_nape::geom::ZPP_AABB x){
	HX_STACK_FRAME("ZPP_AABB","contains","ZPP_AABB.contains","zpp_nape/geom/AABB.hx",495)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(495)
...
{
		HX_STACK_FRAME("ZPP_AABB","combine","ZPP_AABB.combine","zpp_nape/geom/AABB.hx",486)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(487)
		if (((x->minx < this->minx))){
...
bool ZPP_AABB_obj::intersect( ::zpp_nape::geom::ZPP_AABB x){
	HX_STACK_FRAME("ZPP_AABB","intersect","ZPP_AABB.intersect","zpp_nape/geom/AABB.hx",482)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(482)
...
bool ZPP_AABB_obj::intersectY( ::zpp_nape::geom::ZPP_AABB x){
	HX_STACK_FRAME("ZPP_AABB","intersectY","ZPP_AABB.intersectY","zpp_nape/geom/AABB.hx",477)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(477)
...
bool ZPP_AABB_obj::intersectX( ::zpp_nape::geom::ZPP_AABB x){
	HX_STACK_FRAME("ZPP_AABB","intersectX","ZPP_AABB.intersectX","zpp_nape/geom/AABB.hx",472)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(472)
...
{
		HX_STACK_FRAME("ZPP_AABB","mod_max","ZPP_AABB.mod_max","zpp_nape/geom/AABB.hx",445)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_AABB","dom_max","ZPP_AABB.dom_max","zpp_nape/geom/AABB.hx",421)
		HX_STACK_THIS(this)
		HX_STACK_LINE(422)
...
::nape::geom::Vec2 ZPP_AABB_obj::getmax( ){
	HX_STACK_FRAME("ZPP_AABB","getmax","ZPP_AABB.getmax","zpp_nape/geom/AABB.hx",407)
	HX_STACK_THIS(this)
	HX_STACK_LINE(408)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/AABB.hx",409)
						{
							HX_STACK_LINE(409)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(409)
...
{
		HX_STACK_FRAME("ZPP_AABB","mod_min","ZPP_AABB.mod_min","zpp_nape/geom/AABB.hx",380)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_AABB","dom_min","ZPP_AABB.dom_min","zpp_nape/geom/AABB.hx",356)
		HX_STACK_THIS(this)
		HX_STACK_LINE(357)
		if (((this->_validate_dyn() != null()))){
			HX_STACK_LINE(357)
...
::nape::geom::Vec2 ZPP_AABB_obj::getmin( ){
	HX_STACK_FRAME("ZPP_AABB","getmin","ZPP_AABB.getmin","zpp_nape/geom/AABB.hx",342)
	HX_STACK_THIS(this)
	HX_STACK_LINE(343)
	if (((this->wrap_min == null()))){
		HX_STACK_LINE(344)
		{
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_4_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/AABB.hx",344)
						{
							HX_STACK_LINE(344)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(344)
...
Float ZPP_AABB_obj::perimeter( ){
	HX_STACK_FRAME("ZPP_AABB","perimeter","ZPP_AABB.perimeter","zpp_nape/geom/AABB.hx",337)
	HX_STACK_THIS(this)
	HX_STACK_LINE(337)
...
Float ZPP_AABB_obj::height( ){
	HX_STACK_FRAME("ZPP_AABB","height","ZPP_AABB.height","zpp_nape/geom/AABB.hx",332)
	HX_STACK_THIS(this)
	HX_STACK_LINE(332)
...
Float ZPP_AABB_obj::width( ){
	HX_STACK_FRAME("ZPP_AABB","width","ZPP_AABB.width","zpp_nape/geom/AABB.hx",327)
	HX_STACK_THIS(this)
	HX_STACK_LINE(327)
...
::zpp_nape::geom::ZPP_AABB ZPP_AABB_obj::copy( ){
	HX_STACK_FRAME("ZPP_AABB","copy","ZPP_AABB.copy","zpp_nape/geom/AABB.hx",322)
	HX_STACK_THIS(this)
	HX_STACK_LINE(322)
...
{
		HX_STACK_FRAME("ZPP_AABB","free","ZPP_AABB.free","zpp_nape/geom/AABB.hx",247)
		HX_STACK_THIS(this)
		HX_STACK_LINE(248)
		if (((this->outer != null()))){
			HX_STACK_LINE(249)
...
{
		HX_STACK_FRAME("ZPP_AABB","alloc","ZPP_AABB.alloc","zpp_nape/geom/AABB.hx",244)
		HX_STACK_THIS(this)
	}
return null();
}
...
::nape::geom::AABB ZPP_AABB_obj::wrapper( ){
	HX_STACK_FRAME("ZPP_AABB","wrapper","ZPP_AABB.wrapper","zpp_nape/geom/AABB.hx",193)
	HX_STACK_THIS(this)
	HX_STACK_LINE(194)
	if (((this->outer == null()))){
		HX_STACK_LINE(195)
...
{
		HX_STACK_FRAME("ZPP_AABB","invalidate","ZPP_AABB.invalidate","zpp_nape/geom/AABB.hx",188)
		HX_STACK_THIS(this)
		HX_STACK_LINE(188)
		if (((this->_invalidate_dyn() != null()))){
			HX_STACK_LINE(189)
...
{
		HX_STACK_FRAME("ZPP_AABB","validate","ZPP_AABB.validate","zpp_nape/geom/AABB.hx",181)
		HX_STACK_THIS(this)
		HX_STACK_LINE(181)
		if (((this->_validate_dyn() != null()))){
			HX_STACK_LINE(182)
...
::zpp_nape::geom::ZPP_AABB ZPP_AABB_obj::get( Float minx,Float miny,Float maxx,Float maxy){
	HX_STACK_FRAME("ZPP_AABB","get","ZPP_AABB.get","zpp_nape/geom/AABB.hx",258)
