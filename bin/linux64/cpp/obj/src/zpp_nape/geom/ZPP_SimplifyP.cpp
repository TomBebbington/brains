...
{
HX_STACK_FRAME("ZPP_SimplifyP","new","ZPP_SimplifyP.new","zpp_nape/geom/Simplify.hx",257)
{
	HX_STACK_LINE(284)
	this->max = null();
	HX_STACK_LINE(283)
...
{
		HX_STACK_FRAME("ZPP_SimplifyP","alloc","ZPP_SimplifyP.alloc","zpp_nape/geom/Simplify.hx",293)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_SimplifyP","free","ZPP_SimplifyP.free","zpp_nape/geom/Simplify.hx",289)
		HX_STACK_THIS(this)
		HX_STACK_LINE(289)
...
::zpp_nape::geom::ZPP_SimplifyP ZPP_SimplifyP_obj::get( ::zpp_nape::geom::ZPP_SimplifyV min,::zpp_nape::geom::ZPP_SimplifyV max){
	HX_STACK_FRAME("ZPP_SimplifyP","get","ZPP_SimplifyP.get","zpp_nape/geom/Simplify.hx",295)
