...
{
HX_STACK_FRAME("ZPP_MarchSpan","new","ZPP_MarchSpan.new","zpp_nape/geom/MarchingSquares.hx",174)
{
	HX_STACK_LINE(178)
	this->next = null();
	HX_STACK_LINE(177)
...
{
		HX_STACK_FRAME("ZPP_MarchSpan","alloc","ZPP_MarchSpan.alloc","zpp_nape/geom/MarchingSquares.hx",210)
		HX_STACK_THIS(this)
		HX_STACK_LINE(211)
		this->out = false;
		HX_STACK_LINE(212)
...
{
		HX_STACK_FRAME("ZPP_MarchSpan","free","ZPP_MarchSpan.free","zpp_nape/geom/MarchingSquares.hx",206)
		HX_STACK_THIS(this)
		HX_STACK_LINE(206)
		this->parent = hx::ObjectPtr<OBJ_>(this);
	}
