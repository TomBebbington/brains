...
{
HX_STACK_FRAME("ZPP_Ray","new","ZPP_Ray.new","zpp_nape/geom/Ray.hx",174)
{
	HX_STACK_LINE(284)
	this->zip_dir = false;
	HX_STACK_LINE(191)
		...
		if (((ret->zpp_inner == null()))){
			...
			struct _Function_3_1{
				inline static Float Block( ::nape::geom::Vec2 &ret){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",238)
					{
						HX_STACK_LINE(238)
						if (((bool((ret != null())) && bool(ret->zpp_disp)))){
							HX_STACK_LINE(238)
	...
	HX_STACK_LINE(240)
	{
		...
		if (((ret->zpp_inner == null()))){
			...
			struct _Function_3_1{
				inline static Float Block( ::nape::geom::Vec2 &ret){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",240)
					{
						HX_STACK_LINE(240)
						if (((bool((ret != null())) && bool(ret->zpp_disp)))){
							HX_STACK_LINE(240)
...
{
		HX_STACK_FRAME("ZPP_Ray","polysect2","ZPP_Ray.polysect2","zpp_nape/geom/Ray.hx",1185)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p,"p")
...
while((false));
		...
		if (((edge != null()))){
			...
			struct _Function_2_1{
				inline static ::nape::geom::Vec2 Block( Float &nx,Float &ny){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",1312)
					{
						HX_STACK_LINE(1312)
						bool weak = false;		HX_STACK_VAR(weak,"weak");
						HX_STACK_LINE(1312)
						...
						HX_STACK_LINE(1319)
						{
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::RayResult &ret){
									HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",1320)
									{
										HX_STACK_LINE(1320)
		...
		if (((bool((edgemax != null())) && bool((edge != edgemax))))){
			...
			struct _Function_2_1{
				inline static ::nape::geom::Vec2 Block( Float &nx,Float &ny){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",1357)
					{
						HX_STACK_LINE(1357)
						bool weak = false;		HX_STACK_VAR(weak,"weak");
						HX_STACK_LINE(1357)
				...
				HX_STACK_LINE(1360)
				{
					...
					while(((cx_ite != null()))){
						...
						HX_STACK_LINE(1364)
						{
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::RayResult &ret){
									HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",1365)
									{
										HX_STACK_LINE(1365)
										if (((ret->zpp_inner->next != null()))){
											HX_STACK_LINE(1365)
...
::nape::geom::RayResult ZPP_Ray_obj::polysect( ::zpp_nape::shape::ZPP_Polygon p,bool inner,Float mint){
	HX_STACK_FRAME("ZPP_Ray","polysect","ZPP_Ray.polysect","zpp_nape/geom/Ray.hx",1068)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(inner,"inner")
...
while((false));
	...
	if (((edge != null()))){
		...
		struct _Function_2_1{
			inline static ::nape::geom::Vec2 Block( Float &nx,Float &ny){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",1181)
				{
					HX_STACK_LINE(1181)
					bool weak = false;		HX_STACK_VAR(weak,"weak");
					HX_STACK_LINE(1181)
...
{
		HX_STACK_FRAME("ZPP_Ray","circlesect2","ZPP_Ray.circlesect2","zpp_nape/geom/Ray.hx",761)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_ARG(inner,"inner")
		HX_STACK_ARG(list,"list")
		...
		if (((det == (int)0))){
			...
			if (((bool((bool(((bool(!(inner)) || bool((C > (int)0))))) && bool((t > (int)0)))) && bool((t <= this->maxdist))))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( Float &nx,Float &ny){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",853)
						{
							HX_STACK_LINE(853)
							bool weak = false;		HX_STACK_VAR(weak,"weak");
							HX_STACK_LINE(853)
							...
							HX_STACK_LINE(860)
							{
								struct _Function_7_1{
									inline static Float Block( ::nape::geom::RayResult &res){
										HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",861)
										{
											HX_STACK_LINE(861)
			...
			if (((bool((t0 > (int)0)) && bool((t0 <= this->maxdist))))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( Float &nx,Float &ny){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",954)
						{
							HX_STACK_LINE(954)
							bool weak = false;		HX_STACK_VAR(weak,"weak");
							HX_STACK_LINE(954)
					...
					HX_STACK_LINE(957)
					{
						...
						while(((cx_ite != null()))){
							...
							HX_STACK_LINE(961)
							{
								struct _Function_7_1{
									inline static Float Block( ::nape::geom::RayResult &res){
										HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",962)
										{
											HX_STACK_LINE(962)
											if (((res->zpp_inner->next != null()))){
												HX_STACK_LINE(962)
			...
			if (((bool((bool((t1 > (int)0)) && bool((t1 <= this->maxdist)))) && bool(inner)))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( Float &nx,Float &ny){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",1049)
						{
							HX_STACK_LINE(1049)
							bool weak = false;		HX_STACK_VAR(weak,"weak");
							HX_STACK_LINE(1049)
					...
					HX_STACK_LINE(1052)
					{
						...
						while(((cx_ite != null()))){
							...
							HX_STACK_LINE(1056)
							{
								struct _Function_7_1{
									inline static Float Block( ::nape::geom::RayResult &res){
										HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",1057)
										{
											HX_STACK_LINE(1057)
											if (((res->zpp_inner->next != null()))){
												HX_STACK_LINE(1057)
...
::nape::geom::RayResult ZPP_Ray_obj::circlesect( ::zpp_nape::shape::ZPP_Circle c,bool inner,Float mint){
	HX_STACK_FRAME("ZPP_Ray","circlesect","ZPP_Ray.circlesect","zpp_nape/geom/Ray.hx",491)
	HX_STACK_THIS(this)
	HX_STACK_ARG(c,"c")
	HX_STACK_ARG(inner,"inner")
	HX_STACK_ARG(mint,"mint")
	...
	if (((det == (int)0))){
		...
		if (((bool((bool((bool(((bool(!(inner)) || bool((C > (int)0))))) && bool((t > (int)0)))) && bool((t < mint)))) && bool((t <= this->maxdist))))){
			...
			struct _Function_3_1{
				inline static ::nape::geom::Vec2 Block( Float &nx,Float &ny){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",583)
					{
						HX_STACK_LINE(583)
						bool weak = false;		HX_STACK_VAR(weak,"weak");
						HX_STACK_LINE(583)
		...
		if (((t0 > (int)0))){
			...
			if (((bool((t0 < mint)) && bool((t0 <= this->maxdist))))){
				...
				struct _Function_4_1{
					inline static ::nape::geom::Vec2 Block( Float &nx,Float &ny){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",671)
						{
							HX_STACK_LINE(671)
							bool weak = false;		HX_STACK_VAR(weak,"weak");
							HX_STACK_LINE(671)
			...
			if (((bool((t1 > (int)0)) && bool(inner)))){
				...
				if (((bool((t1 < mint)) && bool((t1 <= this->maxdist))))){
					...
					struct _Function_5_1{
						inline static ::nape::geom::Vec2 Block( Float &nx,Float &ny){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",754)
							{
								HX_STACK_LINE(754)
								bool weak = false;		HX_STACK_VAR(weak,"weak");
								HX_STACK_LINE(754)
...
Float ZPP_Ray_obj::aabbsect( ::zpp_nape::geom::ZPP_AABB a){
	HX_STACK_FRAME("ZPP_Ray","aabbsect","ZPP_Ray.aabbsect","zpp_nape/geom/Ray.hx",435)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(436)
...
bool ZPP_Ray_obj::aabbtest( ::zpp_nape::geom::ZPP_AABB a){
	HX_STACK_FRAME("ZPP_Ray","aabbtest","ZPP_Ray.aabbtest","zpp_nape/geom/Ray.hx",427)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(428)
	...
	struct _Function_1_1{
		inline static Float Block( Float &dot1){
			HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Ray.hx",430)
			{
				HX_STACK_LINE(431)
...
::zpp_nape::geom::ZPP_AABB ZPP_Ray_obj::rayAABB( ){
	HX_STACK_FRAME("ZPP_Ray","rayAABB","ZPP_Ray.rayAABB","zpp_nape/geom/Ray.hx",391)
	HX_STACK_THIS(this)
	HX_STACK_LINE(392)
...
{
		HX_STACK_FRAME("ZPP_Ray","validate_dir","ZPP_Ray.validate_dir","zpp_nape/geom/Ray.hx",291)
		HX_STACK_THIS(this)
		HX_STACK_LINE(291)
		if ((this->zip_dir)){
			HX_STACK_LINE(292)
...
{
		HX_STACK_FRAME("ZPP_Ray","invalidate_dir","ZPP_Ray.invalidate_dir","zpp_nape/geom/Ray.hx",288)
		HX_STACK_THIS(this)
		HX_STACK_LINE(288)
		this->zip_dir = true;
	}
...
{
		HX_STACK_FRAME("ZPP_Ray","direction_invalidate","ZPP_Ray.direction_invalidate","zpp_nape/geom/Ray.hx",214)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(215)
		{
...
{
		HX_STACK_FRAME("ZPP_Ray","origin_invalidate","ZPP_Ray.origin_invalidate","zpp_nape/geom/Ray.hx",193)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(194)
		this->originx = x->x;
