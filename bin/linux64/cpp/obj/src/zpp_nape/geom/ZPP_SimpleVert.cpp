...
{
HX_STACK_FRAME("ZPP_SimpleVert","new","ZPP_SimpleVert.new","zpp_nape/geom/Simple.hx",174)
{
	HX_STACK_LINE(205)
	this->node = null();
	HX_STACK_LINE(180)
...
{
		HX_STACK_FRAME("ZPP_SimpleVert","alloc","ZPP_SimpleVert.alloc","zpp_nape/geom/Simple.hx",215)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_SimpleVert","free","ZPP_SimpleVert.free","zpp_nape/geom/Simple.hx",208)
		HX_STACK_THIS(this)
		HX_STACK_LINE(209)
		this->links->clear();
		HX_STACK_LINE(210)
...
bool ZPP_SimpleVert_obj::less_xy( ::zpp_nape::geom::ZPP_SimpleVert p,::zpp_nape::geom::ZPP_SimpleVert q){
	HX_STACK_FRAME("ZPP_SimpleVert","less_xy","ZPP_SimpleVert.less_xy","zpp_nape/geom/Simple.hx",238)
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(q,"q")
	HX_STACK_LINE(238)
...
{
		HX_STACK_FRAME("ZPP_SimpleVert","swap_nodes","ZPP_SimpleVert.swap_nodes","zpp_nape/geom/Simple.hx",240)
		HX_STACK_ARG(p,"p")
		HX_STACK_ARG(q,"q")
		HX_STACK_LINE(241)
...
::zpp_nape::geom::ZPP_SimpleVert ZPP_SimpleVert_obj::get( Float x,Float y){
	HX_STACK_FRAME("ZPP_SimpleVert","get","ZPP_SimpleVert.get","zpp_nape/geom/Simple.hx",246)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(247)
