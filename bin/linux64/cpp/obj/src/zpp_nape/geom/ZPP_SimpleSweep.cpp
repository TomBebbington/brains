...
{
HX_STACK_FRAME("ZPP_SimpleSweep","new","ZPP_SimpleSweep.new","zpp_nape/geom/Simple.hx",464)
{
	HX_STACK_LINE(466)
	this->tree = null();
	HX_STACK_LINE(465)
...
::zpp_nape::geom::ZPP_SimpleEvent ZPP_SimpleSweep_obj::intersection( ::zpp_nape::geom::ZPP_SimpleSeg p,::zpp_nape::geom::ZPP_SimpleSeg q){
	HX_STACK_FRAME("ZPP_SimpleSweep","intersection","ZPP_SimpleSweep.intersection","zpp_nape/geom/Simple.hx",737)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(q,"q")
	HX_STACK_LINE(737)
			...
			HX_STACK_LINE(778)
			{
				...
				HX_STACK_LINE(778)
				{
					...
					if (((::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool == null()))){
						HX_STACK_LINE(778)
						ret1 = ::zpp_nape::geom::ZPP_SimpleEvent_obj::__new();
					}
					else{
						HX_STACK_LINE(778)
...
bool ZPP_SimpleSweep_obj::intersect( ::zpp_nape::geom::ZPP_SimpleSeg p,::zpp_nape::geom::ZPP_SimpleSeg q){
	HX_STACK_FRAME("ZPP_SimpleSweep","intersect","ZPP_SimpleSweep.intersect","zpp_nape/geom/Simple.hx",719)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(q,"q")
	HX_STACK_LINE(719)
...
{
		HX_STACK_FRAME("ZPP_SimpleSweep","remove","ZPP_SimpleSweep.remove","zpp_nape/geom/Simple.hx",710)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(711)
...
::zpp_nape::geom::ZPP_SimpleSeg ZPP_SimpleSweep_obj::add( ::zpp_nape::geom::ZPP_SimpleSeg e){
	HX_STACK_FRAME("ZPP_SimpleSweep","add","ZPP_SimpleSweep.add","zpp_nape/geom/Simple.hx",696)
	HX_STACK_THIS(this)
	HX_STACK_ARG(e,"e")
	HX_STACK_LINE(697)
...
{
		HX_STACK_FRAME("ZPP_SimpleSweep","clear","ZPP_SimpleSweep.clear","zpp_nape/geom/Simple.hx",694)
		HX_STACK_THIS(this)
		HX_STACK_LINE(694)
		this->tree->clear();
	}
...
bool ZPP_SimpleSweep_obj::edge_lt( ::zpp_nape::geom::ZPP_SimpleSeg p,::zpp_nape::geom::ZPP_SimpleSeg q){
	HX_STACK_FRAME("ZPP_SimpleSweep","edge_lt","ZPP_SimpleSweep.edge_lt","zpp_nape/geom/Simple.hx",493)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p,"p")
	HX_STACK_ARG(q,"q")
	HX_STACK_LINE(494)
			...
			if (((p->left->x == p->right->x))){
				...
				struct _Function_4_1{
					inline static Float Block( Float &uy,Float &ux,Float &vy,Float &vx,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q,::zpp_nape::geom::ZPP_SimpleSeg &p){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Simple.hx",505)
						{
							HX_STACK_LINE(506)
				...
				HX_STACK_LINE(505)
				return (_Function_4_1::Block(uy,ux,vy,vx,flip,q,p) < (int)0);
			}
		}
		else{
			HX_STACK_LINE(518)
			if (((p->right == q->left))){
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::geom::ZPP_SimpleSeg &q,::zpp_nape::geom::ZPP_SimpleSeg &p){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Simple.hx",520)
						{
							HX_STACK_LINE(520)
				...
				struct _Function_4_2{
					inline static Float Block( Float &uy,Float &ux,Float &vy,Float &vx,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q,::zpp_nape::geom::ZPP_SimpleSeg &p){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Simple.hx",523)
						{
							HX_STACK_LINE(524)
				...
				if (((p->left == q->left))){
					...
					if (((p->left->x == p->right->x))){
						...
						struct _Function_6_1{
							inline static Float Block( Float &uy,Float &ux,Float &vy,Float &vx,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q,::zpp_nape::geom::ZPP_SimpleSeg &p){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Simple.hx",541)
								{
									HX_STACK_LINE(542)
									flip = (p->right->x < p->left->x);
									HX_STACK_LINE(543)
						...
						HX_STACK_LINE(541)
						return (_Function_6_1::Block(uy,ux,vy,vx,flip,q,p) < (int)0);
					}
				}
				else{
					HX_STACK_LINE(554)
					if (((p->right == q->right))){
						...
						if (((p->left->x == p->right->x))){
							...
							struct _Function_7_1{
								inline static Float Block( Float &uy,Float &ux,Float &vy,Float &vx,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q,::zpp_nape::geom::ZPP_SimpleSeg &p){
									HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Simple.hx",559)
									{
										HX_STACK_LINE(560)
										flip = (p->right->x < p->left->x);
										HX_STACK_LINE(561)
							...
							HX_STACK_LINE(559)
							return (_Function_7_1::Block(uy,ux,vy,vx,flip,q,p) < (int)0);
						}
					}
				}
			}
	...
	if (((p->left->x == p->right->x))){
		...
		if (((q->left->x == q->right->x))){
			...
			HX_STACK_LINE(636)
			bool qlrg;		HX_STACK_VAR(qlrg,"qlrg");
			struct _Function_3_1{
				inline static Float Block( Float &uy,Float &ux,Float &vy,Float &vx,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q,::zpp_nape::geom::ZPP_SimpleSeg &p){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Simple.hx",636)
					{
						HX_STACK_LINE(637)
						flip = (p->right->x < p->left->x);
						HX_STACK_LINE(638)
			...
			HX_STACK_LINE(636)
			qlrg = (_Function_3_1::Block(uy,ux,vy,vx,flip,q,p) < 0.0);
			HX_STACK_LINE(648)
			bool aqlrg;		HX_STACK_VAR(aqlrg,"aqlrg");
			struct _Function_3_2{
				inline static Float Block( Float &uy,Float &ux,Float &vy,Float &vx,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q,::zpp_nape::geom::ZPP_SimpleSeg &p){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Simple.hx",648)
					{
						HX_STACK_LINE(649)
						flip = (p->right->x < p->left->x);
						HX_STACK_LINE(650)
			...
			HX_STACK_LINE(648)
			aqlrg = (_Function_3_2::Block(uy,ux,vy,vx,flip,q,p) < 0.0);
			HX_STACK_LINE(660)
			if (((qlrg == aqlrg))){
				HX_STACK_LINE(660)
				return qlrg;
				...
				HX_STACK_LINE(662)
				bool plrg;		HX_STACK_VAR(plrg,"plrg");
				struct _Function_4_1{
					inline static Float Block( Float &uy,Float &ux,Float &vy,Float &vx,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q,::zpp_nape::geom::ZPP_SimpleSeg &p){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Simple.hx",662)
						{
							HX_STACK_LINE(663)
							flip = (q->right->x < q->left->x);
							HX_STACK_LINE(664)
				...
				HX_STACK_LINE(662)
				plrg = (_Function_4_1::Block(uy,ux,vy,vx,flip,q,p) >= 0.0);
				HX_STACK_LINE(674)
				bool aplrg;		HX_STACK_VAR(aplrg,"aplrg");
				struct _Function_4_2{
					inline static Float Block( Float &uy,Float &ux,Float &vy,Float &vx,bool &flip,::zpp_nape::geom::ZPP_SimpleSeg &q,::zpp_nape::geom::ZPP_SimpleSeg &p){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/geom/Simple.hx",674)
						{
							HX_STACK_LINE(675)
							flip = (q->right->x < q->left->x);
							HX_STACK_LINE(676)
				...
				HX_STACK_LINE(674)
				aplrg = (_Function_4_2::Block(uy,ux,vy,vx,flip,q,p) >= 0.0);
				HX_STACK_LINE(686)
				if (((plrg == aplrg))){
					HX_STACK_LINE(686)
					return plrg;
...
{
		HX_STACK_FRAME("ZPP_SimpleSweep","swap_nodes","ZPP_SimpleSweep.swap_nodes","zpp_nape/geom/Simple.hx",488)
		HX_STACK_THIS(this)
		HX_STACK_ARG(p,"p")
		HX_STACK_ARG(q,"q")
		HX_STACK_LINE(489)
