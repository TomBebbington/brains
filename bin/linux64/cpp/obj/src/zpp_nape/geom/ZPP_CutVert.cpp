...
{
HX_STACK_FRAME("ZPP_CutVert","new","ZPP_CutVert.new","zpp_nape/geom/Cutter.hx",174)
{
	HX_STACK_LINE(208)
	this->used = false;
	HX_STACK_LINE(207)
...
{
		HX_STACK_FRAME("ZPP_CutVert","free","ZPP_CutVert.free","zpp_nape/geom/Cutter.hx",215)
		HX_STACK_THIS(this)
		HX_STACK_LINE(216)
		this->vert = null();
		HX_STACK_LINE(217)
...
{
		HX_STACK_FRAME("ZPP_CutVert","alloc","ZPP_CutVert.alloc","zpp_nape/geom/Cutter.hx",212)
		HX_STACK_THIS(this)
	}
return null();
}
...
::zpp_nape::geom::ZPP_CutVert ZPP_CutVert_obj::path( ::zpp_nape::geom::ZPP_GeomVert poly){
	HX_STACK_FRAME("ZPP_CutVert","path","ZPP_CutVert.path","zpp_nape/geom/Cutter.hx",220)
