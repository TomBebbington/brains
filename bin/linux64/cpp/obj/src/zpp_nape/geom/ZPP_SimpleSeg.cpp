...
{
HX_STACK_FRAME("ZPP_SimpleSeg","new","ZPP_SimpleSeg.new","zpp_nape/geom/Simple.hx",289)
{
	HX_STACK_LINE(331)
	this->node = null();
	HX_STACK_LINE(330)
...
bool ZPP_SimpleSeg_obj::less_xy( ::zpp_nape::geom::ZPP_SimpleVert a,::zpp_nape::geom::ZPP_SimpleVert b){
	HX_STACK_FRAME("ZPP_SimpleSeg","less_xy","ZPP_SimpleSeg.less_xy","zpp_nape/geom/Simple.hx",333)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(333)
...
{
		HX_STACK_FRAME("ZPP_SimpleSeg","alloc","ZPP_SimpleSeg.alloc","zpp_nape/geom/Simple.hx",329)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_SimpleSeg","free","ZPP_SimpleSeg.free","zpp_nape/geom/Simple.hx",321)
		HX_STACK_THIS(this)
		HX_STACK_LINE(322)
...
::zpp_nape::geom::ZPP_SimpleSeg ZPP_SimpleSeg_obj::get( ::zpp_nape::geom::ZPP_SimpleVert left,::zpp_nape::geom::ZPP_SimpleVert right){
	HX_STACK_FRAME("ZPP_SimpleSeg","get","ZPP_SimpleSeg.get","zpp_nape/geom/Simple.hx",356)
