...
{
HX_STACK_FRAME("ZPP_AABBNode","new","ZPP_AABBNode.new","zpp_nape/space/DynAABBPhase.hx",174)
{
	HX_STACK_LINE(265)
...
bool ZPP_AABBNode_obj::isLeaf( ){
	HX_STACK_FRAME("ZPP_AABBNode","isLeaf","ZPP_AABBNode.isLeaf","zpp_nape/space/DynAABBPhase.hx",269)
	HX_STACK_THIS(this)
	HX_STACK_LINE(269)
...
{
		HX_STACK_FRAME("ZPP_AABBNode","free","ZPP_AABBNode.free","zpp_nape/space/DynAABBPhase.hx",237)
		HX_STACK_THIS(this)
		HX_STACK_LINE(238)
		this->height = (int)-1;
		HX_STACK_LINE(239)
...
{
		HX_STACK_FRAME("ZPP_AABBNode","alloc","ZPP_AABBNode.alloc","zpp_nape/space/DynAABBPhase.hx",213)
		HX_STACK_THIS(this)
		HX_STACK_LINE(214)
		{
			HX_STACK_LINE(215)
