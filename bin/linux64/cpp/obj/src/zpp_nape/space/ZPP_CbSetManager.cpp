...
{
HX_STACK_FRAME("ZPP_CbSetManager","new","ZPP_CbSetManager.new","zpp_nape/space/Space.hx",1191)
...
bool ZPP_CbSetManager_obj::valid_listener( ::zpp_nape::callbacks::ZPP_Listener i){
	HX_STACK_FRAME("ZPP_CbSetManager","valid_listener","ZPP_CbSetManager.valid_listener","zpp_nape/space/Space.hx",1375)
	HX_STACK_THIS(this)
	HX_STACK_ARG(i,"i")
	HX_STACK_LINE(1375)
...
::zpp_nape::callbacks::ZPP_CbSetPair ZPP_CbSetManager_obj::pair( ::zpp_nape::callbacks::ZPP_CbSet a,::zpp_nape::callbacks::ZPP_CbSet b){
	HX_STACK_FRAME("ZPP_CbSetManager","pair","ZPP_CbSetManager.pair","zpp_nape/space/Space.hx",1348)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(1349)
...
{
		HX_STACK_FRAME("ZPP_CbSetManager","validate","ZPP_CbSetManager.validate","zpp_nape/space/Space.hx",1328)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1328)
...
{
		HX_STACK_FRAME("ZPP_CbSetManager","clear","ZPP_CbSetManager.clear","zpp_nape/space/Space.hx",1286)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_CbSetManager","remove","ZPP_CbSetManager.remove","zpp_nape/space/Space.hx",1253)
		HX_STACK_THIS(this)
...
::zpp_nape::callbacks::ZPP_CbSet ZPP_CbSetManager_obj::get( ::zpp_nape::util::ZNPList_ZPP_CbType cbTypes){
	HX_STACK_FRAME("ZPP_CbSetManager","get","ZPP_CbSetManager.get","zpp_nape/space/Space.hx",1194)
	HX_STACK_THIS(this)
