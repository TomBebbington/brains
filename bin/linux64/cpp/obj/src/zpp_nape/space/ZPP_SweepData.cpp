...
{
HX_STACK_FRAME("ZPP_SweepData","new","ZPP_SweepData.new","zpp_nape/space/SweepPhase.hx",174)
{
	HX_STACK_LINE(202)
	this->aabb = null();
	HX_STACK_LINE(201)
...
bool ZPP_SweepData_obj::gt( ::zpp_nape::space::ZPP_SweepData x){
	HX_STACK_FRAME("ZPP_SweepData","gt","ZPP_SweepData.gt","zpp_nape/space/SweepPhase.hx",217)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(217)
...
{
		HX_STACK_FRAME("ZPP_SweepData","alloc","ZPP_SweepData.alloc","zpp_nape/space/SweepPhase.hx",212)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_SweepData","free","ZPP_SweepData.free","zpp_nape/space/SweepPhase.hx",205)
		HX_STACK_THIS(this)
		HX_STACK_LINE(206)
		this->prev = null();
		HX_STACK_LINE(207)
