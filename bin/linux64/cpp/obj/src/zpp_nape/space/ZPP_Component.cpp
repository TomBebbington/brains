...
{
HX_STACK_FRAME("ZPP_Component","new","ZPP_Component.new","zpp_nape/space/Space.hx",579)
{
	HX_STACK_LINE(613)
	this->woken = false;
	HX_STACK_LINE(612)
...
{
		HX_STACK_FRAME("ZPP_Component","reset","ZPP_Component.reset","zpp_nape/space/Space.hx",637)
		HX_STACK_THIS(this)
		HX_STACK_LINE(638)
		this->sleeping = false;
		HX_STACK_LINE(639)
...
{
		HX_STACK_FRAME("ZPP_Component","alloc","ZPP_Component.alloc","zpp_nape/space/Space.hx",630)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Component","free","ZPP_Component.free","zpp_nape/space/Space.hx",616)
		HX_STACK_THIS(this)
		HX_STACK_LINE(617)
		this->body = null();
		HX_STACK_LINE(618)
