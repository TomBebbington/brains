...
{
HX_STACK_FRAME("ZPP_AABBPair","new","ZPP_AABBPair.new","zpp_nape/space/DynAABBPhase.hx",273)
{
	HX_STACK_LINE(281)
	this->next = null();
	HX_STACK_LINE(280)
...
{
		HX_STACK_FRAME("ZPP_AABBPair","free","ZPP_AABBPair.free","zpp_nape/space/DynAABBPhase.hx",321)
		HX_STACK_THIS(this)
		HX_STACK_LINE(330)
...
{
		HX_STACK_FRAME("ZPP_AABBPair","alloc","ZPP_AABBPair.alloc","zpp_nape/space/DynAABBPhase.hx",310)
		HX_STACK_THIS(this)
	}
return null();
}
