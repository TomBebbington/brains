...
{
HX_STACK_FRAME("ZPP_Island","new","ZPP_Island.new","zpp_nape/space/Space.hx",174)
{
	HX_STACK_LINE(532)
	this->waket = (int)0;
	HX_STACK_LINE(531)
...
{
		HX_STACK_FRAME("ZPP_Island","alloc","ZPP_Island.alloc","zpp_nape/space/Space.hx",572)
		HX_STACK_THIS(this)
		HX_STACK_LINE(572)
		this->waket = (int)0;
	}
...
{
		HX_STACK_FRAME("ZPP_Island","free","ZPP_Island.free","zpp_nape/space/Space.hx",560)
		HX_STACK_THIS(this)
	}
return null();
}
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::at( int ind){
	HX_STACK_FRAME("ZPP_Island","at","ZPP_Island.at","zpp_nape/space/Space.hx",518)
	HX_STACK_THIS(this)
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::iterator_at( int ind){
	HX_STACK_FRAME("ZPP_Island","iterator_at","ZPP_Island.iterator_at","zpp_nape/space/Space.hx",505)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ind,"ind")
	HX_STACK_LINE(514)
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::back( ){
	HX_STACK_FRAME("ZPP_Island","back","ZPP_Island.back","zpp_nape/space/Space.hx",496)
	HX_STACK_THIS(this)
	HX_STACK_LINE(497)
	::zpp_nape::space::ZPP_Island ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(498)
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::front( ){
	HX_STACK_FRAME("ZPP_Island","front","ZPP_Island.front","zpp_nape/space/Space.hx",494)
	HX_STACK_THIS(this)
	HX_STACK_LINE(494)
	return this->next;
}
...
bool ZPP_Island_obj::inlined_has( ::zpp_nape::space::ZPP_Island obj){
	HX_STACK_FRAME("ZPP_Island","inlined_has","ZPP_Island.inlined_has","zpp_nape/space/Space.hx",463)
	HX_STACK_THIS(this)
...
bool ZPP_Island_obj::has( ::zpp_nape::space::ZPP_Island obj){
	HX_STACK_FRAME("ZPP_Island","has","ZPP_Island.has","zpp_nape/space/Space.hx",459)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(459)
	bool ret;		HX_STACK_VAR(ret,"ret");
...
int ZPP_Island_obj::size( ){
	HX_STACK_FRAME("ZPP_Island","size","ZPP_Island.size","zpp_nape/space/Space.hx",456)
	HX_STACK_THIS(this)
	HX_STACK_LINE(456)
	return this->length;
}
...
bool ZPP_Island_obj::empty( ){
	HX_STACK_FRAME("ZPP_Island","empty","ZPP_Island.empty","zpp_nape/space/Space.hx",451)
	HX_STACK_THIS(this)
	HX_STACK_LINE(451)
...
{
		HX_STACK_FRAME("ZPP_Island","reverse","ZPP_Island.reverse","zpp_nape/space/Space.hx",435)
		HX_STACK_THIS(this)
		HX_STACK_LINE(436)
...
{
		HX_STACK_FRAME("ZPP_Island","inlined_clear","ZPP_Island.inlined_clear","zpp_nape/space/Space.hx",430)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Island","clear","ZPP_Island.clear","zpp_nape/space/Space.hx",425)
		HX_STACK_THIS(this)
	}
return null();
}
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::splice( ::zpp_nape::space::ZPP_Island pre,int n){
	HX_STACK_FRAME("ZPP_Island","splice","ZPP_Island.splice","zpp_nape/space/Space.hx",420)
	HX_STACK_THIS(this)
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::inlined_erase( ::zpp_nape::space::ZPP_Island pre){
	HX_STACK_FRAME("ZPP_Island","inlined_erase","ZPP_Island.inlined_erase","zpp_nape/space/Space.hx",388)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(397)
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::erase( ::zpp_nape::space::ZPP_Island pre){
	HX_STACK_FRAME("ZPP_Island","erase","ZPP_Island.erase","zpp_nape/space/Space.hx",384)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(384)
	::zpp_nape::space::ZPP_Island old;		HX_STACK_VAR(old,"old");
...
bool ZPP_Island_obj::inlined_try_remove( ::zpp_nape::space::ZPP_Island obj){
	HX_STACK_FRAME("ZPP_Island","inlined_try_remove","ZPP_Island.inlined_try_remove","zpp_nape/space/Space.hx",360)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(369)
	::zpp_nape::space::ZPP_Island pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZPP_Island","inlined_remove","ZPP_Island.inlined_remove","zpp_nape/space/Space.hx",356)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(356)
		::zpp_nape::space::ZPP_Island pre = null();		HX_STACK_VAR(pre,"pre");
...
bool ZPP_Island_obj::try_remove( ::zpp_nape::space::ZPP_Island obj){
	HX_STACK_FRAME("ZPP_Island","try_remove","ZPP_Island.try_remove","zpp_nape/space/Space.hx",322)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(331)
	::zpp_nape::space::ZPP_Island pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZPP_Island","remove","ZPP_Island.remove","zpp_nape/space/Space.hx",320)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(320)
		::zpp_nape::space::ZPP_Island pre = null();		HX_STACK_VAR(pre,"pre");
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::inlined_pop_unsafe( ){
	HX_STACK_FRAME("ZPP_Island","inlined_pop_unsafe","ZPP_Island.inlined_pop_unsafe","zpp_nape/space/Space.hx",298)
	HX_STACK_THIS(this)
	HX_STACK_LINE(307)
	::zpp_nape::space::ZPP_Island ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(308)
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::pop_unsafe( ){
	HX_STACK_FRAME("ZPP_Island","pop_unsafe","ZPP_Island.pop_unsafe","zpp_nape/space/Space.hx",294)
	HX_STACK_THIS(this)
	HX_STACK_LINE(294)
	::zpp_nape::space::ZPP_Island ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(294)
...
{
		HX_STACK_FRAME("ZPP_Island","inlined_pop","ZPP_Island.inlined_pop","zpp_nape/space/Space.hx",274)
		HX_STACK_THIS(this)
		HX_STACK_LINE(283)
		::zpp_nape::space::ZPP_Island ret = this->next;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(284)
...
{
		HX_STACK_FRAME("ZPP_Island","pop","ZPP_Island.pop","zpp_nape/space/Space.hx",270)
		HX_STACK_THIS(this)
		HX_STACK_LINE(270)
		::zpp_nape::space::ZPP_Island ret = this->next;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(270)
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::inlined_insert( ::zpp_nape::space::ZPP_Island cur,::zpp_nape::space::ZPP_Island o){
	HX_STACK_FRAME("ZPP_Island","inlined_insert","ZPP_Island.inlined_insert","zpp_nape/space/Space.hx",244)
	HX_STACK_THIS(this)
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::insert( ::zpp_nape::space::ZPP_Island cur,::zpp_nape::space::ZPP_Island o){
	HX_STACK_FRAME("ZPP_Island","insert","ZPP_Island.insert","zpp_nape/space/Space.hx",240)
	HX_STACK_THIS(this)
	HX_STACK_ARG(cur,"cur")
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(240)
...
{
		HX_STACK_FRAME("ZPP_Island","addAll","ZPP_Island.addAll","zpp_nape/space/Space.hx",230)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(231)
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::inlined_add( ::zpp_nape::space::ZPP_Island o){
	HX_STACK_FRAME("ZPP_Island","inlined_add","ZPP_Island.inlined_add","zpp_nape/space/Space.hx",202)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(211)
	::zpp_nape::space::ZPP_Island temp;		HX_STACK_VAR(temp,"temp");
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::add( ::zpp_nape::space::ZPP_Island o){
	HX_STACK_FRAME("ZPP_Island","add","ZPP_Island.add","zpp_nape/space/Space.hx",198)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(198)
	::zpp_nape::space::ZPP_Island temp;		HX_STACK_VAR(temp,"temp");
...
{
		HX_STACK_FRAME("ZPP_Island","setbegin","ZPP_Island.setbegin","zpp_nape/space/Space.hx",192)
		HX_STACK_THIS(this)
		HX_STACK_ARG(i,"i")
		HX_STACK_LINE(193)
		this->next = i;
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::begin( ){
	HX_STACK_FRAME("ZPP_Island","begin","ZPP_Island.begin","zpp_nape/space/Space.hx",184)
	HX_STACK_THIS(this)
	HX_STACK_LINE(184)
	return this->next;
}
...
::zpp_nape::space::ZPP_Island ZPP_Island_obj::elem( ){
	HX_STACK_FRAME("ZPP_Island","elem","ZPP_Island.elem","zpp_nape/space/Space.hx",179)
	HX_STACK_THIS(this)
	HX_STACK_LINE(179)
