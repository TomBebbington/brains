...
{
HX_STACK_FRAME("ZPP_AABBTree","new","ZPP_AABBTree.new","zpp_nape/space/DynAABBPhase.hx",335)
{
	HX_STACK_LINE(336)
	this->root = null();
}
...
::zpp_nape::space::ZPP_AABBNode ZPP_AABBTree_obj::balance( ::zpp_nape::space::ZPP_AABBNode a){
	HX_STACK_FRAME("ZPP_AABBTree","balance","ZPP_AABBTree.balance","zpp_nape/space/DynAABBPhase.hx",590)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(590)
			...
			if (((f->height > g->height))){
				...
				struct _Function_4_1{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &b,::zpp_nape::space::ZPP_AABBNode &g){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",612)
						{
							HX_STACK_LINE(613)
				...
				struct _Function_4_2{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &a,::zpp_nape::space::ZPP_AABBNode &f){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",617)
						{
							HX_STACK_LINE(618)
				...
				struct _Function_4_1{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &b,::zpp_nape::space::ZPP_AABBNode &f){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",629)
						{
							HX_STACK_LINE(630)
							int x = b->height;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(631)
				...
				struct _Function_4_2{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &a,::zpp_nape::space::ZPP_AABBNode &g){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",634)
						{
							HX_STACK_LINE(635)
							int x = a->height;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(636)
				...
				if (((f->height > g->height))){
					...
					struct _Function_5_1{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &c,::zpp_nape::space::ZPP_AABBNode &g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",659)
							{
								HX_STACK_LINE(660)
					...
					struct _Function_5_2{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &a,::zpp_nape::space::ZPP_AABBNode &f){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",664)
							{
								HX_STACK_LINE(665)
								int x = a->height;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(666)
					...
					struct _Function_5_1{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &c,::zpp_nape::space::ZPP_AABBNode &f){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",676)
							{
								HX_STACK_LINE(677)
								int x = c->height;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(678)
					...
					struct _Function_5_2{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &a,::zpp_nape::space::ZPP_AABBNode &g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",681)
							{
								HX_STACK_LINE(682)
								int x = a->height;		HX_STACK_VAR(x,"x");
								HX_STACK_LINE(683)
...
{
		HX_STACK_FRAME("ZPP_AABBTree","inlined_removeLeaf","ZPP_AABBTree.inlined_removeLeaf","zpp_nape/space/DynAABBPhase.hx",521)
		HX_STACK_THIS(this)
				...
				while(((node != null()))){
						...
						if (((balance > (int)1))){
							...
							if (((f->height > g->height))){
								...
								struct _Function_7_1{
									inline static int Block( ::zpp_nape::space::ZPP_AABBNode &b,::zpp_nape::space::ZPP_AABBNode &g){
										HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",552)
										{
											HX_STACK_LINE(552)
											int x = b->height;		HX_STACK_VAR(x,"x");
											HX_STACK_LINE(552)
							...
							if (((balance < (int)-1))){
								...
								if (((f->height > g->height))){
									...
									HX_STACK_LINE(552)
									b->height = ((int)1 + _Function_8_2::Block(node,g));
								}
								HX_STACK_LINE(552)
								node = b;
							}
					...
					struct _Function_4_1{
						inline static int Block( ::zpp_nape::space::ZPP_AABBNode &child1,::zpp_nape::space::ZPP_AABBNode &child2){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",556)
							{
								HX_STACK_LINE(557)
...
{
		HX_STACK_FRAME("ZPP_AABBTree","removeLeaf","ZPP_AABBTree.removeLeaf","zpp_nape/space/DynAABBPhase.hx",516)
		HX_STACK_THIS(this)
		HX_STACK_ARG(leaf,"leaf")
		HX_STACK_LINE(516)
		if (((leaf == this->root))){
					...
					if (((bool((node->child1 == null())) || bool((node->height < (int)2))))){
						...
						if (((balance > (int)1))){
							...
							if (((f->height > g->height))){
								...
								struct _Function_7_1{
									inline static int Block( ::zpp_nape::space::ZPP_AABBNode &b,::zpp_nape::space::ZPP_AABBNode &g){
										HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",516)
										{
											HX_STACK_LINE(516)
											int x = b->height;		HX_STACK_VAR(x,"x");
											HX_STACK_LINE(516)
...
{
		HX_STACK_FRAME("ZPP_AABBTree","inlined_insertLeaf","ZPP_AABBTree.inlined_insertLeaf","zpp_nape/space/DynAABBPhase.hx",426)
		HX_STACK_THIS(this)
		HX_STACK_ARG(leaf,"leaf")
		HX_STACK_LINE(426)
		if (((this->root == null()))){
			...
			while((!(((node->child1 == null()))))){
					...
					if (((child1->child1 == null()))){
						struct _Function_5_1{
							inline static Float Block( ){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",443)
								{
									HX_STACK_LINE(443)
									::zpp_nape::geom::ZPP_AABB _this = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(443)
				...
				HX_STACK_LINE(450)
				{
					...
					if (((child2->child1 == null()))){
						struct _Function_5_1{
							inline static Float Block( ){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",452)
								{
									HX_STACK_LINE(452)
									::zpp_nape::geom::ZPP_AABB _this = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(452)
			...
			while(((node != null()))){
					...
					if (((balance > (int)1))){
						...
						if (((f->height > g->height))){
							...
							struct _Function_6_1{
								inline static int Block( ::zpp_nape::space::ZPP_AABBNode &b,::zpp_nape::space::ZPP_AABBNode &g){
									HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",502)
									{
										HX_STACK_LINE(502)
										int x = b->height;		HX_STACK_VAR(x,"x");
										HX_STACK_LINE(502)
				...
				struct _Function_3_1{
					inline static int Block( ::zpp_nape::space::ZPP_AABBNode &child1,::zpp_nape::space::ZPP_AABBNode &child2){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",505)
						{
							HX_STACK_LINE(506)
							int x = child1->height;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(507)
...
{
		HX_STACK_FRAME("ZPP_AABBTree","insertLeaf","ZPP_AABBTree.insertLeaf","zpp_nape/space/DynAABBPhase.hx",421)
		HX_STACK_THIS(this)
		HX_STACK_ARG(leaf,"leaf")
		HX_STACK_LINE(421)
		if (((this->root == null()))){
			...
			while((!(((node->child1 == null()))))){
				...
				HX_STACK_LINE(421)
				{
					...
					if (((child1->child1 == null()))){
						struct _Function_5_1{
							inline static Float Block( ){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/DynAABBPhase.hx",421)
								{
									HX_STACK_LINE(421)
									::zpp_nape::geom::ZPP_AABB _this = ::zpp_nape::space::ZPP_AABBTree_obj::tmpaabb;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(421)
...
{
		HX_STACK_FRAME("ZPP_AABBTree","clear","ZPP_AABBTree.clear","zpp_nape/space/DynAABBPhase.hx",338)
		HX_STACK_THIS(this)
		HX_STACK_LINE(339)
		if (((this->root == null()))){
			HX_STACK_LINE(339)
