...
{
HX_STACK_FRAME("ZPP_SweepPhase","new","ZPP_SweepPhase.new","zpp_nape/space/SweepPhase.hx",221)
...
::nape::geom::RayResultList ZPP_SweepPhase_obj::rayMultiCast( ::zpp_nape::geom::ZPP_Ray ray,bool inner,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::geom::RayResultList output){
	HX_STACK_FRAME("ZPP_SweepPhase","rayMultiCast","ZPP_SweepPhase.rayMultiCast","zpp_nape/space/SweepPhase.hx",745)
	HX_STACK_THIS(this)
		...
		while(((bool((a != null())) && bool((a->aabb->minx <= rayab->minx))))){
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &rayab){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",753)
					{
						HX_STACK_LINE(753)
		...
		if (((ray->dirx < (int)0))){
			...
			while(((a != null()))){
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &rayab){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",772)
						{
							HX_STACK_LINE(772)
							::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(772)
			...
			while(((bool((a != null())) && bool((a->aabb->minx <= rayab->maxx))))){
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &rayab){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",785)
						{
							HX_STACK_LINE(785)
							::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(785)
...
::nape::geom::RayResult ZPP_SweepPhase_obj::rayCast( ::zpp_nape::geom::ZPP_Ray ray,bool inner,::zpp_nape::dynamics::ZPP_InteractionFilter filter){
	HX_STACK_FRAME("ZPP_SweepPhase","rayCast","ZPP_SweepPhase.rayCast","zpp_nape/space/SweepPhase.hx",657)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ray,"ray")
	HX_STACK_ARG(inner,"inner")
	HX_STACK_ARG(filter,"filter")
	...
	if (((ray->dirx == (int)0))){
		...
		while(((bool((a != null())) && bool((a->aabb->minx <= rayab->minx))))){
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &rayab){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",666)
					{
						HX_STACK_LINE(666)
						::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(666)
		...
		if (((ray->dirx < (int)0))){
			...
			while(((a != null()))){
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &rayab){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",691)
						{
							HX_STACK_LINE(691)
							::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(691)
			...
			while(((bool((bool((a != null())) && bool((a->aabb->minx <= rayab->maxx)))) && bool((a->aabb->minx < (ray->originx + (ray->dirx * mint))))))){
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &rayab){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",710)
						{
							HX_STACK_LINE(710)
							::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(710)
...
::nape::phys::BodyList ZPP_SweepPhase_obj::bodiesInShape( ::zpp_nape::shape::ZPP_Shape shape,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::phys::BodyList output){
	HX_STACK_FRAME("ZPP_SweepPhase","bodiesInShape","ZPP_SweepPhase.bodiesInShape","zpp_nape/space/SweepPhase.hx",624)
	HX_STACK_THIS(this)
	...
	while(((bool((a != null())) && bool((a->aabb->minx <= ab->maxx))))){
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &ab){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",633)
				{
					HX_STACK_LINE(633)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(633)
		...
		if ((_Function_2_1::Block(a,ab))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::shape::ZPP_Shape &shape2,::zpp_nape::dynamics::ZPP_InteractionFilter &filter){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",636)
					{
						HX_STACK_LINE(636)
...
::nape::shape::ShapeList ZPP_SweepPhase_obj::shapesInShape( ::zpp_nape::shape::ZPP_Shape shape,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::shape::ShapeList output){
	HX_STACK_FRAME("ZPP_SweepPhase","shapesInShape","ZPP_SweepPhase.shapesInShape","zpp_nape/space/SweepPhase.hx",603)
	HX_STACK_THIS(this)
	HX_STACK_ARG(shape,"shape")
	HX_STACK_ARG(containment,"containment")
	HX_STACK_ARG(filter,"filter")
	...
	while(((bool((a != null())) && bool((a->aabb->minx <= ab->maxx))))){
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &ab){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",611)
				{
					HX_STACK_LINE(611)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(611)
		...
		if ((_Function_2_1::Block(a,ab))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::shape::ZPP_Shape &shape2,::zpp_nape::dynamics::ZPP_InteractionFilter &filter){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",613)
					{
						HX_STACK_LINE(613)
						::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape2->filter;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(613)
...
::nape::phys::BodyList ZPP_SweepPhase_obj::bodiesInCircle( Float x,Float y,Float r,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::phys::BodyList output){
	HX_STACK_FRAME("ZPP_SweepPhase","bodiesInCircle","ZPP_SweepPhase.bodiesInCircle","zpp_nape/space/SweepPhase.hx",570)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_ARG(r,"r")
	...
	while(((bool((a != null())) && bool((a->aabb->minx <= ab->maxx))))){
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &ab){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",579)
				{
					HX_STACK_LINE(579)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(579)
		...
		if ((_Function_2_1::Block(a,ab))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::shape::ZPP_Shape &shape,::zpp_nape::dynamics::ZPP_InteractionFilter &filter){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",582)
					{
						HX_STACK_LINE(582)
...
::nape::shape::ShapeList ZPP_SweepPhase_obj::shapesInCircle( Float x,Float y,Float r,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::shape::ShapeList output){
	HX_STACK_FRAME("ZPP_SweepPhase","shapesInCircle","ZPP_SweepPhase.shapesInCircle","zpp_nape/space/SweepPhase.hx",549)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_ARG(r,"r")
	...
	while(((bool((a != null())) && bool((a->aabb->minx <= ab->maxx))))){
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &ab){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",557)
				{
					HX_STACK_LINE(557)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(557)
		...
		if ((_Function_2_1::Block(a,ab))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::shape::ZPP_Shape &shape,::zpp_nape::dynamics::ZPP_InteractionFilter &filter){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",559)
					{
						HX_STACK_LINE(559)
						::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(559)
...
::nape::phys::BodyList ZPP_SweepPhase_obj::bodiesInAABB( ::zpp_nape::geom::ZPP_AABB aabb,bool strict,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::phys::BodyList output){
	HX_STACK_FRAME("ZPP_SweepPhase","bodiesInAABB","ZPP_SweepPhase.bodiesInAABB","zpp_nape/space/SweepPhase.hx",499)
	HX_STACK_THIS(this)
	...
	while(((bool((a != null())) && bool((a->aabb->minx <= ab->maxx))))){
		...
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &ab){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",510)
				{
					HX_STACK_LINE(510)
					::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(510)
		...
		if ((_Function_2_1::Block(a,ab))){
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::shape::ZPP_Shape &shape,::zpp_nape::dynamics::ZPP_InteractionFilter &filter){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",511)
					{
						HX_STACK_LINE(511)
						::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(511)
					...
					if ((containment)){
						...
						struct _Function_6_1{
							inline static bool Block( ::zpp_nape::shape::ZPP_Shape &shape,::zpp_nape::geom::ZPP_AABB &ab){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",538)
								{
									HX_STACK_LINE(538)
									::zpp_nape::geom::ZPP_AABB x = shape->aabb;		HX_STACK_VAR(x,"x");
									HX_STACK_LINE(538)
...
::nape::shape::ShapeList ZPP_SweepPhase_obj::shapesInAABB( ::zpp_nape::geom::ZPP_AABB aabb,bool strict,bool containment,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::shape::ShapeList output){
	HX_STACK_FRAME("ZPP_SweepPhase","shapesInAABB","ZPP_SweepPhase.shapesInAABB","zpp_nape/space/SweepPhase.hx",471)
	HX_STACK_THIS(this)
	HX_STACK_ARG(aabb,"aabb")
	HX_STACK_ARG(strict,"strict")
	HX_STACK_ARG(containment,"containment")
	...
	while(((bool((a != null())) && bool((a->aabb->minx <= ab->maxx))))){
		...
		struct _Function_2_1{
			inline static bool Block( ::zpp_nape::shape::ZPP_Shape &shape,::zpp_nape::dynamics::ZPP_InteractionFilter &filter){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",480)
				{
					HX_STACK_LINE(480)
					::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(480)
			...
			if ((strict)){
				...
				if ((containment)){
					...
					struct _Function_5_1{
						inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &ab){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",486)
							{
								HX_STACK_LINE(486)
					...
					if ((_Function_5_1::Block(a,ab))){
						...
						struct _Function_6_1{
							inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &ab){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",487)
								{
									HX_STACK_LINE(487)
									::zpp_nape::geom::ZPP_AABB _this = a->aabb;		HX_STACK_VAR(_this,"_this");
									HX_STACK_LINE(487)
				...
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::space::ZPP_SweepData &a,::zpp_nape::geom::ZPP_AABB &ab){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",492)
						{
							HX_STACK_LINE(492)
							::zpp_nape::geom::ZPP_AABB x = a->aabb;		HX_STACK_VAR(x,"x");
							HX_STACK_LINE(492)
...
::nape::phys::BodyList ZPP_SweepPhase_obj::bodiesUnderPoint( Float x,Float y,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::phys::BodyList output){
	HX_STACK_FRAME("ZPP_SweepPhase","bodiesUnderPoint","ZPP_SweepPhase.bodiesUnderPoint","zpp_nape/space/SweepPhase.hx",429)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_ARG(filter,"filter")
	...
	while(((bool((a != null())) && bool((a->aabb->minx <= x))))){
		...
		if (((bool((bool((a->aabb->maxx >= x)) && bool((a->aabb->miny <= y)))) && bool((a->aabb->maxy >= y))))){
			...
			if ((!(ret->has(body)))){
				struct _Function_4_1{
					inline static bool Block( ::zpp_nape::shape::ZPP_Shape &shape,::zpp_nape::dynamics::ZPP_InteractionFilter &filter){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",440)
						{
							HX_STACK_LINE(440)
							::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(440)
...
::nape::shape::ShapeList ZPP_SweepPhase_obj::shapesUnderPoint( Float x,Float y,::zpp_nape::dynamics::ZPP_InteractionFilter filter,::nape::shape::ShapeList output){
	HX_STACK_FRAME("ZPP_SweepPhase","shapesUnderPoint","ZPP_SweepPhase.shapesUnderPoint","zpp_nape/space/SweepPhase.hx",390)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_ARG(filter,"filter")
	...
	while(((bool((a != null())) && bool((a->aabb->minx <= x))))){
		...
		if (((bool((bool((a->aabb->maxx >= x)) && bool((a->aabb->miny <= y)))) && bool((a->aabb->maxy >= y))))){
			...
			struct _Function_3_1{
				inline static bool Block( ::zpp_nape::shape::ZPP_Shape &shape,::zpp_nape::dynamics::ZPP_InteractionFilter &filter){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",399)
					{
						HX_STACK_LINE(399)
						::zpp_nape::dynamics::ZPP_InteractionFilter _this = shape->filter;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(399)
...
{
		HX_STACK_FRAME("ZPP_SweepPhase","clear","ZPP_SweepPhase.clear","zpp_nape/space/SweepPhase.hx",385)
		HX_STACK_THIS(this)
		HX_STACK_LINE(385)
...
{
		HX_STACK_FRAME("ZPP_SweepPhase","broadphase","ZPP_SweepPhase.broadphase","zpp_nape/space/SweepPhase.hx",346)
		HX_STACK_THIS(this)
		HX_STACK_ARG(space,"space")
				...
				while(((d2 != null()))){
					...
					struct _Function_4_1{
						inline static bool Block( ::zpp_nape::shape::ZPP_Shape &s1,::zpp_nape::shape::ZPP_Shape &s2){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/space/SweepPhase.hx",370)
							{
								HX_STACK_LINE(370)
...
{
		HX_STACK_FRAME("ZPP_SweepPhase","sync_broadphase_fast","ZPP_SweepPhase.sync_broadphase_fast","zpp_nape/space/SweepPhase.hx",313)
		HX_STACK_THIS(this)
		HX_STACK_LINE(314)
		::zpp_nape::space::ZPP_SweepData a = this->list->next;		HX_STACK_VAR(a,"a");
		HX_STACK_LINE(315)
...
{
		HX_STACK_FRAME("ZPP_SweepPhase","sync_broadphase","ZPP_SweepPhase.sync_broadphase","zpp_nape/space/SweepPhase.hx",307)
		HX_STACK_THIS(this)
		HX_STACK_LINE(308)
...
{
		HX_STACK_FRAME("ZPP_SweepPhase","__sync","ZPP_SweepPhase.__sync","zpp_nape/space/SweepPhase.hx",305)
		HX_STACK_THIS(this)
		HX_STACK_ARG(shape,"shape")
		HX_STACK_LINE(305)
...
{
		HX_STACK_FRAME("ZPP_SweepPhase","__remove","ZPP_SweepPhase.__remove","zpp_nape/space/SweepPhase.hx",262)
		HX_STACK_THIS(this)
		HX_STACK_ARG(shape,"shape")
		HX_STACK_LINE(271)
...
{
		HX_STACK_FRAME("ZPP_SweepPhase","__insert","ZPP_SweepPhase.__insert","zpp_nape/space/SweepPhase.hx",228)
		HX_STACK_THIS(this)
		HX_STACK_ARG(shape,"shape")
		HX_STACK_LINE(237)
