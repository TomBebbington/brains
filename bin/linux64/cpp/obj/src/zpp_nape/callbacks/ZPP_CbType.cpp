...
{
HX_STACK_FRAME("ZPP_CbType","new","ZPP_CbType.new","zpp_nape/callbacks/CbType.hx",174)
{
	HX_STACK_LINE(301)
...
{
		HX_STACK_FRAME("ZPP_CbType","invalidateconstraint","ZPP_CbType.invalidateconstraint","zpp_nape/callbacks/CbType.hx",339)
		HX_STACK_THIS(this)
		HX_STACK_LINE(340)
...
{
		HX_STACK_FRAME("ZPP_CbType","removeconstraint","ZPP_CbType.removeconstraint","zpp_nape/callbacks/CbType.hx",332)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(333)
...
{
		HX_STACK_FRAME("ZPP_CbType","addconstraint","ZPP_CbType.addconstraint","zpp_nape/callbacks/CbType.hx",304)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(313)
		{
...
{
		HX_STACK_FRAME("ZPP_CbType","invalidatebody","ZPP_CbType.invalidatebody","zpp_nape/callbacks/CbType.hx",292)
		HX_STACK_THIS(this)
		HX_STACK_LINE(293)
		::zpp_nape::util::ZNPNode_ZPP_CbSet cx_ite = this->cbsets->head;		HX_STACK_VAR(cx_ite,"cx_ite");
		HX_STACK_LINE(294)
...
{
		HX_STACK_FRAME("ZPP_CbType","removebody","ZPP_CbType.removebody","zpp_nape/callbacks/CbType.hx",285)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(286)
...
{
		HX_STACK_FRAME("ZPP_CbType","addbody","ZPP_CbType.addbody","zpp_nape/callbacks/CbType.hx",257)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(266)
		{
...
{
		HX_STACK_FRAME("ZPP_CbType","invalidateint","ZPP_CbType.invalidateint","zpp_nape/callbacks/CbType.hx",245)
		HX_STACK_THIS(this)
		HX_STACK_LINE(246)
		::zpp_nape::util::ZNPNode_ZPP_CbSet cx_ite = this->cbsets->head;		HX_STACK_VAR(cx_ite,"cx_ite");
		HX_STACK_LINE(247)
...
{
		HX_STACK_FRAME("ZPP_CbType","removeint","ZPP_CbType.removeint","zpp_nape/callbacks/CbType.hx",238)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(239)
...
{
		HX_STACK_FRAME("ZPP_CbType","addint","ZPP_CbType.addint","zpp_nape/callbacks/CbType.hx",210)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(219)
		{
...
{
		HX_STACK_FRAME("ZPP_CbType","remInteractor","ZPP_CbType.remInteractor","zpp_nape/callbacks/CbType.hx",205)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_CbType","remConstraint","ZPP_CbType.remConstraint","zpp_nape/callbacks/CbType.hx",200)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_CbType","addInteractor","ZPP_CbType.addInteractor","zpp_nape/callbacks/CbType.hx",195)
		HX_STACK_THIS(this)
		HX_STACK_ARG(intx,"intx")
		HX_STACK_LINE(195)
...
{
		HX_STACK_FRAME("ZPP_CbType","addConstraint","ZPP_CbType.addConstraint","zpp_nape/callbacks/CbType.hx",190)
		HX_STACK_THIS(this)
		HX_STACK_ARG(con,"con")
		HX_STACK_LINE(190)
...
bool ZPP_CbType_obj::setlt( ::zpp_nape::callbacks::ZPP_CbType a,::zpp_nape::callbacks::ZPP_CbType b){
	HX_STACK_FRAME("ZPP_CbType","setlt","ZPP_CbType.setlt","zpp_nape/callbacks/CbType.hx",181)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(181)
	return (a->id < b->id);
