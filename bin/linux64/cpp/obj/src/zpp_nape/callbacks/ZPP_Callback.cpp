...
{
HX_STACK_FRAME("ZPP_Callback","new","ZPP_Callback.new","zpp_nape/callbacks/Callback.hx",174)
{
	HX_STACK_LINE(435)
...
{
		HX_STACK_FRAME("ZPP_Callback","genarbs","ZPP_Callback.genarbs","zpp_nape/callbacks/Callback.hx",416)
		HX_STACK_THIS(this)
		HX_STACK_LINE(425)
...
{
		HX_STACK_FRAME("ZPP_Callback","alloc","ZPP_Callback.alloc","zpp_nape/callbacks/Callback.hx",407)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Callback","free","ZPP_Callback.free","zpp_nape/callbacks/Callback.hx",395)
		HX_STACK_THIS(this)
		HX_STACK_LINE(396)
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::rev_at( int i){
	HX_STACK_FRAME("ZPP_Callback","rev_at","ZPP_Callback.rev_at","zpp_nape/callbacks/Callback.hx",356)
	HX_STACK_THIS(this)
	HX_STACK_ARG(i,"i")
	HX_STACK_LINE(365)
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::at( int i){
	HX_STACK_FRAME("ZPP_Callback","at","ZPP_Callback.at","zpp_nape/callbacks/Callback.hx",343)
	HX_STACK_THIS(this)
	HX_STACK_ARG(i,"i")
	HX_STACK_LINE(352)
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::cyclePrev( ::zpp_nape::callbacks::ZPP_Callback o){
	HX_STACK_FRAME("ZPP_Callback","cyclePrev","ZPP_Callback.cyclePrev","zpp_nape/callbacks/Callback.hx",340)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(340)
	if (((o->prev == null()))){
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::cycleNext( ::zpp_nape::callbacks::ZPP_Callback o){
	HX_STACK_FRAME("ZPP_Callback","cycleNext","ZPP_Callback.cycleNext","zpp_nape/callbacks/Callback.hx",328)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(328)
	if (((o->next == null()))){
...
{
		HX_STACK_FRAME("ZPP_Callback","rotateR","ZPP_Callback.rotateR","zpp_nape/callbacks/Callback.hx",317)
		HX_STACK_THIS(this)
		HX_STACK_LINE(317)
...
{
		HX_STACK_FRAME("ZPP_Callback","rotateL","ZPP_Callback.rotateL","zpp_nape/callbacks/Callback.hx",314)
		HX_STACK_THIS(this)
		HX_STACK_LINE(314)
		this->push(this->pop());
	}
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::splice( ::zpp_nape::callbacks::ZPP_Callback o){
	HX_STACK_FRAME("ZPP_Callback","splice","ZPP_Callback.splice","zpp_nape/callbacks/Callback.hx",298)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(299)
...
{
		HX_STACK_FRAME("ZPP_Callback","clear","ZPP_Callback.clear","zpp_nape/callbacks/Callback.hx",296)
		HX_STACK_THIS(this)
		HX_STACK_LINE(296)
		while((!(this->empty()))){
			HX_STACK_LINE(296)
...
bool ZPP_Callback_obj::empty( ){
	HX_STACK_FRAME("ZPP_Callback","empty","ZPP_Callback.empty","zpp_nape/callbacks/Callback.hx",293)
	HX_STACK_THIS(this)
	HX_STACK_LINE(293)
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::pop_rev( ){
	HX_STACK_FRAME("ZPP_Callback","pop_rev","ZPP_Callback.pop_rev","zpp_nape/callbacks/Callback.hx",276)
	HX_STACK_THIS(this)
	HX_STACK_LINE(285)
	::zpp_nape::callbacks::ZPP_Callback ret = this->prev;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(286)
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::pop( ){
	HX_STACK_FRAME("ZPP_Callback","pop","ZPP_Callback.pop","zpp_nape/callbacks/Callback.hx",260)
	HX_STACK_THIS(this)
	HX_STACK_LINE(269)
	::zpp_nape::callbacks::ZPP_Callback ret = this->next;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(270)
...
{
		HX_STACK_FRAME("ZPP_Callback","push_rev","ZPP_Callback.push_rev","zpp_nape/callbacks/Callback.hx",244)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_Callback","push","ZPP_Callback.push","zpp_nape/callbacks/Callback.hx",228)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(237)
		if (((this->prev != null()))){
...
::nape::callbacks::InteractionCallback ZPP_Callback_obj::wrapper_int( ){
	HX_STACK_FRAME("ZPP_Callback","wrapper_int","ZPP_Callback.wrapper_int","zpp_nape/callbacks/Callback.hx",207)
	HX_STACK_THIS(this)
	HX_STACK_LINE(208)
...
::nape::callbacks::ConstraintCallback ZPP_Callback_obj::wrapper_con( ){
	HX_STACK_FRAME("ZPP_Callback","wrapper_con","ZPP_Callback.wrapper_con","zpp_nape/callbacks/Callback.hx",194)
	HX_STACK_THIS(this)
	HX_STACK_LINE(195)
...
::nape::callbacks::BodyCallback ZPP_Callback_obj::wrapper_body( ){
	HX_STACK_FRAME("ZPP_Callback","wrapper_body","ZPP_Callback.wrapper_body","zpp_nape/callbacks/Callback.hx",181)
	HX_STACK_THIS(this)
	HX_STACK_LINE(182)
