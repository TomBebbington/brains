...
{
HX_STACK_FRAME("ZPP_CbSetPair","new","ZPP_CbSetPair.new","zpp_nape/callbacks/CbSetPair.hx",174)
{
	HX_STACK_LINE(264)
	this->listeners = null();
	HX_STACK_LINE(263)
...
{
		HX_STACK_FRAME("ZPP_CbSetPair","forall","ZPP_CbSetPair.forall","zpp_nape/callbacks/CbSetPair.hx",350)
		HX_STACK_THIS(this)
...
bool ZPP_CbSetPair_obj::single_intersection( ::zpp_nape::callbacks::ZPP_InteractionListener i){
	HX_STACK_FRAME("ZPP_CbSetPair","single_intersection","ZPP_CbSetPair.single_intersection","zpp_nape/callbacks/CbSetPair.hx",327)
	HX_STACK_THIS(this)
	HX_STACK_ARG(i,"i")
	HX_STACK_LINE(336)
...
bool ZPP_CbSetPair_obj::empty_intersection( ){
	HX_STACK_FRAME("ZPP_CbSetPair","empty_intersection","ZPP_CbSetPair.empty_intersection","zpp_nape/callbacks/CbSetPair.hx",323)
	HX_STACK_THIS(this)
	HX_STACK_LINE(323)
...
{
		HX_STACK_FRAME("ZPP_CbSetPair","__validate","ZPP_CbSetPair.__validate","zpp_nape/callbacks/CbSetPair.hx",278)
		HX_STACK_THIS(this)
		HX_STACK_LINE(279)
		...
		while(((bool((aite != null())) && bool((bite != null()))))){
			...
			if (((ax == bx))){
				struct _Function_3_1{
					inline static bool Block( ::zpp_nape::callbacks::ZPP_InteractionListener &ax,::zpp_nape::callbacks::ZPP_CbSetPair_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/callbacks/CbSetPair.hx",302)
						{
							HX_STACK_LINE(302)
				...
				HX_STACK_LINE(302)
				if (((bool((bool(_Function_3_1::Block(ax,this)) && bool(_Function_3_2::Block(ax,this)))) || bool((bool(_Function_3_3::Block(ax,this)) && bool(_Function_3_4::Block(ax,this))))))){
					HX_STACK_LINE(303)
...
{
		HX_STACK_FRAME("ZPP_CbSetPair","validate","ZPP_CbSetPair.validate","zpp_nape/callbacks/CbSetPair.hx",273)
		HX_STACK_THIS(this)
		HX_STACK_LINE(273)
...
{
		HX_STACK_FRAME("ZPP_CbSetPair","invalidate","ZPP_CbSetPair.invalidate","zpp_nape/callbacks/CbSetPair.hx",268)
		HX_STACK_THIS(this)
		HX_STACK_LINE(268)
...
bool ZPP_CbSetPair_obj::compatible( ::zpp_nape::callbacks::ZPP_InteractionListener i){
	HX_STACK_FRAME("ZPP_CbSetPair","compatible","ZPP_CbSetPair.compatible","zpp_nape/callbacks/CbSetPair.hx",261)
	HX_STACK_THIS(this)
	HX_STACK_ARG(i,"i")
	struct _Function_1_1{
		inline static bool Block( ::zpp_nape::callbacks::ZPP_InteractionListener &i,::zpp_nape::callbacks::ZPP_CbSetPair_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","zpp_nape/callbacks/CbSetPair.hx",261)
			{
				HX_STACK_LINE(261)
...
{
		HX_STACK_FRAME("ZPP_CbSetPair","alloc","ZPP_CbSetPair.alloc","zpp_nape/callbacks/CbSetPair.hx",211)
		HX_STACK_THIS(this)
		HX_STACK_LINE(211)
		this->zip_listeners = true;
	}
...
{
		HX_STACK_FRAME("ZPP_CbSetPair","free","ZPP_CbSetPair.free","zpp_nape/callbacks/CbSetPair.hx",204)
		HX_STACK_THIS(this)
		HX_STACK_LINE(205)
		this->a = this->b = null();
		HX_STACK_LINE(206)
...
::zpp_nape::callbacks::ZPP_CbSetPair ZPP_CbSetPair_obj::get( ::zpp_nape::callbacks::ZPP_CbSet a,::zpp_nape::callbacks::ZPP_CbSet b){
	HX_STACK_FRAME("ZPP_CbSetPair","get","ZPP_CbSetPair.get","zpp_nape/callbacks/CbSetPair.hx",217)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(218)
...
bool ZPP_CbSetPair_obj::setlt( ::zpp_nape::callbacks::ZPP_CbSetPair x,::zpp_nape::callbacks::ZPP_CbSetPair y){
	HX_STACK_FRAME("ZPP_CbSetPair","setlt","ZPP_CbSetPair.setlt","zpp_nape/callbacks/CbSetPair.hx",256)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(256)
