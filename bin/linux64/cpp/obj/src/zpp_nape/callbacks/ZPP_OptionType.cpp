...
{
HX_STACK_FRAME("ZPP_OptionType","new","ZPP_OptionType.new","zpp_nape/callbacks/OptionType.hx",174)
{
	HX_STACK_LINE(184)
...
{
		HX_STACK_FRAME("ZPP_OptionType","append","ZPP_OptionType.append","zpp_nape/callbacks/OptionType.hx",312)
		HX_STACK_THIS(this)
			...
			if ((::Std_obj::is(val,hx::ClassOf< ::nape::callbacks::CbTypeList >()))){
				...
				struct _Function_3_1{
					inline static ::nape::callbacks::CbTypeIterator Block( ::nape::callbacks::CbTypeList &cbs){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/callbacks/OptionType.hx",324)
						{
							HX_STACK_LINE(324)
...
::zpp_nape::callbacks::ZPP_OptionType ZPP_OptionType_obj::set( ::zpp_nape::callbacks::ZPP_OptionType options){
	HX_STACK_FRAME("ZPP_OptionType","set","ZPP_OptionType.set","zpp_nape/callbacks/OptionType.hx",289)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_OptionType","append_type","ZPP_OptionType.append_type","zpp_nape/callbacks/OptionType.hx",264)
		HX_STACK_THIS(this)
		HX_STACK_ARG(list,"list")
		HX_STACK_ARG(val,"val")
		HX_STACK_LINE(264)
...
{
		HX_STACK_FRAME("ZPP_OptionType","effect_change","ZPP_OptionType.effect_change","zpp_nape/callbacks/OptionType.hx",226)
		HX_STACK_THIS(this)
		HX_STACK_ARG(val,"val")
...
bool ZPP_OptionType_obj::nonemptyintersection( ::zpp_nape::util::ZNPList_ZPP_CbType xs,::zpp_nape::util::ZNPList_ZPP_CbType ys){
	HX_STACK_FRAME("ZPP_OptionType","nonemptyintersection","ZPP_OptionType.nonemptyintersection","zpp_nape/callbacks/OptionType.hx",203)
	HX_STACK_THIS(this)
	HX_STACK_ARG(xs,"xs")
	HX_STACK_ARG(ys,"ys")
	HX_STACK_LINE(204)
...
bool ZPP_OptionType_obj::compatible( ::zpp_nape::util::ZNPList_ZPP_CbType xs){
	HX_STACK_FRAME("ZPP_OptionType","compatible","ZPP_OptionType.compatible","zpp_nape/callbacks/OptionType.hx",201)
	HX_STACK_THIS(this)
	HX_STACK_ARG(xs,"xs")
	HX_STACK_LINE(201)
...
bool ZPP_OptionType_obj::included( ::zpp_nape::util::ZNPList_ZPP_CbType xs){
	HX_STACK_FRAME("ZPP_OptionType","included","ZPP_OptionType.included","zpp_nape/callbacks/OptionType.hx",197)
	HX_STACK_THIS(this)
	HX_STACK_ARG(xs,"xs")
	HX_STACK_LINE(197)
...
bool ZPP_OptionType_obj::excluded( ::zpp_nape::util::ZNPList_ZPP_CbType xs){
	HX_STACK_FRAME("ZPP_OptionType","excluded","ZPP_OptionType.excluded","zpp_nape/callbacks/OptionType.hx",193)
	HX_STACK_THIS(this)
	HX_STACK_ARG(xs,"xs")
	HX_STACK_LINE(193)
...
{
		HX_STACK_FRAME("ZPP_OptionType","setup_excludes","ZPP_OptionType.setup_excludes","zpp_nape/callbacks/OptionType.hx",189)
		HX_STACK_THIS(this)
		HX_STACK_LINE(189)
...
{
		HX_STACK_FRAME("ZPP_OptionType","setup_includes","ZPP_OptionType.setup_includes","zpp_nape/callbacks/OptionType.hx",186)
		HX_STACK_THIS(this)
		HX_STACK_LINE(186)
...
::nape::callbacks::OptionType ZPP_OptionType_obj::argument( Dynamic val){
	HX_STACK_FRAME("ZPP_OptionType","argument","ZPP_OptionType.argument","zpp_nape/callbacks/OptionType.hx",351)
	HX_STACK_ARG(val,"val")
	HX_STACK_LINE(351)
	if (((val == null()))){
		HX_STACK_LINE(351)
