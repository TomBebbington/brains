...
{
HX_STACK_FRAME("ZPP_Listener","new","ZPP_Listener.new","zpp_nape/callbacks/Listener.hx",174)
{
	HX_STACK_LINE(186)
	this->space = null();
	HX_STACK_LINE(185)
...
{
		HX_STACK_FRAME("ZPP_Listener","removedFromSpace","ZPP_Listener.removedFromSpace","zpp_nape/callbacks/Listener.hx",197)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Listener","addedToSpace","ZPP_Listener.addedToSpace","zpp_nape/callbacks/Listener.hx",196)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Listener","invalidate_precedence","ZPP_Listener.invalidate_precedence","zpp_nape/callbacks/Listener.hx",195)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Listener","swapEvent","ZPP_Listener.swapEvent","zpp_nape/callbacks/Listener.hx",194)
		HX_STACK_THIS(this)
...
bool ZPP_Listener_obj::setlt( ::zpp_nape::callbacks::ZPP_Listener a,::zpp_nape::callbacks::ZPP_Listener b){
	HX_STACK_FRAME("ZPP_Listener","setlt","ZPP_Listener.setlt","zpp_nape/callbacks/Listener.hx",192)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(192)
