...
{
HX_STACK_FRAME("ZPP_ConstraintListener","new","ZPP_ConstraintListener.new","zpp_nape/callbacks/Listener.hx",268)
...
{
		HX_STACK_FRAME("ZPP_ConstraintListener","swapEvent","ZPP_ConstraintListener.swapEvent","zpp_nape/callbacks/Listener.hx",324)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_ConstraintListener","invalidate_precedence","ZPP_ConstraintListener.invalidate_precedence","zpp_nape/callbacks/Listener.hx",319)
		HX_STACK_THIS(this)
		HX_STACK_LINE(319)
		if (((this->space != null()))){
			HX_STACK_LINE(320)
...
{
		HX_STACK_FRAME("ZPP_ConstraintListener","cbtype_change","ZPP_ConstraintListener.cbtype_change","zpp_nape/callbacks/Listener.hx",313)
		HX_STACK_THIS(this)
		HX_STACK_ARG(cb,"cb")
...
{
		HX_STACK_FRAME("ZPP_ConstraintListener","removedFromSpace","ZPP_ConstraintListener.removedFromSpace","zpp_nape/callbacks/Listener.hx",300)
		HX_STACK_THIS(this)
		HX_STACK_LINE(301)
		{
			HX_STACK_LINE(302)
...
{
		HX_STACK_FRAME("ZPP_ConstraintListener","addedToSpace","ZPP_ConstraintListener.addedToSpace","zpp_nape/callbacks/Listener.hx",287)
		HX_STACK_THIS(this)
		HX_STACK_LINE(288)
...
{
		HX_STACK_FRAME("ZPP_ConstraintListener","immutable_options","ZPP_ConstraintListener.immutable_options","zpp_nape/callbacks/Listener.hx",274)
		HX_STACK_THIS(this)
		HX_STACK_LINE(274)
