...
{
HX_STACK_FRAME("ZPP_Compound","new","ZPP_Compound.new","zpp_nape/phys/Compound.hx",174)
{
	HX_STACK_LINE(184)
	this->space = null();
	HX_STACK_LINE(183)
...
::nape::phys::Compound ZPP_Compound_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	HX_STACK_FRAME("ZPP_Compound","copy","ZPP_Compound.copy","zpp_nape/phys/Compound.hx",336)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_Compound","compounds_modifiable","ZPP_Compound.compounds_modifiable","zpp_nape/phys/Compound.hx",306)
		HX_STACK_THIS(this)
		HX_STACK_LINE(306)
...
{
		HX_STACK_FRAME("ZPP_Compound","compounds_subber","ZPP_Compound.compounds_subber","zpp_nape/phys/Compound.hx",299)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(300)
...
bool ZPP_Compound_obj::compounds_adder( ::nape::phys::Compound x){
	HX_STACK_FRAME("ZPP_Compound","compounds_adder","ZPP_Compound.compounds_adder","zpp_nape/phys/Compound.hx",280)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(282)
	...
	if (((cur == x->zpp_inner))){
		HX_STACK_LINE(285)
		HX_STACK_DO_THROW((((HX_CSTRING("Error: Assignment would cause a cycle in the Compound tree: assigning ") + x->toString()) + HX_CSTRING(".compound = ")) + this->outer->toString()));
		HX_STACK_LINE(286)
		return false;
	}
	HX_STACK_LINE(289)
...
{
		HX_STACK_FRAME("ZPP_Compound","constraints_modifiable","ZPP_Compound.constraints_modifiable","zpp_nape/phys/Compound.hx",277)
		HX_STACK_THIS(this)
		HX_STACK_LINE(277)
...
{
		HX_STACK_FRAME("ZPP_Compound","constraints_subber","ZPP_Compound.constraints_subber","zpp_nape/phys/Compound.hx",270)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(271)
		x->zpp_inner->compound = null();
...
bool ZPP_Compound_obj::constraints_adder( ::nape::constraint::Constraint x){
	HX_STACK_FRAME("ZPP_Compound","constraints_adder","ZPP_Compound.constraints_adder","zpp_nape/phys/Compound.hx",260)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(260)
	if (((x->zpp_inner->compound != hx::ObjectPtr<OBJ_>(this)))){
...
{
		HX_STACK_FRAME("ZPP_Compound","bodies_modifiable","ZPP_Compound.bodies_modifiable","zpp_nape/phys/Compound.hx",255)
		HX_STACK_THIS(this)
		HX_STACK_LINE(255)
...
{
		HX_STACK_FRAME("ZPP_Compound","bodies_subber","ZPP_Compound.bodies_subber","zpp_nape/phys/Compound.hx",248)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(249)
		x->zpp_inner->compound = null();
...
bool ZPP_Compound_obj::bodies_adder( ::nape::phys::Body x){
	HX_STACK_FRAME("ZPP_Compound","bodies_adder","ZPP_Compound.bodies_adder","zpp_nape/phys/Compound.hx",238)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(238)
	if (((x->zpp_inner->compound != hx::ObjectPtr<OBJ_>(this)))){
...
{
		HX_STACK_FRAME("ZPP_Compound","breakApart","ZPP_Compound.breakApart","zpp_nape/phys/Compound.hx",196)
		HX_STACK_THIS(this)
		HX_STACK_LINE(197)
		if (((this->space != null()))){
			HX_STACK_LINE(198)
...
{
		HX_STACK_FRAME("ZPP_Compound","removedFromSpace","ZPP_Compound.removedFromSpace","zpp_nape/phys/Compound.hx",194)
		HX_STACK_THIS(this)
		HX_STACK_LINE(194)
		this->__iremovedFromSpace();
	}
...
{
		HX_STACK_FRAME("ZPP_Compound","addedToSpace","ZPP_Compound.addedToSpace","zpp_nape/phys/Compound.hx",191)
		HX_STACK_THIS(this)
		HX_STACK_LINE(191)
...
{
		HX_STACK_FRAME("ZPP_Compound","__imutable_midstep","ZPP_Compound.__imutable_midstep","zpp_nape/phys/Compound.hx",187)
		HX_STACK_THIS(this)
