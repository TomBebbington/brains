...
{
HX_STACK_FRAME("ZPP_FluidProperties","new","ZPP_FluidProperties.new","zpp_nape/phys/FluidProperties.hx",174)
{
	HX_STACK_LINE(303)
...
{
		HX_STACK_FRAME("ZPP_FluidProperties","invalidate","ZPP_FluidProperties.invalidate","zpp_nape/phys/FluidProperties.hx",356)
		HX_STACK_THIS(this)
		HX_STACK_LINE(357)
...
{
		HX_STACK_FRAME("ZPP_FluidProperties","getgravity","ZPP_FluidProperties.getgravity","zpp_nape/phys/FluidProperties.hx",349)
		HX_STACK_THIS(this)
		HX_STACK_LINE(350)
		{
			HX_STACK_LINE(350)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/phys/FluidProperties.hx",350)
						{
							HX_STACK_LINE(350)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(350)
...
{
		HX_STACK_FRAME("ZPP_FluidProperties","gravity_validate","ZPP_FluidProperties.gravity_validate","zpp_nape/phys/FluidProperties.hx",328)
		HX_STACK_THIS(this)
		HX_STACK_LINE(329)
...
{
		HX_STACK_FRAME("ZPP_FluidProperties","gravity_invalidate","ZPP_FluidProperties.gravity_invalidate","zpp_nape/phys/FluidProperties.hx",304)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(305)
		{
...
::zpp_nape::phys::ZPP_FluidProperties ZPP_FluidProperties_obj::copy( ){
	HX_STACK_FRAME("ZPP_FluidProperties","copy","ZPP_FluidProperties.copy","zpp_nape/phys/FluidProperties.hx",251)
	HX_STACK_THIS(this)
	HX_STACK_LINE(252)
...
{
		HX_STACK_FRAME("ZPP_FluidProperties","remShape","ZPP_FluidProperties.remShape","zpp_nape/phys/FluidProperties.hx",249)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_FluidProperties","addShape","ZPP_FluidProperties.addShape","zpp_nape/phys/FluidProperties.hx",244)
		HX_STACK_THIS(this)
		HX_STACK_ARG(shape,"shape")
		HX_STACK_LINE(244)
...
{
		HX_STACK_FRAME("ZPP_FluidProperties","feature_cons","ZPP_FluidProperties.feature_cons","zpp_nape/phys/FluidProperties.hx",239)
		HX_STACK_THIS(this)
		HX_STACK_LINE(239)
		this->shapes = ::zpp_nape::util::ZNPList_ZPP_Shape_obj::__new();
	}
...
{
		HX_STACK_FRAME("ZPP_FluidProperties","alloc","ZPP_FluidProperties.alloc","zpp_nape/phys/FluidProperties.hx",233)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_FluidProperties","free","ZPP_FluidProperties.free","zpp_nape/phys/FluidProperties.hx",229)
		HX_STACK_THIS(this)
		HX_STACK_LINE(229)
		this->outer = null();
	}
...
::nape::phys::FluidProperties ZPP_FluidProperties_obj::wrapper( ){
	HX_STACK_FRAME("ZPP_FluidProperties","wrapper","ZPP_FluidProperties.wrapper","zpp_nape/phys/FluidProperties.hx",202)
	HX_STACK_THIS(this)
	HX_STACK_LINE(203)
	if (((this->outer == null()))){
		HX_STACK_LINE(204)
