...
{
HX_STACK_FRAME("ZPP_Material","new","ZPP_Material.new","zpp_nape/phys/Material.hx",174)
{
	HX_STACK_LINE(255)
...
{
		HX_STACK_FRAME("ZPP_Material","invalidate","ZPP_Material.invalidate","zpp_nape/phys/Material.hx",285)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(286)
...
{
		HX_STACK_FRAME("ZPP_Material","set","ZPP_Material.set","zpp_nape/phys/Material.hx",273)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(274)
...
::zpp_nape::phys::ZPP_Material ZPP_Material_obj::copy( ){
	HX_STACK_FRAME("ZPP_Material","copy","ZPP_Material.copy","zpp_nape/phys/Material.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(265)
...
{
		HX_STACK_FRAME("ZPP_Material","remShape","ZPP_Material.remShape","zpp_nape/phys/Material.hx",249)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_Material","addShape","ZPP_Material.addShape","zpp_nape/phys/Material.hx",244)
		HX_STACK_THIS(this)
		HX_STACK_ARG(shape,"shape")
		HX_STACK_LINE(244)
...
{
		HX_STACK_FRAME("ZPP_Material","feature_cons","ZPP_Material.feature_cons","zpp_nape/phys/Material.hx",239)
		HX_STACK_THIS(this)
		HX_STACK_LINE(239)
		this->shapes = ::zpp_nape::util::ZNPList_ZPP_Shape_obj::__new();
	}
...
{
		HX_STACK_FRAME("ZPP_Material","alloc","ZPP_Material.alloc","zpp_nape/phys/Material.hx",233)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Material","free","ZPP_Material.free","zpp_nape/phys/Material.hx",229)
		HX_STACK_THIS(this)
		HX_STACK_LINE(229)
		this->outer = null();
	}
...
::nape::phys::Material ZPP_Material_obj::wrapper( ){
	HX_STACK_FRAME("ZPP_Material","wrapper","ZPP_Material.wrapper","zpp_nape/phys/Material.hx",202)
	HX_STACK_THIS(this)
	HX_STACK_LINE(203)
	if (((this->outer == null()))){
		HX_STACK_LINE(204)
