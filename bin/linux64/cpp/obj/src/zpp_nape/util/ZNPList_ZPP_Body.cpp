...
{
HX_STACK_FRAME("ZNPList_ZPP_Body","new","ZNPList_ZPP_Body.new","zpp_nape/util/Lists.hx",1426)
{
	HX_STACK_LINE(1436)
	this->length = (int)0;
	HX_STACK_LINE(1435)
...
::zpp_nape::phys::ZPP_Body ZNPList_ZPP_Body_obj::at( int ind){
	HX_STACK_FRAME("ZNPList_ZPP_Body","at","ZNPList_ZPP_Body.at","zpp_nape/util/Lists.hx",1829)
	HX_STACK_THIS(this)
...
::zpp_nape::util::ZNPNode_ZPP_Body ZNPList_ZPP_Body_obj::iterator_at( int ind){
	HX_STACK_FRAME("ZNPList_ZPP_Body","iterator_at","ZNPList_ZPP_Body.iterator_at","zpp_nape/util/Lists.hx",1816)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ind,"ind")
	HX_STACK_LINE(1825)
...
::zpp_nape::phys::ZPP_Body ZNPList_ZPP_Body_obj::back( ){
	HX_STACK_FRAME("ZNPList_ZPP_Body","back","ZNPList_ZPP_Body.back","zpp_nape/util/Lists.hx",1807)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1808)
	::zpp_nape::util::ZNPNode_ZPP_Body ret = this->head;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(1809)
...
::zpp_nape::phys::ZPP_Body ZNPList_ZPP_Body_obj::front( ){
	HX_STACK_FRAME("ZNPList_ZPP_Body","front","ZNPList_ZPP_Body.front","zpp_nape/util/Lists.hx",1805)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1805)
...
bool ZNPList_ZPP_Body_obj::inlined_has( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZNPList_ZPP_Body","inlined_has","ZNPList_ZPP_Body.inlined_has","zpp_nape/util/Lists.hx",1774)
	HX_STACK_THIS(this)
...
bool ZNPList_ZPP_Body_obj::has( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZNPList_ZPP_Body","has","ZNPList_ZPP_Body.has","zpp_nape/util/Lists.hx",1770)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(1770)
	bool ret;		HX_STACK_VAR(ret,"ret");
...
int ZNPList_ZPP_Body_obj::size( ){
	HX_STACK_FRAME("ZNPList_ZPP_Body","size","ZNPList_ZPP_Body.size","zpp_nape/util/Lists.hx",1767)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1767)
	return this->length;
}
...
bool ZNPList_ZPP_Body_obj::empty( ){
	HX_STACK_FRAME("ZNPList_ZPP_Body","empty","ZNPList_ZPP_Body.empty","zpp_nape/util/Lists.hx",1762)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1762)
...
{
		HX_STACK_FRAME("ZNPList_ZPP_Body","reverse","ZNPList_ZPP_Body.reverse","zpp_nape/util/Lists.hx",1746)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1747)
...
{
		HX_STACK_FRAME("ZNPList_ZPP_Body","inlined_clear","ZNPList_ZPP_Body.inlined_clear","zpp_nape/util/Lists.hx",1741)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1742)
...
{
		HX_STACK_FRAME("ZNPList_ZPP_Body","clear","ZNPList_ZPP_Body.clear","zpp_nape/util/Lists.hx",1736)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1736)
		while((!(((this->head == null()))))){
			HX_STACK_LINE(1736)
...
::zpp_nape::util::ZNPNode_ZPP_Body ZNPList_ZPP_Body_obj::splice( ::zpp_nape::util::ZNPNode_ZPP_Body pre,int n){
	HX_STACK_FRAME("ZNPList_ZPP_Body","splice","ZNPList_ZPP_Body.splice","zpp_nape/util/Lists.hx",1731)
	HX_STACK_THIS(this)
...
::zpp_nape::util::ZNPNode_ZPP_Body ZNPList_ZPP_Body_obj::inlined_erase( ::zpp_nape::util::ZNPNode_ZPP_Body pre){
	HX_STACK_FRAME("ZNPList_ZPP_Body","inlined_erase","ZNPList_ZPP_Body.inlined_erase","zpp_nape/util/Lists.hx",1685)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(1694)
...
::zpp_nape::util::ZNPNode_ZPP_Body ZNPList_ZPP_Body_obj::erase( ::zpp_nape::util::ZNPNode_ZPP_Body pre){
	HX_STACK_FRAME("ZNPList_ZPP_Body","erase","ZNPList_ZPP_Body.erase","zpp_nape/util/Lists.hx",1681)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(1681)
	::zpp_nape::util::ZNPNode_ZPP_Body old;		HX_STACK_VAR(old,"old");
...
bool ZNPList_ZPP_Body_obj::inlined_try_remove( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZNPList_ZPP_Body","inlined_try_remove","ZNPList_ZPP_Body.inlined_try_remove","zpp_nape/util/Lists.hx",1657)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(1666)
	::zpp_nape::util::ZNPNode_ZPP_Body pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZNPList_ZPP_Body","inlined_remove","ZNPList_ZPP_Body.inlined_remove","zpp_nape/util/Lists.hx",1653)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(1653)
		::zpp_nape::util::ZNPNode_ZPP_Body pre = null();		HX_STACK_VAR(pre,"pre");
...
bool ZNPList_ZPP_Body_obj::try_remove( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZNPList_ZPP_Body","try_remove","ZNPList_ZPP_Body.try_remove","zpp_nape/util/Lists.hx",1619)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(1628)
	::zpp_nape::util::ZNPNode_ZPP_Body pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZNPList_ZPP_Body","remove","ZNPList_ZPP_Body.remove","zpp_nape/util/Lists.hx",1617)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(1617)
		::zpp_nape::util::ZNPNode_ZPP_Body pre = null();		HX_STACK_VAR(pre,"pre");
...
::zpp_nape::phys::ZPP_Body ZNPList_ZPP_Body_obj::inlined_pop_unsafe( ){
	HX_STACK_FRAME("ZNPList_ZPP_Body","inlined_pop_unsafe","ZNPList_ZPP_Body.inlined_pop_unsafe","zpp_nape/util/Lists.hx",1595)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1604)
...
::zpp_nape::phys::ZPP_Body ZNPList_ZPP_Body_obj::pop_unsafe( ){
	HX_STACK_FRAME("ZNPList_ZPP_Body","pop_unsafe","ZNPList_ZPP_Body.pop_unsafe","zpp_nape/util/Lists.hx",1591)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1591)
	::zpp_nape::phys::ZPP_Body ret = this->head->elt;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(1591)
...
{
		HX_STACK_FRAME("ZNPList_ZPP_Body","inlined_pop","ZNPList_ZPP_Body.inlined_pop","zpp_nape/util/Lists.hx",1557)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1566)
		::zpp_nape::util::ZNPNode_ZPP_Body ret = this->head;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(1567)
...
{
		HX_STACK_FRAME("ZNPList_ZPP_Body","pop","ZNPList_ZPP_Body.pop","zpp_nape/util/Lists.hx",1553)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1553)
		::zpp_nape::util::ZNPNode_ZPP_Body ret = this->head;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(1553)
...
::zpp_nape::util::ZNPNode_ZPP_Body ZNPList_ZPP_Body_obj::inlined_insert( ::zpp_nape::util::ZNPNode_ZPP_Body cur,::zpp_nape::phys::ZPP_Body o){
	HX_STACK_FRAME("ZNPList_ZPP_Body","inlined_insert","ZNPList_ZPP_Body.inlined_insert","zpp_nape/util/Lists.hx",1509)
	HX_STACK_THIS(this)
...
::zpp_nape::util::ZNPNode_ZPP_Body ZNPList_ZPP_Body_obj::insert( ::zpp_nape::util::ZNPNode_ZPP_Body cur,::zpp_nape::phys::ZPP_Body o){
	HX_STACK_FRAME("ZNPList_ZPP_Body","insert","ZNPList_ZPP_Body.insert","zpp_nape/util/Lists.hx",1505)
	HX_STACK_THIS(this)
	HX_STACK_ARG(cur,"cur")
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(1505)
...
{
		HX_STACK_FRAME("ZNPList_ZPP_Body","addAll","ZNPList_ZPP_Body.addAll","zpp_nape/util/Lists.hx",1495)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(1496)
...
::zpp_nape::phys::ZPP_Body ZNPList_ZPP_Body_obj::inlined_add( ::zpp_nape::phys::ZPP_Body o){
	HX_STACK_FRAME("ZNPList_ZPP_Body","inlined_add","ZNPList_ZPP_Body.inlined_add","zpp_nape/util/Lists.hx",1449)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(1458)
	::zpp_nape::util::ZNPNode_ZPP_Body temp;		HX_STACK_VAR(temp,"temp");
...
::zpp_nape::phys::ZPP_Body ZNPList_ZPP_Body_obj::add( ::zpp_nape::phys::ZPP_Body o){
	HX_STACK_FRAME("ZNPList_ZPP_Body","add","ZNPList_ZPP_Body.add","zpp_nape/util/Lists.hx",1445)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(1445)
	::zpp_nape::util::ZNPNode_ZPP_Body temp;		HX_STACK_VAR(temp,"temp");
...
{
		HX_STACK_FRAME("ZNPList_ZPP_Body","setbegin","ZNPList_ZPP_Body.setbegin","zpp_nape/util/Lists.hx",1439)
		HX_STACK_THIS(this)
		HX_STACK_ARG(i,"i")
		HX_STACK_LINE(1440)
		this->head = i;
...
::zpp_nape::util::ZNPNode_ZPP_Body ZNPList_ZPP_Body_obj::begin( ){
	HX_STACK_FRAME("ZNPList_ZPP_Body","begin","ZNPList_ZPP_Body.begin","zpp_nape/util/Lists.hx",1432)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1432)
	return this->head;
}
