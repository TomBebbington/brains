...
{
HX_STACK_FRAME("ZNPNode_ZPP_SimplifyP","new","ZNPNode_ZPP_SimplifyP.new","zpp_nape/util/Lists.hx",15545)
{
	HX_STACK_LINE(15579)
	this->elt = null();
	HX_STACK_LINE(15570)
...
::zpp_nape::geom::ZPP_SimplifyP ZNPNode_ZPP_SimplifyP_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_SimplifyP","elem","ZNPNode_ZPP_SimplifyP.elem","zpp_nape/util/Lists.hx",15584)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15584)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_SimplifyP","free","ZNPNode_ZPP_SimplifyP.free","zpp_nape/util/Lists.hx",15577)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15577)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_SimplifyP","alloc","ZNPNode_ZPP_SimplifyP.alloc","zpp_nape/util/Lists.hx",15573)
		HX_STACK_THIS(this)
	}
return null();
}
