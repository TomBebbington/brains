...
{
HX_STACK_FRAME("ZNPNode_ZPP_Compound","new","ZNPNode_ZPP_Compound.new","zpp_nape/util/Lists.hx",14986)
{
	HX_STACK_LINE(15020)
	this->elt = null();
	HX_STACK_LINE(15011)
...
::zpp_nape::phys::ZPP_Compound ZNPNode_ZPP_Compound_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_Compound","elem","ZNPNode_ZPP_Compound.elem","zpp_nape/util/Lists.hx",15025)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15025)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Compound","free","ZNPNode_ZPP_Compound.free","zpp_nape/util/Lists.hx",15018)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15018)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Compound","alloc","ZNPNode_ZPP_Compound.alloc","zpp_nape/util/Lists.hx",15014)
		HX_STACK_THIS(this)
	}
return null();
}
