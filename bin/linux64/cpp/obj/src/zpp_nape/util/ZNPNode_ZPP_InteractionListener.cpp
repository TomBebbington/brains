...
{
HX_STACK_FRAME("ZNPNode_ZPP_InteractionListener","new","ZNPNode_ZPP_InteractionListener.new","zpp_nape/util/Lists.hx",15029)
{
	HX_STACK_LINE(15063)
	this->elt = null();
	HX_STACK_LINE(15054)
...
::zpp_nape::callbacks::ZPP_InteractionListener ZNPNode_ZPP_InteractionListener_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_InteractionListener","elem","ZNPNode_ZPP_InteractionListener.elem","zpp_nape/util/Lists.hx",15068)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15068)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_InteractionListener","free","ZNPNode_ZPP_InteractionListener.free","zpp_nape/util/Lists.hx",15061)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15061)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_InteractionListener","alloc","ZNPNode_ZPP_InteractionListener.alloc","zpp_nape/util/Lists.hx",15057)
		HX_STACK_THIS(this)
	}
return null();
}
