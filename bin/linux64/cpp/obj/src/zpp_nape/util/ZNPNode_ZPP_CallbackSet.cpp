...
{
HX_STACK_FRAME("ZNPNode_ZPP_CallbackSet","new","ZNPNode_ZPP_CallbackSet.new","zpp_nape/util/Lists.hx",14814)
{
	HX_STACK_LINE(14848)
	this->elt = null();
	HX_STACK_LINE(14839)
...
::zpp_nape::space::ZPP_CallbackSet ZNPNode_ZPP_CallbackSet_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_CallbackSet","elem","ZNPNode_ZPP_CallbackSet.elem","zpp_nape/util/Lists.hx",14853)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14853)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CallbackSet","free","ZNPNode_ZPP_CallbackSet.free","zpp_nape/util/Lists.hx",14846)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14846)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CallbackSet","alloc","ZNPNode_ZPP_CallbackSet.alloc","zpp_nape/util/Lists.hx",14842)
		HX_STACK_THIS(this)
	}
return null();
}
