...
{
HX_STACK_FRAME("ZNPNode_ZPP_PartitionVertex","new","ZNPNode_ZPP_PartitionVertex.new","zpp_nape/util/Lists.hx",15416)
{
	HX_STACK_LINE(15450)
	this->elt = null();
	HX_STACK_LINE(15441)
...
::zpp_nape::geom::ZPP_PartitionVertex ZNPNode_ZPP_PartitionVertex_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_PartitionVertex","elem","ZNPNode_ZPP_PartitionVertex.elem","zpp_nape/util/Lists.hx",15455)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15455)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_PartitionVertex","free","ZNPNode_ZPP_PartitionVertex.free","zpp_nape/util/Lists.hx",15448)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15448)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_PartitionVertex","alloc","ZNPNode_ZPP_PartitionVertex.alloc","zpp_nape/util/Lists.hx",15444)
		HX_STACK_THIS(this)
	}
return null();
}
