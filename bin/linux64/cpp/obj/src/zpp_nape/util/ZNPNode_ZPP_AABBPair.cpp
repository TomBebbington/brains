...
{
HX_STACK_FRAME("ZNPNode_ZPP_AABBPair","new","ZNPNode_ZPP_AABBPair.new","zpp_nape/util/Lists.hx",15674)
{
	HX_STACK_LINE(15708)
	this->elt = null();
	HX_STACK_LINE(15699)
...
::zpp_nape::space::ZPP_AABBPair ZNPNode_ZPP_AABBPair_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_AABBPair","elem","ZNPNode_ZPP_AABBPair.elem","zpp_nape/util/Lists.hx",15713)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15713)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_AABBPair","free","ZNPNode_ZPP_AABBPair.free","zpp_nape/util/Lists.hx",15706)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15706)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_AABBPair","alloc","ZNPNode_ZPP_AABBPair.alloc","zpp_nape/util/Lists.hx",15702)
		HX_STACK_THIS(this)
	}
return null();
}
