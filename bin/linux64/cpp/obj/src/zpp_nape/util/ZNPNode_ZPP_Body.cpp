...
{
HX_STACK_FRAME("ZNPNode_ZPP_Body","new","ZNPNode_ZPP_Body.new","zpp_nape/util/Lists.hx",14900)
{
	HX_STACK_LINE(14934)
	this->elt = null();
	HX_STACK_LINE(14925)
...
::zpp_nape::phys::ZPP_Body ZNPNode_ZPP_Body_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_Body","elem","ZNPNode_ZPP_Body.elem","zpp_nape/util/Lists.hx",14939)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14939)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Body","free","ZNPNode_ZPP_Body.free","zpp_nape/util/Lists.hx",14932)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14932)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Body","alloc","ZNPNode_ZPP_Body.alloc","zpp_nape/util/Lists.hx",14928)
		HX_STACK_THIS(this)
	}
return null();
}
