...
{
HX_STACK_FRAME("ZPP_Debug","new","ZPP_Debug.new","zpp_nape/util/Debug.hx",174)
...
{
		HX_STACK_FRAME("ZPP_Debug","sup_setbg","ZPP_Debug.sup_setbg","zpp_nape/util/Debug.hx",422)
		HX_STACK_THIS(this)
...
bool ZPP_Debug_obj::cull( ::zpp_nape::geom::ZPP_AABB aabb){
	HX_STACK_FRAME("ZPP_Debug","cull","ZPP_Debug.cull","zpp_nape/util/Debug.hx",271)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_Debug","setform","ZPP_Debug.setform","zpp_nape/util/Debug.hx",265)
		HX_STACK_THIS(this)
		HX_STACK_LINE(266)
...
{
		HX_STACK_FRAME("ZPP_Debug","xform_invalidate","ZPP_Debug.xform_invalidate","zpp_nape/util/Debug.hx",201)
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static Float Block( ::zpp_nape::util::ZPP_Debug_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/util/Debug.hx",202)
				{
					HX_STACK_LINE(203)
		...
		HX_STACK_LINE(202)
		this->xdet = ::Math_obj::sqrt(_Function_1_1::Block(this));
		HX_STACK_LINE(206)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/util/Debug.hx",208)
						{
							HX_STACK_LINE(208)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(208)
			...
			HX_STACK_LINE(251)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &q){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/util/Debug.hx",251)
						{
							HX_STACK_LINE(251)
							if (((bool((q != null())) && bool(q->zpp_disp)))){
								HX_STACK_LINE(251)
		...
		HX_STACK_LINE(255)
		{
			...
			HX_STACK_LINE(255)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &q){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/util/Debug.hx",255)
						{
							HX_STACK_LINE(255)
							if (((bool((q != null())) && bool(q->zpp_disp)))){
								HX_STACK_LINE(255)
		...
		HX_STACK_LINE(259)
		{
			HX_STACK_LINE(259)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &q){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/util/Debug.hx",259)
						{
							HX_STACK_LINE(259)
							if (((bool((q != null())) && bool(q->zpp_disp)))){
								HX_STACK_LINE(259)
