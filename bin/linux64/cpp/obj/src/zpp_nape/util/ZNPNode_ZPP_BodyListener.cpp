...
{
HX_STACK_FRAME("ZNPNode_ZPP_BodyListener","new","ZNPNode_ZPP_BodyListener.new","zpp_nape/util/Lists.hx",15201)
{
	HX_STACK_LINE(15235)
	this->elt = null();
	HX_STACK_LINE(15226)
...
::zpp_nape::callbacks::ZPP_BodyListener ZNPNode_ZPP_BodyListener_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_BodyListener","elem","ZNPNode_ZPP_BodyListener.elem","zpp_nape/util/Lists.hx",15240)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15240)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_BodyListener","free","ZNPNode_ZPP_BodyListener.free","zpp_nape/util/Lists.hx",15233)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15233)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_BodyListener","alloc","ZNPNode_ZPP_BodyListener.alloc","zpp_nape/util/Lists.hx",15229)
		HX_STACK_THIS(this)
	}
return null();
}
