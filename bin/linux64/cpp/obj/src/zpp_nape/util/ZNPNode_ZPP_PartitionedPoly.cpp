...
{
HX_STACK_FRAME("ZNPNode_ZPP_PartitionedPoly","new","ZNPNode_ZPP_PartitionedPoly.new","zpp_nape/util/Lists.hx",15459)
{
	HX_STACK_LINE(15493)
	this->elt = null();
	HX_STACK_LINE(15484)
...
::zpp_nape::geom::ZPP_PartitionedPoly ZNPNode_ZPP_PartitionedPoly_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_PartitionedPoly","elem","ZNPNode_ZPP_PartitionedPoly.elem","zpp_nape/util/Lists.hx",15498)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15498)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_PartitionedPoly","free","ZNPNode_ZPP_PartitionedPoly.free","zpp_nape/util/Lists.hx",15491)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15491)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_PartitionedPoly","alloc","ZNPNode_ZPP_PartitionedPoly.alloc","zpp_nape/util/Lists.hx",15487)
		HX_STACK_THIS(this)
	}
return null();
}
