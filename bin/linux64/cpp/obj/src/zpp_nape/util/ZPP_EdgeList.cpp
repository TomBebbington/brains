...
{
HX_STACK_FRAME("ZPP_EdgeList","new","ZPP_EdgeList.new","zpp_nape/util/Lists.hx",17115)
{
	HX_STACK_LINE(17170)
...
{
		HX_STACK_FRAME("ZPP_EdgeList","invalidate","ZPP_EdgeList.invalidate","zpp_nape/util/Lists.hx",17162)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17163)
		this->_invalidated = true;
		HX_STACK_LINE(17164)
...
{
		HX_STACK_FRAME("ZPP_EdgeList","validate","ZPP_EdgeList.validate","zpp_nape/util/Lists.hx",17157)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17157)
...
{
		HX_STACK_FRAME("ZPP_EdgeList","modify_test","ZPP_EdgeList.modify_test","zpp_nape/util/Lists.hx",17153)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17153)
...
{
		HX_STACK_FRAME("ZPP_EdgeList","modified","ZPP_EdgeList.modified","zpp_nape/util/Lists.hx",17146)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17147)
...
{
		HX_STACK_FRAME("ZPP_EdgeList","valmod","ZPP_EdgeList.valmod","zpp_nape/util/Lists.hx",17136)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17137)
		this->validate();
		HX_STACK_LINE(17138)
...
bool imm = __o_imm.Default(false);
	HX_STACK_FRAME("ZPP_EdgeList","get","ZPP_EdgeList.get","zpp_nape/util/Lists.hx",17129)
