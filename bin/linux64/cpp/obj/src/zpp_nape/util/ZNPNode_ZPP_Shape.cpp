...
{
HX_STACK_FRAME("ZNPNode_ZPP_Shape","new","ZNPNode_ZPP_Shape.new","zpp_nape/util/Lists.hx",14857)
{
	HX_STACK_LINE(14891)
	this->elt = null();
	HX_STACK_LINE(14882)
...
::zpp_nape::shape::ZPP_Shape ZNPNode_ZPP_Shape_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_Shape","elem","ZNPNode_ZPP_Shape.elem","zpp_nape/util/Lists.hx",14896)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14896)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Shape","free","ZNPNode_ZPP_Shape.free","zpp_nape/util/Lists.hx",14889)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14889)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Shape","alloc","ZNPNode_ZPP_Shape.alloc","zpp_nape/util/Lists.hx",14885)
		HX_STACK_THIS(this)
	}
return null();
}
