...
{
HX_STACK_FRAME("ZNPNode_ZPP_SimpleEvent","new","ZNPNode_ZPP_SimpleEvent.new","zpp_nape/util/Lists.hx",15631)
{
	HX_STACK_LINE(15665)
	this->elt = null();
	HX_STACK_LINE(15656)
...
::zpp_nape::geom::ZPP_SimpleEvent ZNPNode_ZPP_SimpleEvent_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_SimpleEvent","elem","ZNPNode_ZPP_SimpleEvent.elem","zpp_nape/util/Lists.hx",15670)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15670)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_SimpleEvent","free","ZNPNode_ZPP_SimpleEvent.free","zpp_nape/util/Lists.hx",15663)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15663)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_SimpleEvent","alloc","ZNPNode_ZPP_SimpleEvent.alloc","zpp_nape/util/Lists.hx",15659)
		HX_STACK_THIS(this)
	}
return null();
}
