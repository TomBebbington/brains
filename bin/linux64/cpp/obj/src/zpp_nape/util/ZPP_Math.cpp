...
Float ZPP_Math_obj::sqrt( Float x){
	HX_STACK_FRAME("ZPP_Math","sqrt","ZPP_Math.sqrt","zpp_nape/util/Math.hx",189)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(189)
...
Float ZPP_Math_obj::invsqrt( Float x){
	HX_STACK_FRAME("ZPP_Math","invsqrt","ZPP_Math.invsqrt","zpp_nape/util/Math.hx",206)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(206)
...
Float ZPP_Math_obj::sqr( Float x){
	HX_STACK_FRAME("ZPP_Math","sqr","ZPP_Math.sqr","zpp_nape/util/Math.hx",219)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(219)
	return (x * x);
}
...
Float ZPP_Math_obj::clamp2( Float x,Float a){
	HX_STACK_FRAME("ZPP_Math","clamp2","ZPP_Math.clamp2","zpp_nape/util/Math.hx",231)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(231)
...
Float ZPP_Math_obj::clamp( Float x,Float a,Float b){
	HX_STACK_FRAME("ZPP_Math","clamp","ZPP_Math.clamp","zpp_nape/util/Math.hx",243)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(243)
