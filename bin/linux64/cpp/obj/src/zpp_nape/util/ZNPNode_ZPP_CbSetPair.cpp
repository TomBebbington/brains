...
{
HX_STACK_FRAME("ZNPNode_ZPP_CbSetPair","new","ZNPNode_ZPP_CbSetPair.new","zpp_nape/util/Lists.hx",15287)
{
	HX_STACK_LINE(15321)
	this->elt = null();
	HX_STACK_LINE(15312)
...
::zpp_nape::callbacks::ZPP_CbSetPair ZNPNode_ZPP_CbSetPair_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_CbSetPair","elem","ZNPNode_ZPP_CbSetPair.elem","zpp_nape/util/Lists.hx",15326)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15326)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CbSetPair","free","ZNPNode_ZPP_CbSetPair.free","zpp_nape/util/Lists.hx",15319)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15319)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CbSetPair","alloc","ZNPNode_ZPP_CbSetPair.alloc","zpp_nape/util/Lists.hx",15315)
		HX_STACK_THIS(this)
	}
return null();
}
