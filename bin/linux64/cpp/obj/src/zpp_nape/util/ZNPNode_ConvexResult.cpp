...
{
HX_STACK_FRAME("ZNPNode_ConvexResult","new","ZNPNode_ConvexResult.new","zpp_nape/util/Lists.hx",16147)
{
	HX_STACK_LINE(16181)
	this->elt = null();
	HX_STACK_LINE(16172)
...
::nape::geom::ConvexResult ZNPNode_ConvexResult_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ConvexResult","elem","ZNPNode_ConvexResult.elem","zpp_nape/util/Lists.hx",16186)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16186)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ConvexResult","free","ZNPNode_ConvexResult.free","zpp_nape/util/Lists.hx",16179)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16179)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ConvexResult","alloc","ZNPNode_ConvexResult.alloc","zpp_nape/util/Lists.hx",16175)
		HX_STACK_THIS(this)
	}
return null();
}
