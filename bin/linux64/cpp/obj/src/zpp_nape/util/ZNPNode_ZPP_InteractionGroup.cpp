...
{
HX_STACK_FRAME("ZNPNode_ZPP_InteractionGroup","new","ZNPNode_ZPP_InteractionGroup.new","zpp_nape/util/Lists.hx",15889)
{
	HX_STACK_LINE(15923)
	this->elt = null();
	HX_STACK_LINE(15914)
...
::zpp_nape::dynamics::ZPP_InteractionGroup ZNPNode_ZPP_InteractionGroup_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_InteractionGroup","elem","ZNPNode_ZPP_InteractionGroup.elem","zpp_nape/util/Lists.hx",15928)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15928)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_InteractionGroup","free","ZNPNode_ZPP_InteractionGroup.free","zpp_nape/util/Lists.hx",15921)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15921)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_InteractionGroup","alloc","ZNPNode_ZPP_InteractionGroup.alloc","zpp_nape/util/Lists.hx",15917)
		HX_STACK_THIS(this)
	}
return null();
}
