...
{
HX_STACK_FRAME("ZNPNode_ZPP_CutInt","new","ZNPNode_ZPP_CutInt.new","zpp_nape/util/Lists.hx",15330)
{
	HX_STACK_LINE(15364)
	this->elt = null();
	HX_STACK_LINE(15355)
...
::zpp_nape::geom::ZPP_CutInt ZNPNode_ZPP_CutInt_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_CutInt","elem","ZNPNode_ZPP_CutInt.elem","zpp_nape/util/Lists.hx",15369)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15369)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CutInt","free","ZNPNode_ZPP_CutInt.free","zpp_nape/util/Lists.hx",15362)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15362)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CutInt","alloc","ZNPNode_ZPP_CutInt.alloc","zpp_nape/util/Lists.hx",15358)
		HX_STACK_THIS(this)
	}
return null();
}
