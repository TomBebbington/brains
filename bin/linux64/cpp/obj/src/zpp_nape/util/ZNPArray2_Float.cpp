...
{
HX_STACK_FRAME("ZNPArray2_Float","new","ZNPArray2_Float.new","zpp_nape/util/Array2.hx",175)
...
Float ZNPArray2_Float_obj::set( int x,int y,Float obj){
	HX_STACK_FRAME("ZNPArray2_Float","set","ZNPArray2_Float.set","zpp_nape/util/Array2.hx",231)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
...
Float ZNPArray2_Float_obj::get( int x,int y){
	HX_STACK_FRAME("ZNPArray2_Float","get","ZNPArray2_Float.get","zpp_nape/util/Array2.hx",218)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(218)
...
{
		HX_STACK_FRAME("ZNPArray2_Float","resize","ZNPArray2_Float.resize","zpp_nape/util/Array2.hx",191)
		HX_STACK_THIS(this)
		HX_STACK_ARG(width,"width")
		HX_STACK_ARG(height,"height")
