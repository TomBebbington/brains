...
{
HX_STACK_FRAME("ZNPNode_ZPP_Edge","new","ZNPNode_ZPP_Edge.new","zpp_nape/util/Lists.hx",15717)
{
	HX_STACK_LINE(15751)
	this->elt = null();
	HX_STACK_LINE(15742)
...
::zpp_nape::shape::ZPP_Edge ZNPNode_ZPP_Edge_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_Edge","elem","ZNPNode_ZPP_Edge.elem","zpp_nape/util/Lists.hx",15756)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15756)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Edge","free","ZNPNode_ZPP_Edge.free","zpp_nape/util/Lists.hx",15749)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15749)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Edge","alloc","ZNPNode_ZPP_Edge.alloc","zpp_nape/util/Lists.hx",15745)
		HX_STACK_THIS(this)
	}
return null();
}
