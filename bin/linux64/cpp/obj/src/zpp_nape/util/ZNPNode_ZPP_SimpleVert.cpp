...
{
HX_STACK_FRAME("ZNPNode_ZPP_SimpleVert","new","ZNPNode_ZPP_SimpleVert.new","zpp_nape/util/Lists.hx",15588)
{
	HX_STACK_LINE(15622)
	this->elt = null();
	HX_STACK_LINE(15613)
...
::zpp_nape::geom::ZPP_SimpleVert ZNPNode_ZPP_SimpleVert_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_SimpleVert","elem","ZNPNode_ZPP_SimpleVert.elem","zpp_nape/util/Lists.hx",15627)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15627)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_SimpleVert","free","ZNPNode_ZPP_SimpleVert.free","zpp_nape/util/Lists.hx",15620)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15620)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_SimpleVert","alloc","ZNPNode_ZPP_SimpleVert.alloc","zpp_nape/util/Lists.hx",15616)
		HX_STACK_THIS(this)
	}
return null();
}
