...
{
HX_STACK_FRAME("ZNPNode_ZPP_ConstraintListener","new","ZNPNode_ZPP_ConstraintListener.new","zpp_nape/util/Lists.hx",15244)
{
	HX_STACK_LINE(15278)
	this->elt = null();
	HX_STACK_LINE(15269)
...
::zpp_nape::callbacks::ZPP_ConstraintListener ZNPNode_ZPP_ConstraintListener_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_ConstraintListener","elem","ZNPNode_ZPP_ConstraintListener.elem","zpp_nape/util/Lists.hx",15283)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15283)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_ConstraintListener","free","ZNPNode_ZPP_ConstraintListener.free","zpp_nape/util/Lists.hx",15276)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15276)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_ConstraintListener","alloc","ZNPNode_ZPP_ConstraintListener.alloc","zpp_nape/util/Lists.hx",15272)
		HX_STACK_THIS(this)
	}
return null();
}
