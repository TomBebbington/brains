...
{
HX_STACK_FRAME("ZNPNode_ZPP_GeomVert","new","ZNPNode_ZPP_GeomVert.new","zpp_nape/util/Lists.hx",15502)
{
	HX_STACK_LINE(15536)
	this->elt = null();
	HX_STACK_LINE(15527)
...
::zpp_nape::geom::ZPP_GeomVert ZNPNode_ZPP_GeomVert_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_GeomVert","elem","ZNPNode_ZPP_GeomVert.elem","zpp_nape/util/Lists.hx",15541)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15541)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_GeomVert","free","ZNPNode_ZPP_GeomVert.free","zpp_nape/util/Lists.hx",15534)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15534)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_GeomVert","alloc","ZNPNode_ZPP_GeomVert.alloc","zpp_nape/util/Lists.hx",15530)
		HX_STACK_THIS(this)
	}
return null();
}
