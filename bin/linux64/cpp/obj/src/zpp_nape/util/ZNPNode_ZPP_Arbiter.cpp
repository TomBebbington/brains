...
{
HX_STACK_FRAME("ZNPNode_ZPP_Arbiter","new","ZNPNode_ZPP_Arbiter.new","zpp_nape/util/Lists.hx",15158)
{
	HX_STACK_LINE(15192)
	this->elt = null();
	HX_STACK_LINE(15183)
...
::zpp_nape::dynamics::ZPP_Arbiter ZNPNode_ZPP_Arbiter_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_Arbiter","elem","ZNPNode_ZPP_Arbiter.elem","zpp_nape/util/Lists.hx",15197)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15197)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Arbiter","free","ZNPNode_ZPP_Arbiter.free","zpp_nape/util/Lists.hx",15190)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15190)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Arbiter","alloc","ZNPNode_ZPP_Arbiter.alloc","zpp_nape/util/Lists.hx",15186)
		HX_STACK_THIS(this)
	}
return null();
}
