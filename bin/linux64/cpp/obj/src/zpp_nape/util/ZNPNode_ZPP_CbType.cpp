...
{
HX_STACK_FRAME("ZNPNode_ZPP_CbType","new","ZNPNode_ZPP_CbType.new","zpp_nape/util/Lists.hx",14771)
{
	HX_STACK_LINE(14805)
	this->elt = null();
	HX_STACK_LINE(14796)
...
::zpp_nape::callbacks::ZPP_CbType ZNPNode_ZPP_CbType_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_CbType","elem","ZNPNode_ZPP_CbType.elem","zpp_nape/util/Lists.hx",14810)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14810)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CbType","free","ZNPNode_ZPP_CbType.free","zpp_nape/util/Lists.hx",14803)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14803)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CbType","alloc","ZNPNode_ZPP_CbType.alloc","zpp_nape/util/Lists.hx",14799)
		HX_STACK_THIS(this)
	}
return null();
}
