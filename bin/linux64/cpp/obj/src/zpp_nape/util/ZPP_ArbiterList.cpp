...
{
HX_STACK_FRAME("ZPP_ArbiterList","new","ZPP_ArbiterList.new","zpp_nape/util/Lists.hx",17301)
{
	HX_STACK_LINE(17356)
...
{
		HX_STACK_FRAME("ZPP_ArbiterList","invalidate","ZPP_ArbiterList.invalidate","zpp_nape/util/Lists.hx",17348)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17349)
		this->_invalidated = true;
		HX_STACK_LINE(17350)
...
{
		HX_STACK_FRAME("ZPP_ArbiterList","validate","ZPP_ArbiterList.validate","zpp_nape/util/Lists.hx",17343)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17343)
...
{
		HX_STACK_FRAME("ZPP_ArbiterList","modify_test","ZPP_ArbiterList.modify_test","zpp_nape/util/Lists.hx",17339)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17339)
...
{
		HX_STACK_FRAME("ZPP_ArbiterList","modified","ZPP_ArbiterList.modified","zpp_nape/util/Lists.hx",17332)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17333)
...
{
		HX_STACK_FRAME("ZPP_ArbiterList","valmod","ZPP_ArbiterList.valmod","zpp_nape/util/Lists.hx",17322)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17323)
		this->validate();
		HX_STACK_LINE(17324)
...
bool imm = __o_imm.Default(false);
	HX_STACK_FRAME("ZPP_ArbiterList","get","ZPP_ArbiterList.get","zpp_nape/util/Lists.hx",17315)
