...
{
HX_STACK_FRAME("ZNPNode_ZPP_GeomPoly","new","ZNPNode_ZPP_GeomPoly.new","zpp_nape/util/Lists.hx",16190)
{
	HX_STACK_LINE(16224)
	this->elt = null();
	HX_STACK_LINE(16215)
...
::zpp_nape::geom::ZPP_GeomPoly ZNPNode_ZPP_GeomPoly_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_GeomPoly","elem","ZNPNode_ZPP_GeomPoly.elem","zpp_nape/util/Lists.hx",16229)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16229)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_GeomPoly","free","ZNPNode_ZPP_GeomPoly.free","zpp_nape/util/Lists.hx",16222)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16222)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_GeomPoly","alloc","ZNPNode_ZPP_GeomPoly.alloc","zpp_nape/util/Lists.hx",16218)
		HX_STACK_THIS(this)
	}
return null();
}
