...
{
HX_STACK_FRAME("ZNPArray2_ZPP_MarchPair","new","ZNPArray2_ZPP_MarchPair.new","zpp_nape/util/Array2.hx",295)
...
::zpp_nape::geom::ZPP_MarchPair ZNPArray2_ZPP_MarchPair_obj::set( int x,int y,::zpp_nape::geom::ZPP_MarchPair obj){
	HX_STACK_FRAME("ZNPArray2_ZPP_MarchPair","set","ZNPArray2_ZPP_MarchPair.set","zpp_nape/util/Array2.hx",351)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
...
::zpp_nape::geom::ZPP_MarchPair ZNPArray2_ZPP_MarchPair_obj::get( int x,int y){
	HX_STACK_FRAME("ZNPArray2_ZPP_MarchPair","get","ZNPArray2_ZPP_MarchPair.get","zpp_nape/util/Array2.hx",338)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(338)
...
{
		HX_STACK_FRAME("ZNPArray2_ZPP_MarchPair","resize","ZNPArray2_ZPP_MarchPair.resize","zpp_nape/util/Array2.hx",311)
		HX_STACK_THIS(this)
		HX_STACK_ARG(width,"width")
		HX_STACK_ARG(height,"height")
