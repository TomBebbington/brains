...
{
HX_STACK_FRAME("ZPP_BodyList","new","ZPP_BodyList.new","zpp_nape/util/Lists.hx",16557)
{
	HX_STACK_LINE(16612)
...
{
		HX_STACK_FRAME("ZPP_BodyList","invalidate","ZPP_BodyList.invalidate","zpp_nape/util/Lists.hx",16604)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16605)
		this->_invalidated = true;
		HX_STACK_LINE(16606)
...
{
		HX_STACK_FRAME("ZPP_BodyList","validate","ZPP_BodyList.validate","zpp_nape/util/Lists.hx",16599)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16599)
...
{
		HX_STACK_FRAME("ZPP_BodyList","modify_test","ZPP_BodyList.modify_test","zpp_nape/util/Lists.hx",16595)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16595)
...
{
		HX_STACK_FRAME("ZPP_BodyList","modified","ZPP_BodyList.modified","zpp_nape/util/Lists.hx",16588)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16589)
...
{
		HX_STACK_FRAME("ZPP_BodyList","valmod","ZPP_BodyList.valmod","zpp_nape/util/Lists.hx",16578)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16579)
		this->validate();
		HX_STACK_LINE(16580)
...
bool imm = __o_imm.Default(false);
	HX_STACK_FRAME("ZPP_BodyList","get","ZPP_BodyList.get","zpp_nape/util/Lists.hx",16571)
