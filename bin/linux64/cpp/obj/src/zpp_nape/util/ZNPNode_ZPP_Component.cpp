...
{
HX_STACK_FRAME("ZNPNode_ZPP_Component","new","ZNPNode_ZPP_Component.new","zpp_nape/util/Lists.hx",15803)
{
	HX_STACK_LINE(15837)
	this->elt = null();
	HX_STACK_LINE(15828)
...
::zpp_nape::space::ZPP_Component ZNPNode_ZPP_Component_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_Component","elem","ZNPNode_ZPP_Component.elem","zpp_nape/util/Lists.hx",15842)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15842)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Component","free","ZNPNode_ZPP_Component.free","zpp_nape/util/Lists.hx",15835)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15835)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Component","alloc","ZNPNode_ZPP_Component.alloc","zpp_nape/util/Lists.hx",15831)
		HX_STACK_THIS(this)
	}
return null();
}
