...
{
HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","new","FastHash2_Hashable2_Boolfalse.new","zpp_nape/util/FastHash.hx",256)
{
	HX_STACK_LINE(258)
	this->cnt = (int)0;
	HX_STACK_LINE(257)
...
int FastHash2_Hashable2_Boolfalse_obj::hash( int id,int di){
	HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","hash","FastHash2_Hashable2_Boolfalse.hash","zpp_nape/util/FastHash.hx",417)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(417)
...
{
		HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","remove","FastHash2_Hashable2_Boolfalse.remove","zpp_nape/util/FastHash.hx",382)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","add","FastHash2_Hashable2_Boolfalse.add","zpp_nape/util/FastHash.hx",350)
		HX_STACK_THIS(this)
		HX_STACK_ARG(arb,"arb")
		HX_STACK_LINE(359)
		int h = (int(((arb->id * (int)106039) + arb->di)) & int((int)1048575));		HX_STACK_VAR(h,"h");
...
{
		HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","maybeAdd","FastHash2_Hashable2_Boolfalse.maybeAdd","zpp_nape/util/FastHash.hx",316)
		HX_STACK_THIS(this)
		HX_STACK_ARG(arb,"arb")
		HX_STACK_LINE(325)
		int h = (int(((arb->id * (int)106039) + arb->di)) & int((int)1048575));		HX_STACK_VAR(h,"h");
...
bool FastHash2_Hashable2_Boolfalse_obj::has( int id,int di){
	HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","has","FastHash2_Hashable2_Boolfalse.has","zpp_nape/util/FastHash.hx",307)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(308)
...
::zpp_nape::util::Hashable2_Boolfalse FastHash2_Hashable2_Boolfalse_obj::ordered_get( int id,int di){
	HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","ordered_get","FastHash2_Hashable2_Boolfalse.ordered_get","zpp_nape/util/FastHash.hx",299)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(300)
...
::zpp_nape::util::Hashable2_Boolfalse FastHash2_Hashable2_Boolfalse_obj::get( int id,int di){
	HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","get","FastHash2_Hashable2_Boolfalse.get","zpp_nape/util/FastHash.hx",288)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(289)
...
{
		HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","clear","FastHash2_Hashable2_Boolfalse.clear","zpp_nape/util/FastHash.hx",273)
		HX_STACK_THIS(this)
		HX_STACK_LINE(273)
		int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(273)
...
bool FastHash2_Hashable2_Boolfalse_obj::empty( ){
	HX_STACK_FRAME("FastHash2_Hashable2_Boolfalse","empty","FastHash2_Hashable2_Boolfalse.empty","zpp_nape/util/FastHash.hx",269)
	HX_STACK_THIS(this)
	HX_STACK_LINE(269)
