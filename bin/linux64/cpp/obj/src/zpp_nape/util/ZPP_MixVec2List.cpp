...
{
HX_STACK_FRAME("ZPP_MixVec2List","new","ZPP_MixVec2List.new","zpp_nape/util/Lists.hx",16277)
{
	HX_STACK_LINE(16282)
	this->at_index = (int)0;
	HX_STACK_LINE(16281)
...
{
		HX_STACK_FRAME("ZPP_MixVec2List","clear","ZPP_MixVec2List.clear","zpp_nape/util/Lists.hx",16481)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16483)
...
bool ZPP_MixVec2List_obj::remove( ::nape::geom::Vec2 obj){
	HX_STACK_FRAME("ZPP_MixVec2List","remove","ZPP_MixVec2List.remove","zpp_nape/util/Lists.hx",16450)
	HX_STACK_THIS(this)
...
::nape::geom::Vec2 ZPP_MixVec2List_obj::shift( ){
	HX_STACK_FRAME("ZPP_MixVec2List","shift","ZPP_MixVec2List.shift","zpp_nape/util/Lists.hx",16421)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16423)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(16423)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		if (((this->zpp_gl() == (int)1))){
			...
			HX_STACK_LINE(16433)
			ite = this->inner->iterator_at((this->zpp_gl() - (int)2));
		}
		HX_STACK_LINE(16434)
		if (((ite == null()))){
			HX_STACK_LINE(16434)
...
::nape::geom::Vec2 ZPP_MixVec2List_obj::pop( ){
	HX_STACK_FRAME("ZPP_MixVec2List","pop","ZPP_MixVec2List.pop","zpp_nape/util/Lists.hx",16392)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16394)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(16394)
...
bool ZPP_MixVec2List_obj::unshift( ::nape::geom::Vec2 obj){
	HX_STACK_FRAME("ZPP_MixVec2List","unshift","ZPP_MixVec2List.unshift","zpp_nape/util/Lists.hx",16370)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(16372)
	if ((this->zpp_inner->immutable)){
	...
	if ((obj->zpp_inner->_inuse)){
		HX_STACK_LINE(16377)
		HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Vec2")) + HX_CSTRING(" is already in use")));
	}
	HX_STACK_LINE(16379)
...
bool ZPP_MixVec2List_obj::push( ::nape::geom::Vec2 obj){
	HX_STACK_FRAME("ZPP_MixVec2List","push","ZPP_MixVec2List.push","zpp_nape/util/Lists.hx",16348)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(16350)
	if ((this->zpp_inner->immutable)){
...
::nape::geom::Vec2 ZPP_MixVec2List_obj::at( int index){
	HX_STACK_FRAME("ZPP_MixVec2List","at","ZPP_MixVec2List.at","zpp_nape/util/Lists.hx",16321)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_MixVec2List","zpp_vm","ZPP_MixVec2List.zpp_vm","zpp_nape/util/Lists.hx",16312)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16313)
...
int ZPP_MixVec2List_obj::zpp_gl( ){
	HX_STACK_FRAME("ZPP_MixVec2List","zpp_gl","ZPP_MixVec2List.zpp_gl","zpp_nape/util/Lists.hx",16296)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16297)
	this->zpp_vm();
	HX_STACK_LINE(16298)
...
bool immutable = __o_immutable.Default(false);
	HX_STACK_FRAME("ZPP_MixVec2List","get","ZPP_MixVec2List.get","zpp_nape/util/Lists.hx",16283)
