...
{
HX_STACK_FRAME("ZNPNode_RayResult","new","ZNPNode_RayResult.new","zpp_nape/util/Lists.hx",16233)
{
	HX_STACK_LINE(16267)
	this->elt = null();
	HX_STACK_LINE(16258)
...
::nape::geom::RayResult ZNPNode_RayResult_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_RayResult","elem","ZNPNode_RayResult.elem","zpp_nape/util/Lists.hx",16272)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16272)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_RayResult","free","ZNPNode_RayResult.free","zpp_nape/util/Lists.hx",16265)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16265)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_RayResult","alloc","ZNPNode_RayResult.alloc","zpp_nape/util/Lists.hx",16261)
		HX_STACK_THIS(this)
	}
return null();
}
