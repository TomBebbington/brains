...
{
HX_STACK_FRAME("ZPP_InteractorList","new","ZPP_InteractorList.new","zpp_nape/util/Lists.hx",16619)
{
	HX_STACK_LINE(16674)
...
{
		HX_STACK_FRAME("ZPP_InteractorList","invalidate","ZPP_InteractorList.invalidate","zpp_nape/util/Lists.hx",16666)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16667)
		this->_invalidated = true;
		HX_STACK_LINE(16668)
...
{
		HX_STACK_FRAME("ZPP_InteractorList","validate","ZPP_InteractorList.validate","zpp_nape/util/Lists.hx",16661)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16661)
...
{
		HX_STACK_FRAME("ZPP_InteractorList","modify_test","ZPP_InteractorList.modify_test","zpp_nape/util/Lists.hx",16657)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16657)
...
{
		HX_STACK_FRAME("ZPP_InteractorList","modified","ZPP_InteractorList.modified","zpp_nape/util/Lists.hx",16650)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16651)
...
{
		HX_STACK_FRAME("ZPP_InteractorList","valmod","ZPP_InteractorList.valmod","zpp_nape/util/Lists.hx",16640)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16641)
		this->validate();
		HX_STACK_LINE(16642)
...
bool imm = __o_imm.Default(false);
	HX_STACK_FRAME("ZPP_InteractorList","get","ZPP_InteractorList.get","zpp_nape/util/Lists.hx",16633)
