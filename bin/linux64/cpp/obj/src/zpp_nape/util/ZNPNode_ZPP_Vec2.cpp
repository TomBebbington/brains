...
{
HX_STACK_FRAME("ZNPNode_ZPP_Vec2","new","ZNPNode_ZPP_Vec2.new","zpp_nape/util/Lists.hx",15760)
{
	HX_STACK_LINE(15794)
	this->elt = null();
	HX_STACK_LINE(15785)
...
::zpp_nape::geom::ZPP_Vec2 ZNPNode_ZPP_Vec2_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_Vec2","elem","ZNPNode_ZPP_Vec2.elem","zpp_nape/util/Lists.hx",15799)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15799)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Vec2","free","ZNPNode_ZPP_Vec2.free","zpp_nape/util/Lists.hx",15792)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15792)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Vec2","alloc","ZNPNode_ZPP_Vec2.alloc","zpp_nape/util/Lists.hx",15788)
		HX_STACK_THIS(this)
	}
return null();
}
