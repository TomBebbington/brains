...
{
HX_STACK_FRAME("ZNPList_RayResult","new","ZNPList_RayResult.new","zpp_nape/util/Lists.hx",14353)
{
	HX_STACK_LINE(14363)
	this->length = (int)0;
	HX_STACK_LINE(14362)
...
::nape::geom::RayResult ZNPList_RayResult_obj::at( int ind){
	HX_STACK_FRAME("ZNPList_RayResult","at","ZNPList_RayResult.at","zpp_nape/util/Lists.hx",14756)
	HX_STACK_THIS(this)
...
::zpp_nape::util::ZNPNode_RayResult ZNPList_RayResult_obj::iterator_at( int ind){
	HX_STACK_FRAME("ZNPList_RayResult","iterator_at","ZNPList_RayResult.iterator_at","zpp_nape/util/Lists.hx",14743)
	HX_STACK_THIS(this)
	HX_STACK_ARG(ind,"ind")
	HX_STACK_LINE(14752)
...
::nape::geom::RayResult ZNPList_RayResult_obj::back( ){
	HX_STACK_FRAME("ZNPList_RayResult","back","ZNPList_RayResult.back","zpp_nape/util/Lists.hx",14734)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14735)
	::zpp_nape::util::ZNPNode_RayResult ret = this->head;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(14736)
...
::nape::geom::RayResult ZNPList_RayResult_obj::front( ){
	HX_STACK_FRAME("ZNPList_RayResult","front","ZNPList_RayResult.front","zpp_nape/util/Lists.hx",14732)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14732)
...
bool ZNPList_RayResult_obj::inlined_has( ::nape::geom::RayResult obj){
	HX_STACK_FRAME("ZNPList_RayResult","inlined_has","ZNPList_RayResult.inlined_has","zpp_nape/util/Lists.hx",14701)
	HX_STACK_THIS(this)
...
bool ZNPList_RayResult_obj::has( ::nape::geom::RayResult obj){
	HX_STACK_FRAME("ZNPList_RayResult","has","ZNPList_RayResult.has","zpp_nape/util/Lists.hx",14697)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(14697)
	bool ret;		HX_STACK_VAR(ret,"ret");
...
int ZNPList_RayResult_obj::size( ){
	HX_STACK_FRAME("ZNPList_RayResult","size","ZNPList_RayResult.size","zpp_nape/util/Lists.hx",14694)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14694)
	return this->length;
}
...
bool ZNPList_RayResult_obj::empty( ){
	HX_STACK_FRAME("ZNPList_RayResult","empty","ZNPList_RayResult.empty","zpp_nape/util/Lists.hx",14689)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14689)
...
{
		HX_STACK_FRAME("ZNPList_RayResult","reverse","ZNPList_RayResult.reverse","zpp_nape/util/Lists.hx",14673)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14674)
...
{
		HX_STACK_FRAME("ZNPList_RayResult","inlined_clear","ZNPList_RayResult.inlined_clear","zpp_nape/util/Lists.hx",14668)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14669)
...
{
		HX_STACK_FRAME("ZNPList_RayResult","clear","ZNPList_RayResult.clear","zpp_nape/util/Lists.hx",14663)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14663)
		while((!(((this->head == null()))))){
			HX_STACK_LINE(14663)
...
::zpp_nape::util::ZNPNode_RayResult ZNPList_RayResult_obj::splice( ::zpp_nape::util::ZNPNode_RayResult pre,int n){
	HX_STACK_FRAME("ZNPList_RayResult","splice","ZNPList_RayResult.splice","zpp_nape/util/Lists.hx",14658)
	HX_STACK_THIS(this)
...
::zpp_nape::util::ZNPNode_RayResult ZNPList_RayResult_obj::inlined_erase( ::zpp_nape::util::ZNPNode_RayResult pre){
	HX_STACK_FRAME("ZNPList_RayResult","inlined_erase","ZNPList_RayResult.inlined_erase","zpp_nape/util/Lists.hx",14612)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(14621)
...
::zpp_nape::util::ZNPNode_RayResult ZNPList_RayResult_obj::erase( ::zpp_nape::util::ZNPNode_RayResult pre){
	HX_STACK_FRAME("ZNPList_RayResult","erase","ZNPList_RayResult.erase","zpp_nape/util/Lists.hx",14608)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pre,"pre")
	HX_STACK_LINE(14608)
	::zpp_nape::util::ZNPNode_RayResult old;		HX_STACK_VAR(old,"old");
...
bool ZNPList_RayResult_obj::inlined_try_remove( ::nape::geom::RayResult obj){
	HX_STACK_FRAME("ZNPList_RayResult","inlined_try_remove","ZNPList_RayResult.inlined_try_remove","zpp_nape/util/Lists.hx",14584)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(14593)
	::zpp_nape::util::ZNPNode_RayResult pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZNPList_RayResult","inlined_remove","ZNPList_RayResult.inlined_remove","zpp_nape/util/Lists.hx",14580)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(14580)
		::zpp_nape::util::ZNPNode_RayResult pre = null();		HX_STACK_VAR(pre,"pre");
...
bool ZNPList_RayResult_obj::try_remove( ::nape::geom::RayResult obj){
	HX_STACK_FRAME("ZNPList_RayResult","try_remove","ZNPList_RayResult.try_remove","zpp_nape/util/Lists.hx",14546)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(14555)
	::zpp_nape::util::ZNPNode_RayResult pre = null();		HX_STACK_VAR(pre,"pre");
...
{
		HX_STACK_FRAME("ZNPList_RayResult","remove","ZNPList_RayResult.remove","zpp_nape/util/Lists.hx",14544)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(14544)
		::zpp_nape::util::ZNPNode_RayResult pre = null();		HX_STACK_VAR(pre,"pre");
...
::nape::geom::RayResult ZNPList_RayResult_obj::inlined_pop_unsafe( ){
	HX_STACK_FRAME("ZNPList_RayResult","inlined_pop_unsafe","ZNPList_RayResult.inlined_pop_unsafe","zpp_nape/util/Lists.hx",14522)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14531)
...
::nape::geom::RayResult ZNPList_RayResult_obj::pop_unsafe( ){
	HX_STACK_FRAME("ZNPList_RayResult","pop_unsafe","ZNPList_RayResult.pop_unsafe","zpp_nape/util/Lists.hx",14518)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14518)
	::nape::geom::RayResult ret = this->head->elt;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(14518)
...
{
		HX_STACK_FRAME("ZNPList_RayResult","inlined_pop","ZNPList_RayResult.inlined_pop","zpp_nape/util/Lists.hx",14484)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14493)
		::zpp_nape::util::ZNPNode_RayResult ret = this->head;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(14494)
...
{
		HX_STACK_FRAME("ZNPList_RayResult","pop","ZNPList_RayResult.pop","zpp_nape/util/Lists.hx",14480)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14480)
		::zpp_nape::util::ZNPNode_RayResult ret = this->head;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(14480)
...
::zpp_nape::util::ZNPNode_RayResult ZNPList_RayResult_obj::inlined_insert( ::zpp_nape::util::ZNPNode_RayResult cur,::nape::geom::RayResult o){
	HX_STACK_FRAME("ZNPList_RayResult","inlined_insert","ZNPList_RayResult.inlined_insert","zpp_nape/util/Lists.hx",14436)
	HX_STACK_THIS(this)
...
::zpp_nape::util::ZNPNode_RayResult ZNPList_RayResult_obj::insert( ::zpp_nape::util::ZNPNode_RayResult cur,::nape::geom::RayResult o){
	HX_STACK_FRAME("ZNPList_RayResult","insert","ZNPList_RayResult.insert","zpp_nape/util/Lists.hx",14432)
	HX_STACK_THIS(this)
	HX_STACK_ARG(cur,"cur")
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(14432)
...
{
		HX_STACK_FRAME("ZNPList_RayResult","addAll","ZNPList_RayResult.addAll","zpp_nape/util/Lists.hx",14422)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(14423)
...
::nape::geom::RayResult ZNPList_RayResult_obj::inlined_add( ::nape::geom::RayResult o){
	HX_STACK_FRAME("ZNPList_RayResult","inlined_add","ZNPList_RayResult.inlined_add","zpp_nape/util/Lists.hx",14376)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(14385)
	::zpp_nape::util::ZNPNode_RayResult temp;		HX_STACK_VAR(temp,"temp");
...
::nape::geom::RayResult ZNPList_RayResult_obj::add( ::nape::geom::RayResult o){
	HX_STACK_FRAME("ZNPList_RayResult","add","ZNPList_RayResult.add","zpp_nape/util/Lists.hx",14372)
	HX_STACK_THIS(this)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(14372)
	::zpp_nape::util::ZNPNode_RayResult temp;		HX_STACK_VAR(temp,"temp");
...
{
		HX_STACK_FRAME("ZNPList_RayResult","setbegin","ZNPList_RayResult.setbegin","zpp_nape/util/Lists.hx",14366)
		HX_STACK_THIS(this)
		HX_STACK_ARG(i,"i")
		HX_STACK_LINE(14367)
		this->head = i;
...
::zpp_nape::util::ZNPNode_RayResult ZNPList_RayResult_obj::begin( ){
	HX_STACK_FRAME("ZNPList_RayResult","begin","ZNPList_RayResult.begin","zpp_nape/util/Lists.hx",14359)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14359)
	return this->head;
}
