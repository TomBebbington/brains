...
{
HX_STACK_FRAME("ZNPNode_ZPP_Constraint","new","ZNPNode_ZPP_Constraint.new","zpp_nape/util/Lists.hx",14943)
{
	HX_STACK_LINE(14977)
	this->elt = null();
	HX_STACK_LINE(14968)
...
::zpp_nape::constraint::ZPP_Constraint ZNPNode_ZPP_Constraint_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_Constraint","elem","ZNPNode_ZPP_Constraint.elem","zpp_nape/util/Lists.hx",14982)
	HX_STACK_THIS(this)
	HX_STACK_LINE(14982)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Constraint","free","ZNPNode_ZPP_Constraint.free","zpp_nape/util/Lists.hx",14975)
		HX_STACK_THIS(this)
		HX_STACK_LINE(14975)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_Constraint","alloc","ZNPNode_ZPP_Constraint.alloc","zpp_nape/util/Lists.hx",14971)
		HX_STACK_THIS(this)
	}
return null();
}
