...
{
HX_STACK_FRAME("ZNPArray2_ZPP_GeomVert","new","ZNPArray2_ZPP_GeomVert.new","zpp_nape/util/Array2.hx",235)
...
::zpp_nape::geom::ZPP_GeomVert ZNPArray2_ZPP_GeomVert_obj::set( int x,int y,::zpp_nape::geom::ZPP_GeomVert obj){
	HX_STACK_FRAME("ZNPArray2_ZPP_GeomVert","set","ZNPArray2_ZPP_GeomVert.set","zpp_nape/util/Array2.hx",291)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
...
::zpp_nape::geom::ZPP_GeomVert ZNPArray2_ZPP_GeomVert_obj::get( int x,int y){
	HX_STACK_FRAME("ZNPArray2_ZPP_GeomVert","get","ZNPArray2_ZPP_GeomVert.get","zpp_nape/util/Array2.hx",278)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(278)
...
{
		HX_STACK_FRAME("ZNPArray2_ZPP_GeomVert","resize","ZNPArray2_ZPP_GeomVert.resize","zpp_nape/util/Array2.hx",251)
		HX_STACK_THIS(this)
		HX_STACK_ARG(width,"width")
		HX_STACK_ARG(height,"height")
