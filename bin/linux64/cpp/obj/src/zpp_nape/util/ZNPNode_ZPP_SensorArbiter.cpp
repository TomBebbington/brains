...
{
HX_STACK_FRAME("ZNPNode_ZPP_SensorArbiter","new","ZNPNode_ZPP_SensorArbiter.new","zpp_nape/util/Lists.hx",15975)
{
	HX_STACK_LINE(16009)
	this->elt = null();
	HX_STACK_LINE(16000)
...
::zpp_nape::dynamics::ZPP_SensorArbiter ZNPNode_ZPP_SensorArbiter_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_SensorArbiter","elem","ZNPNode_ZPP_SensorArbiter.elem","zpp_nape/util/Lists.hx",16014)
	HX_STACK_THIS(this)
	HX_STACK_LINE(16014)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_SensorArbiter","free","ZNPNode_ZPP_SensorArbiter.free","zpp_nape/util/Lists.hx",16007)
		HX_STACK_THIS(this)
		HX_STACK_LINE(16007)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_SensorArbiter","alloc","ZNPNode_ZPP_SensorArbiter.alloc","zpp_nape/util/Lists.hx",16003)
		HX_STACK_THIS(this)
	}
return null();
}
