...
{
HX_STACK_FRAME("ZPP_InteractionGroupList","new","ZPP_InteractionGroupList.new","zpp_nape/util/Lists.hx",17239)
{
	HX_STACK_LINE(17294)
...
{
		HX_STACK_FRAME("ZPP_InteractionGroupList","invalidate","ZPP_InteractionGroupList.invalidate","zpp_nape/util/Lists.hx",17286)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17287)
		this->_invalidated = true;
		HX_STACK_LINE(17288)
...
{
		HX_STACK_FRAME("ZPP_InteractionGroupList","validate","ZPP_InteractionGroupList.validate","zpp_nape/util/Lists.hx",17281)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17281)
...
{
		HX_STACK_FRAME("ZPP_InteractionGroupList","modify_test","ZPP_InteractionGroupList.modify_test","zpp_nape/util/Lists.hx",17277)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17277)
...
{
		HX_STACK_FRAME("ZPP_InteractionGroupList","modified","ZPP_InteractionGroupList.modified","zpp_nape/util/Lists.hx",17270)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17271)
...
{
		HX_STACK_FRAME("ZPP_InteractionGroupList","valmod","ZPP_InteractionGroupList.valmod","zpp_nape/util/Lists.hx",17260)
		HX_STACK_THIS(this)
		HX_STACK_LINE(17261)
		this->validate();
		HX_STACK_LINE(17262)
...
bool imm = __o_imm.Default(false);
	HX_STACK_FRAME("ZPP_InteractionGroupList","get","ZPP_InteractionGroupList.get","zpp_nape/util/Lists.hx",17253)
