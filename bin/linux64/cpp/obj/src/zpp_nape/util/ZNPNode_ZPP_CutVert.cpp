...
{
HX_STACK_FRAME("ZNPNode_ZPP_CutVert","new","ZNPNode_ZPP_CutVert.new","zpp_nape/util/Lists.hx",15373)
{
	HX_STACK_LINE(15407)
	this->elt = null();
	HX_STACK_LINE(15398)
...
::zpp_nape::geom::ZPP_CutVert ZNPNode_ZPP_CutVert_obj::elem( ){
	HX_STACK_FRAME("ZNPNode_ZPP_CutVert","elem","ZNPNode_ZPP_CutVert.elem","zpp_nape/util/Lists.hx",15412)
	HX_STACK_THIS(this)
	HX_STACK_LINE(15412)
	return this->elt;
}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CutVert","free","ZNPNode_ZPP_CutVert.free","zpp_nape/util/Lists.hx",15405)
		HX_STACK_THIS(this)
		HX_STACK_LINE(15405)
		this->elt = null();
	}
...
{
		HX_STACK_FRAME("ZNPNode_ZPP_CutVert","alloc","ZNPNode_ZPP_CutVert.alloc","zpp_nape/util/Lists.hx",15401)
		HX_STACK_THIS(this)
	}
return null();
}
