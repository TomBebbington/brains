...
{
HX_STACK_FRAME("ZPP_Set_ZPP_Body","new","ZPP_Set_ZPP_Body.new","zpp_nape/util/RBTree.hx",175)
{
	HX_STACK_LINE(216)
	this->colour = (int)0;
	HX_STACK_LINE(215)
...
::zpp_nape::util::ZPP_Set_ZPP_Body ZPP_Set_ZPP_Body_obj::insert( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","insert","ZPP_Set_ZPP_Body.insert","zpp_nape/util/RBTree.hx",997)
	HX_STACK_THIS(this)
...
::zpp_nape::util::ZPP_Set_ZPP_Body ZPP_Set_ZPP_Body_obj::try_insert( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","try_insert","ZPP_Set_ZPP_Body.try_insert","zpp_nape/util/RBTree.hx",905)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(906)
...
bool ZPP_Set_ZPP_Body_obj::try_insert_bool( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","try_insert_bool","ZPP_Set_ZPP_Body.try_insert_bool","zpp_nape/util/RBTree.hx",813)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(814)
	::zpp_nape::util::ZPP_Set_ZPP_Body x = null();		HX_STACK_VAR(x,"x");
...
{
		HX_STACK_FRAME("ZPP_Set_ZPP_Body","__fix_dbl_red","ZPP_Set_ZPP_Body.__fix_dbl_red","zpp_nape/util/RBTree.hx",725)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(725)
		while((true)){
...
{
		HX_STACK_FRAME("ZPP_Set_ZPP_Body","__fix_neg_red","ZPP_Set_ZPP_Body.__fix_neg_red","zpp_nape/util/RBTree.hx",657)
		HX_STACK_THIS(this)
...
::zpp_nape::util::ZPP_Set_ZPP_Body ZPP_Set_ZPP_Body_obj::clear_node( ::zpp_nape::util::ZPP_Set_ZPP_Body node,Dynamic lambda){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","clear_node","ZPP_Set_ZPP_Body.clear_node","zpp_nape/util/RBTree.hx",622)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_Set_ZPP_Body","clear_with","ZPP_Set_ZPP_Body.clear_with","zpp_nape/util/RBTree.hx",614)
		HX_STACK_THIS(this)
		HX_STACK_ARG(lambda,"lambda")
		HX_STACK_LINE(614)
		if (((this->parent == null()))){
...
{
		HX_STACK_FRAME("ZPP_Set_ZPP_Body","clear","ZPP_Set_ZPP_Body.clear","zpp_nape/util/RBTree.hx",610)
		HX_STACK_THIS(this)
		HX_STACK_LINE(610)
		if (((this->parent == null()))){
			HX_STACK_LINE(610)
...
{
		HX_STACK_FRAME("ZPP_Set_ZPP_Body","remove_node","ZPP_Set_ZPP_Body.remove_node","zpp_nape/util/RBTree.hx",489)
		HX_STACK_THIS(this)
...
::zpp_nape::phys::ZPP_Body ZPP_Set_ZPP_Body_obj::predecessor( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","predecessor","ZPP_Set_ZPP_Body.predecessor","zpp_nape/util/RBTree.hx",477)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(486)
...
::zpp_nape::phys::ZPP_Body ZPP_Set_ZPP_Body_obj::successor( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","successor","ZPP_Set_ZPP_Body.successor","zpp_nape/util/RBTree.hx",465)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(474)
...
::zpp_nape::util::ZPP_Set_ZPP_Body ZPP_Set_ZPP_Body_obj::predecessor_node( ::zpp_nape::util::ZPP_Set_ZPP_Body cur){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","predecessor_node","ZPP_Set_ZPP_Body.predecessor_node","zpp_nape/util/RBTree.hx",442)
	HX_STACK_THIS(this)
	HX_STACK_ARG(cur,"cur")
	HX_STACK_LINE(451)
	if (((cur->prev != null()))){
...
::zpp_nape::util::ZPP_Set_ZPP_Body ZPP_Set_ZPP_Body_obj::successor_node( ::zpp_nape::util::ZPP_Set_ZPP_Body cur){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","successor_node","ZPP_Set_ZPP_Body.successor_node","zpp_nape/util/RBTree.hx",419)
	HX_STACK_THIS(this)
	HX_STACK_ARG(cur,"cur")
	HX_STACK_LINE(428)
	if (((cur->next != null()))){
...
{
		HX_STACK_FRAME("ZPP_Set_ZPP_Body","remove","ZPP_Set_ZPP_Body.remove","zpp_nape/util/RBTree.hx",407)
		HX_STACK_THIS(this)
		HX_STACK_ARG(obj,"obj")
		HX_STACK_LINE(408)
...
::zpp_nape::phys::ZPP_Body ZPP_Set_ZPP_Body_obj::pop_front( ){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","pop_front","ZPP_Set_ZPP_Body.pop_front","zpp_nape/util/RBTree.hx",392)
	HX_STACK_THIS(this)
	HX_STACK_LINE(401)
	::zpp_nape::util::ZPP_Set_ZPP_Body cur = this->parent;		HX_STACK_VAR(cur,"cur");
	HX_STACK_LINE(402)
...
::zpp_nape::phys::ZPP_Body ZPP_Set_ZPP_Body_obj::first( ){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","first","ZPP_Set_ZPP_Body.first","zpp_nape/util/RBTree.hx",379)
	HX_STACK_THIS(this)
	HX_STACK_LINE(388)
	::zpp_nape::util::ZPP_Set_ZPP_Body cur = this->parent;		HX_STACK_VAR(cur,"cur");
	HX_STACK_LINE(389)
...
::zpp_nape::phys::ZPP_Body ZPP_Set_ZPP_Body_obj::lower_bound( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","lower_bound","ZPP_Set_ZPP_Body.lower_bound","zpp_nape/util/RBTree.hx",343)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(344)
...
::zpp_nape::util::ZPP_Set_ZPP_Body ZPP_Set_ZPP_Body_obj::find_weak( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","find_weak","ZPP_Set_ZPP_Body.find_weak","zpp_nape/util/RBTree.hx",333)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(334)
	::zpp_nape::util::ZPP_Set_ZPP_Body cur = this->parent;		HX_STACK_VAR(cur,"cur");
...
bool ZPP_Set_ZPP_Body_obj::has_weak( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","has_weak","ZPP_Set_ZPP_Body.has_weak","zpp_nape/util/RBTree.hx",331)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(331)
...
::zpp_nape::util::ZPP_Set_ZPP_Body ZPP_Set_ZPP_Body_obj::find( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","find","ZPP_Set_ZPP_Body.find","zpp_nape/util/RBTree.hx",322)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(323)
	::zpp_nape::util::ZPP_Set_ZPP_Body cur = this->parent;		HX_STACK_VAR(cur,"cur");
...
bool ZPP_Set_ZPP_Body_obj::has( ::zpp_nape::phys::ZPP_Body obj){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","has","ZPP_Set_ZPP_Body.has","zpp_nape/util/RBTree.hx",320)
	HX_STACK_THIS(this)
	HX_STACK_ARG(obj,"obj")
	HX_STACK_LINE(320)
...
int ZPP_Set_ZPP_Body_obj::size( ){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","size","ZPP_Set_ZPP_Body.size","zpp_nape/util/RBTree.hx",289)
	HX_STACK_THIS(this)
	HX_STACK_LINE(290)
...
bool ZPP_Set_ZPP_Body_obj::singular( ){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","singular","ZPP_Set_ZPP_Body.singular","zpp_nape/util/RBTree.hx",287)
	HX_STACK_THIS(this)
	HX_STACK_LINE(287)
...
bool ZPP_Set_ZPP_Body_obj::empty( ){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","empty","ZPP_Set_ZPP_Body.empty","zpp_nape/util/RBTree.hx",284)
	HX_STACK_THIS(this)
	HX_STACK_LINE(284)
...
bool ZPP_Set_ZPP_Body_obj::verify( ){
	HX_STACK_FRAME("ZPP_Set_ZPP_Body","verify","ZPP_Set_ZPP_Body.verify","zpp_nape/util/RBTree.hx",218)
	HX_STACK_THIS(this)
	HX_STACK_LINE(228)
	if ((!(this->empty()))){
		HX_STACK_LINE(229)
...
{
		HX_STACK_FRAME("ZPP_Set_ZPP_Body","alloc","ZPP_Set_ZPP_Body.alloc","zpp_nape/util/RBTree.hx",209)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("ZPP_Set_ZPP_Body","free","ZPP_Set_ZPP_Body.free","zpp_nape/util/RBTree.hx",202)
		HX_STACK_THIS(this)
		HX_STACK_LINE(203)
		this->data = null();
		HX_STACK_LINE(204)
