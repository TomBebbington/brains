...
{
HX_STACK_FRAME("Hashable2_Boolfalse","new","Hashable2_Boolfalse.new","zpp_nape/util/FastHash.hx",176)
{
	HX_STACK_LINE(205)
	this->di = (int)0;
	HX_STACK_LINE(204)
...
{
		HX_STACK_FRAME("Hashable2_Boolfalse","alloc","Hashable2_Boolfalse.alloc","zpp_nape/util/FastHash.hx",211)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("Hashable2_Boolfalse","free","Hashable2_Boolfalse.free","zpp_nape/util/FastHash.hx",208)
		HX_STACK_THIS(this)
	}
return null();
}
...
::zpp_nape::util::Hashable2_Boolfalse Hashable2_Boolfalse_obj::get( int id,int di,bool val){
	HX_STACK_FRAME("Hashable2_Boolfalse","get","Hashable2_Boolfalse.get","zpp_nape/util/FastHash.hx",214)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
...
::zpp_nape::util::Hashable2_Boolfalse Hashable2_Boolfalse_obj::getpersist( int id,int di){
	HX_STACK_FRAME("Hashable2_Boolfalse","getpersist","Hashable2_Boolfalse.getpersist","zpp_nape/util/FastHash.hx",220)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(221)
	::zpp_nape::util::Hashable2_Boolfalse ret;		HX_STACK_VAR(ret,"ret");
...
::zpp_nape::util::Hashable2_Boolfalse Hashable2_Boolfalse_obj::ordered_get( int id,int di,bool val){
	HX_STACK_FRAME("Hashable2_Boolfalse","ordered_get","Hashable2_Boolfalse.ordered_get","zpp_nape/util/FastHash.hx",245)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_ARG(val,"val")
	HX_STACK_LINE(245)
...
::zpp_nape::util::Hashable2_Boolfalse Hashable2_Boolfalse_obj::ordered_get_persist( int id,int di){
	HX_STACK_FRAME("Hashable2_Boolfalse","ordered_get_persist","Hashable2_Boolfalse.ordered_get_persist","zpp_nape/util/FastHash.hx",249)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(249)
	if (((id <= di))){
