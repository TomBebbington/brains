...
{
HX_STACK_FRAME("ZPP_PivotJoint","new","ZPP_PivotJoint.new","zpp_nape/constraint/PivotJoint.hx",174)
{
	HX_STACK_LINE(324)
	this->stepped = false;
	HX_STACK_LINE(323)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","draw","ZPP_PivotJoint.draw","zpp_nape/constraint/PivotJoint.hx",1342)
		HX_STACK_THIS(this)
		HX_STACK_ARG(g,"g")
		HX_STACK_LINE(1343)
		::nape::constraint::PivotJoint me = this->outer_zn;		HX_STACK_VAR(me,"me");
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PivotJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PivotJoint.hx",1344)
				{
					HX_STACK_LINE(1344)
		...
		struct _Function_1_2{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PivotJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PivotJoint.hx",1345)
				{
					HX_STACK_LINE(1345)
			...
			HX_STACK_LINE(1348)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &n){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PivotJoint.hx",1348)
						{
							HX_STACK_LINE(1348)
							if (((bool((n != null())) && bool(n->zpp_disp)))){
								HX_STACK_LINE(1348)
				...
				HX_STACK_LINE(1348)
				nl = ::Math_obj::sqrt(((_Function_3_1::Block(n) * _Function_3_2::Block(n)) + (_Function_3_3::Block(n) * _Function_3_4::Block(n))));
			}
			HX_STACK_LINE(1349)
			if (((nl != (int)0))){
				HX_STACK_LINE(1349)
...
bool ZPP_PivotJoint_obj::applyImpulsePos( ){
	HX_STACK_FRAME("ZPP_PivotJoint","applyImpulsePos","ZPP_PivotJoint.applyImpulsePos","zpp_nape/constraint/PivotJoint.hx",1034)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1035)
...
bool ZPP_PivotJoint_obj::applyImpulseVel( ){
	HX_STACK_FRAME("ZPP_PivotJoint","applyImpulseVel","ZPP_PivotJoint.applyImpulseVel","zpp_nape/constraint/PivotJoint.hx",858)
	HX_STACK_THIS(this)
	HX_STACK_LINE(859)
	Float Ex = 0.0;		HX_STACK_VAR(Ex,"Ex");
	HX_STACK_LINE(860)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","warmStart","ZPP_PivotJoint.warmStart","zpp_nape/constraint/PivotJoint.hx",826)
		HX_STACK_THIS(this)
		HX_STACK_LINE(827)
		{
			HX_STACK_LINE(828)
...
bool ZPP_PivotJoint_obj::preStep( Float dt){
	HX_STACK_FRAME("ZPP_PivotJoint","preStep","ZPP_PivotJoint.preStep","zpp_nape/constraint/PivotJoint.hx",615)
	HX_STACK_THIS(this)
	HX_STACK_ARG(dt,"dt")
	HX_STACK_LINE(616)
	if (((this->pre_dt == -1.0))){
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","clearcache","ZPP_PivotJoint.clearcache","zpp_nape/constraint/PivotJoint.hx",592)
		HX_STACK_THIS(this)
		HX_STACK_LINE(593)
		{
			HX_STACK_LINE(594)
...
bool ZPP_PivotJoint_obj::pair_exists( int id,int di){
	HX_STACK_FRAME("ZPP_PivotJoint","pair_exists","ZPP_PivotJoint.pair_exists","zpp_nape/constraint/PivotJoint.hx",590)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(590)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","forest","ZPP_PivotJoint.forest","zpp_nape/constraint/PivotJoint.hx",491)
		HX_STACK_THIS(this)
		HX_STACK_LINE(492)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","wake_connected","ZPP_PivotJoint.wake_connected","zpp_nape/constraint/PivotJoint.hx",487)
		HX_STACK_THIS(this)
		HX_STACK_LINE(488)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","validate","ZPP_PivotJoint.validate","zpp_nape/constraint/PivotJoint.hx",481)
		HX_STACK_THIS(this)
		HX_STACK_LINE(482)
		...
		if (((this->b1 == this->b2))){
			HX_STACK_LINE(483)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: PivotJoint cannot be simulated with body1 == body2 (body1=body2=") + this->b1->outer->toString()) + HX_CSTRING(")")));
		}
		HX_STACK_LINE(484)
		if (((bool((this->b1->space != this->space)) || bool((this->b2->space != this->space))))){
			HX_STACK_LINE(484)
			HX_STACK_DO_THROW(((((HX_CSTRING("Error: Constraints must have each body within the same space to which the constraint has been assigned (body1=") + this->b1->outer->toString()) + HX_CSTRING(", body2=")) + this->b2->outer->toString()) + HX_CSTRING(")")));
		}
		HX_STACK_LINE(485)
		if (((bool(!(((this->b1->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_DYNAMIC)))) && bool(!(((this->b2->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_DYNAMIC))))))){
			HX_STACK_LINE(485)
			HX_STACK_DO_THROW(((((HX_CSTRING("Error: Constraints cannot have both bodies non-dynamic (body1=") + this->b1->outer->toString()) + HX_CSTRING(", body2=")) + this->b2->outer->toString()) + HX_CSTRING(")")));
		}
	}
return null();
}
...
::nape::constraint::Constraint ZPP_PivotJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	HX_STACK_FRAME("ZPP_PivotJoint","copy","ZPP_PivotJoint.copy","zpp_nape/constraint/PivotJoint.hx",325)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static ::nape::geom::Vec2 Block( ::zpp_nape::constraint::ZPP_PivotJoint_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PivotJoint.hx",326)
			{
				HX_STACK_LINE(326)
	...
	if (((bool((dict != null())) && bool((this->b1 != null()))))){
		...
		if (((b != null()))){
			...
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/PivotJoint.hx",346)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(346)
	...
	if (((bool((dict != null())) && bool((this->b2 != null()))))){
		...
		if (((b != null()))){
			...
			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Array< ::Dynamic >,ret)
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/PivotJoint.hx",367)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(367)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","setup_a2","ZPP_PivotJoint.setup_a2","zpp_nape/constraint/PivotJoint.hx",308)
		HX_STACK_THIS(this)
		HX_STACK_LINE(309)
		{
			HX_STACK_LINE(309)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PivotJoint.hx",309)
						{
							HX_STACK_LINE(309)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(309)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","invalidate_a2","ZPP_PivotJoint.invalidate_a2","zpp_nape/constraint/PivotJoint.hx",284)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(285)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","validate_a2","ZPP_PivotJoint.validate_a2","zpp_nape/constraint/PivotJoint.hx",263)
		HX_STACK_THIS(this)
		HX_STACK_LINE(264)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","setup_a1","ZPP_PivotJoint.setup_a1","zpp_nape/constraint/PivotJoint.hx",250)
		HX_STACK_THIS(this)
		HX_STACK_LINE(251)
		{
			HX_STACK_LINE(251)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PivotJoint.hx",251)
						{
							HX_STACK_LINE(251)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(251)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","invalidate_a1","ZPP_PivotJoint.invalidate_a1","zpp_nape/constraint/PivotJoint.hx",226)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(227)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","validate_a1","ZPP_PivotJoint.validate_a1","zpp_nape/constraint/PivotJoint.hx",205)
		HX_STACK_THIS(this)
		HX_STACK_LINE(206)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","inactiveBodies","ZPP_PivotJoint.inactiveBodies","zpp_nape/constraint/PivotJoint.hx",191)
		HX_STACK_THIS(this)
		HX_STACK_LINE(193)
		if (((this->b1 != null()))){
			HX_STACK_LINE(193)
...
{
		HX_STACK_FRAME("ZPP_PivotJoint","activeBodies","ZPP_PivotJoint.activeBodies","zpp_nape/constraint/PivotJoint.hx",183)
		HX_STACK_THIS(this)
		HX_STACK_LINE(185)
		if (((this->b1 != null()))){
			HX_STACK_LINE(185)
...
::nape::geom::Vec3 ZPP_PivotJoint_obj::bodyImpulse( ::zpp_nape::phys::ZPP_Body b){
	HX_STACK_FRAME("ZPP_PivotJoint","bodyImpulse","ZPP_PivotJoint.bodyImpulse","zpp_nape/constraint/PivotJoint.hx",177)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(177)
	if ((this->stepped)){
