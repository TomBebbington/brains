...
{
HX_STACK_FRAME("ZPP_PulleyJoint","new","ZPP_PulleyJoint.new","zpp_nape/constraint/PulleyJoint.hx",174)
{
	HX_STACK_LINE(645)
	this->stepped = false;
	HX_STACK_LINE(644)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","drawLink","ZPP_PulleyJoint.drawLink","zpp_nape/constraint/PulleyJoint.hx",2217)
		HX_STACK_THIS(this)
		HX_STACK_ARG(g,"g")
		HX_STACK_ARG(a1,"a1")
		HX_STACK_ARG(a2,"a2")
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","draw","ZPP_PulleyJoint.draw","zpp_nape/constraint/PulleyJoint.hx",2192)
		HX_STACK_THIS(this)
		HX_STACK_ARG(g,"g")
		HX_STACK_LINE(2193)
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PulleyJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",2194)
				{
					HX_STACK_LINE(2194)
		...
		struct _Function_1_2{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PulleyJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",2195)
				{
					HX_STACK_LINE(2195)
		...
		struct _Function_1_3{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PulleyJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",2196)
				{
					HX_STACK_LINE(2196)
		...
		struct _Function_1_4{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::PulleyJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",2197)
				{
					HX_STACK_LINE(2197)
		...
		HX_STACK_LINE(2200)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &n12){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",2200)
					{
						HX_STACK_LINE(2200)
						if (((bool((n12 != null())) && bool(n12->zpp_disp)))){
							HX_STACK_LINE(2200)
			...
			HX_STACK_LINE(2200)
			nl12 = ::Math_obj::sqrt(((_Function_2_1::Block(n12) * _Function_2_2::Block(n12)) + (_Function_2_3::Block(n12) * _Function_2_4::Block(n12))));
		}
		HX_STACK_LINE(2201)
		...
		HX_STACK_LINE(2201)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &n34){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",2201)
					{
						HX_STACK_LINE(2201)
						if (((bool((n34 != null())) && bool(n34->zpp_disp)))){
							HX_STACK_LINE(2201)
			...
			HX_STACK_LINE(2201)
			nl34 = ::Math_obj::sqrt(((_Function_2_1::Block(n34) * _Function_2_2::Block(n34)) + (_Function_2_3::Block(n34) * _Function_2_4::Block(n34))));
		}
		HX_STACK_LINE(2202)
...
bool ZPP_PulleyJoint_obj::applyImpulsePos( ){
	HX_STACK_FRAME("ZPP_PulleyJoint","applyImpulsePos","ZPP_PulleyJoint.applyImpulsePos","zpp_nape/constraint/PulleyJoint.hx",1633)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1634)
	...
	HX_STACK_LINE(1713)
	{
		...
		HX_STACK_LINE(1722)
		C12 = ::Math_obj::sqrt(((t12x * t12x) + (t12y * t12y)));
		HX_STACK_LINE(1723)
		Float C34;		HX_STACK_VAR(C34,"C34");
		HX_STACK_LINE(1723)
		C34 = ::Math_obj::sqrt(((t34x * t34x) + (t34y * t34y)));
		HX_STACK_LINE(1724)
		if (((C12 != (int)0))){
			HX_STACK_LINE(1726)
		...
		if (((C34 != (int)0))){
			...
			HX_STACK_LINE(1769)
			t = (Float(this->ratio) / Float(::Math_obj::sqrt(((n34x * n34x) + (n34y * n34y)))));
			HX_STACK_LINE(1778)
			hx::MultEq(n34x,t);
			HX_STACK_LINE(1779)
			hx::MultEq(n34y,t);
...
bool ZPP_PulleyJoint_obj::applyImpulseVel( ){
	HX_STACK_FRAME("ZPP_PulleyJoint","applyImpulseVel","ZPP_PulleyJoint.applyImpulseVel","zpp_nape/constraint/PulleyJoint.hx",1487)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1488)
	if ((this->slack)){
		HX_STACK_LINE(1488)
	...
	Float E;		HX_STACK_VAR(E,"E");
	HX_STACK_LINE(1490)
	E = ((((((((this->n12x * ((((this->b2->velx + this->b2->kinvelx) - this->b1->velx) - this->b1->kinvelx))) + (this->n12y * ((((this->b2->vely + this->b2->kinvely) - this->b1->vely) - this->b1->kinvely)))) + (this->n34x * ((((this->b4->velx + this->b4->kinvelx) - this->b3->velx) - this->b3->kinvelx)))) + (this->n34y * ((((this->b4->vely + this->b4->kinvely) - this->b3->vely) - this->b3->kinvely)))) + (((this->b2->angvel + this->b2->kinangvel)) * this->cx2)) - (((this->b1->angvel + this->b1->kinangvel)) * this->cx1)) + (((this->b4->angvel + this->b4->kinangvel)) * this->cx4)) - (((this->b3->angvel + this->b3->kinangvel)) * this->cx3));
	HX_STACK_LINE(1492)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","warmStart","ZPP_PulleyJoint.warmStart","zpp_nape/constraint/PulleyJoint.hx",1368)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1368)
		if ((!(this->slack))){
			HX_STACK_LINE(1428)
...
bool ZPP_PulleyJoint_obj::preStep( Float dt){
	HX_STACK_FRAME("ZPP_PulleyJoint","preStep","ZPP_PulleyJoint.preStep","zpp_nape/constraint/PulleyJoint.hx",1165)
	HX_STACK_THIS(this)
	HX_STACK_ARG(dt,"dt")
	HX_STACK_LINE(1166)
	if (((this->pre_dt == -1.0))){
	...
	HX_STACK_LINE(1187)
	{
		...
		if (((C34 != (int)0))){
			...
			Float t;		HX_STACK_VAR(t,"t");
			HX_STACK_LINE(1243)
			t = (Float(this->ratio) / Float(::Math_obj::sqrt(((this->n34x * this->n34x) + (this->n34y * this->n34y)))));
			HX_STACK_LINE(1252)
			hx::MultEq(this->n34x,t);
			HX_STACK_LINE(1253)
			hx::MultEq(this->n34y,t);
		...
		if ((!(this->stiff))){
			...
			struct _Function_3_1{
				inline static Float Block( ::zpp_nape::constraint::ZPP_PulleyJoint_obj *__this,Float &biasCoef,Float &dt){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",1344)
					{
						HX_STACK_LINE(1345)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","clearcache","ZPP_PulleyJoint.clearcache","zpp_nape/constraint/PulleyJoint.hx",1161)
		HX_STACK_THIS(this)
		HX_STACK_LINE(1162)
		this->jAcc = (int)0;
		HX_STACK_LINE(1163)
...
bool ZPP_PulleyJoint_obj::pair_exists( int id,int di){
	HX_STACK_FRAME("ZPP_PulleyJoint","pair_exists","ZPP_PulleyJoint.pair_exists","zpp_nape/constraint/PulleyJoint.hx",1159)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(1159)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","forest","ZPP_PulleyJoint.forest","zpp_nape/constraint/PulleyJoint.hx",964)
		HX_STACK_THIS(this)
		HX_STACK_LINE(965)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","wake_connected","ZPP_PulleyJoint.wake_connected","zpp_nape/constraint/PulleyJoint.hx",958)
		HX_STACK_THIS(this)
		HX_STACK_LINE(959)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","validate","ZPP_PulleyJoint.validate","zpp_nape/constraint/PulleyJoint.hx",950)
		HX_STACK_THIS(this)
		HX_STACK_LINE(951)
...
::nape::constraint::Constraint ZPP_PulleyJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	HX_STACK_FRAME("ZPP_PulleyJoint","copy","ZPP_PulleyJoint.copy","zpp_nape/constraint/PulleyJoint.hx",646)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static ::nape::geom::Vec2 Block( ::zpp_nape::constraint::ZPP_PulleyJoint_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",647)
			{
				HX_STACK_LINE(647)
	...
	if (((bool((dict != null())) && bool((this->b1 != null()))))){
		...
		if (((b != null()))){
			...
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/PulleyJoint.hx",667)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(667)
	...
	if (((bool((dict != null())) && bool((this->b2 != null()))))){
		...
		if (((b != null()))){
			...
			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Array< ::Dynamic >,ret)
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/PulleyJoint.hx",688)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(688)
	...
	if (((bool((dict != null())) && bool((this->b3 != null()))))){
		...
		if (((b != null()))){
			...
			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Array< ::Dynamic >,ret)
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/PulleyJoint.hx",709)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(709)
	...
	if (((bool((dict != null())) && bool((this->b4 != null()))))){
		...
		if (((b != null()))){
			...
			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Array< ::Dynamic >,ret)
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/PulleyJoint.hx",730)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(730)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","setup_a4","ZPP_PulleyJoint.setup_a4","zpp_nape/constraint/PulleyJoint.hx",633)
		HX_STACK_THIS(this)
		HX_STACK_LINE(634)
		{
			HX_STACK_LINE(634)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",634)
						{
							HX_STACK_LINE(634)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(634)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","invalidate_a4","ZPP_PulleyJoint.invalidate_a4","zpp_nape/constraint/PulleyJoint.hx",609)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(610)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","validate_a4","ZPP_PulleyJoint.validate_a4","zpp_nape/constraint/PulleyJoint.hx",588)
		HX_STACK_THIS(this)
		HX_STACK_LINE(589)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","setup_a3","ZPP_PulleyJoint.setup_a3","zpp_nape/constraint/PulleyJoint.hx",575)
		HX_STACK_THIS(this)
		HX_STACK_LINE(576)
		{
			HX_STACK_LINE(576)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",576)
						{
							HX_STACK_LINE(576)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(576)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","invalidate_a3","ZPP_PulleyJoint.invalidate_a3","zpp_nape/constraint/PulleyJoint.hx",551)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(552)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","validate_a3","ZPP_PulleyJoint.validate_a3","zpp_nape/constraint/PulleyJoint.hx",530)
		HX_STACK_THIS(this)
		HX_STACK_LINE(531)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","setup_a2","ZPP_PulleyJoint.setup_a2","zpp_nape/constraint/PulleyJoint.hx",517)
		HX_STACK_THIS(this)
		HX_STACK_LINE(518)
		{
			HX_STACK_LINE(518)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",518)
						{
							HX_STACK_LINE(518)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(518)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","invalidate_a2","ZPP_PulleyJoint.invalidate_a2","zpp_nape/constraint/PulleyJoint.hx",493)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(494)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","validate_a2","ZPP_PulleyJoint.validate_a2","zpp_nape/constraint/PulleyJoint.hx",472)
		HX_STACK_THIS(this)
		HX_STACK_LINE(473)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","setup_a1","ZPP_PulleyJoint.setup_a1","zpp_nape/constraint/PulleyJoint.hx",459)
		HX_STACK_THIS(this)
		HX_STACK_LINE(460)
		{
			HX_STACK_LINE(460)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",460)
						{
							HX_STACK_LINE(460)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(460)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","invalidate_a1","ZPP_PulleyJoint.invalidate_a1","zpp_nape/constraint/PulleyJoint.hx",435)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(436)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","validate_a1","ZPP_PulleyJoint.validate_a1","zpp_nape/constraint/PulleyJoint.hx",414)
		HX_STACK_THIS(this)
		HX_STACK_LINE(415)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","inactiveBodies","ZPP_PulleyJoint.inactiveBodies","zpp_nape/constraint/PulleyJoint.hx",394)
		HX_STACK_THIS(this)
		HX_STACK_LINE(396)
		if (((this->b1 != null()))){
			HX_STACK_LINE(396)
...
{
		HX_STACK_FRAME("ZPP_PulleyJoint","activeBodies","ZPP_PulleyJoint.activeBodies","zpp_nape/constraint/PulleyJoint.hx",380)
		HX_STACK_THIS(this)
		HX_STACK_LINE(382)
		if (((this->b1 != null()))){
			HX_STACK_LINE(382)
...
::nape::geom::Vec3 ZPP_PulleyJoint_obj::bodyImpulse( ::zpp_nape::phys::ZPP_Body b){
	HX_STACK_FRAME("ZPP_PulleyJoint","bodyImpulse","ZPP_PulleyJoint.bodyImpulse","zpp_nape/constraint/PulleyJoint.hx",354)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(354)
	if ((this->stepped)){
		...
		if (((b == this->b1))){
				...
				HX_STACK_LINE(357)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",357)
							{
								HX_STACK_LINE(357)
					...
					HX_STACK_LINE(357)
					x = (_Function_5_1::Block(_g) - (this->jAcc * this->n12x));
					HX_STACK_LINE(357)
					{
						HX_STACK_LINE(357)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
			...
			HX_STACK_LINE(358)
			{
				...
				HX_STACK_LINE(358)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",358)
							{
								HX_STACK_LINE(358)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(358)
					...
					HX_STACK_LINE(358)
					y = (_Function_5_1::Block(_g) - (this->jAcc * this->n12y));
					HX_STACK_LINE(358)
					{
						HX_STACK_LINE(358)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
			...
			HX_STACK_LINE(359)
			{
				...
				HX_STACK_LINE(359)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",359)
							{
								HX_STACK_LINE(359)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(359)
					...
					HX_STACK_LINE(359)
					z = (_Function_5_1::Block(_g) - (this->cx1 * this->jAcc));
					HX_STACK_LINE(359)
					{
						HX_STACK_LINE(359)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
		...
		if (((b == this->b2))){
			HX_STACK_LINE(362)
			{
				...
				HX_STACK_LINE(362)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",362)
							{
								HX_STACK_LINE(362)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(362)
			...
			HX_STACK_LINE(363)
			{
				...
				HX_STACK_LINE(363)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",363)
							{
								HX_STACK_LINE(363)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(363)
			...
			HX_STACK_LINE(364)
			{
				...
				HX_STACK_LINE(364)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",364)
							{
								HX_STACK_LINE(364)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(364)
					...
					HX_STACK_LINE(364)
					z = (_Function_5_1::Block(_g) + (this->cx2 * this->jAcc));
					HX_STACK_LINE(364)
					{
						HX_STACK_LINE(364)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
		...
		if (((b == this->b3))){
			HX_STACK_LINE(367)
			{
				...
				HX_STACK_LINE(367)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",367)
							{
								HX_STACK_LINE(367)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(367)
					...
					HX_STACK_LINE(367)
					x = (_Function_5_1::Block(_g) - (this->jAcc * this->n34x));
					HX_STACK_LINE(367)
					{
						HX_STACK_LINE(367)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
			...
			HX_STACK_LINE(368)
			{
				...
				HX_STACK_LINE(368)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",368)
							{
								HX_STACK_LINE(368)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(368)
					...
					HX_STACK_LINE(368)
					y = (_Function_5_1::Block(_g) - (this->jAcc * this->n34y));
					HX_STACK_LINE(368)
					{
						HX_STACK_LINE(368)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
			...
			HX_STACK_LINE(369)
			{
				...
				HX_STACK_LINE(369)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",369)
							{
								HX_STACK_LINE(369)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(369)
					...
					HX_STACK_LINE(369)
					z = (_Function_5_1::Block(_g) - (this->cx3 * this->jAcc));
					HX_STACK_LINE(369)
					{
						HX_STACK_LINE(369)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
		...
		if (((b == this->b4))){
			HX_STACK_LINE(372)
			{
				...
				HX_STACK_LINE(372)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",372)
							{
								HX_STACK_LINE(372)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(372)
			...
			HX_STACK_LINE(373)
			{
				...
				HX_STACK_LINE(373)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",373)
							{
								HX_STACK_LINE(373)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(373)
			...
			HX_STACK_LINE(374)
			{
				...
				HX_STACK_LINE(374)
				{
					...
					struct _Function_5_1{
						inline static Float Block( ::nape::geom::Vec3 &_g){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/PulleyJoint.hx",374)
							{
								HX_STACK_LINE(374)
								if (((bool((_g != null())) && bool(_g->zpp_disp)))){
									HX_STACK_LINE(374)
					...
					HX_STACK_LINE(374)
					z = (_Function_5_1::Block(_g) + (this->cx4 * this->jAcc));
					HX_STACK_LINE(374)
					{
						HX_STACK_LINE(374)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
...
bool ZPP_PulleyJoint_obj::is_slack( ){
	HX_STACK_FRAME("ZPP_PulleyJoint","is_slack","ZPP_PulleyJoint.is_slack","zpp_nape/constraint/PulleyJoint.hx",183)
	HX_STACK_THIS(this)
	HX_STACK_LINE(184)
	bool slack;		HX_STACK_VAR(slack,"slack");
	HX_STACK_LINE(185)
