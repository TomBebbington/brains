...
{
		HX_STACK_FRAME("ZPP_AngleDraw","indicator","ZPP_AngleDraw.indicator","zpp_nape/constraint/AngleJoint.hx",652)
		HX_STACK_ARG(g,"g")
		HX_STACK_ARG(c,"c")
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",653)
						{
							HX_STACK_LINE(653)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(653)
...
int coils = __o_coils.Default(4);
	HX_STACK_FRAME("ZPP_AngleDraw","drawSpiralSpring","ZPP_AngleDraw.drawSpiralSpring","zpp_nape/constraint/AngleJoint.hx",658)
	HX_STACK_ARG(g,"g")
	HX_STACK_ARG(c,"c")
	HX_STACK_ARG(a0,"a0")
	HX_STACK_ARG(a1,"a1")
	...
	HX_STACK_ARG(coils,"coils")
{
		...
		HX_STACK_LINE(688)
		{
			...
			HX_STACK_LINE(690)
			R0 = (p + ((0.75 * Delta) * ::Math_obj::sin(((((int)2 * coils) * ::Math_obj::PI) * (int)0))));
		}
		HX_STACK_LINE(692)
		...
		HX_STACK_LINE(692)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &c){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",692)
					{
						HX_STACK_LINE(692)
		...
		HX_STACK_LINE(693)
		DR = (dr + ((((1.5 * coils) * Delta) * ::Math_obj::PI) * ::Math_obj::cos(((((int)2 * coils) * ::Math_obj::PI) * (int)0))));
		HX_STACK_LINE(696)
		...
		HX_STACK_LINE(698)
		{
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",698)
						{
							HX_STACK_LINE(698)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(698)
		...
		HX_STACK_LINE(699)
		{
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",699)
						{
							HX_STACK_LINE(699)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(699)
		...
		HX_STACK_LINE(700)
		{
			...
			while(((_g < dcnt))){
				...
				HX_STACK_LINE(704)
				{
					...
					HX_STACK_LINE(706)
					R1 = (p + ((0.75 * Delta) * ::Math_obj::sin((((((int)2 * coils) * ::Math_obj::PI) * ((i + (int)1))) * dtime))));
				}
				HX_STACK_LINE(708)
				{
					HX_STACK_LINE(708)
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec2 &c){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",708)
							{
								HX_STACK_LINE(708)
								if (((bool((c != null())) && bool(c->zpp_disp)))){
									HX_STACK_LINE(708)
				...
				HX_STACK_LINE(709)
				DR1 = (dr + ((((1.5 * coils) * Delta) * ::Math_obj::PI) * ::Math_obj::cos((((((int)2 * coils) * ::Math_obj::PI) * ((i + (int)1))) * dtime))));
				HX_STACK_LINE(712)
				...
				if (((bool((bool(((den * den) < ::nape::Config_obj::epsilon)) || bool((((ux * vx) + (uy * vy)) <= (int)0)))) || bool((((ux * vx) + (uy * vy)) > 0.999))))){
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec2 &p1){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",717)
							{
								HX_STACK_LINE(717)
								if (((bool((p1 != null())) && bool(p1->zpp_disp)))){
									HX_STACK_LINE(717)
					...
					HX_STACK_LINE(717)
					t = (Float((((((_Function_4_1::Block(p1) - _Function_4_2::Block(p0))) * vy) + (((_Function_4_3::Block(p0) - _Function_4_4::Block(p1))) * vx)))) / Float(den));
					HX_STACK_LINE(718)
					if (((t <= (int)0))){
						HX_STACK_LINE(718)
						g->drawLine(p0,p1,col);
						...
						HX_STACK_LINE(720)
						{
							...
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::Vec2 &p0){
									HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",720)
									{
										HX_STACK_LINE(720)
										if (((bool((p0 != null())) && bool(p0->zpp_disp)))){
											HX_STACK_LINE(720)
						...
						HX_STACK_LINE(721)
						{
							...
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::Vec2 &p0){
									HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",721)
									{
										HX_STACK_LINE(721)
										if (((bool((p0 != null())) && bool(p0->zpp_disp)))){
											HX_STACK_LINE(721)
				...
				HX_STACK_LINE(730)
				{
					...
					HX_STACK_LINE(730)
					{
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec2 &p0){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",730)
								{
									HX_STACK_LINE(730)
									if (((bool((p0 != null())) && bool(p0->zpp_disp)))){
										HX_STACK_LINE(730)
						...
						HX_STACK_LINE(730)
						if ((!(((bool((_Function_5_1::Block(p0) == x)) && bool((_Function_5_2::Block(p0) == y))))))){
							HX_STACK_LINE(730)
							{
								HX_STACK_LINE(730)
								p0->zpp_inner->x = x;
...
{
		HX_STACK_FRAME("ZPP_AngleDraw","drawSpiral","ZPP_AngleDraw.drawSpiral","zpp_nape/constraint/AngleJoint.hx",736)
		HX_STACK_ARG(g,"g")
		HX_STACK_ARG(c,"c")
		HX_STACK_ARG(a0,"a0")
		HX_STACK_ARG(a1,"a1")
		...
		HX_STACK_LINE(757)
		{
			...
			struct _Function_2_1{
				inline static Float Block( ::nape::geom::Vec2 &c){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",757)
					{
						HX_STACK_LINE(757)
						if (((bool((c != null())) && bool(c->zpp_disp)))){
							HX_STACK_LINE(757)
		...
		HX_STACK_LINE(760)
		{
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",760)
						{
							HX_STACK_LINE(760)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(760)
		...
		HX_STACK_LINE(761)
		{
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",761)
						{
							HX_STACK_LINE(761)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(761)
		...
		HX_STACK_LINE(762)
		{
			...
			while(((_g < dcnt))){
				...
				HX_STACK_LINE(767)
				{
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec2 &c){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",767)
							{
								HX_STACK_LINE(767)
								if (((bool((c != null())) && bool(c->zpp_disp)))){
									HX_STACK_LINE(767)
					...
					HX_STACK_LINE(767)
					x = (_Function_4_1::Block(c) + (r11 * c1));
					HX_STACK_LINE(767)
					Float y;		HX_STACK_VAR(y,"y");
					struct _Function_4_2{
						inline static Float Block( ::nape::geom::Vec2 &c){
					...
					HX_STACK_LINE(767)
					y = (_Function_4_2::Block(c) + (r11 * s1));
					HX_STACK_LINE(767)
					if (((bool((p1 != null())) && bool(p1->zpp_disp)))){
						HX_STACK_LINE(767)
						HX_STACK_DO_THROW(((HX_CSTRING("Error: ") + HX_CSTRING("Vec2")) + HX_CSTRING(" has been disposed and cannot be used!")));
				...
				if ((((den * den) < ::nape::Config_obj::epsilon))){
					...
					struct _Function_4_1{
						inline static Float Block( ::nape::geom::Vec2 &p1){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",773)
							{
								HX_STACK_LINE(773)
								if (((bool((p1 != null())) && bool(p1->zpp_disp)))){
									HX_STACK_LINE(773)
					...
					if (((t <= (int)0))){
						...
						HX_STACK_LINE(776)
						{
							...
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::Vec2 &p0){
									HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",776)
									{
										HX_STACK_LINE(776)
										if (((bool((p0 != null())) && bool(p0->zpp_disp)))){
											HX_STACK_LINE(776)
						...
						HX_STACK_LINE(777)
						{
							...
							struct _Function_6_1{
								inline static Float Block( ::nape::geom::Vec2 &p0){
									HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",777)
									{
										HX_STACK_LINE(777)
										if (((bool((p0 != null())) && bool(p0->zpp_disp)))){
											HX_STACK_LINE(777)
				...
				HX_STACK_LINE(787)
				{
					...
					HX_STACK_LINE(787)
					{
						...
						struct _Function_5_1{
							inline static Float Block( ::nape::geom::Vec2 &p0){
								HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",787)
								{
									HX_STACK_LINE(787)
									if (((bool((p0 != null())) && bool(p0->zpp_disp)))){
										HX_STACK_LINE(787)
