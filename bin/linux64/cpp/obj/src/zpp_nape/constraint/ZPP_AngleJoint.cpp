...
{
HX_STACK_FRAME("ZPP_AngleJoint","new","ZPP_AngleJoint.new","zpp_nape/constraint/AngleJoint.hx",174)
{
	HX_STACK_LINE(244)
	this->stepped = false;
	HX_STACK_LINE(243)
...
{
		HX_STACK_FRAME("ZPP_AngleJoint","draw","ZPP_AngleJoint.draw","zpp_nape/constraint/AngleJoint.hx",579)
		HX_STACK_THIS(this)
		HX_STACK_ARG(g,"g")
		HX_STACK_LINE(580)
		...
		struct _Function_1_1{
			inline static ::nape::space::Space Block( ::nape::constraint::AngleJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",583)
				{
					HX_STACK_LINE(583)
		...
		if (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) )) != (_Function_1_1::Block(me))->zpp_inner->__static))){
			...
			if (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot > min))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",597)
						{
							HX_STACK_LINE(597)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(597)
				...
				HX_STACK_LINE(597)
				::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiral(g,_Function_3_1::Block(me),min,dr,(minrad + (((min - min)) * delrad)),(minrad + (((dr - min)) * delrad)),(int)16776960);
			}
			else{
				HX_STACK_LINE(599)
				if (((bool(!(this->stiff)) && bool((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot < min))))){
					struct _Function_4_1{
						inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",600)
							{
								HX_STACK_LINE(600)
								::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(600)
			...
			if (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot < max))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",608)
						{
							HX_STACK_LINE(608)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(608)
				...
				HX_STACK_LINE(608)
				::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiral(g,_Function_3_1::Block(me),dr,max,(minrad + (((dr - min)) * delrad)),(minrad + (((max - min)) * delrad)),(int)65535);
			}
			else{
				HX_STACK_LINE(610)
				if (((bool(!(this->stiff)) && bool((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) ))->zpp_inner->rot > max))))){
					struct _Function_4_1{
						inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",611)
							{
								HX_STACK_LINE(611)
								::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(611)
			...
			struct _Function_2_1{
				inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",613)
					{
						HX_STACK_LINE(613)
						::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(613)
		...
		struct _Function_1_2{
			inline static ::nape::space::Space Block( ::nape::constraint::AngleJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",615)
				{
					HX_STACK_LINE(615)
					::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(615)
		...
		if (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) )) != (_Function_1_2::Block(me))->zpp_inner->__static))){
			...
			if (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot > min))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",629)
						{
							HX_STACK_LINE(629)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(629)
				...
				if (((bool(!(this->stiff)) && bool((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot < min))))){
					struct _Function_4_1{
						inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",632)
							{
								HX_STACK_LINE(632)
								::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(632)
			...
			if (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot < max))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",640)
						{
							HX_STACK_LINE(640)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(640)
				...
				if (((bool(!(this->stiff)) && bool((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) ))->zpp_inner->rot > max))))){
					struct _Function_4_1{
						inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
							HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",643)
							{
								HX_STACK_LINE(643)
								::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(643)
			...
			struct _Function_2_1{
				inline static ::nape::geom::Vec2 Block( ::nape::constraint::AngleJoint &me){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",645)
					{
						HX_STACK_LINE(645)
						::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(645)
...
bool ZPP_AngleJoint_obj::applyImpulsePos( ){
	HX_STACK_FRAME("ZPP_AngleJoint","applyImpulsePos","ZPP_AngleJoint.applyImpulsePos","zpp_nape/constraint/AngleJoint.hx",532)
	HX_STACK_THIS(this)
	HX_STACK_LINE(533)
...
bool ZPP_AngleJoint_obj::applyImpulseVel( ){
	HX_STACK_FRAME("ZPP_AngleJoint","applyImpulseVel","ZPP_AngleJoint.applyImpulseVel","zpp_nape/constraint/AngleJoint.hx",493)
	HX_STACK_THIS(this)
	HX_STACK_LINE(494)
	if ((this->slack)){
		HX_STACK_LINE(494)
	...
	Float E;		HX_STACK_VAR(E,"E");
	HX_STACK_LINE(496)
	E = (this->scale * ((((this->ratio * ((this->b2->angvel + this->b2->kinangvel))) - this->b1->angvel) - this->b1->kinangvel)));
	HX_STACK_LINE(498)
...
{
		HX_STACK_FRAME("ZPP_AngleJoint","warmStart","ZPP_AngleJoint.warmStart","zpp_nape/constraint/AngleJoint.hx",482)
		HX_STACK_THIS(this)
		HX_STACK_LINE(482)
		if ((!(this->slack))){
			HX_STACK_LINE(488)
...
bool ZPP_AngleJoint_obj::preStep( Float dt){
	HX_STACK_FRAME("ZPP_AngleJoint","preStep","ZPP_AngleJoint.preStep","zpp_nape/constraint/AngleJoint.hx",417)
	HX_STACK_THIS(this)
	HX_STACK_ARG(dt,"dt")
	HX_STACK_LINE(418)
	if (((this->pre_dt == -1.0))){
		...
		if ((!(this->stiff))){
			...
			struct _Function_3_1{
				inline static Float Block( ::zpp_nape::constraint::ZPP_AngleJoint_obj *__this,Float &biasCoef,Float &dt){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/AngleJoint.hx",458)
					{
						HX_STACK_LINE(459)
...
{
		HX_STACK_FRAME("ZPP_AngleJoint","clearcache","ZPP_AngleJoint.clearcache","zpp_nape/constraint/AngleJoint.hx",412)
		HX_STACK_THIS(this)
		HX_STACK_LINE(413)
		this->jAcc = (int)0;
		HX_STACK_LINE(414)
...
bool ZPP_AngleJoint_obj::pair_exists( int id,int di){
	HX_STACK_FRAME("ZPP_AngleJoint","pair_exists","ZPP_AngleJoint.pair_exists","zpp_nape/constraint/AngleJoint.hx",410)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(410)
...
{
		HX_STACK_FRAME("ZPP_AngleJoint","forest","ZPP_AngleJoint.forest","zpp_nape/constraint/AngleJoint.hx",311)
		HX_STACK_THIS(this)
		HX_STACK_LINE(312)
...
{
		HX_STACK_FRAME("ZPP_AngleJoint","wake_connected","ZPP_AngleJoint.wake_connected","zpp_nape/constraint/AngleJoint.hx",307)
		HX_STACK_THIS(this)
		HX_STACK_LINE(308)
...
{
		HX_STACK_FRAME("ZPP_AngleJoint","validate","ZPP_AngleJoint.validate","zpp_nape/constraint/AngleJoint.hx",300)
		HX_STACK_THIS(this)
		HX_STACK_LINE(301)
...
::nape::constraint::Constraint ZPP_AngleJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	HX_STACK_FRAME("ZPP_AngleJoint","copy","ZPP_AngleJoint.copy","zpp_nape/constraint/AngleJoint.hx",245)
	HX_STACK_THIS(this)
	...
	if (((bool((dict != null())) && bool((this->b1 != null()))))){
		...
		if (((b != null()))){
			...
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/AngleJoint.hx",266)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(266)
	...
	if (((bool((dict != null())) && bool((this->b2 != null()))))){
		...
		if (((b != null()))){
			...
			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Array< ::Dynamic >,ret)
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/AngleJoint.hx",287)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(287)
...
{
		HX_STACK_FRAME("ZPP_AngleJoint","inactiveBodies","ZPP_AngleJoint.inactiveBodies","zpp_nape/constraint/AngleJoint.hx",229)
		HX_STACK_THIS(this)
		HX_STACK_LINE(231)
		if (((this->b1 != null()))){
			HX_STACK_LINE(231)
...
{
		HX_STACK_FRAME("ZPP_AngleJoint","activeBodies","ZPP_AngleJoint.activeBodies","zpp_nape/constraint/AngleJoint.hx",221)
		HX_STACK_THIS(this)
		HX_STACK_LINE(223)
		if (((this->b1 != null()))){
			HX_STACK_LINE(223)
...
::nape::geom::Vec3 ZPP_AngleJoint_obj::bodyImpulse( ::zpp_nape::phys::ZPP_Body b){
	HX_STACK_FRAME("ZPP_AngleJoint","bodyImpulse","ZPP_AngleJoint.bodyImpulse","zpp_nape/constraint/AngleJoint.hx",215)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(215)
	if ((this->stepped)){
...
bool ZPP_AngleJoint_obj::is_slack( ){
	HX_STACK_FRAME("ZPP_AngleJoint","is_slack","ZPP_AngleJoint.is_slack","zpp_nape/constraint/AngleJoint.hx",184)
	HX_STACK_THIS(this)
	HX_STACK_LINE(185)
	bool slack;		HX_STACK_VAR(slack,"slack");
	HX_STACK_LINE(186)
