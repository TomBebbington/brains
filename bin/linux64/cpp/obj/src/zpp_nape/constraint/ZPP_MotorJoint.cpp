...
{
HX_STACK_FRAME("ZPP_MotorJoint","new","ZPP_MotorJoint.new","zpp_nape/constraint/MotorJoint.hx",174)
{
	HX_STACK_LINE(206)
	this->stepped = false;
	HX_STACK_LINE(205)
...
bool ZPP_MotorJoint_obj::applyImpulsePos( ){
	HX_STACK_FRAME("ZPP_MotorJoint","applyImpulsePos","ZPP_MotorJoint.applyImpulsePos","zpp_nape/constraint/MotorJoint.hx",436)
	HX_STACK_THIS(this)
	HX_STACK_LINE(436)
	return false;
}
...
bool ZPP_MotorJoint_obj::applyImpulseVel( ){
	HX_STACK_FRAME("ZPP_MotorJoint","applyImpulseVel","ZPP_MotorJoint.applyImpulseVel","zpp_nape/constraint/MotorJoint.hx",402)
	HX_STACK_THIS(this)
	HX_STACK_LINE(403)
	Float E;		HX_STACK_VAR(E,"E");
	HX_STACK_LINE(404)
	E = ((((this->ratio * ((this->b2->angvel + this->b2->kinangvel))) - this->b1->angvel) - this->b1->kinangvel) - this->rate);
	HX_STACK_LINE(406)
...
{
		HX_STACK_FRAME("ZPP_MotorJoint","warmStart","ZPP_MotorJoint.warmStart","zpp_nape/constraint/MotorJoint.hx",397)
		HX_STACK_THIS(this)
		HX_STACK_LINE(398)
...
bool ZPP_MotorJoint_obj::preStep( Float dt){
	HX_STACK_FRAME("ZPP_MotorJoint","preStep","ZPP_MotorJoint.preStep","zpp_nape/constraint/MotorJoint.hx",375)
	HX_STACK_THIS(this)
	HX_STACK_ARG(dt,"dt")
	HX_STACK_LINE(376)
	if (((this->pre_dt == -1.0))){
...
{
		HX_STACK_FRAME("ZPP_MotorJoint","clearcache","ZPP_MotorJoint.clearcache","zpp_nape/constraint/MotorJoint.hx",371)
		HX_STACK_THIS(this)
		HX_STACK_LINE(372)
		this->jAcc = (int)0;
		HX_STACK_LINE(373)
...
bool ZPP_MotorJoint_obj::pair_exists( int id,int di){
	HX_STACK_FRAME("ZPP_MotorJoint","pair_exists","ZPP_MotorJoint.pair_exists","zpp_nape/constraint/MotorJoint.hx",369)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(369)
...
{
		HX_STACK_FRAME("ZPP_MotorJoint","forest","ZPP_MotorJoint.forest","zpp_nape/constraint/MotorJoint.hx",270)
		HX_STACK_THIS(this)
		HX_STACK_LINE(271)
...
{
		HX_STACK_FRAME("ZPP_MotorJoint","wake_connected","ZPP_MotorJoint.wake_connected","zpp_nape/constraint/MotorJoint.hx",266)
		HX_STACK_THIS(this)
		HX_STACK_LINE(267)
...
{
		HX_STACK_FRAME("ZPP_MotorJoint","validate","ZPP_MotorJoint.validate","zpp_nape/constraint/MotorJoint.hx",260)
		HX_STACK_THIS(this)
		HX_STACK_LINE(261)
...
::nape::constraint::Constraint ZPP_MotorJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	HX_STACK_FRAME("ZPP_MotorJoint","copy","ZPP_MotorJoint.copy","zpp_nape/constraint/MotorJoint.hx",207)
	HX_STACK_THIS(this)
	...
	if (((bool((dict != null())) && bool((this->b1 != null()))))){
		...
		if (((b != null()))){
			...
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/MotorJoint.hx",228)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(228)
	...
	if (((bool((dict != null())) && bool((this->b2 != null()))))){
		...
		if (((b != null()))){
			...
			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Array< ::Dynamic >,ret)
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/MotorJoint.hx",249)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(249)
...
{
		HX_STACK_FRAME("ZPP_MotorJoint","inactiveBodies","ZPP_MotorJoint.inactiveBodies","zpp_nape/constraint/MotorJoint.hx",193)
		HX_STACK_THIS(this)
		HX_STACK_LINE(195)
		if (((this->b1 != null()))){
			HX_STACK_LINE(195)
...
{
		HX_STACK_FRAME("ZPP_MotorJoint","activeBodies","ZPP_MotorJoint.activeBodies","zpp_nape/constraint/MotorJoint.hx",185)
		HX_STACK_THIS(this)
		HX_STACK_LINE(187)
		if (((this->b1 != null()))){
			HX_STACK_LINE(187)
...
::nape::geom::Vec3 ZPP_MotorJoint_obj::bodyImpulse( ::zpp_nape::phys::ZPP_Body b){
	HX_STACK_FRAME("ZPP_MotorJoint","bodyImpulse","ZPP_MotorJoint.bodyImpulse","zpp_nape/constraint/MotorJoint.hx",179)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(179)
	if ((this->stepped)){
