...
{
HX_STACK_FRAME("ZPP_CopyHelper","new","ZPP_CopyHelper.new","zpp_nape/constraint/Constraint.hx",555)
{
	HX_STACK_LINE(558)
	this->cb = null();
	HX_STACK_LINE(557)
...
::zpp_nape::constraint::ZPP_CopyHelper ZPP_CopyHelper_obj::dict( int id,::nape::phys::Body bc){
	HX_STACK_FRAME("ZPP_CopyHelper","dict","ZPP_CopyHelper.dict","zpp_nape/constraint/Constraint.hx",560)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(bc,"bc")
	HX_STACK_LINE(561)
...
::zpp_nape::constraint::ZPP_CopyHelper ZPP_CopyHelper_obj::todo( int id,Dynamic cb){
	HX_STACK_FRAME("ZPP_CopyHelper","todo","ZPP_CopyHelper.todo","zpp_nape/constraint/Constraint.hx",566)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(cb,"cb")
	HX_STACK_LINE(567)
	::zpp_nape::constraint::ZPP_CopyHelper ret = ::zpp_nape::constraint::ZPP_CopyHelper_obj::__new();		HX_STACK_VAR(ret,"ret");
