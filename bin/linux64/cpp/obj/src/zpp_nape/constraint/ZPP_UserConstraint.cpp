...
{
HX_STACK_FRAME("ZPP_UserConstraint","new","ZPP_UserConstraint.new","zpp_nape/constraint/UserConstraint.hx",174)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","draw","ZPP_UserConstraint.draw","zpp_nape/constraint/UserConstraint.hx",565)
		HX_STACK_THIS(this)
		HX_STACK_ARG(g,"g")
		HX_STACK_LINE(565)
...
bool ZPP_UserConstraint_obj::applyImpulsePos( ){
	HX_STACK_FRAME("ZPP_UserConstraint","applyImpulsePos","ZPP_UserConstraint.applyImpulsePos","zpp_nape/constraint/UserConstraint.hx",533)
	HX_STACK_THIS(this)
	HX_STACK_LINE(534)
	if ((this->velonly)){
		HX_STACK_LINE(534)
	...
	HX_STACK_LINE(544)
	{
		...
		while(((_g < _g1->length))){
			...
			HX_STACK_LINE(547)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/UserConstraint.hx",557)
						{
							HX_STACK_LINE(557)
				...
				struct _Function_4_2{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/UserConstraint.hx",558)
						{
							HX_STACK_LINE(558)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(558)
			...
			HX_STACK_LINE(560)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/UserConstraint.hx",560)
						{
							HX_STACK_LINE(560)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(560)
				...
				HX_STACK_LINE(560)
				dr = (_Function_4_1::Block(this) * b->iinertia);
				HX_STACK_LINE(560)
				hx::AddEq(b->rot,dr);
				HX_STACK_LINE(560)
				if ((((dr * dr) > 0.0001))){
...
bool ZPP_UserConstraint_obj::applyImpulseVel( ){
	HX_STACK_FRAME("ZPP_UserConstraint","applyImpulseVel","ZPP_UserConstraint.applyImpulseVel","zpp_nape/constraint/UserConstraint.hx",499)
	HX_STACK_THIS(this)
	HX_STACK_LINE(500)
	...
	HX_STACK_LINE(513)
	{
		...
		while(((_g < _g1->length))){
			...
			HX_STACK_LINE(516)
			{
				...
				struct _Function_4_1{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/UserConstraint.hx",526)
						{
							HX_STACK_LINE(526)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(526)
				...
				struct _Function_4_2{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/UserConstraint.hx",527)
						{
							HX_STACK_LINE(527)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(527)
			...
			struct _Function_3_1{
				inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/UserConstraint.hx",529)
					{
						HX_STACK_LINE(529)
						::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(529)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","warmStart","ZPP_UserConstraint.warmStart","zpp_nape/constraint/UserConstraint.hx",478)
		HX_STACK_THIS(this)
		HX_STACK_LINE(478)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(478)
		...
		while(((_g < _g1->length))){
			...
			HX_STACK_LINE(481)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/UserConstraint.hx",491)
						{
							HX_STACK_LINE(491)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(491)
				...
				struct _Function_3_2{
					inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/UserConstraint.hx",492)
						{
							HX_STACK_LINE(492)
							::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(492)
			...
			struct _Function_2_1{
				inline static Float Block( ::zpp_nape::constraint::ZPP_UserConstraint_obj *__this){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/UserConstraint.hx",494)
					{
						HX_STACK_LINE(494)
						::nape::geom::Vec3 _this = __this->vec3;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(494)
...
bool ZPP_UserConstraint_obj::preStep( Float dt){
	HX_STACK_FRAME("ZPP_UserConstraint","preStep","ZPP_UserConstraint.preStep","zpp_nape/constraint/UserConstraint.hx",441)
	HX_STACK_THIS(this)
	HX_STACK_ARG(dt,"dt")
	HX_STACK_LINE(445)
	if (((this->pre_dt == -1.0))){
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","transform","ZPP_UserConstraint.transform","zpp_nape/constraint/UserConstraint.hx",415)
		HX_STACK_THIS(this)
		HX_STACK_ARG(L,"L")
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(416)
...
Array< Float > ZPP_UserConstraint_obj::solve( Array< Float > m){
	HX_STACK_FRAME("ZPP_UserConstraint","solve","ZPP_UserConstraint.solve","zpp_nape/constraint/UserConstraint.hx",392)
	HX_STACK_THIS(this)
	HX_STACK_ARG(m,"m")
	HX_STACK_LINE(393)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","_clamp","ZPP_UserConstraint._clamp","zpp_nape/constraint/UserConstraint.hx",384)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
...
Float ZPP_UserConstraint_obj::lsq( Array< Float > v){
	HX_STACK_FRAME("ZPP_UserConstraint","lsq","ZPP_UserConstraint.lsq","zpp_nape/constraint/UserConstraint.hx",379)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(380)
	Float sum = 0.0;		HX_STACK_VAR(sum,"sum");
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","clearcache","ZPP_UserConstraint.clearcache","zpp_nape/constraint/UserConstraint.hx",375)
		HX_STACK_THIS(this)
		HX_STACK_LINE(376)
		{
			HX_STACK_LINE(376)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","broken","ZPP_UserConstraint.broken","zpp_nape/constraint/UserConstraint.hx",373)
		HX_STACK_THIS(this)
		HX_STACK_LINE(373)
...
bool ZPP_UserConstraint_obj::pair_exists( int id,int di){
	HX_STACK_FRAME("ZPP_UserConstraint","pair_exists","ZPP_UserConstraint.pair_exists","zpp_nape/constraint/UserConstraint.hx",356)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(357)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","forest","ZPP_UserConstraint.forest","zpp_nape/constraint/UserConstraint.hx",305)
		HX_STACK_THIS(this)
		HX_STACK_LINE(305)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(305)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","wake_connected","ZPP_UserConstraint.wake_connected","zpp_nape/constraint/UserConstraint.hx",300)
		HX_STACK_THIS(this)
		HX_STACK_LINE(300)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(300)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","validate","ZPP_UserConstraint.validate","zpp_nape/constraint/UserConstraint.hx",295)
		HX_STACK_THIS(this)
		HX_STACK_LINE(296)
		{
			HX_STACK_LINE(296)
...
::nape::constraint::Constraint ZPP_UserConstraint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	HX_STACK_FRAME("ZPP_UserConstraint","copy","ZPP_UserConstraint.copy","zpp_nape/constraint/UserConstraint.hx",254)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","inactiveBodies","ZPP_UserConstraint.inactiveBodies","zpp_nape/constraint/UserConstraint.hx",249)
		HX_STACK_THIS(this)
		HX_STACK_LINE(249)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(249)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","activeBodies","ZPP_UserConstraint.activeBodies","zpp_nape/constraint/UserConstraint.hx",244)
		HX_STACK_THIS(this)
		HX_STACK_LINE(244)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(244)
...
::nape::geom::Vec3 ZPP_UserConstraint_obj::bodyImpulse( ::zpp_nape::phys::ZPP_Body b){
	HX_STACK_FRAME("ZPP_UserConstraint","bodyImpulse","ZPP_UserConstraint.bodyImpulse","zpp_nape/constraint/UserConstraint.hx",237)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(238)
	{
...
bool ZPP_UserConstraint_obj::remBody( ::zpp_nape::phys::ZPP_Body b){
	HX_STACK_FRAME("ZPP_UserConstraint","remBody","ZPP_UserConstraint.remBody","zpp_nape/constraint/UserConstraint.hx",207)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(216)
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","addBody","ZPP_UserConstraint.addBody","zpp_nape/constraint/UserConstraint.hx",183)
		HX_STACK_THIS(this)
		HX_STACK_ARG(b,"b")
		HX_STACK_LINE(192)
		::zpp_nape::constraint::ZPP_UserBody match = null();		HX_STACK_VAR(match,"match");
...
{
		HX_STACK_FRAME("ZPP_UserConstraint","bindVec2_invalidate","ZPP_UserConstraint.bindVec2_invalidate","zpp_nape/constraint/UserConstraint.hx",177)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(177)
