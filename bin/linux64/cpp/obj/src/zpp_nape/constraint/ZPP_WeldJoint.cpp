...
{
HX_STACK_FRAME("ZPP_WeldJoint","new","ZPP_WeldJoint.new","zpp_nape/constraint/WeldJoint.hx",174)
{
	HX_STACK_LINE(330)
	this->stepped = false;
	HX_STACK_LINE(329)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","draw","ZPP_WeldJoint.draw","zpp_nape/constraint/WeldJoint.hx",1531)
		HX_STACK_THIS(this)
		HX_STACK_ARG(g,"g")
		HX_STACK_LINE(1532)
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1533)
				{
					HX_STACK_LINE(1533)
		...
		struct _Function_1_2{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
				HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1534)
				{
					HX_STACK_LINE(1534)
		...
		if ((!(this->stiff))){
			...
			HX_STACK_LINE(1537)
			{
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &n){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1537)
						{
							HX_STACK_LINE(1537)
							if (((bool((n != null())) && bool(n->zpp_disp)))){
								HX_STACK_LINE(1537)
			...
			struct _Function_2_1{
				inline static ::nape::space::Space Block( ::nape::constraint::WeldJoint &me){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1543)
					{
						HX_STACK_LINE(1543)
			...
			if (((((  (((me->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b1->outer) )) != (_Function_2_1::Block(me))->zpp_inner->__static))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1551)
						{
							HX_STACK_LINE(1551)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(1551)
				...
				struct _Function_3_2{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1552)
						{
							HX_STACK_LINE(1552)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(1552)
			...
			struct _Function_2_2{
				inline static ::nape::space::Space Block( ::nape::constraint::WeldJoint &me){
					HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1556)
					{
						HX_STACK_LINE(1556)
						::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(1556)
			...
			if (((((  (((me->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(me->zpp_inner_zn->b2->outer) )) != (_Function_2_2::Block(me))->zpp_inner->__static))){
				...
				struct _Function_3_1{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1564)
						{
							HX_STACK_LINE(1564)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(1564)
				...
				struct _Function_3_2{
					inline static ::nape::geom::Vec2 Block( ::nape::constraint::WeldJoint &me){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1565)
						{
							HX_STACK_LINE(1565)
							::nape::phys::Body _this;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(1565)
...
bool ZPP_WeldJoint_obj::applyImpulsePos( ){
	HX_STACK_FRAME("ZPP_WeldJoint","applyImpulsePos","ZPP_WeldJoint.applyImpulsePos","zpp_nape/constraint/WeldJoint.hx",1143)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1144)
	...
	struct _Function_1_1{
		inline static Float Block( ){
			HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",1196)
			{
				HX_STACK_LINE(1196)
...
bool ZPP_WeldJoint_obj::applyImpulseVel( ){
	HX_STACK_FRAME("ZPP_WeldJoint","applyImpulseVel","ZPP_WeldJoint.applyImpulseVel","zpp_nape/constraint/WeldJoint.hx",922)
	HX_STACK_THIS(this)
	HX_STACK_LINE(923)
	Float Ex = 0.0;		HX_STACK_VAR(Ex,"Ex");
	HX_STACK_LINE(924)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","warmStart","ZPP_WeldJoint.warmStart","zpp_nape/constraint/WeldJoint.hx",890)
		HX_STACK_THIS(this)
		HX_STACK_LINE(891)
		{
			HX_STACK_LINE(892)
...
bool ZPP_WeldJoint_obj::preStep( Float dt){
	HX_STACK_FRAME("ZPP_WeldJoint","preStep","ZPP_WeldJoint.preStep","zpp_nape/constraint/WeldJoint.hx",628)
	HX_STACK_THIS(this)
	HX_STACK_ARG(dt,"dt")
	HX_STACK_LINE(629)
	if (((this->pre_dt == -1.0))){
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","clearcache","ZPP_WeldJoint.clearcache","zpp_nape/constraint/WeldJoint.hx",602)
		HX_STACK_THIS(this)
		HX_STACK_LINE(603)
		{
			HX_STACK_LINE(604)
...
bool ZPP_WeldJoint_obj::pair_exists( int id,int di){
	HX_STACK_FRAME("ZPP_WeldJoint","pair_exists","ZPP_WeldJoint.pair_exists","zpp_nape/constraint/WeldJoint.hx",600)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
	HX_STACK_ARG(di,"di")
	HX_STACK_LINE(600)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","forest","ZPP_WeldJoint.forest","zpp_nape/constraint/WeldJoint.hx",501)
		HX_STACK_THIS(this)
		HX_STACK_LINE(502)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","wake_connected","ZPP_WeldJoint.wake_connected","zpp_nape/constraint/WeldJoint.hx",497)
		HX_STACK_THIS(this)
		HX_STACK_LINE(498)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","validate","ZPP_WeldJoint.validate","zpp_nape/constraint/WeldJoint.hx",491)
		HX_STACK_THIS(this)
		HX_STACK_LINE(492)
...
::nape::constraint::Constraint ZPP_WeldJoint_obj::copy( Array< ::Dynamic > dict,Array< ::Dynamic > todo){
	HX_STACK_FRAME("ZPP_WeldJoint","copy","ZPP_WeldJoint.copy","zpp_nape/constraint/WeldJoint.hx",331)
	HX_STACK_THIS(this)
	...
	struct _Function_1_1{
		inline static ::nape::geom::Vec2 Block( ::zpp_nape::constraint::ZPP_WeldJoint_obj *__this){
			HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",332)
			{
				HX_STACK_LINE(332)
	...
	if (((bool((dict != null())) && bool((this->b1 != null()))))){
		...
		if (((b != null()))){
			...
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/WeldJoint.hx",352)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(352)
	...
	if (((bool((dict != null())) && bool((this->b2 != null()))))){
		...
		if (((b != null()))){
			...
			HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_3_1,Array< ::Dynamic >,ret)
			Void run(::nape::phys::Body b1){
				HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","zpp_nape/constraint/WeldJoint.hx",373)
				HX_STACK_ARG(b1,"b1")
				{
					HX_STACK_LINE(373)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","setup_a2","ZPP_WeldJoint.setup_a2","zpp_nape/constraint/WeldJoint.hx",308)
		HX_STACK_THIS(this)
		HX_STACK_LINE(309)
		{
			HX_STACK_LINE(309)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",309)
						{
							HX_STACK_LINE(309)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(309)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","invalidate_a2","ZPP_WeldJoint.invalidate_a2","zpp_nape/constraint/WeldJoint.hx",284)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(285)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","validate_a2","ZPP_WeldJoint.validate_a2","zpp_nape/constraint/WeldJoint.hx",263)
		HX_STACK_THIS(this)
		HX_STACK_LINE(264)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","setup_a1","ZPP_WeldJoint.setup_a1","zpp_nape/constraint/WeldJoint.hx",250)
		HX_STACK_THIS(this)
		HX_STACK_LINE(251)
		{
			HX_STACK_LINE(251)
			...
			if (((ret->zpp_inner == null()))){
				...
				struct _Function_3_1{
					inline static Float Block( ::nape::geom::Vec2 &ret){
						HX_STACK_FRAME("*","closure","*.closure","zpp_nape/constraint/WeldJoint.hx",251)
						{
							HX_STACK_LINE(251)
							if (((bool((ret != null())) && bool(ret->zpp_disp)))){
								HX_STACK_LINE(251)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","invalidate_a1","ZPP_WeldJoint.invalidate_a1","zpp_nape/constraint/WeldJoint.hx",226)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(227)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","validate_a1","ZPP_WeldJoint.validate_a1","zpp_nape/constraint/WeldJoint.hx",205)
		HX_STACK_THIS(this)
		HX_STACK_LINE(206)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","inactiveBodies","ZPP_WeldJoint.inactiveBodies","zpp_nape/constraint/WeldJoint.hx",191)
		HX_STACK_THIS(this)
		HX_STACK_LINE(193)
		if (((this->b1 != null()))){
			HX_STACK_LINE(193)
...
{
		HX_STACK_FRAME("ZPP_WeldJoint","activeBodies","ZPP_WeldJoint.activeBodies","zpp_nape/constraint/WeldJoint.hx",183)
		HX_STACK_THIS(this)
		HX_STACK_LINE(185)
		if (((this->b1 != null()))){
			HX_STACK_LINE(185)
...
::nape::geom::Vec3 ZPP_WeldJoint_obj::bodyImpulse( ::zpp_nape::phys::ZPP_Body b){
	HX_STACK_FRAME("ZPP_WeldJoint","bodyImpulse","ZPP_WeldJoint.bodyImpulse","zpp_nape/constraint/WeldJoint.hx",177)
	HX_STACK_THIS(this)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(177)
	if ((this->stepped)){
