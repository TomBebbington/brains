...
{
HX_STACK_FRAME("Label","new","Label.new","com/haxepunk/debug/LayerList.hx",20)
{
	HX_STACK_LINE(20)
	super::__construct();
}
...
int Label_obj::set_layer( int value){
	HX_STACK_FRAME("Label","set_layer","Label.set_layer","com/haxepunk/debug/LayerList.hx",24)
	HX_STACK_THIS(this)
