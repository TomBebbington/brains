...
{
HX_STACK_FRAME("LayerList","new","LayerList.new","com/haxepunk/debug/LayerList.hx",37)
...
{
		HX_STACK_FRAME("LayerList","update","LayerList.update","com/haxepunk/debug/LayerList.hx",125)
		HX_STACK_THIS(this)
		HX_STACK_LINE(126)
...
{
		HX_STACK_FRAME("LayerList","onClick","LayerList.onClick","com/haxepunk/debug/LayerList.hx",114)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(115)
...
{
		HX_STACK_FRAME("LayerList","set","LayerList.set","com/haxepunk/debug/LayerList.hx",65)
		HX_STACK_THIS(this)
