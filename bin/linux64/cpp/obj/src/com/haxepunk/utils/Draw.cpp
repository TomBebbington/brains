...
Void Draw_obj::init( ){
{
		HX_STACK_FRAME("Draw","init","Draw.init","com/haxepunk/utils/Draw.hx",31)
		HX_STACK_LINE(32)
...
{
		HX_STACK_FRAME("Draw","setTarget","Draw.setTarget","com/haxepunk/utils/Draw.hx",52)
...
{
		HX_STACK_FRAME("Draw","resetTarget","Draw.resetTarget","com/haxepunk/utils/Draw.hx",62)
		HX_STACK_LINE(63)
...
{
		HX_STACK_FRAME("Draw","drawToScreen","Draw.drawToScreen","com/haxepunk/utils/Draw.hx",71)
		HX_STACK_LINE(71)
...
int color = __o_color.Default(16777215);
	HX_STACK_FRAME("Draw","line","Draw.line","com/haxepunk/utils/Draw.hx",91)
	HX_STACK_ARG(x1,"x1")
	HX_STACK_ARG(y1,"y1")
	HX_STACK_ARG(x2,"x2")
	HX_STACK_ARG(y2,"y2")
...
Float thick = __o_thick.Default(1);
	HX_STACK_FRAME("Draw","linePlus","Draw.linePlus","com/haxepunk/utils/Draw.hx",198)
	HX_STACK_ARG(x1,"x1")
	HX_STACK_ARG(y1,"y1")
	HX_STACK_ARG(x2,"x2")
	HX_STACK_ARG(y2,"y2")
...
int color = __o_color.Default(16777215);
Float alpha = __o_alpha.Default(1);
	HX_STACK_FRAME("Draw","rect","Draw.rect","com/haxepunk/utils/Draw.hx",226)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
...
int color = __o_color.Default(16777215);
	HX_STACK_FRAME("Draw","circle","Draw.circle","com/haxepunk/utils/Draw.hx",260)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
...
int thick = __o_thick.Default(1);
	HX_STACK_FRAME("Draw","circlePlus","Draw.circlePlus","com/haxepunk/utils/Draw.hx",313)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_ARG(radius,"radius")
	HX_STACK_ARG(color,"color")
...
int color = __o_color.Default(16777215);
Float alpha = __o_alpha.Default(1);
	HX_STACK_FRAME("Draw","hitbox","Draw.hitbox","com/haxepunk/utils/Draw.hx",355)
	HX_STACK_ARG(e,"e")
...
Float alpha = __o_alpha.Default(1);
	HX_STACK_FRAME("Draw","curve","Draw.curve","com/haxepunk/utils/Draw.hx",414)
	HX_STACK_ARG(x1,"x1")
	HX_STACK_ARG(y1,"y1")
	HX_STACK_ARG(x2,"x2")
	HX_STACK_ARG(y2,"y2")
...
int y = __o_y.Default(0);
	HX_STACK_FRAME("Draw","graphic","Draw.graphic","com/haxepunk/utils/Draw.hx",439)
	HX_STACK_ARG(g,"g")
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
{
...
Dynamic addEntityPosition = __o_addEntityPosition.Default(false);
	HX_STACK_FRAME("Draw","entity","Draw.entity","com/haxepunk/utils/Draw.hx",462)
	HX_STACK_ARG(e,"e")
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
...
Dynamic x = __o_x.Default(0);
Dynamic y = __o_y.Default(0);
	HX_STACK_FRAME("Draw","text","Draw.text","com/haxepunk/utils/Draw.hx",477)
