...
{
HX_STACK_FRAME("Touch","new","Touch.new","com/haxepunk/utils/Touch.hx",31)
...
{
		HX_STACK_FRAME("Touch","update","Touch.update","com/haxepunk/utils/Touch.hx",61)
		HX_STACK_THIS(this)
		HX_STACK_LINE(61)
...
bool Touch_obj::get_pressed( ){
	HX_STACK_FRAME("Touch","get_pressed","Touch.get_pressed","com/haxepunk/utils/Touch.hx",54)
	HX_STACK_THIS(this)
	HX_STACK_LINE(54)
...
Float Touch_obj::get_sceneY( ){
	HX_STACK_FRAME("Touch","get_sceneY","Touch.get_sceneY","com/haxepunk/utils/Touch.hx",48)
	HX_STACK_THIS(this)
	HX_STACK_LINE(48)
...
Float Touch_obj::get_sceneX( ){
	HX_STACK_FRAME("Touch","get_sceneX","Touch.get_sceneX","com/haxepunk/utils/Touch.hx",42)
	HX_STACK_THIS(this)
	HX_STACK_LINE(42)
