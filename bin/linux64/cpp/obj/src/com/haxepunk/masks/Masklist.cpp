...
{
HX_STACK_FRAME("Masklist","new","Masklist.new","com/haxepunk/masks/Masklist.hx",18)
...
int Masklist_obj::get_count( ){
	HX_STACK_FRAME("Masklist","get_count","Masklist.get_count","com/haxepunk/masks/Masklist.hx",175)
	HX_STACK_THIS(this)
	HX_STACK_LINE(175)
	return this->_count;
}
...
{
		HX_STACK_FRAME("Masklist","debugDraw","Masklist.debugDraw","com/haxepunk/masks/Masklist.hx",168)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Masklist","update","Masklist.update","com/haxepunk/masks/Masklist.hx",144)
		HX_STACK_THIS(this)
		HX_STACK_LINE(146)
...
{
		HX_STACK_FRAME("Masklist","assignTo","Masklist.assignTo","com/haxepunk/masks/Masklist.hx",137)
		HX_STACK_THIS(this)
...
int index = __o_index.Default(0);
	HX_STACK_FRAME("Masklist","getMask","Masklist.getMask","com/haxepunk/masks/Masklist.hx",133)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Masklist","removeAll","Masklist.removeAll","com/haxepunk/masks/Masklist.hx",118)
		HX_STACK_THIS(this)
		HX_STACK_LINE(119)
		{
			HX_STACK_LINE(119)
...
int index = __o_index.Default(0);
	HX_STACK_FRAME("Masklist","removeAt","Masklist.removeAt","com/haxepunk/masks/Masklist.hx",95)
	HX_STACK_THIS(this)
	HX_STACK_ARG(index,"index")
{
		HX_STACK_LINE(96)
...
::com::haxepunk::Mask Masklist_obj::remove( ::com::haxepunk::Mask mask){
	HX_STACK_FRAME("Masklist","remove","Masklist.remove","com/haxepunk/masks/Masklist.hx",70)
	HX_STACK_THIS(this)
...
::com::haxepunk::Mask Masklist_obj::add( ::com::haxepunk::Mask mask){
	HX_STACK_FRAME("Masklist","add","Masklist.add","com/haxepunk/masks/Masklist.hx",56)
	HX_STACK_THIS(this)
	HX_STACK_ARG(mask,"mask")
	HX_STACK_LINE(57)
...
bool Masklist_obj::collideMasklist( ::com::haxepunk::masks::Masklist other){
	HX_STACK_FRAME("Masklist","collideMasklist","Masklist.collideMasklist","com/haxepunk/masks/Masklist.hx",39)
	HX_STACK_THIS(this)
...
bool Masklist_obj::collide( ::com::haxepunk::Mask mask){
	HX_STACK_FRAME("Masklist","collide","Masklist.collide","com/haxepunk/masks/Masklist.hx",29)
	HX_STACK_THIS(this)
	HX_STACK_ARG(mask,"mask")
	HX_STACK_LINE(30)
	{
