...
{
HX_STACK_FRAME("Projection","new","Projection.new","com/haxepunk/math/Projection.hx",11)
{
	HX_STACK_LINE(11)
...
::String Projection_obj::toString( ){
	HX_STACK_FRAME("Projection","toString","Projection.toString","com/haxepunk/math/Projection.hx",26)
	HX_STACK_THIS(this)
	HX_STACK_LINE(26)
...
Float Projection_obj::getOverlap( ::com::haxepunk::math::Projection other){
	HX_STACK_FRAME("Projection","getOverlap","Projection.getOverlap","com/haxepunk/math/Projection.hx",21)
	HX_STACK_THIS(this)
...
bool Projection_obj::overlaps( ::com::haxepunk::math::Projection other){
	HX_STACK_FRAME("Projection","overlaps","Projection.overlaps","com/haxepunk/math/Projection.hx",16)
	HX_STACK_THIS(this)
	HX_STACK_ARG(other,"other")
	HX_STACK_LINE(16)
