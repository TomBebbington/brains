...
{
HX_STACK_FRAME("Vector","new","Vector.new","com/haxepunk/math/Vector.hx",10)
...
::com::haxepunk::math::Vector Vector_obj::cross( ){
	HX_STACK_FRAME("Vector","cross","Vector.cross","com/haxepunk/math/Vector.hx",23)
	HX_STACK_THIS(this)
	HX_STACK_LINE(23)
...
Float Vector_obj::dot( ::flash::geom::Point p){
	HX_STACK_FRAME("Vector","dot","Vector.dot","com/haxepunk/math/Vector.hx",18)
	HX_STACK_THIS(this)
	HX_STACK_ARG(p,"p")
	HX_STACK_LINE(18)
