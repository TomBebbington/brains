...
{
HX_STACK_FRAME("Tween","new","Tween.new","com/haxepunk/Tween.hx",40)
...
Float Tween_obj::get_scale( ){
	HX_STACK_FRAME("Tween","get_scale","Tween.get_scale","com/haxepunk/Tween.hx",127)
	HX_STACK_THIS(this)
	HX_STACK_LINE(127)
	return this->_t;
}
...
Float Tween_obj::set_percent( Float value){
	HX_STACK_FRAME("Tween","set_percent","Tween.set_percent","com/haxepunk/Tween.hx",124)
	HX_STACK_THIS(this)
...
Float Tween_obj::get_percent( ){
	HX_STACK_FRAME("Tween","get_percent","Tween.get_percent","com/haxepunk/Tween.hx",123)
	HX_STACK_THIS(this)
	HX_STACK_LINE(123)
...
{
		HX_STACK_FRAME("Tween","cancel","Tween.cancel","com/haxepunk/Tween.hx",114)
		HX_STACK_THIS(this)
		HX_STACK_LINE(115)
		this->active = false;
		HX_STACK_LINE(116)
...
{
		HX_STACK_FRAME("Tween","finish","Tween.finish","com/haxepunk/Tween.hx",90)
		HX_STACK_THIS(this)
		HX_STACK_LINE(91)
		{
			HX_STACK_LINE(91)
...
{
		HX_STACK_FRAME("Tween","start","Tween.start","com/haxepunk/Tween.hx",74)
		HX_STACK_THIS(this)
		HX_STACK_LINE(75)
		this->_time = (int)0;
		HX_STACK_LINE(76)
...
{
		HX_STACK_FRAME("Tween","update","Tween.update","com/haxepunk/Tween.hx",58)
		HX_STACK_THIS(this)
		HX_STACK_LINE(59)
