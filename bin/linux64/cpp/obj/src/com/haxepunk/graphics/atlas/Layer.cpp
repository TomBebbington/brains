...
{
HX_STACK_FRAME("Layer","new","Layer.new","com/haxepunk/graphics/atlas/AtlasData.hx",23)
{
	HX_STACK_LINE(24)
...
{
		HX_STACK_FRAME("Layer","prepare","Layer.prepare","com/haxepunk/graphics/atlas/AtlasData.hx",29)
		HX_STACK_THIS(this)
		HX_STACK_LINE(30)
		if (((this->index < this->data->length))){
			HX_STACK_LINE(32)
