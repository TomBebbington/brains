...
{
HX_STACK_FRAME("Graphiclist","new","Graphiclist.new","com/haxepunk/graphics/Graphiclist.hx",20)
...
{
		HX_STACK_FRAME("Graphiclist","updateCheck","Graphiclist.updateCheck","com/haxepunk/graphics/Graphiclist.hx",174)
		HX_STACK_THIS(this)
		HX_STACK_LINE(175)
		this->active = false;
		HX_STACK_LINE(176)
...
int Graphiclist_obj::set_layer( int value){
	HX_STACK_FRAME("Graphiclist","set_layer","Graphiclist.set_layer","com/haxepunk/graphics/Graphiclist.hx",162)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Graphiclist","setEntity","Graphiclist.setEntity","com/haxepunk/graphics/Graphiclist.hx",152)
		HX_STACK_THIS(this)
...
int Graphiclist_obj::get_count( ){
	HX_STACK_FRAME("Graphiclist","get_count","Graphiclist.get_count","com/haxepunk/graphics/Graphiclist.hx",149)
	HX_STACK_THIS(this)
	HX_STACK_LINE(149)
	return this->_count;
}
...
Array< ::Dynamic > Graphiclist_obj::get_children( ){
	HX_STACK_FRAME("Graphiclist","get_children","Graphiclist.get_children","com/haxepunk/graphics/Graphiclist.hx",143)
	HX_STACK_THIS(this)
	HX_STACK_LINE(143)
...
{
		HX_STACK_FRAME("Graphiclist","removeAll","Graphiclist.removeAll","com/haxepunk/graphics/Graphiclist.hx",132)
		HX_STACK_THIS(this)
		HX_STACK_LINE(133)
		{
			HX_STACK_LINE(133)
...
int index = __o_index.Default(0);
	HX_STACK_FRAME("Graphiclist","removeAt","Graphiclist.removeAt","com/haxepunk/graphics/Graphiclist.hx",121)
	HX_STACK_THIS(this)
...
::com::haxepunk::Graphic Graphiclist_obj::remove( ::com::haxepunk::Graphic graphic){
	HX_STACK_FRAME("Graphiclist","remove","Graphiclist.remove","com/haxepunk/graphics/Graphiclist.hx",99)
	HX_STACK_THIS(this)
	HX_STACK_ARG(graphic,"graphic")
	HX_STACK_LINE(100)
...
::com::haxepunk::Graphic Graphiclist_obj::add( ::com::haxepunk::Graphic graphic){
	HX_STACK_FRAME("Graphiclist","add","Graphiclist.add","com/haxepunk/graphics/Graphiclist.hx",85)
	HX_STACK_THIS(this)
	HX_STACK_ARG(graphic,"graphic")
	HX_STACK_LINE(86)
	if (((graphic == null()))){
...
{
		HX_STACK_FRAME("Graphiclist","destroy","Graphiclist.destroy","com/haxepunk/graphics/Graphiclist.hx",73)
		HX_STACK_THIS(this)
		HX_STACK_LINE(73)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(73)
...
{
		HX_STACK_FRAME("Graphiclist","render","Graphiclist.render","com/haxepunk/graphics/Graphiclist.hx",45)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Graphiclist","update","Graphiclist.update","com/haxepunk/graphics/Graphiclist.hx",37)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(37)
