...
{
HX_STACK_FRAME("Engine","new","Engine.new","com/haxepunk/Engine.hx",54)
...
bool fixed = __o_fixed.Default(false);
{
	...
	HX_STACK_LINE(62)
	{
		...
		HX_STACK_LINE(62)
		::com::haxepunk::HXP_obj::renderMode = i;
	}
	HX_STACK_LINE(66)
	if (((renderMode != null()))){
		HX_STACK_LINE(68)
...
{
		HX_STACK_FRAME("Engine","checkScene","Engine.checkScene","com/haxepunk/Engine.hx",362)
		HX_STACK_THIS(this)
		HX_STACK_LINE(363)
...
{
		HX_STACK_FRAME("Engine","onTimer","Engine.onTimer","com/haxepunk/Engine.hx",310)
		HX_STACK_THIS(this)
		HX_STACK_LINE(312)
			...
			if ((::com::haxepunk::HXP_obj::consoleEnabled())){
				struct _Function_3_1{
					inline static ::com::haxepunk::debug::Console Block( ){
						HX_STACK_FRAME("*","closure","*.closure","com/haxepunk/Engine.hx",338)
						{
							HX_STACK_LINE(338)
...
{
		HX_STACK_FRAME("Engine","onEnterFrame","Engine.onEnterFrame","com/haxepunk/Engine.hx",276)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(278)
		...
		if ((::com::haxepunk::HXP_obj::consoleEnabled())){
			struct _Function_2_1{
				inline static ::com::haxepunk::debug::Console Block( ){
					HX_STACK_FRAME("*","closure","*.closure","com/haxepunk/Engine.hx",290)
					{
						HX_STACK_LINE(290)
						if (((::com::haxepunk::HXP_obj::_console == null()))){
							HX_STACK_LINE(290)
...
{
		HX_STACK_FRAME("Engine","onStage","Engine.onStage","com/haxepunk/Engine.hx",233)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(241)
...
{
		HX_STACK_FRAME("Engine","resize","Engine.resize","com/haxepunk/Engine.hx",220)
		HX_STACK_THIS(this)
		HX_STACK_LINE(221)
...
{
		HX_STACK_FRAME("Engine","setStageProperties","Engine.setStageProperties","com/haxepunk/Engine.hx",178)
		HX_STACK_THIS(this)
		HX_STACK_LINE(177)
		...
		Void run(::flash::events::Event e){
			HX_STACK_FRAME("*","_Function_1_1","*._Function_1_1","com/haxepunk/Engine.hx",191)
			HX_STACK_ARG(e,"e")
			{
				HX_STACK_LINE(191)
		...
		Void run(::flash::events::Event e){
			HX_STACK_FRAME("*","_Function_1_2","*._Function_1_2","com/haxepunk/Engine.hx",194)
			HX_STACK_ARG(e,"e")
			{
				HX_STACK_LINE(195)
		...
		Void run(::flash::events::Event e){
			HX_STACK_FRAME("*","_Function_1_3","*._Function_1_3","com/haxepunk/Engine.hx",200)
			HX_STACK_ARG(e,"e")
			{
				HX_STACK_LINE(201)
		...
		bool run(int orientation){
			HX_STACK_FRAME("*","_Function_1_4","*._Function_1_4","com/haxepunk/Engine.hx",207)
...
{
		HX_STACK_FRAME("Engine","render","Engine.render","com/haxepunk/Engine.hx",144)
		HX_STACK_THIS(this)
		HX_STACK_LINE(145)
...
{
		HX_STACK_FRAME("Engine","update","Engine.update","com/haxepunk/Engine.hx",128)
		HX_STACK_THIS(this)
		HX_STACK_LINE(129)
		::com::haxepunk::HXP_obj::_scene->updateLists(null());
		HX_STACK_LINE(130)
...
{
		HX_STACK_FRAME("Engine","focusLost","Engine.focusLost","com/haxepunk/Engine.hx",122)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("Engine","focusGained","Engine.focusGained","com/haxepunk/Engine.hx",117)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("Engine","init","Engine.init","com/haxepunk/Engine.hx",112)
		HX_STACK_THIS(this)
	}
return null();
}
