...
{
HX_STACK_FRAME("MultiVarTween","new","MultiVarTween.new","com/haxepunk/tweens/misc/MultiVarTween.hx",17)
...
{
		HX_STACK_FRAME("MultiVarTween","update","MultiVarTween.update","com/haxepunk/tweens/misc/MultiVarTween.hx",69)
		HX_STACK_THIS(this)
		HX_STACK_LINE(70)
		this->super::update();
		HX_STACK_LINE(71)
...
{
		HX_STACK_FRAME("MultiVarTween","tween","MultiVarTween.tween","com/haxepunk/tweens/misc/MultiVarTween.hx",33)
		HX_STACK_THIS(this)
