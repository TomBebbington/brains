...
{
HX_STACK_FRAME("Alarm","new","Alarm.new","com/haxepunk/tweens/misc/Alarm.hx",18)
...
Float Alarm_obj::get_remaining( ){
	HX_STACK_FRAME("Alarm","get_remaining","Alarm.get_remaining","com/haxepunk/tweens/misc/Alarm.hx",47)
	HX_STACK_THIS(this)
	HX_STACK_LINE(47)
...
Float Alarm_obj::get_duration( ){
	HX_STACK_FRAME("Alarm","get_duration","Alarm.get_duration","com/haxepunk/tweens/misc/Alarm.hx",41)
	HX_STACK_THIS(this)
	HX_STACK_LINE(41)
	return this->_target;
}
...
Float Alarm_obj::get_elapsed( ){
	HX_STACK_FRAME("Alarm","get_elapsed","Alarm.get_elapsed","com/haxepunk/tweens/misc/Alarm.hx",35)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
	return this->_time;
}
...
{
		HX_STACK_FRAME("Alarm","reset","Alarm.reset","com/haxepunk/tweens/misc/Alarm.hx",26)
		HX_STACK_THIS(this)
		HX_STACK_ARG(duration,"duration")
		HX_STACK_LINE(27)
