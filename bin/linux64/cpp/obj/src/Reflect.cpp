...
bool Reflect_obj::hasField( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","hasField","Reflect.hasField","Reflect.hx",25)
	HX_STACK_ARG(o,"o")
...
Dynamic Reflect_obj::field( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","field","Reflect.field","Reflect.hx",29)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(29)
	if (((o == null()))){
...
{
		HX_STACK_FRAME("Reflect","setField","Reflect.setField","Reflect.hx",33)
		HX_STACK_ARG(o,"o")
		HX_STACK_ARG(field,"field")
...
Dynamic Reflect_obj::callMethod( Dynamic o,Dynamic func,Dynamic args){
	HX_STACK_FRAME("Reflect","callMethod","Reflect.callMethod","Reflect.hx",46)
	HX_STACK_ARG(o,"o")
...
Array< ::String > Reflect_obj::fields( Dynamic o){
	HX_STACK_FRAME("Reflect","fields","Reflect.fields","Reflect.hx",53)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(54)
	if (((o == null()))){
		HX_STACK_LINE(54)
...
bool Reflect_obj::isFunction( Dynamic f){
	HX_STACK_FRAME("Reflect","isFunction","Reflect.isFunction","Reflect.hx",61)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(61)
...
bool Reflect_obj::compareMethods( Dynamic f1,Dynamic f2){
	HX_STACK_FRAME("Reflect","compareMethods","Reflect.compareMethods","Reflect.hx",68)
	HX_STACK_ARG(f1,"f1")
	HX_STACK_ARG(f2,"f2")
	HX_STACK_LINE(69)
	if (((f1 == f2))){
...
bool Reflect_obj::isObject( Dynamic v){
	HX_STACK_FRAME("Reflect","isObject","Reflect.isObject","Reflect.hx",76)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(77)
	if (((v == null()))){
		HX_STACK_LINE(77)
...
bool Reflect_obj::deleteField( Dynamic o,::String field){
	HX_STACK_FRAME("Reflect","deleteField","Reflect.deleteField","Reflect.hx",87)
	HX_STACK_ARG(o,"o")
	HX_STACK_ARG(field,"field")
	HX_STACK_LINE(88)
	if (((o == null()))){
...
Dynamic Reflect_obj::copy( Dynamic o){
	HX_STACK_FRAME("Reflect","copy","Reflect.copy","Reflect.hx",92)
	HX_STACK_ARG(o,"o")
	HX_STACK_LINE(93)
	if (((o == null()))){
		HX_STACK_LINE(93)
	...
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_FRAME("*","closure","*.closure","Reflect.hx",97)
			{
...
Dynamic Reflect_obj::makeVarArgs( Dynamic f){
	HX_STACK_FRAME("Reflect","makeVarArgs","Reflect.makeVarArgs","Reflect.hx",105)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(105)
