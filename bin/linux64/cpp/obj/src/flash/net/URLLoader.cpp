...
{
HX_STACK_FRAME("URLLoader","new","URLLoader.new","flash/net/URLLoader.hx",35)
...
{
		HX_STACK_FRAME("URLLoader","__dataComplete","URLLoader.__dataComplete","flash/net/URLLoader.hx",215)
		HX_STACK_THIS(this)
		HX_STACK_LINE(217)
...
{
		HX_STACK_FRAME("URLLoader","update","URLLoader.update","flash/net/URLLoader.hx",153)
		HX_STACK_THIS(this)
		HX_STACK_LINE(153)
			...
			if (((this->state == (int)3))){
				...
				if (((code < (int)400))){
					...
					HX_STACK_LINE(181)
					{
						...
						HX_STACK_LINE(181)
						switch( (int)(_g->dataFormat->__Index())){
...
{
		HX_STACK_FRAME("URLLoader","dispatchHTTPStatus","URLLoader.dispatchHTTPStatus","flash/net/URLLoader.hx",146)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("URLLoader","onError","URLLoader.onError","flash/net/URLLoader.hx",136)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("URLLoader","load","URLLoader.load","flash/net/URLLoader.hx",82)
		HX_STACK_THIS(this)
		HX_STACK_ARG(request,"request")
		HX_STACK_LINE(84)
		this->state = (int)1;
...
Array< ::String > URLLoader_obj::getCookies( ){
	HX_STACK_FRAME("URLLoader","getCookies","URLLoader.getCookies","flash/net/URLLoader.hx",63)
	HX_STACK_THIS(this)
	HX_STACK_LINE(63)
...
{
		HX_STACK_FRAME("URLLoader","close","URLLoader.close","flash/net/URLLoader.hx",54)
		HX_STACK_THIS(this)
	}
return null();
}
...
bool URLLoader_obj::hasActive( ){
	HX_STACK_FRAME("URLLoader","hasActive","URLLoader.hasActive","flash/net/URLLoader.hx",70)
	HX_STACK_LINE(70)
...
{
		HX_STACK_FRAME("URLLoader","initialize","URLLoader.initialize","flash/net/URLLoader.hx",77)
...
bool URLLoader_obj::__loadPending( ){
	HX_STACK_FRAME("URLLoader","__loadPending","URLLoader.__loadPending","flash/net/URLLoader.hx",242)
	HX_STACK_LINE(242)
	return !(::flash::net::URLLoader_obj::activeLoaders->isEmpty());
}
...
{
		HX_STACK_FRAME("URLLoader","__pollData","URLLoader.__pollData","flash/net/URLLoader.hx",249)
		HX_STACK_LINE(249)
