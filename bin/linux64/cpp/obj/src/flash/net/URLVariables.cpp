...
{
HX_STACK_FRAME("URLVariables","new","URLVariables.new","flash/net/URLVariables.hx",9)
...
::String URLVariables_obj::toString( ){
	HX_STACK_FRAME("URLVariables","toString","URLVariables.toString","flash/net/URLVariables.hx",49)
	HX_STACK_THIS(this)
	HX_STACK_LINE(51)
...
{
		HX_STACK_FRAME("URLVariables","decode","URLVariables.decode","flash/net/URLVariables.hx",18)
		HX_STACK_THIS(this)
		...
		HX_STACK_LINE(30)
		{
			...
			while(((_g < fields1->length))){
				...
				if (((index > (int)0))){
					HX_STACK_LINE(36)
					::String field1 = ::StringTools_obj::urlDecode(field.substr((int)0,index));		HX_STACK_VAR(field1,"field1");
					HX_STACK_LINE(36)
					Dynamic value = ::StringTools_obj::urlDecode(field.substr((index + (int)1),null()));		HX_STACK_VAR(value,"value");
					HX_STACK_LINE(36)
