...
{
HX_STACK_FRAME("URLRequest","new","URLRequest.new","flash/net/URLRequest.hx",30)
...
{
		HX_STACK_FRAME("URLRequest","__prepare","URLRequest.__prepare","flash/net/URLRequest.hx",68)
		HX_STACK_THIS(this)
		HX_STACK_LINE(68)
		if (((this->data == null()))){
			HX_STACK_LINE(70)
...
{
		HX_STACK_FRAME("URLRequest","digestAuth","URLRequest.digestAuth","flash/net/URLRequest.hx",58)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("URLRequest","basicAuth","URLRequest.basicAuth","flash/net/URLRequest.hx",50)
		HX_STACK_THIS(this)
		HX_STACK_ARG(user,"user")
		HX_STACK_ARG(password,"password")
		HX_STACK_LINE(52)
