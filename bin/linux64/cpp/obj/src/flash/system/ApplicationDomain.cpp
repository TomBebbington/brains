...
{
HX_STACK_FRAME("ApplicationDomain","new","ApplicationDomain.new","flash/system/ApplicationDomain.hx",14)
...
bool ApplicationDomain_obj::hasDefinition( ::String name){
	HX_STACK_FRAME("ApplicationDomain","hasDefinition","ApplicationDomain.hasDefinition","flash/system/ApplicationDomain.hx",36)
	HX_STACK_THIS(this)
...
Dynamic ApplicationDomain_obj::getDefinition( ::String name){
	HX_STACK_FRAME("ApplicationDomain","getDefinition","ApplicationDomain.getDefinition","flash/system/ApplicationDomain.hx",29)
	HX_STACK_THIS(this)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(29)
