...
{
HX_STACK_FRAME("Font","new","Font.new","flash/text/Font.hx",24)
...
::String Font_obj::toString( ){
	HX_STACK_FRAME("Font","toString","Font.toString","flash/text/Font.hx",134)
	HX_STACK_THIS(this)
	HX_STACK_LINE(134)
...
bool enumerateDeviceFonts = __o_enumerateDeviceFonts.Default(false);
	HX_STACK_FRAME("Font","enumerateFonts","Font.enumerateFonts","flash/text/Font.hx",74)
		...
		if ((enumerateDeviceFonts)){
			...
			if (((::flash::text::Font_obj::__deviceFonts == null()))){
				...
				Void run(::String name,int style){
					HX_STACK_FRAME("*","_Function_3_1","*._Function_3_1","flash/text/Font.hx",84)
...
Dynamic Font_obj::load( ::String filename){
	HX_STACK_FRAME("Font","load","Font.load","flash/text/Font.hx",97)
...
Dynamic Font_obj::loadBytes( ::flash::utils::ByteArray bytes){
	HX_STACK_FRAME("Font","loadBytes","Font.loadBytes","flash/text/Font.hx",105)
...
{
		HX_STACK_FRAME("Font","registerFont","Font.registerFont","flash/text/Font.hx",113)
