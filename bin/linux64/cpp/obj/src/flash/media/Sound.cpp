...
{
HX_STACK_FRAME("Sound","new","Sound.new","flash/media/Sound.hx",31)
...
Float Sound_obj::get_length( ){
	HX_STACK_FRAME("Sound","get_length","Sound.get_length","flash/media/Sound.hx",278)
	HX_STACK_THIS(this)
	HX_STACK_LINE(280)
...
bool Sound_obj::get_isBuffering( ){
	HX_STACK_FRAME("Sound","get_isBuffering","Sound.get_isBuffering","flash/media/Sound.hx",270)
	HX_STACK_THIS(this)
	HX_STACK_LINE(272)
	this->__checkLoading();
	HX_STACK_LINE(273)
...
::flash::media::ID3Info Sound_obj::get_id3( ){
	HX_STACK_FRAME("Sound","get_id3","Sound.get_id3","flash/media/Sound.hx",253)
	HX_STACK_THIS(this)
	HX_STACK_LINE(255)
	this->__checkLoading();
	HX_STACK_LINE(257)
...
{
		HX_STACK_FRAME("Sound","__onError","Sound.__onError","flash/media/Sound.hx",237)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Sound","__checkLoading","Sound.__checkLoading","flash/media/Sound.hx",212)
		HX_STACK_THIS(this)
		HX_STACK_LINE(212)
...
int loops = __o_loops.Default(0);
	HX_STACK_FRAME("Sound","play","Sound.play","flash/media/Sound.hx",170)
	HX_STACK_THIS(this)
...
Float sampleRate = __o_sampleRate.Default(44100.0);
	HX_STACK_FRAME("Sound","loadPCMFromByteArray","Sound.loadPCMFromByteArray","flash/media/Sound.hx",122)
	HX_STACK_THIS(this)
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_FRAME("Sound","loadCompressedDataFromByteArray","Sound.loadCompressedDataFromByteArray","flash/media/Sound.hx",106)
	HX_STACK_THIS(this)
	HX_STACK_ARG(bytes,"bytes")
...
bool forcePlayAsMusic = __o_forcePlayAsMusic.Default(false);
	HX_STACK_FRAME("Sound","load","Sound.load","flash/media/Sound.hx",83)
	HX_STACK_THIS(this)
	HX_STACK_ARG(stream,"stream")
	HX_STACK_ARG(context,"context")
	HX_STACK_ARG(forcePlayAsMusic,"forcePlayAsMusic")
{
		...
		if (((this->__handle == null()))){
			HX_STACK_LINE(92)
			HX_STACK_DO_THROW((HX_CSTRING("Could not load:") + stream->url));
		}
		else{
			HX_STACK_LINE(96)
			this->url = stream->url;
...
{
		HX_STACK_FRAME("Sound","close","Sound.close","flash/media/Sound.hx",69)
		HX_STACK_THIS(this)
		HX_STACK_LINE(71)
		if (((this->__handle != null()))){
			HX_STACK_LINE(73)
...
bool useWeakReference = __o_useWeakReference.Default(false);
	HX_STACK_FRAME("Sound","addEventListener","Sound.addEventListener","flash/media/Sound.hx",49)
	HX_STACK_THIS(this)
