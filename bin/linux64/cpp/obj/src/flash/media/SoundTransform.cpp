...
{
HX_STACK_FRAME("SoundTransform","new","SoundTransform.new","flash/media/SoundTransform.hx",11)
...
::flash::media::SoundTransform SoundTransform_obj::clone( ){
	HX_STACK_FRAME("SoundTransform","clone","SoundTransform.clone","flash/media/SoundTransform.hx",21)
	HX_STACK_THIS(this)
	HX_STACK_LINE(21)
