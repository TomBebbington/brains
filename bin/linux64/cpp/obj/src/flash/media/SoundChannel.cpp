...
{
HX_STACK_FRAME("SoundChannel","new","SoundChannel.new","flash/media/SoundChannel.hx",26)
...
::flash::media::SoundTransform SoundChannel_obj::set_soundTransform( ::flash::media::SoundTransform value){
	HX_STACK_FRAME("SoundChannel","set_soundTransform","SoundChannel.set_soundTransform","flash/media/SoundChannel.hx",171)
	HX_STACK_THIS(this)
...
::flash::media::SoundTransform SoundChannel_obj::get_soundTransform( ){
	HX_STACK_FRAME("SoundChannel","get_soundTransform","SoundChannel.get_soundTransform","flash/media/SoundChannel.hx",158)
	HX_STACK_THIS(this)
	HX_STACK_LINE(160)
...
Float SoundChannel_obj::set_position( Float value){
	HX_STACK_FRAME("SoundChannel","set_position","SoundChannel.set_position","flash/media/SoundChannel.hx",155)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(155)
...
Float SoundChannel_obj::get_position( ){
	HX_STACK_FRAME("SoundChannel","get_position","SoundChannel.get_position","flash/media/SoundChannel.hx",154)
	HX_STACK_THIS(this)
	HX_STACK_LINE(154)
...
Float SoundChannel_obj::get_rightPeak( ){
	HX_STACK_FRAME("SoundChannel","get_rightPeak","SoundChannel.get_rightPeak","flash/media/SoundChannel.hx",153)
	HX_STACK_THIS(this)
	HX_STACK_LINE(153)
...
Float SoundChannel_obj::get_leftPeak( ){
	HX_STACK_FRAME("SoundChannel","get_leftPeak","SoundChannel.get_leftPeak","flash/media/SoundChannel.hx",152)
	HX_STACK_THIS(this)
	HX_STACK_LINE(152)
...
bool SoundChannel_obj::__checkComplete( ){
	HX_STACK_FRAME("SoundChannel","__checkComplete","SoundChannel.__checkComplete","flash/media/SoundChannel.hx",74)
	HX_STACK_THIS(this)
	HX_STACK_LINE(76)
	if (((this->__handle != null()))){
		HX_STACK_LINE(78)
...
{
		HX_STACK_FRAME("SoundChannel","stop","SoundChannel.stop","flash/media/SoundChannel.hx",66)
		HX_STACK_THIS(this)
		HX_STACK_LINE(68)
...
::flash::media::SoundChannel SoundChannel_obj::createDynamic( Dynamic handle,::flash::media::SoundTransform soundTransform,::flash::events::EventDispatcher dataProvider){
	HX_STACK_FRAME("SoundChannel","createDynamic","SoundChannel.createDynamic","flash/media/SoundChannel.hx",51)
	HX_STACK_ARG(handle,"handle")
	HX_STACK_ARG(soundTransform,"soundTransform")
...
bool SoundChannel_obj::__completePending( ){
	HX_STACK_FRAME("SoundChannel","__completePending","SoundChannel.__completePending","flash/media/SoundChannel.hx",117)
	HX_STACK_LINE(117)
...
{
		HX_STACK_FRAME("SoundChannel","__pollComplete","SoundChannel.__pollComplete","flash/media/SoundChannel.hx",124)
		HX_STACK_LINE(124)
