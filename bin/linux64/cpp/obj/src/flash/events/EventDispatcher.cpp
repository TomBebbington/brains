...
{
HX_STACK_FRAME("EventDispatcher","new","EventDispatcher.new","flash/events/EventDispatcher.hx",16)
...
{
		HX_STACK_FRAME("EventDispatcher","__dispatchIOErrorEvent","EventDispatcher.__dispatchIOErrorEvent","flash/events/EventDispatcher.hx",198)
		HX_STACK_THIS(this)
		HX_STACK_LINE(198)
...
{
		HX_STACK_FRAME("EventDispatcher","__dispatchCompleteEvent","EventDispatcher.__dispatchCompleteEvent","flash/events/EventDispatcher.hx",191)
		HX_STACK_THIS(this)
		HX_STACK_LINE(191)
...
bool EventDispatcher_obj::willTrigger( ::String type){
	HX_STACK_FRAME("EventDispatcher","willTrigger","EventDispatcher.willTrigger","flash/events/EventDispatcher.hx",176)
	HX_STACK_THIS(this)
...
::String EventDispatcher_obj::toString( ){
	HX_STACK_FRAME("EventDispatcher","toString","EventDispatcher.toString","flash/events/EventDispatcher.hx",171)
	HX_STACK_THIS(this)
	HX_STACK_LINE(171)
...
bool capture = __o_capture.Default(false);
	HX_STACK_FRAME("EventDispatcher","removeEventListener","EventDispatcher.removeEventListener","flash/events/EventDispatcher.hx",139)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
...
bool EventDispatcher_obj::hasEventListener( ::String type){
	HX_STACK_FRAME("EventDispatcher","hasEventListener","EventDispatcher.hasEventListener","flash/events/EventDispatcher.hx",114)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
	HX_STACK_LINE(116)
	if (((this->__eventMap == null()))){
...
bool EventDispatcher_obj::dispatchEvent( ::flash::events::Event event){
	HX_STACK_FRAME("EventDispatcher","dispatchEvent","EventDispatcher.dispatchEvent","flash/events/EventDispatcher.hx",47)
	HX_STACK_THIS(this)
...
bool useWeakReference = __o_useWeakReference.Default(false);
	HX_STACK_FRAME("EventDispatcher","addEventListener","EventDispatcher.addEventListener","flash/events/EventDispatcher.hx",24)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
	HX_STACK_ARG(listener,"listener")
...
int EventDispatcher_obj::__sortEvents( ::openfl::utils::WeakRef a,::openfl::utils::WeakRef b){
	HX_STACK_FRAME("EventDispatcher","__sortEvents","EventDispatcher.__sortEvents","flash/events/EventDispatcher.hx",203)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(205)
