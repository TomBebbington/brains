...
{
HX_STACK_FRAME("ErrorEvent","new","ErrorEvent.new","flash/events/ErrorEvent.hx",12)
...
::String ErrorEvent_obj::toString( ){
	HX_STACK_FRAME("ErrorEvent","toString","ErrorEvent.toString","flash/events/ErrorEvent.hx",29)
	HX_STACK_THIS(this)
	HX_STACK_LINE(29)
...
::flash::events::Event ErrorEvent_obj::clone( ){
	HX_STACK_FRAME("ErrorEvent","clone","ErrorEvent.clone","flash/events/ErrorEvent.hx",22)
	HX_STACK_THIS(this)
	HX_STACK_LINE(22)
