...
{
HX_STACK_FRAME("ProgressEvent","new","ProgressEvent.new","flash/events/ProgressEvent.hx",14)
...
::String ProgressEvent_obj::toString( ){
	HX_STACK_FRAME("ProgressEvent","toString","ProgressEvent.toString","flash/events/ProgressEvent.hx",33)
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)
...
::flash::events::Event ProgressEvent_obj::clone( ){
	HX_STACK_FRAME("ProgressEvent","clone","ProgressEvent.clone","flash/events/ProgressEvent.hx",26)
	HX_STACK_THIS(this)
	HX_STACK_LINE(26)
