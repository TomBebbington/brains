...
{
HX_STACK_FRAME("SampleDataEvent","new","SampleDataEvent.new","flash/events/SampleDataEvent.hx",16)
...
::String SampleDataEvent_obj::toString( ){
	HX_STACK_FRAME("SampleDataEvent","toString","SampleDataEvent.toString","flash/events/SampleDataEvent.hx",36)
	HX_STACK_THIS(this)
	HX_STACK_LINE(36)
...
::flash::events::Event SampleDataEvent_obj::clone( ){
	HX_STACK_FRAME("SampleDataEvent","clone","SampleDataEvent.clone","flash/events/SampleDataEvent.hx",29)
	HX_STACK_THIS(this)
	HX_STACK_LINE(29)
