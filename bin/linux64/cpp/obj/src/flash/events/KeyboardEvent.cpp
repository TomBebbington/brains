...
{
HX_STACK_FRAME("KeyboardEvent","new","KeyboardEvent.new","flash/events/KeyboardEvent.hx",19)
...
::String KeyboardEvent_obj::toString( ){
	HX_STACK_FRAME("KeyboardEvent","toString","KeyboardEvent.toString","flash/events/KeyboardEvent.hx",45)
	HX_STACK_THIS(this)
	HX_STACK_LINE(45)
...
::flash::events::Event KeyboardEvent_obj::clone( ){
	HX_STACK_FRAME("KeyboardEvent","clone","KeyboardEvent.clone","flash/events/KeyboardEvent.hx",38)
	HX_STACK_THIS(this)
	HX_STACK_LINE(38)
