...
{
HX_STACK_FRAME("Event","new","Event.new","flash/events/Event.hx",51)
...
::String Event_obj::get_type( ){
	HX_STACK_FRAME("Event","get_type","Event.get_type","flash/events/Event.hx",137)
	HX_STACK_THIS(this)
	HX_STACK_LINE(137)
	return this->__type;
}
...
Dynamic Event_obj::set_target( Dynamic value){
	HX_STACK_FRAME("Event","set_target","Event.set_target","flash/events/Event.hx",136)
	HX_STACK_THIS(this)
...
Dynamic Event_obj::get_target( ){
	HX_STACK_FRAME("Event","get_target","Event.get_target","flash/events/Event.hx",135)
	HX_STACK_THIS(this)
	HX_STACK_LINE(135)
...
::flash::events::EventPhase Event_obj::get_eventPhase( ){
	HX_STACK_FRAME("Event","get_eventPhase","Event.get_eventPhase","flash/events/Event.hx",134)
	HX_STACK_THIS(this)
	HX_STACK_LINE(134)
...
Dynamic Event_obj::set_currentTarget( Dynamic value){
	HX_STACK_FRAME("Event","set_currentTarget","Event.set_currentTarget","flash/events/Event.hx",133)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(133)
...
Dynamic Event_obj::get_currentTarget( ){
	HX_STACK_FRAME("Event","get_currentTarget","Event.get_currentTarget","flash/events/Event.hx",132)
	HX_STACK_THIS(this)
	HX_STACK_LINE(132)
...
bool Event_obj::get_cancelable( ){
	HX_STACK_FRAME("Event","get_cancelable","Event.get_cancelable","flash/events/Event.hx",131)
	HX_STACK_THIS(this)
	HX_STACK_LINE(131)
...
bool Event_obj::get_bubbles( ){
	HX_STACK_FRAME("Event","get_bubbles","Event.get_bubbles","flash/events/Event.hx",130)
	HX_STACK_THIS(this)
	HX_STACK_LINE(130)
...
{
		HX_STACK_FRAME("Event","__setPhase","Event.__setPhase","flash/events/Event.hx",118)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(118)
...
bool Event_obj::__getIsCancelledNow( ){
	HX_STACK_FRAME("Event","__getIsCancelledNow","Event.__getIsCancelledNow","flash/events/Event.hx",111)
	HX_STACK_THIS(this)
	HX_STACK_LINE(111)
...
bool Event_obj::__getIsCancelled( ){
	HX_STACK_FRAME("Event","__getIsCancelled","Event.__getIsCancelled","flash/events/Event.hx",104)
	HX_STACK_THIS(this)
	HX_STACK_LINE(104)
...
::String Event_obj::toString( ){
	HX_STACK_FRAME("Event","toString","Event.toString","flash/events/Event.hx",97)
	HX_STACK_THIS(this)
	HX_STACK_LINE(97)
...
{
		HX_STACK_FRAME("Event","stopPropagation","Event.stopPropagation","flash/events/Event.hx",86)
		HX_STACK_THIS(this)
		HX_STACK_LINE(86)
...
{
		HX_STACK_FRAME("Event","stopImmediatePropagation","Event.stopImmediatePropagation","flash/events/Event.hx",74)
		HX_STACK_THIS(this)
		HX_STACK_LINE(74)
		if ((this->get_cancelable())){
			HX_STACK_LINE(76)
...
::flash::events::Event Event_obj::clone( ){
	HX_STACK_FRAME("Event","clone","Event.clone","flash/events/Event.hx",67)
	HX_STACK_THIS(this)
	HX_STACK_LINE(67)
