...
{
HX_STACK_FRAME("FocusEvent","new","FocusEvent.new","flash/events/FocusEvent.hx",20)
...
::String FocusEvent_obj::toString( ){
	HX_STACK_FRAME("FocusEvent","toString","FocusEvent.toString","flash/events/FocusEvent.hx",40)
	HX_STACK_THIS(this)
	HX_STACK_LINE(40)
...
::flash::events::Event FocusEvent_obj::clone( ){
	HX_STACK_FRAME("FocusEvent","clone","FocusEvent.clone","flash/events/FocusEvent.hx",33)
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)
