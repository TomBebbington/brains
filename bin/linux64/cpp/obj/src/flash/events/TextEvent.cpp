...
{
HX_STACK_FRAME("TextEvent","new","TextEvent.new","flash/events/TextEvent.hx",13)
...
::String TextEvent_obj::toString( ){
	HX_STACK_FRAME("TextEvent","toString","TextEvent.toString","flash/events/TextEvent.hx",31)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
...
::flash::events::Event TextEvent_obj::clone( ){
	HX_STACK_FRAME("TextEvent","clone","TextEvent.clone","flash/events/TextEvent.hx",24)
	HX_STACK_THIS(this)
	HX_STACK_LINE(24)
