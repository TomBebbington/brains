...
{
HX_STACK_FRAME("MouseEvent","new","MouseEvent.new","flash/events/MouseEvent.hx",47)
...
::flash::events::MouseEvent MouseEvent_obj::__createSimilar( ::String type,::flash::display::InteractiveObject related,::flash::display::InteractiveObject target){
	HX_STACK_FRAME("MouseEvent","__createSimilar","MouseEvent.__createSimilar","flash/events/MouseEvent.hx",98)
	HX_STACK_THIS(this)
	HX_STACK_ARG(type,"type")
...
{
		HX_STACK_FRAME("MouseEvent","updateAfterEvent","MouseEvent.updateAfterEvent","flash/events/MouseEvent.hx",79)
		HX_STACK_THIS(this)
	}
return null();
}
...
::String MouseEvent_obj::toString( ){
	HX_STACK_FRAME("MouseEvent","toString","MouseEvent.toString","flash/events/MouseEvent.hx",74)
	HX_STACK_THIS(this)
	HX_STACK_LINE(74)
...
::flash::events::Event MouseEvent_obj::clone( ){
	HX_STACK_FRAME("MouseEvent","clone","MouseEvent.clone","flash/events/MouseEvent.hx",67)
	HX_STACK_THIS(this)
	HX_STACK_LINE(67)
...
::flash::events::MouseEvent MouseEvent_obj::__create( ::String type,Dynamic event,::flash::geom::Point local,::flash::display::InteractiveObject target){
	HX_STACK_FRAME("MouseEvent","__create","MouseEvent.__create","flash/events/MouseEvent.hx",86)
	HX_STACK_ARG(type,"type")
