...
{
HX_STACK_FRAME("IOErrorEvent","new","IOErrorEvent.new","flash/events/IOErrorEvent.hx",12)
...
::String IOErrorEvent_obj::toString( ){
	HX_STACK_FRAME("IOErrorEvent","toString","IOErrorEvent.toString","flash/events/IOErrorEvent.hx",26)
	HX_STACK_THIS(this)
	HX_STACK_LINE(26)
...
::flash::events::Event IOErrorEvent_obj::clone( ){
	HX_STACK_FRAME("IOErrorEvent","clone","IOErrorEvent.clone","flash/events/IOErrorEvent.hx",19)
	HX_STACK_THIS(this)
	HX_STACK_LINE(19)
