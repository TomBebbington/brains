...
{
HX_STACK_FRAME("Listener","new","Listener.new","flash/events/EventDispatcher.hx",247)
...
bool Listener_obj::is( Dynamic listener,bool useCapture){
	HX_STACK_FRAME("Listener","is","Listener.is","flash/events/EventDispatcher.hx",266)
	HX_STACK_THIS(this)
	HX_STACK_ARG(listener,"listener")
	HX_STACK_ARG(useCapture,"useCapture")
	HX_STACK_LINE(266)
...
{
		HX_STACK_FRAME("Listener","dispatchEvent","Listener.dispatchEvent","flash/events/EventDispatcher.hx",259)
		HX_STACK_THIS(this)
