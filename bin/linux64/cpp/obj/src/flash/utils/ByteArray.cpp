...
{
HX_STACK_FRAME("ByteArray","new","ByteArray.new","flash/utils/ByteArray.hx",37)
...
HX_STACK_FRAME("ByteArray","__init__","ByteArray.__init__","flash/utils/ByteArray.hx",695)
{

	HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_Function_1_1)
	::flash::utils::ByteArray run(int length){
		HX_STACK_FRAME("*","_Function_1_1","*._Function_1_1","flash/utils/ByteArray.hx",697)
	...
	Void run(::flash::utils::ByteArray bytes,int length){
		HX_STACK_FRAME("*","_Function_1_2","*._Function_1_2","flash/utils/ByteArray.hx",698)
	...
	Array< unsigned char > run(::flash::utils::ByteArray bytes){
		HX_STACK_FRAME("*","_Function_1_3","*._Function_1_3","flash/utils/ByteArray.hx",710)
		HX_STACK_ARG(bytes,"bytes")
		{
			HX_STACK_LINE(710)
			if (((bytes == null()))){
	...
	int run(::flash::utils::ByteArray bytes1){
		HX_STACK_FRAME("*","_Function_1_4","*._Function_1_4","flash/utils/ByteArray.hx",711)
...
::String ByteArray_obj::set_endian( ::String value){
	HX_STACK_FRAME("ByteArray","set_endian","ByteArray.set_endian","flash/utils/ByteArray.hx",750)
	HX_STACK_THIS(this)
...
::String ByteArray_obj::get_endian( ){
	HX_STACK_FRAME("ByteArray","get_endian","ByteArray.get_endian","flash/utils/ByteArray.hx",749)
	HX_STACK_THIS(this)
	HX_STACK_LINE(749)
	if ((this->bigEndian)){
		HX_STACK_LINE(749)
...
int ByteArray_obj::get_byteLength( ){
	HX_STACK_FRAME("ByteArray","get_byteLength","ByteArray.get_byteLength","flash/utils/ByteArray.hx",748)
	HX_STACK_THIS(this)
	HX_STACK_LINE(748)
	return this->length;
}
...
int ByteArray_obj::get_bytesAvailable( ){
	HX_STACK_FRAME("ByteArray","get_bytesAvailable","ByteArray.get_bytesAvailable","flash/utils/ByteArray.hx",747)
	HX_STACK_THIS(this)
	HX_STACK_LINE(747)
...
int ByteArray_obj::__throwEOFi( ){
	HX_STACK_FRAME("ByteArray","__throwEOFi","ByteArray.__throwEOFi","flash/utils/ByteArray.hx",732)
	HX_STACK_THIS(this)
	HX_STACK_LINE(734)
...
{
		HX_STACK_FRAME("ByteArray","__set","ByteArray.__set","flash/utils/ByteArray.hx",724)
		HX_STACK_THIS(this)
...
int ByteArray_obj::__get( int pos){
	HX_STACK_FRAME("ByteArray","__get","ByteArray.__get","flash/utils/ByteArray.hx",685)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_LINE(685)
...
{
		HX_STACK_FRAME("ByteArray","__fromBytes","ByteArray.__fromBytes","flash/utils/ByteArray.hx",670)
		HX_STACK_THIS(this)
		HX_STACK_ARG(bytes,"bytes")
		HX_STACK_LINE(672)
		this->b = bytes->b;
...
{
		HX_STACK_FRAME("ByteArray","writeUTFBytes","ByteArray.writeUTFBytes","flash/utils/ByteArray.hx",657)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(662)
...
{
		HX_STACK_FRAME("ByteArray","writeUTF","ByteArray.writeUTF","flash/utils/ByteArray.hx",643)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(648)
		::haxe::io::Bytes bytes = ::haxe::io::Bytes_obj::ofString(s);		HX_STACK_VAR(bytes,"bytes");
...
{
		HX_STACK_FRAME("ByteArray","writeUnsignedInt","ByteArray.writeUnsignedInt","flash/utils/ByteArray.hx",638)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(638)
		this->writeInt(value);
...
{
		HX_STACK_FRAME("ByteArray","writeShort","ByteArray.writeShort","flash/utils/ByteArray.hx",617)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(619)
...
{
		HX_STACK_FRAME("ByteArray","writeInt","ByteArray.writeInt","flash/utils/ByteArray.hx",594)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(596)
...
{
		HX_STACK_FRAME("ByteArray","writeFloat","ByteArray.writeFloat","flash/utils/ByteArray.hx",581)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(586)
...
{
		HX_STACK_FRAME("ByteArray","writeFile","ByteArray.writeFile","flash/utils/ByteArray.hx",574)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ByteArray","writeDouble","ByteArray.writeDouble","flash/utils/ByteArray.hx",557)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(562)
...
int length = __o_length.Default(0);
	HX_STACK_FRAME("ByteArray","writeBytes","ByteArray.writeBytes","flash/utils/ByteArray.hx",546)
	HX_STACK_THIS(this)
	HX_STACK_ARG(bytes,"bytes")
...
{
		HX_STACK_FRAME("ByteArray","writeByte","ByteArray.writeByte","flash/utils/ByteArray.hx",533)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(535)
...
{
		HX_STACK_FRAME("ByteArray","writeBoolean","ByteArray.writeBoolean","flash/utils/ByteArray.hx",528)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(528)
		this->ensureElem(this->position,true);
		...
		if ((value)){
			HX_STACK_LINE(528)
			this->b[(this->position)++] = (int)1;
		}
		else{
			HX_STACK_LINE(528)
			this->b[(this->position)++] = (int)0;
		}
	}
return null();
}
...
{
		HX_STACK_FRAME("ByteArray","write_uncheck","ByteArray.write_uncheck","flash/utils/ByteArray.hx",518)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ByteArray","uncompress","ByteArray.uncompress","flash/utils/ByteArray.hx",471)
		HX_STACK_THIS(this)
...
::flash::utils::ByteArray ByteArray_obj::slice( int begin,Dynamic end){
	HX_STACK_FRAME("ByteArray","slice","ByteArray.slice","flash/utils/ByteArray.hx",423)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ByteArray","setLength","ByteArray.setLength","flash/utils/ByteArray.hx",410)
		HX_STACK_THIS(this)
		HX_STACK_ARG(length,"length")
		HX_STACK_LINE(412)
		if (((length > (int)0))){
...
::String ByteArray_obj::readUTFBytes( int length){
	HX_STACK_FRAME("ByteArray","readUTFBytes","ByteArray.readUTFBytes","flash/utils/ByteArray.hx",388)
	HX_STACK_THIS(this)
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(390)
...
::String ByteArray_obj::readUTF( ){
	HX_STACK_FRAME("ByteArray","readUTF","ByteArray.readUTF","flash/utils/ByteArray.hx",380)
	HX_STACK_THIS(this)
	HX_STACK_LINE(382)
...
int ByteArray_obj::readUnsignedShort( ){
	HX_STACK_FRAME("ByteArray","readUnsignedShort","ByteArray.readUnsignedShort","flash/utils/ByteArray.hx",370)
	HX_STACK_THIS(this)
	HX_STACK_LINE(372)
...
int ByteArray_obj::readUnsignedInt( ){
	HX_STACK_FRAME("ByteArray","readUnsignedInt","ByteArray.readUnsignedInt","flash/utils/ByteArray.hx",358)
	HX_STACK_THIS(this)
	HX_STACK_LINE(360)
	int ch1;		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(360)
...
int ByteArray_obj::readUnsignedByte( ){
	HX_STACK_FRAME("ByteArray","readUnsignedByte","ByteArray.readUnsignedByte","flash/utils/ByteArray.hx",353)
	HX_STACK_THIS(this)
	HX_STACK_LINE(353)
	if (((this->position < this->length))){
		HX_STACK_LINE(353)
...
int ByteArray_obj::readShort( ){
	HX_STACK_FRAME("ByteArray","readShort","ByteArray.readShort","flash/utils/ByteArray.hx",339)
	HX_STACK_THIS(this)
	HX_STACK_LINE(341)
	int ch1;		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(341)
...
::String ByteArray_obj::readMultiByte( int length,::String charSet){
	HX_STACK_FRAME("ByteArray","readMultiByte","ByteArray.readMultiByte","flash/utils/ByteArray.hx",334)
	HX_STACK_THIS(this)
	HX_STACK_ARG(length,"length")
...
int ByteArray_obj::readInt( ){
	HX_STACK_FRAME("ByteArray","readInt","ByteArray.readInt","flash/utils/ByteArray.hx",320)
	HX_STACK_THIS(this)
	HX_STACK_LINE(322)
	int ch1;		HX_STACK_VAR(ch1,"ch1");
	HX_STACK_LINE(322)
...
Float ByteArray_obj::readFloat( ){
	HX_STACK_FRAME("ByteArray","readFloat","ByteArray.readFloat","flash/utils/ByteArray.hx",300)
	HX_STACK_THIS(this)
	HX_STACK_LINE(302)
...
Float ByteArray_obj::readDouble( ){
	HX_STACK_FRAME("ByteArray","readDouble","ByteArray.readDouble","flash/utils/ByteArray.hx",269)
	HX_STACK_THIS(this)
	HX_STACK_LINE(271)
...
int offset = __o_offset.Default(0);
int length = __o_length.Default(0);
	HX_STACK_FRAME("ByteArray","readBytes","ByteArray.readBytes","flash/utils/ByteArray.hx",231)
	HX_STACK_THIS(this)
...
int ByteArray_obj::readByte( ){
	HX_STACK_FRAME("ByteArray","readByte","ByteArray.readByte","flash/utils/ByteArray.hx",223)
	HX_STACK_THIS(this)
	HX_STACK_LINE(225)
	int value;		HX_STACK_VAR(value,"value");
	HX_STACK_LINE(225)
...
bool ByteArray_obj::readBoolean( ){
	HX_STACK_FRAME("ByteArray","readBoolean","ByteArray.readBoolean","flash/utils/ByteArray.hx",218)
	HX_STACK_THIS(this)
	HX_STACK_LINE(218)
	if (((this->position < this->length))){
		struct _Function_2_1{
			inline static int Block( ::flash::utils::ByteArray_obj *__this){
				HX_STACK_FRAME("*","closure","*.closure","flash/utils/ByteArray.hx",218)
				{
					HX_STACK_LINE(218)
...
{
		HX_STACK_FRAME("ByteArray","inflate","ByteArray.inflate","flash/utils/ByteArray.hx",211)
		HX_STACK_THIS(this)
		HX_STACK_LINE(211)
...
int ByteArray_obj::getStart( ){
	HX_STACK_FRAME("ByteArray","getStart","ByteArray.getStart","flash/utils/ByteArray.hx",204)
	HX_STACK_THIS(this)
	HX_STACK_LINE(204)
	return (int)0;
}
...
int ByteArray_obj::getLength( ){
	HX_STACK_FRAME("ByteArray","getLength","ByteArray.getLength","flash/utils/ByteArray.hx",197)
	HX_STACK_THIS(this)
	HX_STACK_LINE(197)
	return this->length;
}
...
::flash::utils::ByteArray ByteArray_obj::getByteBuffer( ){
	HX_STACK_FRAME("ByteArray","getByteBuffer","ByteArray.getByteBuffer","flash/utils/ByteArray.hx",190)
	HX_STACK_THIS(this)
	HX_STACK_LINE(190)
...
{
		HX_STACK_FRAME("ByteArray","ensureElem","ByteArray.ensureElem","flash/utils/ByteArray.hx",150)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("ByteArray","deflate","ByteArray.deflate","flash/utils/ByteArray.hx",145)
		HX_STACK_THIS(this)
		HX_STACK_LINE(145)
...
{
		HX_STACK_FRAME("ByteArray","compress","ByteArray.compress","flash/utils/ByteArray.hx",95)
		HX_STACK_THIS(this)
		HX_STACK_ARG(algorithm,"algorithm")
		HX_STACK_LINE(100)
		::flash::utils::ByteArray src = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(src,"src");
...
{
		HX_STACK_FRAME("ByteArray","clear","ByteArray.clear","flash/utils/ByteArray.hx",87)
		HX_STACK_THIS(this)
		HX_STACK_LINE(89)
		this->position = (int)0;
		HX_STACK_LINE(90)
...
{
		HX_STACK_FRAME("ByteArray","checkData","ByteArray.checkData","flash/utils/ByteArray.hx",78)
		HX_STACK_THIS(this)
		HX_STACK_ARG(length,"length")
		HX_STACK_LINE(78)
...
::String ByteArray_obj::asString( ){
	HX_STACK_FRAME("ByteArray","asString","ByteArray.asString","flash/utils/ByteArray.hx",71)
	HX_STACK_THIS(this)
	HX_STACK_LINE(71)
...
::flash::utils::ByteArray ByteArray_obj::fromBytes( ::haxe::io::Bytes bytes){
	HX_STACK_FRAME("ByteArray","fromBytes","ByteArray.fromBytes","flash/utils/ByteArray.hx",179)
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_LINE(181)
...
::flash::utils::ByteArray ByteArray_obj::readFile( ::String path){
	HX_STACK_FRAME("ByteArray","readFile","ByteArray.readFile","flash/utils/ByteArray.hx",293)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(293)
