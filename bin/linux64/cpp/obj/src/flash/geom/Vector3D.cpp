...
{
HX_STACK_FRAME("Vector3D","new","Vector3D.new","flash/geom/Vector3D.hx",19)
...
Float Vector3D_obj::get_lengthSquared( ){
	HX_STACK_FRAME("Vector3D","get_lengthSquared","Vector3D.get_lengthSquared","flash/geom/Vector3D.hx",195)
	HX_STACK_THIS(this)
	HX_STACK_LINE(195)
...
Float Vector3D_obj::get_length( ){
	HX_STACK_FRAME("Vector3D","get_length","Vector3D.get_length","flash/geom/Vector3D.hx",194)
	HX_STACK_THIS(this)
	HX_STACK_LINE(194)
...
::String Vector3D_obj::toString( ){
	HX_STACK_FRAME("Vector3D","toString","Vector3D.toString","flash/geom/Vector3D.hx",182)
	HX_STACK_THIS(this)
	HX_STACK_LINE(182)
...
::flash::geom::Vector3D Vector3D_obj::subtract( ::flash::geom::Vector3D a){
	HX_STACK_FRAME("Vector3D","subtract","Vector3D.subtract","flash/geom/Vector3D.hx",175)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(175)
...
{
		HX_STACK_FRAME("Vector3D","scaleBy","Vector3D.scaleBy","flash/geom/Vector3D.hx",164)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(166)
		hx::MultEq(this->x,s);
...
{
		HX_STACK_FRAME("Vector3D","setTo","Vector3D.setTo","flash/geom/Vector3D.hx",155)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xa,"xa")
		HX_STACK_ARG(ya,"ya")
		HX_STACK_ARG(za,"za")
...
{
		HX_STACK_FRAME("Vector3D","project","Vector3D.project","flash/geom/Vector3D.hx",146)
		HX_STACK_THIS(this)
		HX_STACK_LINE(148)
...
Float Vector3D_obj::normalize( ){
	HX_STACK_FRAME("Vector3D","normalize","Vector3D.normalize","flash/geom/Vector3D.hx",129)
	HX_STACK_THIS(this)
	HX_STACK_LINE(131)
...
{
		HX_STACK_FRAME("Vector3D","negate","Vector3D.negate","flash/geom/Vector3D.hx",120)
		HX_STACK_THIS(this)
		HX_STACK_LINE(122)
...
bool allFour = __o_allFour.Default(false);
	HX_STACK_FRAME("Vector3D","nearEquals","Vector3D.nearEquals","flash/geom/Vector3D.hx",115)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Vector3D","incrementBy","Vector3D.incrementBy","flash/geom/Vector3D.hx",104)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_LINE(106)
		hx::AddEq(this->x,a->x);
...
bool allFour = __o_allFour.Default(false);
	HX_STACK_FRAME("Vector3D","equals","Vector3D.equals","flash/geom/Vector3D.hx",99)
	HX_STACK_THIS(this)
	HX_STACK_ARG(toCompare,"toCompare")
	HX_STACK_ARG(allFour,"allFour")
{
...
Float Vector3D_obj::dotProduct( ::flash::geom::Vector3D a){
	HX_STACK_FRAME("Vector3D","dotProduct","Vector3D.dotProduct","flash/geom/Vector3D.hx",92)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(92)
...
{
		HX_STACK_FRAME("Vector3D","decrementBy","Vector3D.decrementBy","flash/geom/Vector3D.hx",70)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_LINE(72)
		hx::SubEq(this->x,a->x);
...
::flash::geom::Vector3D Vector3D_obj::crossProduct( ::flash::geom::Vector3D a){
	HX_STACK_FRAME("Vector3D","crossProduct","Vector3D.crossProduct","flash/geom/Vector3D.hx",65)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(65)
...
{
		HX_STACK_FRAME("Vector3D","copyFrom","Vector3D.copyFrom","flash/geom/Vector3D.hx",54)
		HX_STACK_THIS(this)
...
::flash::geom::Vector3D Vector3D_obj::clone( ){
	HX_STACK_FRAME("Vector3D","clone","Vector3D.clone","flash/geom/Vector3D.hx",49)
	HX_STACK_THIS(this)
	HX_STACK_LINE(49)
...
::flash::geom::Vector3D Vector3D_obj::add( ::flash::geom::Vector3D a){
	HX_STACK_FRAME("Vector3D","add","Vector3D.add","flash/geom/Vector3D.hx",31)
	HX_STACK_THIS(this)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(31)
	return ::flash::geom::Vector3D_obj::__new((this->x + a->x),(this->y + a->y),(this->z + a->z),null());
...
Float Vector3D_obj::angleBetween( ::flash::geom::Vector3D a,::flash::geom::Vector3D b){
	HX_STACK_FRAME("Vector3D","angleBetween","Vector3D.angleBetween","flash/geom/Vector3D.hx",36)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(38)
...
Float Vector3D_obj::distance( ::flash::geom::Vector3D pt1,::flash::geom::Vector3D pt2){
	HX_STACK_FRAME("Vector3D","distance","Vector3D.distance","flash/geom/Vector3D.hx",79)
...
::flash::geom::Vector3D Vector3D_obj::get_X_AXIS( ){
	HX_STACK_FRAME("Vector3D","get_X_AXIS","Vector3D.get_X_AXIS","flash/geom/Vector3D.hx",196)
	HX_STACK_LINE(196)
...
::flash::geom::Vector3D Vector3D_obj::get_Y_AXIS( ){
	HX_STACK_FRAME("Vector3D","get_Y_AXIS","Vector3D.get_Y_AXIS","flash/geom/Vector3D.hx",197)
	HX_STACK_LINE(197)
...
::flash::geom::Vector3D Vector3D_obj::get_Z_AXIS( ){
	HX_STACK_FRAME("Vector3D","get_Z_AXIS","Vector3D.get_Z_AXIS","flash/geom/Vector3D.hx",198)
	HX_STACK_LINE(198)
