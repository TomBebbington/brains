...
{
HX_STACK_FRAME("Rectangle","new","Rectangle.new","flash/geom/Rectangle.hx",20)
...
::flash::geom::Point Rectangle_obj::set_topLeft( ::flash::geom::Point value){
	HX_STACK_FRAME("Rectangle","set_topLeft","Rectangle.set_topLeft","flash/geom/Rectangle.hx",277)
	HX_STACK_THIS(this)
...
::flash::geom::Point Rectangle_obj::get_topLeft( ){
	HX_STACK_FRAME("Rectangle","get_topLeft","Rectangle.get_topLeft","flash/geom/Rectangle.hx",276)
	HX_STACK_THIS(this)
	HX_STACK_LINE(276)
...
Float Rectangle_obj::set_top( Float value){
	HX_STACK_FRAME("Rectangle","set_top","Rectangle.set_top","flash/geom/Rectangle.hx",275)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(275)
...
Float Rectangle_obj::get_top( ){
	HX_STACK_FRAME("Rectangle","get_top","Rectangle.get_top","flash/geom/Rectangle.hx",274)
	HX_STACK_THIS(this)
	HX_STACK_LINE(274)
	return this->y;
}
...
::flash::geom::Point Rectangle_obj::set_size( ::flash::geom::Point value){
	HX_STACK_FRAME("Rectangle","set_size","Rectangle.set_size","flash/geom/Rectangle.hx",273)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(273)
	this->width = value->x;
...
::flash::geom::Point Rectangle_obj::get_size( ){
	HX_STACK_FRAME("Rectangle","get_size","Rectangle.get_size","flash/geom/Rectangle.hx",272)
	HX_STACK_THIS(this)
	HX_STACK_LINE(272)
...
Float Rectangle_obj::set_right( Float value){
	HX_STACK_FRAME("Rectangle","set_right","Rectangle.set_right","flash/geom/Rectangle.hx",271)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(271)
...
Float Rectangle_obj::get_right( ){
	HX_STACK_FRAME("Rectangle","get_right","Rectangle.get_right","flash/geom/Rectangle.hx",270)
	HX_STACK_THIS(this)
	HX_STACK_LINE(270)
...
Float Rectangle_obj::set_left( Float value){
	HX_STACK_FRAME("Rectangle","set_left","Rectangle.set_left","flash/geom/Rectangle.hx",269)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(269)
...
Float Rectangle_obj::get_left( ){
	HX_STACK_FRAME("Rectangle","get_left","Rectangle.get_left","flash/geom/Rectangle.hx",268)
	HX_STACK_THIS(this)
	HX_STACK_LINE(268)
	return this->x;
}
...
::flash::geom::Point Rectangle_obj::set_bottomRight( ::flash::geom::Point value){
	HX_STACK_FRAME("Rectangle","set_bottomRight","Rectangle.set_bottomRight","flash/geom/Rectangle.hx",267)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(267)
...
::flash::geom::Point Rectangle_obj::get_bottomRight( ){
	HX_STACK_FRAME("Rectangle","get_bottomRight","Rectangle.get_bottomRight","flash/geom/Rectangle.hx",266)
	HX_STACK_THIS(this)
	HX_STACK_LINE(266)
...
Float Rectangle_obj::set_bottom( Float value){
	HX_STACK_FRAME("Rectangle","set_bottom","Rectangle.set_bottom","flash/geom/Rectangle.hx",265)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(265)
...
Float Rectangle_obj::get_bottom( ){
	HX_STACK_FRAME("Rectangle","get_bottom","Rectangle.get_bottom","flash/geom/Rectangle.hx",264)
	HX_STACK_THIS(this)
	HX_STACK_LINE(264)
...
::flash::geom::Rectangle Rectangle_obj::_union( ::flash::geom::Rectangle toUnion){
	HX_STACK_FRAME("Rectangle","union","Rectangle.union","flash/geom/Rectangle.hx",246)
	HX_STACK_THIS(this)
...
::flash::geom::Rectangle Rectangle_obj::transform( ::flash::geom::Matrix m){
	HX_STACK_FRAME("Rectangle","transform","Rectangle.transform","flash/geom/Rectangle.hx",213)
	HX_STACK_THIS(this)
	HX_STACK_ARG(m,"m")
	HX_STACK_LINE(215)
...
::String Rectangle_obj::toString( ){
	HX_STACK_FRAME("Rectangle","toString","Rectangle.toString","flash/geom/Rectangle.hx",208)
	HX_STACK_THIS(this)
	HX_STACK_LINE(208)
...
{
		HX_STACK_FRAME("Rectangle","setEmpty","Rectangle.setEmpty","flash/geom/Rectangle.hx",196)
		HX_STACK_THIS(this)
		HX_STACK_LINE(198)
		this->x = (int)0;
		HX_STACK_LINE(199)
...
{
		HX_STACK_FRAME("Rectangle","offsetPoint","Rectangle.offsetPoint","flash/geom/Rectangle.hx",188)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Rectangle","offset","Rectangle.offset","flash/geom/Rectangle.hx",180)
		HX_STACK_THIS(this)
		HX_STACK_ARG(dx,"dx")
		HX_STACK_ARG(dy,"dy")
		HX_STACK_LINE(182)
...
bool Rectangle_obj::isEmpty( ){
	HX_STACK_FRAME("Rectangle","isEmpty","Rectangle.isEmpty","flash/geom/Rectangle.hx",175)
	HX_STACK_THIS(this)
	HX_STACK_LINE(175)
...
bool Rectangle_obj::intersects( ::flash::geom::Rectangle toIntersect){
	HX_STACK_FRAME("Rectangle","intersects","Rectangle.intersects","flash/geom/Rectangle.hx",156)
	HX_STACK_THIS(this)
...
::flash::geom::Rectangle Rectangle_obj::intersection( ::flash::geom::Rectangle toIntersect){
	HX_STACK_FRAME("Rectangle","intersection","Rectangle.intersection","flash/geom/Rectangle.hx",133)
	HX_STACK_THIS(this)
	HX_STACK_ARG(toIntersect,"toIntersect")
	HX_STACK_LINE(135)
	Float x0;		HX_STACK_VAR(x0,"x0");
...
{
		HX_STACK_FRAME("Rectangle","inflatePoint","Rectangle.inflatePoint","flash/geom/Rectangle.hx",128)
		HX_STACK_THIS(this)
		HX_STACK_ARG(point,"point")
		HX_STACK_LINE(128)
...
{
		HX_STACK_FRAME("Rectangle","inflate","Rectangle.inflate","flash/geom/Rectangle.hx",116)
		HX_STACK_THIS(this)
		HX_STACK_ARG(dx,"dx")
		HX_STACK_ARG(dy,"dy")
		HX_STACK_LINE(118)
...
{
		HX_STACK_FRAME("Rectangle","extendBounds","Rectangle.extendBounds","flash/geom/Rectangle.hx",83)
		HX_STACK_THIS(this)
		HX_STACK_ARG(r,"r")
		HX_STACK_LINE(85)
...
bool Rectangle_obj::equals( ::flash::geom::Rectangle toCompare){
	HX_STACK_FRAME("Rectangle","equals","Rectangle.equals","flash/geom/Rectangle.hx",78)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Rectangle","copyFrom","Rectangle.copyFrom","flash/geom/Rectangle.hx",66)
		HX_STACK_THIS(this)
...
bool Rectangle_obj::containsRect( ::flash::geom::Rectangle rect){
	HX_STACK_FRAME("Rectangle","containsRect","Rectangle.containsRect","flash/geom/Rectangle.hx",53)
	HX_STACK_THIS(this)
...
bool Rectangle_obj::containsPoint( ::flash::geom::Point point){
	HX_STACK_FRAME("Rectangle","containsPoint","Rectangle.containsPoint","flash/geom/Rectangle.hx",46)
	HX_STACK_THIS(this)
	HX_STACK_ARG(point,"point")
	HX_STACK_LINE(46)
...
bool Rectangle_obj::contains( Float x,Float y){
	HX_STACK_FRAME("Rectangle","contains","Rectangle.contains","flash/geom/Rectangle.hx",39)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(39)
...
::flash::geom::Rectangle Rectangle_obj::clone( ){
	HX_STACK_FRAME("Rectangle","clone","Rectangle.clone","flash/geom/Rectangle.hx",32)
	HX_STACK_THIS(this)
	HX_STACK_LINE(32)
