...
{
HX_STACK_FRAME("Transform","new","Transform.new","flash/geom/Transform.hx",21)
...
::flash::geom::Rectangle Transform_obj::get_pixelBounds( ){
	HX_STACK_FRAME("Transform","get_pixelBounds","Transform.get_pixelBounds","flash/geom/Transform.hx",39)
	HX_STACK_THIS(this)
	HX_STACK_LINE(39)
...
::flash::geom::Matrix Transform_obj::set_matrix( ::flash::geom::Matrix value){
	HX_STACK_FRAME("Transform","set_matrix","Transform.set_matrix","flash/geom/Transform.hx",38)
	HX_STACK_THIS(this)
...
::flash::geom::Matrix Transform_obj::get_matrix( ){
	HX_STACK_FRAME("Transform","get_matrix","Transform.get_matrix","flash/geom/Transform.hx",37)
	HX_STACK_THIS(this)
	HX_STACK_LINE(37)
...
::flash::geom::Matrix Transform_obj::get_concatenatedMatrix( ){
	HX_STACK_FRAME("Transform","get_concatenatedMatrix","Transform.get_concatenatedMatrix","flash/geom/Transform.hx",36)
	HX_STACK_THIS(this)
	HX_STACK_LINE(36)
...
::flash::geom::ColorTransform Transform_obj::get_concatenatedColorTransform( ){
	HX_STACK_FRAME("Transform","get_concatenatedColorTransform","Transform.get_concatenatedColorTransform","flash/geom/Transform.hx",35)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
...
::flash::geom::ColorTransform Transform_obj::set_colorTransform( ::flash::geom::ColorTransform value){
	HX_STACK_FRAME("Transform","set_colorTransform","Transform.set_colorTransform","flash/geom/Transform.hx",34)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(34)
...
::flash::geom::ColorTransform Transform_obj::get_colorTransform( ){
	HX_STACK_FRAME("Transform","get_colorTransform","Transform.get_colorTransform","flash/geom/Transform.hx",33)
	HX_STACK_THIS(this)
	HX_STACK_LINE(33)
