...
{
HX_STACK_FRAME("Matrix","new","Matrix.new","flash/geom/Matrix.hx",15)
...
{
		HX_STACK_FRAME("Matrix","translate","Matrix.translate","flash/geom/Matrix.hx",345)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_LINE(347)
...
::flash::geom::Point Matrix_obj::transformPoint( ::flash::geom::Point point){
	HX_STACK_FRAME("Matrix","transformPoint","Matrix.transformPoint","flash/geom/Matrix.hx",340)
	HX_STACK_THIS(this)
...
::String Matrix_obj::toString( ){
	HX_STACK_FRAME("Matrix","toString","Matrix.toString","flash/geom/Matrix.hx",333)
	HX_STACK_THIS(this)
	HX_STACK_LINE(333)
...
{
		HX_STACK_FRAME("Matrix","setTo","Matrix.setTo","flash/geom/Matrix.hx",319)
		HX_STACK_THIS(this)
		HX_STACK_ARG(a,"a")
		HX_STACK_ARG(b,"b")
		HX_STACK_ARG(c,"c")
...
Float scale = __o_scale.Default(1);
	HX_STACK_FRAME("Matrix","setRotation","Matrix.setRotation","flash/geom/Matrix.hx",309)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Matrix","scale","Matrix.scale","flash/geom/Matrix.hx",295)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_LINE(297)
...
{
		HX_STACK_FRAME("Matrix","rotate","Matrix.rotate","flash/geom/Matrix.hx",275)
		HX_STACK_THIS(this)
		HX_STACK_ARG(angle,"angle")
		HX_STACK_LINE(277)
...
::flash::geom::Matrix Matrix_obj::mult( ::flash::geom::Matrix m){
	HX_STACK_FRAME("Matrix","mult","Matrix.mult","flash/geom/Matrix.hx",258)
	HX_STACK_THIS(this)
	HX_STACK_ARG(m,"m")
	HX_STACK_LINE(260)
...
::flash::geom::Matrix Matrix_obj::invert( ){
	HX_STACK_FRAME("Matrix","invert","Matrix.invert","flash/geom/Matrix.hx",228)
	HX_STACK_THIS(this)
	HX_STACK_LINE(230)
...
{
		HX_STACK_FRAME("Matrix","identity","Matrix.identity","flash/geom/Matrix.hx",216)
		HX_STACK_THIS(this)
		HX_STACK_LINE(218)
		this->a = (int)1;
		HX_STACK_LINE(219)
...
::flash::geom::Point Matrix_obj::deltaTransformPoint( ::flash::geom::Point point){
	HX_STACK_FRAME("Matrix","deltaTransformPoint","Matrix.deltaTransformPoint","flash/geom/Matrix.hx",211)
	HX_STACK_THIS(this)
	HX_STACK_ARG(point,"point")
	HX_STACK_LINE(211)
...
Float tx = __o_tx.Default(0);
Float ty = __o_ty.Default(0);
	HX_STACK_FRAME("Matrix","createGradientBox","Matrix.createGradientBox","flash/geom/Matrix.hx",183)
	HX_STACK_THIS(this)
...
Float tx = __o_tx.Default(0);
Float ty = __o_ty.Default(0);
	HX_STACK_FRAME("Matrix","createBox","Matrix.createBox","flash/geom/Matrix.hx",172)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Matrix","copyRowTo","Matrix.copyRowTo","flash/geom/Matrix.hx",147)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Matrix","copyRowFrom","Matrix.copyRowFrom","flash/geom/Matrix.hx",121)
		HX_STACK_THIS(this)
		HX_STACK_ARG(row,"row")
		HX_STACK_ARG(vector3D,"vector3D")
		HX_STACK_LINE(121)
...
{
		HX_STACK_FRAME("Matrix","copyFrom","Matrix.copyFrom","flash/geom/Matrix.hx",107)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Matrix","copyColumnTo","Matrix.copyColumnTo","flash/geom/Matrix.hx",80)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Matrix","copyColumnFrom","Matrix.copyColumnFrom","flash/geom/Matrix.hx",54)
		HX_STACK_THIS(this)
		HX_STACK_ARG(column,"column")
		HX_STACK_ARG(vector3D,"vector3D")
		HX_STACK_LINE(54)
...
{
		HX_STACK_FRAME("Matrix","concat","Matrix.concat","flash/geom/Matrix.hx",34)
		HX_STACK_THIS(this)
		HX_STACK_ARG(m,"m")
		HX_STACK_LINE(36)
...
::flash::geom::Matrix Matrix_obj::clone( ){
	HX_STACK_FRAME("Matrix","clone","Matrix.clone","flash/geom/Matrix.hx",29)
	HX_STACK_THIS(this)
	HX_STACK_LINE(29)
