...
{
		HX_STACK_FRAME("Memory","select","Memory.select","flash/Memory.hx",20)
...
int Memory_obj::getByte( int addr){
	HX_STACK_FRAME("Memory","getByte","Memory.getByte","flash/Memory.hx",136)
...
Float Memory_obj::getDouble( int addr){
	HX_STACK_FRAME("Memory","getDouble","Memory.getDouble","flash/Memory.hx",144)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(146)
	if (((bool((addr < (int)0)) || bool((addr >= ::flash::Memory_obj::len))))){
		HX_STACK_LINE(146)
...
Float Memory_obj::getFloat( int addr){
	HX_STACK_FRAME("Memory","getFloat","Memory.getFloat","flash/Memory.hx",152)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(154)
	if (((bool((addr < (int)0)) || bool((addr >= ::flash::Memory_obj::len))))){
		HX_STACK_LINE(154)
...
int Memory_obj::getI32( int addr){
	HX_STACK_FRAME("Memory","getI32","Memory.getI32","flash/Memory.hx",160)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(162)
	if (((bool((addr < (int)0)) || bool((addr >= ::flash::Memory_obj::len))))){
		HX_STACK_LINE(162)
...
int Memory_obj::getUI16( int addr){
	HX_STACK_FRAME("Memory","getUI16","Memory.getUI16","flash/Memory.hx",168)
	HX_STACK_ARG(addr,"addr")
	HX_STACK_LINE(170)
	if (((bool((addr < (int)0)) || bool((addr >= ::flash::Memory_obj::len))))){
		HX_STACK_LINE(170)
...
{
		HX_STACK_FRAME("Memory","setByte","Memory.setByte","flash/Memory.hx",176)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(178)
		if (((bool((addr < (int)0)) || bool((addr >= ::flash::Memory_obj::len))))){
...
{
		HX_STACK_FRAME("Memory","setDouble","Memory.setDouble","flash/Memory.hx",184)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(186)
		if (((bool((addr < (int)0)) || bool((addr >= ::flash::Memory_obj::len))))){
...
{
		HX_STACK_FRAME("Memory","setFloat","Memory.setFloat","flash/Memory.hx",192)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(194)
		if (((bool((addr < (int)0)) || bool((addr >= ::flash::Memory_obj::len))))){
...
{
		HX_STACK_FRAME("Memory","setI16","Memory.setI16","flash/Memory.hx",200)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(202)
		if (((bool((addr < (int)0)) || bool((addr >= ::flash::Memory_obj::len))))){
...
{
		HX_STACK_FRAME("Memory","setI32","Memory.setI32","flash/Memory.hx",208)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(210)
		if (((bool((addr < (int)0)) || bool((addr >= ::flash::Memory_obj::len))))){
