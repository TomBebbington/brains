...
Dynamic Vector_Impl__obj::_new( Dynamic length,Dynamic fixed){
	HX_STACK_FRAME("Vector_Impl_","_new","Vector_Impl_._new","flash/Vector.hx",13)
...
Dynamic Vector_Impl__obj::concat( Dynamic this1,Dynamic a){
	HX_STACK_FRAME("Vector_Impl_","concat","Vector_Impl_.concat","flash/Vector.hx",20)
...
Dynamic Vector_Impl__obj::copy( Dynamic this1){
	HX_STACK_FRAME("Vector_Impl_","copy","Vector_Impl_.copy","flash/Vector.hx",27)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(27)
...
Dynamic Vector_Impl__obj::iterator( Dynamic this1){
	HX_STACK_FRAME("Vector_Impl_","iterator","Vector_Impl_.iterator","flash/Vector.hx",34)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(34)
...
::String Vector_Impl__obj::join( Dynamic this1,::String sep){
	HX_STACK_FRAME("Vector_Impl_","join","Vector_Impl_.join","flash/Vector.hx",41)
	HX_STACK_ARG(this1,"this1")
...
Dynamic Vector_Impl__obj::pop( Dynamic this1){
	HX_STACK_FRAME("Vector_Impl_","pop","Vector_Impl_.pop","flash/Vector.hx",48)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(48)
...
int Vector_Impl__obj::push( Dynamic this1,Dynamic x){
	HX_STACK_FRAME("Vector_Impl_","push","Vector_Impl_.push","flash/Vector.hx",55)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(55)
...
{
		HX_STACK_FRAME("Vector_Impl_","reverse","Vector_Impl_.reverse","flash/Vector.hx",62)
		HX_STACK_ARG(this1,"this1")
		HX_STACK_LINE(62)
...
Dynamic Vector_Impl__obj::shift( Dynamic this1){
	HX_STACK_FRAME("Vector_Impl_","shift","Vector_Impl_.shift","flash/Vector.hx",69)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(69)
...
{
		HX_STACK_FRAME("Vector_Impl_","unshift","Vector_Impl_.unshift","flash/Vector.hx",76)
		HX_STACK_ARG(this1,"this1")
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(76)
...
Dynamic Vector_Impl__obj::slice( Dynamic this1,Dynamic pos,Dynamic end){
	HX_STACK_FRAME("Vector_Impl_","slice","Vector_Impl_.slice","flash/Vector.hx",83)
	HX_STACK_ARG(this1,"this1")
...
{
		HX_STACK_FRAME("Vector_Impl_","sort","Vector_Impl_.sort","flash/Vector.hx",90)
		HX_STACK_ARG(this1,"this1")
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(90)
...
Dynamic Vector_Impl__obj::splice( Dynamic this1,int pos,int len){
	HX_STACK_FRAME("Vector_Impl_","splice","Vector_Impl_.splice","flash/Vector.hx",97)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(pos,"pos")
...
::String Vector_Impl__obj::toString( Dynamic this1){
	HX_STACK_FRAME("Vector_Impl_","toString","Vector_Impl_.toString","flash/Vector.hx",104)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(104)
...
Dynamic from = __o_from.Default(0);
	HX_STACK_FRAME("Vector_Impl_","indexOf","Vector_Impl_.indexOf","flash/Vector.hx",109)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(x,"x")
...
Dynamic from = __o_from.Default(0);
	HX_STACK_FRAME("Vector_Impl_","lastIndexOf","Vector_Impl_.lastIndexOf","flash/Vector.hx",126)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(from,"from")
{
...
Dynamic Vector_Impl__obj::ofArray( Dynamic a){
	HX_STACK_FRAME("Vector_Impl_","ofArray","Vector_Impl_.ofArray","flash/Vector.hx",144)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(144)
...
Dynamic Vector_Impl__obj::convert( Dynamic v){
	HX_STACK_FRAME("Vector_Impl_","convert","Vector_Impl_.convert","flash/Vector.hx",151)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(151)
	return v;
}
...
Dynamic Vector_Impl__obj::fromArray( Dynamic a){
	HX_STACK_FRAME("Vector_Impl_","fromArray","Vector_Impl_.fromArray","flash/Vector.hx",158)
	HX_STACK_ARG(a,"a")
	HX_STACK_LINE(158)
	return a;
}
...
Dynamic Vector_Impl__obj::toArray( Dynamic this1){
	HX_STACK_FRAME("Vector_Impl_","toArray","Vector_Impl_.toArray","flash/Vector.hx",165)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(165)
	return this1;
}
...
int Vector_Impl__obj::get_length( Dynamic this1){
	HX_STACK_FRAME("Vector_Impl_","get_length","Vector_Impl_.get_length","flash/Vector.hx",179)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(179)
...
int Vector_Impl__obj::set_length( Dynamic this1,int value){
	HX_STACK_FRAME("Vector_Impl_","set_length","Vector_Impl_.set_length","flash/Vector.hx",186)
	HX_STACK_ARG(this1,"this1")
...
bool Vector_Impl__obj::get_fixed( Dynamic this1){
	HX_STACK_FRAME("Vector_Impl_","get_fixed","Vector_Impl_.get_fixed","flash/Vector.hx",193)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(193)
	return false;
}
...
bool Vector_Impl__obj::set_fixed( Dynamic this1,bool value){
	HX_STACK_FRAME("Vector_Impl_","set_fixed","Vector_Impl_.set_fixed","flash/Vector.hx",200)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(200)
	return value;
