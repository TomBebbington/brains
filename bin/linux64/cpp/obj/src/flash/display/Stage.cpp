...
{
HX_STACK_FRAME("Stage","new","Stage.new","flash/display/Stage.hx",83)
...
int Stage_obj::get_stageWidth( ){
	HX_STACK_FRAME("Stage","get_stageWidth","Stage.get_stageWidth","flash/display/Stage.hx",1176)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1176)
...
int Stage_obj::get_stageHeight( ){
	HX_STACK_FRAME("Stage","get_stageHeight","Stage.get_stageHeight","flash/display/Stage.hx",1169)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1169)
...
bool Stage_obj::set_stageFocusRect( bool value){
	HX_STACK_FRAME("Stage","set_stageFocusRect","Stage.set_stageFocusRect","flash/display/Stage.hx",1159)
	HX_STACK_THIS(this)
...
bool Stage_obj::get_stageFocusRect( ){
	HX_STACK_FRAME("Stage","get_stageFocusRect","Stage.get_stageFocusRect","flash/display/Stage.hx",1158)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1158)
...
::flash::display::Stage Stage_obj::get_stage( ){
	HX_STACK_FRAME("Stage","get_stage","Stage.get_stage","flash/display/Stage.hx",1153)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1153)
...
::flash::display::StageScaleMode Stage_obj::set_scaleMode( ::flash::display::StageScaleMode value){
	HX_STACK_FRAME("Stage","set_scaleMode","Stage.set_scaleMode","flash/display/Stage.hx",1143)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1145)
...
::flash::display::StageScaleMode Stage_obj::get_scaleMode( ){
	HX_STACK_FRAME("Stage","get_scaleMode","Stage.get_scaleMode","flash/display/Stage.hx",1135)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1137)
...
::flash::display::StageQuality Stage_obj::set_quality( ::flash::display::StageQuality value){
	HX_STACK_FRAME("Stage","set_quality","Stage.set_quality","flash/display/Stage.hx",1127)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1129)
...
::flash::display::StageQuality Stage_obj::get_quality( ){
	HX_STACK_FRAME("Stage","get_quality","Stage.get_quality","flash/display/Stage.hx",1119)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1121)
...
bool Stage_obj::get_isOpenGL( ){
	HX_STACK_FRAME("Stage","get_isOpenGL","Stage.get_isOpenGL","flash/display/Stage.hx",1114)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1114)
...
Float Stage_obj::set_frameRate( Float value){
	HX_STACK_FRAME("Stage","set_frameRate","Stage.set_frameRate","flash/display/Stage.hx",1103)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1105)
...
::flash::display::InteractiveObject Stage_obj::set_focus( ::flash::display::InteractiveObject value){
	HX_STACK_FRAME("Stage","set_focus","Stage.set_focus","flash/display/Stage.hx",1086)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1088)
	if (((value == null()))){
...
::flash::display::InteractiveObject Stage_obj::get_focus( ){
	HX_STACK_FRAME("Stage","get_focus","Stage.get_focus","flash/display/Stage.hx",1077)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1079)
...
Float Stage_obj::get_dpiScale( ){
	HX_STACK_FRAME("Stage","get_dpiScale","Stage.get_dpiScale","flash/display/Stage.hx",1072)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1072)
...
::flash::display::StageDisplayState Stage_obj::set_displayState( ::flash::display::StageDisplayState value){
	HX_STACK_FRAME("Stage","set_displayState","Stage.set_displayState","flash/display/Stage.hx",1062)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1064)
...
::flash::display::StageDisplayState Stage_obj::get_displayState( ){
	HX_STACK_FRAME("Stage","get_displayState","Stage.get_displayState","flash/display/Stage.hx",1054)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1056)
...
::flash::display::StageAlign Stage_obj::set_align( ::flash::display::StageAlign value){
	HX_STACK_FRAME("Stage","set_align","Stage.set_align","flash/display/Stage.hx",1046)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(1048)
...
::flash::display::StageAlign Stage_obj::get_align( ){
	HX_STACK_FRAME("Stage","get_align","Stage.get_align","flash/display/Stage.hx",1038)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1040)
...
Float Stage_obj::__updateNextWake( ){
	HX_STACK_FRAME("Stage","__updateNextWake","Stage.__updateNextWake","flash/display/Stage.hx",1008)
	HX_STACK_THIS(this)
	HX_STACK_LINE(1010)
...
{
		HX_STACK_FRAME("Stage","__stopDrag","Stage.__stopDrag","flash/display/Stage.hx",1000)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Stage","__startDrag","Stage.__startDrag","flash/display/Stage.hx",967)
		HX_STACK_THIS(this)
		HX_STACK_ARG(sprite,"sprite")
...
{
		HX_STACK_FRAME("Stage","__setActive","Stage.__setActive","flash/display/Stage.hx",943)
		HX_STACK_THIS(this)
		HX_STACK_ARG(value,"value")
		HX_STACK_LINE(943)
...
{
		HX_STACK_FRAME("Stage","__render","Stage.__render","flash/display/Stage.hx",915)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Stage","__pollTimers","Stage.__pollTimers","flash/display/Stage.hx",905)
		HX_STACK_THIS(this)
		HX_STACK_LINE(907)
...
{
		HX_STACK_FRAME("Stage","__onTouch","Stage.__onTouch","flash/display/Stage.hx",858)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Stage","__onSysWM","Stage.__onSysWM","flash/display/Stage.hx",850)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(852)
...
{
		HX_STACK_FRAME("Stage","__onResize","Stage.__onResize","flash/display/Stage.hx",842)
		HX_STACK_THIS(this)
		HX_STACK_ARG(width,"width")
		HX_STACK_ARG(height,"height")
		HX_STACK_LINE(844)
...
{
		HX_STACK_FRAME("Stage","__onMouse","Stage.__onMouse","flash/display/Stage.hx",725)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_ARG(type,"type")
...
{
		HX_STACK_FRAME("Stage","__onKey","Stage.__onKey","flash/display/Stage.hx",676)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_ARG(type,"type")
		HX_STACK_LINE(678)
...
{
		HX_STACK_FRAME("Stage","__onJoystick","Stage.__onJoystick","flash/display/Stage.hx",565)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_ARG(type,"type")
		HX_STACK_LINE(567)
...
{
		HX_STACK_FRAME("Stage","__onFocus","Stage.__onFocus","flash/display/Stage.hx",533)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(535)
		Array< ::Dynamic > stack = Array_obj< ::Dynamic >::__new();		HX_STACK_VAR(stack,"stack");
...
{
		HX_STACK_FRAME("Stage","__onChange","Stage.__onChange","flash/display/Stage.hx",520)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(522)
		::flash::display::DisplayObject object = this->__findByID(event->__Field(HX_CSTRING("id"),true));		HX_STACK_VAR(object,"object");
...
Float Stage_obj::__nextFrameDue( Float otherTimers){
	HX_STACK_FRAME("Stage","__nextFrameDue","Stage.__nextFrameDue","flash/display/Stage.hx",496)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Stage","__drag","Stage.__drag","flash/display/Stage.hx",454)
		HX_STACK_THIS(this)
...
Dynamic Stage_obj::__processStageEvent( Dynamic event){
	HX_STACK_FRAME("Stage","__processStageEvent","Stage.__processStageEvent","flash/display/Stage.hx",446)
	HX_STACK_THIS(this)
	HX_STACK_ARG(event,"event")
	HX_STACK_LINE(448)
...
Float Stage_obj::__doProcessStageEvent( Dynamic event){
	HX_STACK_FRAME("Stage","__doProcessStageEvent","Stage.__doProcessStageEvent","flash/display/Stage.hx",292)
	HX_STACK_THIS(this)
	HX_STACK_ARG(event,"event")
	HX_STACK_LINE(294)
...
{
		HX_STACK_FRAME("Stage","__checkRender","Stage.__checkRender","flash/display/Stage.hx",258)
		HX_STACK_THIS(this)
		HX_STACK_LINE(258)
		if (((this->frameRate > (int)0))){
			HX_STACK_LINE(260)
...
bool Stage_obj::__checkInOuts( ::flash::events::MouseEvent event,Array< ::Dynamic > stack,::flash::display::TouchInfo touchInfo){
	HX_STACK_FRAME("Stage","__checkInOuts","Stage.__checkInOuts","flash/display/Stage.hx",186)
	HX_STACK_THIS(this)
	HX_STACK_ARG(event,"event")
...
{
		HX_STACK_FRAME("Stage","__checkFocusInOuts","Stage.__checkFocusInOuts","flash/display/Stage.hx",154)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_ARG(stack,"stack")
		HX_STACK_LINE(156)
...
{
		HX_STACK_FRAME("Stage","showCursor","Stage.showCursor","flash/display/Stage.hx",149)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Stage","invalidate","Stage.invalidate","flash/display/Stage.hx",127)
		HX_STACK_THIS(this)
		HX_STACK_LINE(127)
		this->__invalid = true;
	}
...
int run(){
	HX_STACK_FRAME("Stage","getOrientation","Stage.getOrientation","flash/display/Stage.hx",113)
	HX_STACK_LINE(113)
...
int run(){
	HX_STACK_FRAME("Stage","getNormalOrientation","Stage.getNormalOrientation","flash/display/Stage.hx",120)
	HX_STACK_LINE(120)
...
{
		HX_STACK_FRAME("Stage","setFixedOrientation","Stage.setFixedOrientation","flash/display/Stage.hx",135)
...
bool run(int orientation){
	HX_STACK_FRAME("Stage","shouldRotateInterface","Stage.shouldRotateInterface","flash/display/Stage.hx",142)
	HX_STACK_ARG(orientation,"orientation")
	HX_STACK_LINE(142)
