...
{
HX_STACK_FRAME("BitmapData","new","BitmapData.new","flash/display/BitmapData.hx",41)
...
bool BitmapData_obj::get_transparent( ){
	HX_STACK_FRAME("BitmapData","get_transparent","BitmapData.get_transparent","flash/display/BitmapData.hx",664)
	HX_STACK_THIS(this)
	HX_STACK_LINE(664)
...
int BitmapData_obj::get_height( ){
	HX_STACK_FRAME("BitmapData","get_height","BitmapData.get_height","flash/display/BitmapData.hx",663)
	HX_STACK_THIS(this)
	HX_STACK_LINE(663)
...
int BitmapData_obj::get_width( ){
	HX_STACK_FRAME("BitmapData","get_width","BitmapData.get_width","flash/display/BitmapData.hx",662)
	HX_STACK_THIS(this)
	HX_STACK_LINE(662)
...
::flash::geom::Rectangle BitmapData_obj::get_rect( ){
	HX_STACK_FRAME("BitmapData","get_rect","BitmapData.get_rect","flash/display/BitmapData.hx",661)
	HX_STACK_THIS(this)
	HX_STACK_LINE(661)
...
{
		HX_STACK_FRAME("BitmapData","__loadFromBytes","BitmapData.__loadFromBytes","flash/display/BitmapData.hx",595)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("BitmapData","__drawToSurface","BitmapData.__drawToSurface","flash/display/BitmapData.hx",581)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("BitmapData","unmultiplyAlpha","BitmapData.unmultiplyAlpha","flash/display/BitmapData.hx",574)
		HX_STACK_THIS(this)
		HX_STACK_LINE(574)
...
{
		HX_STACK_FRAME("BitmapData","unlock","BitmapData.unlock","flash/display/BitmapData.hx",565)
		HX_STACK_THIS(this)
...
bool copySource = __o_copySource.Default(false);
	HX_STACK_FRAME("BitmapData","threshold","BitmapData.threshold","flash/display/BitmapData.hx",416)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("BitmapData","setVector","BitmapData.setVector","flash/display/BitmapData.hx",392)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("BitmapData","setPixels","BitmapData.setPixels","flash/display/BitmapData.hx",382)
		HX_STACK_THIS(this)
		HX_STACK_ARG(rect,"rect")
		HX_STACK_ARG(pixels,"pixels")
		HX_STACK_LINE(384)
...
{
		HX_STACK_FRAME("BitmapData","setPixel32","BitmapData.setPixel32","flash/display/BitmapData.hx",377)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(color,"color")
...
{
		HX_STACK_FRAME("BitmapData","setPixel","BitmapData.setPixel","flash/display/BitmapData.hx",370)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(color,"color")
...
{
		HX_STACK_FRAME("BitmapData","setFormat","BitmapData.setFormat","flash/display/BitmapData.hx",363)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("BitmapData","setFlags","BitmapData.setFlags","flash/display/BitmapData.hx",356)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("BitmapData","scroll","BitmapData.scroll","flash/display/BitmapData.hx",348)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_LINE(348)
...
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_FRAME("BitmapData","perlinNoise","BitmapData.perlinNoise","flash/display/BitmapData.hx",331)
	HX_STACK_THIS(this)
...
int channelOptions = __o_channelOptions.Default(7);
bool grayScale = __o_grayScale.Default(false);
	HX_STACK_FRAME("BitmapData","noise","BitmapData.noise","flash/display/BitmapData.hx",326)
	HX_STACK_THIS(this)
	HX_STACK_ARG(randomSeed,"randomSeed")
...
{
		HX_STACK_FRAME("BitmapData","lock","BitmapData.lock","flash/display/BitmapData.hx",317)
		HX_STACK_THIS(this)
	}
return null();
}
...
Array< int > BitmapData_obj::getVector( ::flash::geom::Rectangle rect){
	HX_STACK_FRAME("BitmapData","getVector","BitmapData.getVector","flash/display/BitmapData.hx",271)
	HX_STACK_THIS(this)
	HX_STACK_ARG(rect,"rect")
	HX_STACK_LINE(273)
...
::flash::utils::ByteArray BitmapData_obj::getPixels( ::flash::geom::Rectangle rect){
	HX_STACK_FRAME("BitmapData","getPixels","BitmapData.getPixels","flash/display/BitmapData.hx",236)
	HX_STACK_THIS(this)
	HX_STACK_ARG(rect,"rect")
	HX_STACK_LINE(238)
...
int BitmapData_obj::getPixel32( int x,int y){
	HX_STACK_FRAME("BitmapData","getPixel32","BitmapData.getPixel32","flash/display/BitmapData.hx",231)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(231)
...
int BitmapData_obj::getPixel( int x,int y){
	HX_STACK_FRAME("BitmapData","getPixel","BitmapData.getPixel","flash/display/BitmapData.hx",224)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_LINE(224)
...
bool findColor = __o_findColor.Default(true);
	HX_STACK_FRAME("BitmapData","getColorBoundsRect","BitmapData.getColorBoundsRect","flash/display/BitmapData.hx",213)
	HX_STACK_THIS(this)
	HX_STACK_ARG(mask,"mask")
	HX_STACK_ARG(color,"color")
...
::flash::geom::Rectangle BitmapData_obj::generateFilterRect( ::flash::geom::Rectangle sourceRect,::flash::filters::BitmapFilter filter){
	HX_STACK_FRAME("BitmapData","generateFilterRect","BitmapData.generateFilterRect","flash/display/BitmapData.hx",204)
	HX_STACK_THIS(this)
	HX_STACK_ARG(sourceRect,"sourceRect")
...
{
		HX_STACK_FRAME("BitmapData","floodFill","BitmapData.floodFill","flash/display/BitmapData.hx",199)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_ARG(y,"y")
		HX_STACK_ARG(color,"color")
...
int alpha = __o_alpha.Default(255);
	HX_STACK_FRAME("BitmapData","fillRectEx","BitmapData.fillRectEx","flash/display/BitmapData.hx",192)
	HX_STACK_THIS(this)
	HX_STACK_ARG(rect,"rect")
	HX_STACK_ARG(color,"color")
...
{
		HX_STACK_FRAME("BitmapData","fillRect","BitmapData.fillRect","flash/display/BitmapData.hx",185)
		HX_STACK_THIS(this)
		HX_STACK_ARG(rect,"rect")
		HX_STACK_ARG(color,"color")
		HX_STACK_LINE(185)
...
Float quality = __o_quality.Default(0.9);
	HX_STACK_FRAME("BitmapData","encode","BitmapData.encode","flash/display/BitmapData.hx",164)
	HX_STACK_THIS(this)
	HX_STACK_ARG(format,"format")
...
{
		HX_STACK_FRAME("BitmapData","dumpBits","BitmapData.dumpBits","flash/display/BitmapData.hx",157)
		HX_STACK_THIS(this)
		HX_STACK_LINE(157)
...
bool smoothing = __o_smoothing.Default(false);
	HX_STACK_FRAME("BitmapData","draw","BitmapData.draw","flash/display/BitmapData.hx",150)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("BitmapData","dispose","BitmapData.dispose","flash/display/BitmapData.hx",135)
		HX_STACK_THIS(this)
		HX_STACK_LINE(137)
...
{
		HX_STACK_FRAME("BitmapData","destroyHardwareSurface","BitmapData.destroyHardwareSurface","flash/display/BitmapData.hx",129)
		HX_STACK_THIS(this)
		HX_STACK_LINE(129)
...
{
		HX_STACK_FRAME("BitmapData","createHardwareSurface","BitmapData.createHardwareSurface","flash/display/BitmapData.hx",122)
		HX_STACK_THIS(this)
		HX_STACK_LINE(122)
...
bool mergeAlpha = __o_mergeAlpha.Default(false);
	HX_STACK_FRAME("BitmapData","copyPixels","BitmapData.copyPixels","flash/display/BitmapData.hx",107)
	HX_STACK_THIS(this)
	HX_STACK_ARG(sourceBitmapData,"sourceBitmapData")
	HX_STACK_ARG(sourceRect,"sourceRect")
	HX_STACK_ARG(destPoint,"destPoint")
...
{
		HX_STACK_FRAME("BitmapData","copyChannel","BitmapData.copyChannel","flash/display/BitmapData.hx",100)
		HX_STACK_THIS(this)
		HX_STACK_ARG(sourceBitmapData,"sourceBitmapData")
		HX_STACK_ARG(sourceRect,"sourceRect")
		HX_STACK_ARG(destPoint,"destPoint")
...
{
		HX_STACK_FRAME("BitmapData","colorTransform","BitmapData.colorTransform","flash/display/BitmapData.hx",93)
		HX_STACK_THIS(this)
		HX_STACK_ARG(rect,"rect")
		HX_STACK_ARG(colorTransform,"colorTransform")
		HX_STACK_LINE(93)
...
::flash::display::BitmapData BitmapData_obj::clone( ){
	HX_STACK_FRAME("BitmapData","clone","BitmapData.clone","flash/display/BitmapData.hx",82)
	HX_STACK_THIS(this)
	HX_STACK_LINE(84)
...
{
		HX_STACK_FRAME("BitmapData","clear","BitmapData.clear","flash/display/BitmapData.hx",77)
		HX_STACK_THIS(this)
		HX_STACK_ARG(color,"color")
		HX_STACK_LINE(77)
...
{
		HX_STACK_FRAME("BitmapData","applyFilter","BitmapData.applyFilter","flash/display/BitmapData.hx",70)
		HX_STACK_THIS(this)
		HX_STACK_ARG(sourceBitmapData,"sourceBitmapData")
		HX_STACK_ARG(sourceRect,"sourceRect")
		HX_STACK_ARG(destPoint,"destPoint")
...
int alpha = __o_alpha.Default(255);
	HX_STACK_FRAME("BitmapData","createColor","BitmapData.createColor","flash/display/BitmapData.hx",114)
...
int BitmapData_obj::extractAlpha( int argb){
	HX_STACK_FRAME("BitmapData","extractAlpha","BitmapData.extractAlpha","flash/display/BitmapData.hx",171)
...
int BitmapData_obj::extractColor( int argb){
	HX_STACK_FRAME("BitmapData","extractColor","BitmapData.extractColor","flash/display/BitmapData.hx",178)
	HX_STACK_ARG(argb,"argb")
	HX_STACK_LINE(178)
...
::flash::utils::ByteArray BitmapData_obj::getRGBAPixels( ::flash::display::BitmapData bitmapData){
	HX_STACK_FRAME("BitmapData","getRGBAPixels","BitmapData.getRGBAPixels","flash/display/BitmapData.hx",245)
...
int format = __o_format.Default(0);
	HX_STACK_FRAME("BitmapData","load","BitmapData.load","flash/display/BitmapData.hx",292)
...
::flash::display::BitmapData BitmapData_obj::loadFromBytes( ::flash::utils::ByteArray bytes,::flash::utils::ByteArray rawAlpha){
	HX_STACK_FRAME("BitmapData","loadFromBytes","BitmapData.loadFromBytes","flash/display/BitmapData.hx",301)
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_ARG(rawAlpha,"rawAlpha")
	HX_STACK_LINE(303)
...
::flash::display::BitmapData BitmapData_obj::loadFromHaxeBytes( ::haxe::io::Bytes bytes,::haxe::io::Bytes rawAlpha){
	HX_STACK_FRAME("BitmapData","loadFromHaxeBytes","BitmapData.loadFromHaxeBytes","flash/display/BitmapData.hx",312)
	HX_STACK_ARG(bytes,"bytes")
	HX_STACK_ARG(rawAlpha,"rawAlpha")
	HX_STACK_LINE(312)
...
bool BitmapData_obj::sameValue( int a,int b){
	HX_STACK_FRAME("BitmapData","sameValue","BitmapData.sameValue","flash/display/BitmapData.hx",341)
	HX_STACK_ARG(a,"a")
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(341)
	return (a == b);
...
int BitmapData_obj::__flipPixel( int pixel){
	HX_STACK_FRAME("BitmapData","__flipPixel","BitmapData.__flipPixel","flash/display/BitmapData.hx",588)
...
int BitmapData_obj::__ucompare( int n1,int n2){
	HX_STACK_FRAME("BitmapData","__ucompare","BitmapData.__ucompare","flash/display/BitmapData.hx",600)
	HX_STACK_ARG(n1,"n1")
	HX_STACK_ARG(n2,"n2")
	HX_STACK_LINE(602)
