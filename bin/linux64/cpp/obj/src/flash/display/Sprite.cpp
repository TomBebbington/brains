...
{
HX_STACK_FRAME("Sprite","new","Sprite.new","flash/display/Sprite.hx",16)
{
	HX_STACK_LINE(16)
...
::String Sprite_obj::__getType( ){
	HX_STACK_FRAME("Sprite","__getType","Sprite.__getType","flash/display/Sprite.hx",43)
	HX_STACK_THIS(this)
	HX_STACK_LINE(45)
...
{
		HX_STACK_FRAME("Sprite","stopDrag","Sprite.stopDrag","flash/display/Sprite.hx",34)
		HX_STACK_THIS(this)
		HX_STACK_LINE(34)
...
bool lockCenter = __o_lockCenter.Default(false);
	HX_STACK_FRAME("Sprite","startDrag","Sprite.startDrag","flash/display/Sprite.hx",23)
	HX_STACK_THIS(this)
