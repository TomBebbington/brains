...
{
HX_STACK_FRAME("LoaderInfo","new","LoaderInfo.new","flash/display/LoaderInfo.hx",35)
{
	HX_STACK_LINE(37)
...
::flash::utils::ByteArray LoaderInfo_obj::get_bytes( ){
	HX_STACK_FRAME("LoaderInfo","get_bytes","LoaderInfo.get_bytes","flash/display/LoaderInfo.hx",112)
	HX_STACK_THIS(this)
	HX_STACK_LINE(112)
	return this->data;
}
...
{
		HX_STACK_FRAME("LoaderInfo","this_onComplete","LoaderInfo.this_onComplete","flash/display/LoaderInfo.hx",98)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("LoaderInfo","load","LoaderInfo.load","flash/display/LoaderInfo.hx",65)
		HX_STACK_THIS(this)
...
::flash::display::LoaderInfo LoaderInfo_obj::create( ::flash::display::Loader loader){
	HX_STACK_FRAME("LoaderInfo","create","LoaderInfo.create","flash/display/LoaderInfo.hx",49)
