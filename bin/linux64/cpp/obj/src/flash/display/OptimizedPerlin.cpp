...
{
HX_STACK_FRAME("OptimizedPerlin","new","OptimizedPerlin.new","flash/display/BitmapData.hx",792)

HX_STACK_ARG(__o_seed,"seed")

HX_STACK_ARG(__o_octaves,"octaves")
...
{
		HX_STACK_FRAME("OptimizedPerlin","seedOffset","OptimizedPerlin.seedOffset","flash/display/BitmapData.hx",938)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("OptimizedPerlin","octFreqPers","OptimizedPerlin.octFreqPers","flash/display/BitmapData.hx",915)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("OptimizedPerlin","fill","OptimizedPerlin.fill","flash/display/BitmapData.hx",801)
		HX_STACK_THIS(this)
							...
							while(((_g2 < octaves))){
								...
								struct _Function_7_1{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_FRAME("*","closure","*.closure","flash/display/BitmapData.hx",864)
										{
											HX_STACK_LINE(864)
								...
								struct _Function_7_3{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_FRAME("*","closure","*.closure","flash/display/BitmapData.hx",867)
										{
											HX_STACK_LINE(867)
								...
								struct _Function_7_5{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_FRAME("*","closure","*.closure","flash/display/BitmapData.hx",870)
										{
											HX_STACK_LINE(870)
								...
								struct _Function_7_7{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_FRAME("*","closure","*.closure","flash/display/BitmapData.hx",873)
										{
											HX_STACK_LINE(873)
								...
								struct _Function_7_9{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_FRAME("*","closure","*.closure","flash/display/BitmapData.hx",876)
										{
											HX_STACK_LINE(876)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y1) );
										}
								...
								struct _Function_7_11{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_FRAME("*","closure","*.closure","flash/display/BitmapData.hx",879)
										{
											HX_STACK_LINE(879)
											return (  (((hash < (int)8))) ? Float(x) : Float(y1) );
										}
								...
								struct _Function_7_13{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_FRAME("*","closure","*.closure","flash/display/BitmapData.hx",882)
										{
											HX_STACK_LINE(882)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y) );
										}
								...
								struct _Function_7_15{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_FRAME("*","closure","*.closure","flash/display/BitmapData.hx",885)
										{
											HX_STACK_LINE(885)
											return (  (((hash < (int)8))) ? Float(x) : Float(y) );
										}
