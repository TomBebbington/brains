...
{
HX_STACK_FRAME("MovieClip","new","MovieClip.new","flash/display/MovieClip.hx",16)
{
	HX_STACK_LINE(18)
	super::__construct();
	HX_STACK_LINE(20)
...
int MovieClip_obj::get_totalFrames( ){
	HX_STACK_FRAME("MovieClip","get_totalFrames","MovieClip.get_totalFrames","flash/display/MovieClip.hx",84)
	HX_STACK_THIS(this)
	HX_STACK_LINE(84)
...
int MovieClip_obj::get_framesLoaded( ){
	HX_STACK_FRAME("MovieClip","get_framesLoaded","MovieClip.get_framesLoaded","flash/display/MovieClip.hx",83)
	HX_STACK_THIS(this)
	HX_STACK_LINE(83)
	return this->__totalFrames;
}
...
int MovieClip_obj::get_currentFrame( ){
	HX_STACK_FRAME("MovieClip","get_currentFrame","MovieClip.get_currentFrame","flash/display/MovieClip.hx",82)
	HX_STACK_THIS(this)
	HX_STACK_LINE(82)
...
{
		HX_STACK_FRAME("MovieClip","stop","MovieClip.stop","flash/display/MovieClip.hx",68)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("MovieClip","prevFrame","MovieClip.prevFrame","flash/display/MovieClip.hx",61)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("MovieClip","play","MovieClip.play","flash/display/MovieClip.hx",54)
		HX_STACK_THIS(this)
	}
return null();
}
...
::String MovieClip_obj::__getType( ){
	HX_STACK_FRAME("MovieClip","__getType","MovieClip.__getType","flash/display/MovieClip.hx",49)
	HX_STACK_THIS(this)
	HX_STACK_LINE(49)
...
{
		HX_STACK_FRAME("MovieClip","nextFrame","MovieClip.nextFrame","flash/display/MovieClip.hx",40)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("MovieClip","gotoAndStop","MovieClip.gotoAndStop","flash/display/MovieClip.hx",33)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("MovieClip","gotoAndPlay","MovieClip.gotoAndPlay","flash/display/MovieClip.hx",26)
		HX_STACK_THIS(this)
		HX_STACK_ARG(frame,"frame")
		HX_STACK_ARG(scene,"scene")
	}
