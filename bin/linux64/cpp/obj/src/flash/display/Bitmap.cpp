...
{
HX_STACK_FRAME("Bitmap","new","Bitmap.new","flash/display/Bitmap.hx",15)
...
bool Bitmap_obj::set_smoothing( bool value){
	HX_STACK_FRAME("Bitmap","set_smoothing","Bitmap.set_smoothing","flash/display/Bitmap.hx",72)
	HX_STACK_THIS(this)
...
::flash::display::BitmapData Bitmap_obj::set_bitmapData( ::flash::display::BitmapData value){
	HX_STACK_FRAME("Bitmap","set_bitmapData","Bitmap.set_bitmapData","flash/display/Bitmap.hx",62)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(64)
...
{
		HX_STACK_FRAME("Bitmap","__rebuild","Bitmap.__rebuild","flash/display/Bitmap.hx",37)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
