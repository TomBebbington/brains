...
{
HX_STACK_FRAME("InteractiveObject","new","InteractiveObject.new","flash/display/InteractiveObject.hx",18)
...
bool InteractiveObject_obj::get_needsSoftKeyboard( ){
	HX_STACK_FRAME("InteractiveObject","get_needsSoftKeyboard","InteractiveObject.get_needsSoftKeyboard","flash/display/InteractiveObject.hx",84)
	HX_STACK_THIS(this)
	HX_STACK_LINE(84)
...
bool InteractiveObject_obj::set_needsSoftKeyboard( bool value){
	HX_STACK_FRAME("InteractiveObject","set_needsSoftKeyboard","InteractiveObject.set_needsSoftKeyboard","flash/display/InteractiveObject.hx",74)
	HX_STACK_THIS(this)
...
bool InteractiveObject_obj::get_moveForSoftKeyboard( ){
	HX_STACK_FRAME("InteractiveObject","get_moveForSoftKeyboard","InteractiveObject.get_moveForSoftKeyboard","flash/display/InteractiveObject.hx",69)
	HX_STACK_THIS(this)
	HX_STACK_LINE(69)
...
bool InteractiveObject_obj::set_moveForSoftKeyboard( bool value){
	HX_STACK_FRAME("InteractiveObject","set_moveForSoftKeyboard","InteractiveObject.set_moveForSoftKeyboard","flash/display/InteractiveObject.hx",59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(61)
...
bool InteractiveObject_obj::set_mouseEnabled( bool value){
	HX_STACK_FRAME("InteractiveObject","set_mouseEnabled","InteractiveObject.set_mouseEnabled","flash/display/InteractiveObject.hx",50)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(52)
...
bool InteractiveObject_obj::get_mouseEnabled( ){
	HX_STACK_FRAME("InteractiveObject","get_mouseEnabled","InteractiveObject.get_mouseEnabled","flash/display/InteractiveObject.hx",49)
	HX_STACK_THIS(this)
	HX_STACK_LINE(49)
	return this->__mouseEnabled;
}
...
::flash::display::InteractiveObject InteractiveObject_obj::__asInteractiveObject( ){
	HX_STACK_FRAME("InteractiveObject","__asInteractiveObject","InteractiveObject.__asInteractiveObject","flash/display/InteractiveObject.hx",37)
	HX_STACK_THIS(this)
	HX_STACK_LINE(37)
...
bool InteractiveObject_obj::requestSoftKeyboard( ){
	HX_STACK_FRAME("InteractiveObject","requestSoftKeyboard","InteractiveObject.requestSoftKeyboard","flash/display/InteractiveObject.hx",30)
	HX_STACK_THIS(this)
	HX_STACK_LINE(30)
