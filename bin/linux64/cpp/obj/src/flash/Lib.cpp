...
Dynamic Lib_obj::as( Dynamic v,::Class c){
	HX_STACK_FRAME("Lib","as","Lib.as","flash/Lib.hx",48)
	HX_STACK_ARG(v,"v")
	HX_STACK_ARG(c,"c")
	HX_STACK_LINE(48)
	return v;
...
::flash::display::MovieClip Lib_obj::attach( ::String name){
	HX_STACK_FRAME("Lib","attach","Lib.attach","flash/Lib.hx",55)
...
Void Lib_obj::close( ){
{
		HX_STACK_FRAME("Lib","close","Lib.close","flash/Lib.hx",60)
		HX_STACK_LINE(62)
...
::String title = __o_title.Default(HX_CSTRING("OpenFL"));
	HX_STACK_FRAME("Lib","create","Lib.create","flash/Lib.hx",68)
	...
	HX_STACK_ARG(stageClass,"stageClass")
{
		...
		Void run(Dynamic frameHandle){
			HX_STACK_FRAME("*","_Function_1_1","*._Function_1_1","flash/Lib.hx",89)
...
int flags = __o_flags.Default(0);
	HX_STACK_FRAME("Lib","createManagedStage","Lib.createManagedStage","flash/Lib.hx",114)
	HX_STACK_ARG(width,"width")
	HX_STACK_ARG(height,"height")
	HX_STACK_ARG(flags,"flags")
{
...
::String Lib_obj::findHaxeLib( ::String library){
	HX_STACK_FRAME("Lib","findHaxeLib","Lib.findHaxeLib","flash/Lib.hx",127)
...
int args = __o_args.Default(0);
	HX_STACK_FRAME("Lib","load","Lib.load","flash/Lib.hx",168)
	HX_STACK_ARG(library,"library")
	...
	HX_STACK_ARG(args,"args")
{
		...
		if (((result == null()))){
			...
			HX_STACK_LINE(211)
			if (((::flash::Lib_obj::sysName().substr((int)7,null()).toLowerCase() == HX_CSTRING("windows")))){
				HX_STACK_LINE(211)
				slash = HX_CSTRING("\\");
			}
			else{
...
{
		HX_STACK_FRAME("Lib","loaderTrace","Lib.loaderTrace","flash/Lib.hx",243)
...
::String Lib_obj::sysName( ){
	HX_STACK_FRAME("Lib","sysName","Lib.sysName","flash/Lib.hx",261)
	HX_STACK_LINE(264)
...
Dynamic Lib_obj::tryLoad( ::String name,::String library,::String func,int args){
	HX_STACK_FRAME("Lib","tryLoad","Lib.tryLoad","flash/Lib.hx",273)
	HX_STACK_ARG(name,"name")
	HX_STACK_ARG(library,"library")
...
Void Lib_obj::exit( ){
{
		HX_STACK_FRAME("Lib","exit","Lib.exit","flash/Lib.hx",326)
		HX_STACK_LINE(328)
...
{
		HX_STACK_FRAME("Lib","forceClose","Lib.forceClose","flash/Lib.hx",347)
		HX_STACK_LINE(349)
...
int Lib_obj::getTimer( ){
	HX_STACK_FRAME("Lib","getTimer","Lib.getTimer","flash/Lib.hx",357)
	HX_STACK_LINE(357)
...
{
		HX_STACK_FRAME("Lib","getURL","Lib.getURL","flash/Lib.hx",364)
...
Void Lib_obj::pause( ){
{
		HX_STACK_FRAME("Lib","pause","Lib.pause","flash/Lib.hx",371)
		HX_STACK_LINE(371)
...
{
		HX_STACK_FRAME("Lib","postUICallback","Lib.postUICallback","flash/Lib.hx",381)
...
Void Lib_obj::resume( ){
{
		HX_STACK_FRAME("Lib","resume","Lib.resume","flash/Lib.hx",389)
		HX_STACK_LINE(389)
...
{
		HX_STACK_FRAME("Lib","setIcon","Lib.setIcon","flash/Lib.hx",394)
...
{
		HX_STACK_FRAME("Lib","setPackage","Lib.setPackage","flash/Lib.hx",402)
...
{
		HX_STACK_FRAME("Lib","__setCurrentStage","Lib.__setCurrentStage","flash/Lib.hx",416)
...
{
		HX_STACK_FRAME("Lib","trace","Lib.trace","flash/Lib.hx",423)
...
::flash::display::MovieClip Lib_obj::get_current( ){
	HX_STACK_FRAME("Lib","get_current","Lib.get_current","flash/Lib.hx",435)
	HX_STACK_LINE(437)
	if (((::flash::Lib_obj::__current == null()))){
		HX_STACK_LINE(439)
...
::flash::display::Stage Lib_obj::get_stage( ){
	HX_STACK_FRAME("Lib","get_stage","Lib.get_stage","flash/Lib.hx",454)
	HX_STACK_LINE(456)
	if (((::flash::Lib_obj::__stage == null()))){
		HX_STACK_LINE(458)
