...
{
HX_STACK_FRAME("Process","new","Process.new","sys/io/Process.hx",100)
...
HX_STACK_ARG(args,"args")
{
	...
	{
		HX_STACK_LINE(101)
		this->p = ::sys::io::Process_obj::_run(cmd,args);
	}
	}
	catch(Dynamic __e){
		{
...
{
		HX_STACK_FRAME("Process","close","Process.close","sys/io/Process.hx",116)
		HX_STACK_THIS(this)
		HX_STACK_LINE(116)
