...
{
HX_STACK_FRAME("Stdout","new","Stdout.new","sys/io/Process.hx",64)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
	HX_STACK_FRAME("Stdout","readBytes","Stdout.readBytes","sys/io/Process.hx",76)
	HX_STACK_THIS(this)
...
int Stdout_obj::readByte( ){
	HX_STACK_FRAME("Stdout","readByte","Stdout.readByte","sys/io/Process.hx",70)
	HX_STACK_THIS(this)
	HX_STACK_LINE(71)
