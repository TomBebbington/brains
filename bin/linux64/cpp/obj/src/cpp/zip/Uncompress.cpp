...
{
HX_STACK_FRAME("Uncompress","new","Uncompress.new","cpp/zip/Uncompress.hx",28)
...
{
		HX_STACK_FRAME("Uncompress","close","Uncompress.close","cpp/zip/Uncompress.hx",40)
		HX_STACK_THIS(this)
		HX_STACK_LINE(40)
...
{
		HX_STACK_FRAME("Uncompress","setFlushMode","Uncompress.setFlushMode","cpp/zip/Uncompress.hx",36)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(36)
...
Dynamic Uncompress_obj::this_run( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("Uncompress","this_run","Uncompress.this_run","cpp/zip/Uncompress.hx",32)
	HX_STACK_THIS(this)
...
::haxe::io::Bytes Uncompress_obj::run( ::haxe::io::Bytes src,Dynamic bufsize){
	HX_STACK_FRAME("Uncompress","run","Uncompress.run","cpp/zip/Uncompress.hx",43)
	HX_STACK_ARG(src,"src")
