...
{
HX_STACK_FRAME("Compress","new","Compress.new","cpp/zip/Compress.hx",29)
...
{
		HX_STACK_FRAME("Compress","close","Compress.close","cpp/zip/Compress.hx",41)
		HX_STACK_THIS(this)
		HX_STACK_LINE(41)
...
{
		HX_STACK_FRAME("Compress","setFlushMode","Compress.setFlushMode","cpp/zip/Compress.hx",37)
		HX_STACK_THIS(this)
		HX_STACK_ARG(f,"f")
		HX_STACK_LINE(37)
...
Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("Compress","execute","Compress.execute","cpp/zip/Compress.hx",33)
	HX_STACK_THIS(this)
...
::haxe::io::Bytes Compress_obj::run( ::haxe::io::Bytes s,int level){
	HX_STACK_FRAME("Compress","run","Compress.run","cpp/zip/Compress.hx",44)
	HX_STACK_ARG(s,"s")
	HX_STACK_ARG(level,"level")
	HX_STACK_LINE(45)
